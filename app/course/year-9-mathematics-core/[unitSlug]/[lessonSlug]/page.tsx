...
export async function generateMetadata({
  ...
  return buildCourseLessonMetadata("year-9-mathematics-core", unitSlug, lessonSlug);
}

export default async function Year9MathematicsCoreLessonPage({
  params,
}: {
  params: Promise<{ unitSlug: string; lessonSlug: string }>;
}) {
  ...
  return (
    <NewCourseLessonPage
      courseSlug="year-9-mathematics-core"
      unitSlug={unitSlug}
