...
} from "../../../lib/lessons/financialMathematics";
...
export default function FinancialMathematicsModulePage() {
  const activeCount = financialMathematicsLessons.length;
  const plannedCount = financialMathematicsOutline.length;
      ...
      <section className="mx-auto max-w-5xl space-y-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
          ...
          <section className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <div className="mt-6">
              {financialMathematicsOutline.map((lesson, index) => {
                const isActive = lesson.status === "active";
                const isLast = index === financialMathematicsOutline.length - 1;
                const content = (
                  <div
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`${isLast ? "" : "pb-5"}`}>
                      {isActive ? (
                        <Link
                          href={`/course/financial-mathematics/${lesson.slug}`}
                          className="block"
                        >
                          {content}
                        </Link>
