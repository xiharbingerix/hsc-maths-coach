...
} from "../../../lib/lessons/furtherIntegralCalculus";
...
export default function FurtherIntegralCalculusModulePage() {
  const activeCount = furtherIntegralCalculusLessons.length;
  const plannedCount = furtherIntegralCalculusOutline.length;
      ...
      <section className="mx-auto max-w-5xl space-y-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
          ...
          <section className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <div className="mt-6">
              {furtherIntegralCalculusOutline.map((lesson, index) => {
                const isActive = lesson.status === "active";
                const isLast =
                  index === furtherIntegralCalculusOutline.length - 1;
                const content = (
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`${isLast ? "" : "pb-5"}`}>
                      {isActive ? (
                        <Link
                          href={`/course/further-integral-calculus/${lesson.slug}`}
                          className="block"
                        >
                          {content}
                        </Link>
