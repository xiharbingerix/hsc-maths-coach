...
} from "../../../lib/lessons/functionsGraphingTechniques";
...
export default function FunctionsGraphingTechniquesModulePage() {
  const activeCount = functionsGraphingTechniquesLessons.length;
  const plannedCount = functionsGraphingTechniquesOutline.length;
      ...
      <section className="mx-auto max-w-5xl space-y-8">
        <header className="rounded-2xl bg-white p-6 shadow-sm md:p-8">
          ...
          <p className="mt-4 max-w-3xl text-slate-600">
            ...
            absolute value functions, inverse functions, graphical solving, and
            modelling skills for Year 12 Mathematics Advanced.
          </p>
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
          <div className="space-y-6">
            <section className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <ul className="mt-4 space-y-3 text-slate-700">
                <li>Start with domain, range, and function notation.</li>
                <li>Use mastery quizzes to check whether each skill is secure.</li>
                <li>If you miss the pass mark, work through the full staged lesson.</li>
                <li>Return to graphing basics before tackling transformations or modelling questions.</li>
              </ul>
            </section>
          ...
          <section className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <div className="mt-6">
              {functionsGraphingTechniquesOutline.map((lesson, index) => {
                const isActive = lesson.status === "active";
                const isLast =
                  index === functionsGraphingTechniquesOutline.length - 1;
                const content = (
                  <div
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`${isLast ? "" : "pb-5"}`}>
                      {isActive ? (
                        <Link
                          href={`/course/functions-graphing-techniques/${lesson.slug}`}
                          className="block"
                        >
                          {content}
                        </Link>
