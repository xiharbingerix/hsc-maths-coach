...
} from "../../../lib/lessons/exponentialLogarithmicFunctions";
...
const unitCoverage = [
  ...
  "Domain restrictions",
  "Continuous growth and decay modelling",
  "Half-life and doubling time",
];

export default function ExponentialLogarithmicFunctionsModulePage() {
  const activeCount = exponentialLogarithmicFunctionsLessons.length;
  const plannedCount = exponentialLogarithmicFunctionsOutline.length;
      ...
      <section className="mx-auto max-w-5xl space-y-8">
        <header className="rounded-2xl bg-white p-6 shadow-sm md:p-8">
          ...
          <p className="mt-4 max-w-3xl text-slate-600">
            A HSC-focused unit for logarithm laws, change of base, Euler's
            number, natural logarithms, equations with e and ln, and continuous
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
          <div className="space-y-6">
            <section className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <ul className="mt-4 space-y-3 text-slate-700">
                <li>Check domains before simplifying or solving logarithms.</li>
                <li>Use multiple-choice exact forms to compare symbolic answers.</li>
                <li>Isolate exponential terms before applying natural logarithms.</li>
                <li>Finish with the mixed exam practice lesson.</li>
              </ul>
            </section>
          ...
          <section className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <div className="mt-6">
              {exponentialLogarithmicFunctionsOutline.map((lesson, index) => {
                const isLast =
                  index === exponentialLogarithmicFunctionsOutline.length - 1;
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`${isLast ? "" : "pb-5"}`}>
                      <Link
                        href={`/course/exponential-logarithmic-functions/${lesson.slug}`}
                        className="block"
                      >
