# Year 12 Standard 1 Course Status
...
2. Add Standard 1-specific statistics and data analysis content.
3. Expand the pathway unit-by-unit and mark units active as lessons are implemented.
4. Review overlap with Standard 2 to ensure shared lessons remain appropriate for both courses.
