...
- ✅ calculus-applications — complete (registered). All 7 skill subtopics at 10 D4
  + 10 D5 each (Related Rates; Exponential Growth and Decay; Simple Harmonic
  Motion; Areas Between Curves and Volumes of Revolution; Multiplicity of Zeroes
...
- ✅ binomial-distribution — complete (registered). All 5 skill subtopics at 10 D4
...
- 🟡 vectors — subtopics 1–2 done (Vectors, Scalars and Notation; Vector Addition
  and Subtraction — 10 D4 + 10 D5 each);
  subtopics 3–7 pending (The Dot Product; Vector
  ...
  lesson in this unit; D6 placement TBD (inverse-trig precedent: attach to a
  skill subtopic).
