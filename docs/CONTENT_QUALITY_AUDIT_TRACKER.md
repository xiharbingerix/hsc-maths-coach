...
| Year 11 Advanced | Yes | in_progress | Whole-course question-quality audit complete 2026-07-30; the current build has 126 seeded lessons / 2,452 rows and the final verdict remains FAIL. Graph Transformations, Trigonometry and Measure of Angles, Trigonometric Identities and Equations, Exponential and Logarithmic Functions, Integration, Introduction to Differentiation, Exponential and Logarithmic Calculus, Trigonometric Calculus, Working with Functions, Curve Sketching, Sequences and Series, Probability and Data, Motion and Rates, Series and Finance, and Graphs and Equations are complete and seeded LIVE. The latest completed unit has 95 standard questions, 30 D4-D5 mastery tasks, zero shallow explanations, exact repeats, or scoped source-audit findings, and 95 active live rows with no stale or retired mastery IDs. The current course distribution is D1 210 / D2 726 / D3 804 / D4 355 / D5 356 / D6 1. See `docs/audits/year-11-advanced-question-quality-audit.md`. |
...
and Series complete; Probability and Data complete; Motion and Rates complete;
Series and Finance complete; Graphs and Equations complete)
...
- [ ] P1 — rebuild every mastery set to the required cognitive mix and 10-question
  ...
  - [x] Curve Sketching — complete:
        `stationary-points`, `classifying-stationary-points`,
        `concavity-inflection`, `systematic-curve-sketching`,
        `reading-derivative-graphs`, `optimisation`, and
        `curve-sketching-exam-practice` (7/7 subtopics).
    - Expanded the unit from 119 to 133 standard questions so every lesson now
      has 4 guided + 5 independent + 10 mastery.
    - All 70 new mastery tasks use a per-lesson 4 D3 / 3 D4 / 3 D5 ramp,
      exactly three diagnostic MCQs, seven constructed responses, all five task
      classifications, diagnostic intent, and per-distractor misconception
      mappings.
    - Mastery now spans derivative multiplicity, parameter families,
      polynomial reconstruction, inconclusive classification tests, concavity
      transitions, complete sketch synthesis, derivative-graph interpretation,
      constrained design, global extrema, and symbolic optimisation.
    - Added ten authored Cartesian graphs and two labelled cylinder diagrams;
      strengthened all retained constructed-response feedback and variants; and
      corrected three inherited optimisation, evaluation, and classification
      defects before publication.
    - Seeded LIVE on 2026-07-31: 147 active unit rows, all 70 new mastery IDs,
      28 D3 / 21 D4 / 21 D5 across mastery, 56 historical rows inactive,
      zero active retired mastery IDs, and zero stale unit rows.
    - Completed-unit gate: zero shallow explanations, zero exact cross-subtopic
      repeats, zero deterministic scoped source-audit findings, complete
  ...
  - [x] Probability and Data — complete:
        `data-displays-summary-statistics`,
        `probability-relative-frequency`, `sets-venn-diagrams`,
        `conditional-probability-independence`,
        `discrete-random-variables`,
        `expected-value-standard-deviation`, and
        `probability-data-exam-practice` (7/7 subtopics).
    - All 133 standard questions retain 4 guided + 5 independent + 10 mastery.
    - All 70 new mastery tasks use a per-lesson 4 D3 / 3 D4 / 3 D5 ramp,
      exactly three diagnostic MCQs, seven constructed responses, all five task
      classifications, diagnostic intent, and per-distractor misconception
      mappings.
    - Mastery now spans robust statistic selection, outlier boundaries,
      summary reconstruction, probability bounds, Venn feasibility, conditional
      reversal, independence, parameterised distributions, game design, and
      cross-representation expectation and variance synthesis.
    - Added sixteen authored mastery visuals across box plots, frequency tables,
      two-way tables, and Venn diagrams; retained all sound existing visual
      stimuli and completed constructed-answer variants.
    - Seeded LIVE on 2026-07-31: 140 active unit rows, all 70 new mastery IDs,
      28 D3 / 21 D4 / 21 D5 across mastery, 285 historical rows inactive,
      zero active retired mastery IDs, and zero stale unit rows.
    - Completed-unit gate: zero shallow explanations, zero exact cross-subtopic
      repeats, zero deterministic scoped source-audit findings, complete
      constructed-answer variants, authored difficulty persistence, 356/356
      repository tests passing, mastery selector, TypeScript and lint passing,
      326 course visual rows, and zero required visuals missing.
  - [x] Motion and Rates — complete:
        `displacement-velocity-acceleration`,
        `finding-displacement-by-integration`, `motion-analysis`,
        `rates-of-change-applications`, and
        `motion-rates-exam-practice` (5/5 subtopics).
    - All 95 standard questions retain 4 guided + 5 independent + 10 mastery.
    - All 50 new mastery tasks use a per-lesson 4 D3 / 3 D4 / 3 D5 ramp,
      exactly three diagnostic MCQs, seven constructed responses, all five task
      classifications, diagnostic intent, and per-distractor misconception
      mappings.
    - Mastery now spans derivative-chain interpretation, reverse motion
      reconstruction, repeated-root analysis, parameter investigations,
      displacement-versus-distance proofs, piecewise velocity graphs, related
      rates, exponential models, and synoptic kinematics synthesis.
    - Added five authored velocity graphs; strengthened every retained
      constructed-response explanation and variant; and corrected six inherited
      ambiguity, answer-key, boundary, duplicate-choice, and wording defects.
    - Seeded LIVE on 2026-07-31: 95 active unit rows, all 50 new mastery IDs,
      20 D3 / 15 D4 / 15 D5 across mastery, 51 historical rows inactive,
      zero active retired mastery IDs, and zero stale unit rows.
    - Completed-unit gate: zero shallow explanations, zero exact cross-subtopic
      repeats, zero deterministic scoped source-audit findings, complete
      constructed-answer variants, authored difficulty persistence, 360/360
      repository tests passing, mastery selector, TypeScript and targeted lint
      passing, 331 course visual rows, and zero required visuals missing.
- [x] Series and Finance — complete:
      `compound-interest`, `recursive-formulas-financial`,
      `superannuation-future-value`, `loan-repayments-present-value`, and
      `series-finance-exam-practice` (5/5 subtopics).
  - All 95 standard questions retain 4 guided + 5 independent + 10 mastery.
  - All 50 new mastery tasks use a per-lesson 4 D3 / 3 D4 / 3 D5 ramp,
    exactly three diagnostic MCQs, seven constructed responses, all five task
    classifications, diagnostic intent, and per-distractor misconception
    mappings.
  - Mastery now spans timing-sensitive cash flows, reverse rate and principal
    recovery, recurrence fixed points, annuity derivations, amortisation-table
    interpretation, strategy comparison, negative amortisation, and
    present-value/future-value synthesis.
  - Added four authored financial data tables; strengthened all retained
    constructed-response feedback and variants; and corrected 20 inherited
    numerical, timing, modelling, wording, and answer-completeness defects.
  - Seeded LIVE on 2026-07-31: 95 active unit rows, all 50 new mastery IDs,
    20 D3 / 15 D4 / 15 D5 across mastery, 51 historical rows inactive,
    zero active retired mastery IDs, and zero stale unit rows.
  - Completed-unit gate: zero shallow explanations, zero exact cross-subtopic
    repeats, zero deterministic scoped source-audit findings, complete
    constructed-answer variants, authored difficulty persistence, 364/364
    repository tests passing, mastery selector, TypeScript and targeted lint
    passing, 335 course visual rows, and zero required visuals missing.
- [x] Graphs and Equations — complete:
      `factor-remainder-theorem`, `sum-product-of-roots`,
      `graphing-polynomials`, `simultaneous-equations-nonlinear`, and
      `graphs-equations-exam-practice` (5/5 subtopics).
  - All 95 standard questions retain 4 guided + 5 independent + 10 mastery.
  - All 50 new mastery tasks use a per-lesson 4 D3 / 3 D4 / 3 D5 ramp,
    exactly three diagnostic MCQs, seven constructed responses, all five task
    classifications, diagnostic intent, and per-distractor misconception
    mappings.
  - Mastery now spans polynomial and remainder reconstruction, repeated-root
    parameter families, transformed roots, multiplicity and sign analysis,
    curve-to-factor inference, tangency classification, and nonlinear-system
    synthesis.
  - Added six authored Cartesian graph stimuli and retained five sound visual
    questions; corrected nine active retained answer/choice defects and seven
    additional broken retired-source keys or explanations.
  - Seeded LIVE on 2026-07-31: 95 active unit rows, all 50 new mastery IDs,
    20 D3 / 15 D4 / 15 D5 across mastery, 40 historical rows inactive,
    zero active retired mastery IDs, and zero stale unit rows.
  - Completed-unit gate: zero shallow explanations, zero exact cross-subtopic
    repeats, zero deterministic scoped source-audit findings, complete
    constructed-answer variants, authored difficulty persistence, 368/368
    repository tests passing, mastery selector, TypeScript and targeted lint
    passing, 339 course visual rows, and zero required visuals missing.
