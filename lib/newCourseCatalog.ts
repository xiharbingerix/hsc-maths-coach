...
import { year9Wave1ValidationLessonOverride, year9Chapter1NumberLessonOverride, year9Chapter1PercentagesLessonOverride, year9Chapter1FinanceLessonOverride, year9Chapter2ExpressionsLessonOverride, year9Chapter2EquationsLessonOverride, year9Chapter2SimultaneousLessonOverride, year9Chapter3PythagorasLessonOverride, year9Chapter3TrigRatiosLessonOverride, year9Chapter3TrigApplicationsLessonOverride, year9Chapter4GraphingLessonOverride, year9Chapter4EquationsLessonOverride, year9Chapter4GeometryLessonOverride, year9Chapter5MeasurementLessonOverride, year9Chapter5SolidsLessonOverride, year9Chapter6IndexLawsLessonOverride, year9Chapter6ScientificNotationLessonOverride, year9Chapter6SurdsLessonOverride, year9Chapter7AnglesLessonOverride, year9Chapter7CongruenceLessonOverride, year9Chapter8ProbabilityLessonOverride, year9Chapter8ProbabilityBLessonOverride, year9Chapter8DataAnalysisLessonOverride, year9Chapter8DataAnalysisBLessonOverride, year9Chapter9ExpandingLessonOverride, year9Chapter9FactorisingLessonOverride, year9Chapter9FractionsLessonOverride, year9Chapter10QuadraticEquationsLessonOverride, year9Chapter10ParabolasLessonOverride, year9AlgebraicTechniquesLessonOverride, year9ConstantRatesOfChangeLessonOverride, year9EquationsLessonOverride, year9EquationsBLessonOverride, year9FinancialMathematicsLessonOverride, year9GeometricalRepresentationsLessonOverride, year9IndexLawsLessonOverride, year9LinearRelationshipsCLessonOverride, year9PrismsAndCylindersLessonOverride, year9SimultaneousEquationsLessonOverride, year9VariationRatesLessonOverride, year9WorkingWithTrianglesLessonOverride } from "./lessons/year9";
...
export function buildLesson(
  ...
  const override =
    ...
    year9Chapter1NumberLessonOverride(course, unit, lesson) ??
    year9Chapter1PercentagesLessonOverride(course, unit, lesson) ??
    year9Chapter1FinanceLessonOverride(course, unit, lesson) ??
    year9Chapter2ExpressionsLessonOverride(course, unit, lesson) ??
    year9Chapter2EquationsLessonOverride(course, unit, lesson) ??
    year9Chapter2SimultaneousLessonOverride(course, unit, lesson) ??
    year9Chapter3PythagorasLessonOverride(course, unit, lesson) ??
    year9Chapter3TrigRatiosLessonOverride(course, unit, lesson) ??
    year9Chapter3TrigApplicationsLessonOverride(course, unit, lesson) ??
    year9Chapter4GraphingLessonOverride(course, unit, lesson) ??
    year9Chapter4EquationsLessonOverride(course, unit, lesson) ??
    year9Chapter4GeometryLessonOverride(course, unit, lesson) ??
    year9Chapter5MeasurementLessonOverride(course, unit, lesson) ??
    year9Chapter5SolidsLessonOverride(course, unit, lesson) ??
    year9Chapter6IndexLawsLessonOverride(course, unit, lesson) ??
    year9Chapter6ScientificNotationLessonOverride(course, unit, lesson) ??
    year9Chapter6SurdsLessonOverride(course, unit, lesson) ??
    year9Chapter7AnglesLessonOverride(course, unit, lesson) ??
    year9Chapter7CongruenceLessonOverride(course, unit, lesson) ??
    year9Chapter8ProbabilityLessonOverride(course, unit, lesson) ??
    year9Chapter8ProbabilityBLessonOverride(course, unit, lesson) ??
    year9Chapter8DataAnalysisLessonOverride(course, unit, lesson) ??
    year9Chapter8DataAnalysisBLessonOverride(course, unit, lesson) ??
    year9Chapter9ExpandingLessonOverride(course, unit, lesson) ??
    year9Chapter9FactorisingLessonOverride(course, unit, lesson) ??
    year9Chapter9FractionsLessonOverride(course, unit, lesson) ??
    year9Chapter10QuadraticEquationsLessonOverride(course, unit, lesson) ??
    year9Chapter10ParabolasLessonOverride(course, unit, lesson) ??
...
export const newCoursePathways: CoursePathwaySeed[] = [
  ...
  },
  {
    ...
    yearLevel: "9",
    courseType: "standard",
    // Base pathway: exists only to derive the core/advanced variants; not shown to students.
    status: "hidden",
    description:
    ...
    units: [
      {
        ...
        lessons: [
        { slug: "computations-with-integers", title: "Computations with Integers", description: "Add, subtract, multiply and divide positive and negative integers using order of operations.", pathTag: "consolidating", stableSkillId: "y9-computations-with-integers", skillCheckpoints: [{ stableCheckpointId: "y9-computations-with-integers-c1", label: "Integer operations and order of operations" }] },
        { slug: "decimal-places-significant-figures", title: "Decimal Places and Significant Figures", description: "Round numbers to a given number of decimal places and to significant figures.", pathTag: "core", stableSkillId: "y9-decimal-places-significant-figures", skillCheckpoints: [{ stableCheckpointId: "y9-decimal-places-significant-figures-c1", label: "Rounding to decimal places and significant figures" }] },
        { slug: "rational-numbers", title: "Rational Numbers", description: "Recognise rational numbers and convert between fractions and decimals.", pathTag: "consolidating", stableSkillId: "y9-rational-numbers", skillCheckpoints: [{ stableCheckpointId: "y9-rational-numbers-c1", label: "Fractions, decimals and rational numbers" }] },
        { slug: "computation-with-fractions", title: "Computation with Fractions", description: "Add, subtract, multiply and divide fractions and simplify the result.", pathTag: "consolidating", stableSkillId: "y9-computation-with-fractions", skillCheckpoints: [{ stableCheckpointId: "y9-computation-with-fractions-c1", label: "Operations with fractions" }] },
        { slug: "ratios-rates-best-buys", title: "Ratios, Rates and Best Buys", description: "Simplify ratios, work with rates, and compare unit prices to find the best buy.", pathTag: "consolidating", stableSkillId: "y9-ratios-rates-best-buys", skillCheckpoints: [{ stableCheckpointId: "y9-ratios-rates-best-buys-c1", label: "Ratios, rates and best buys" }] },
        { slug: "percentages-and-money", title: "Percentages and Money", description: "Find percentages of amounts and convert between percentages, fractions and decimals.", pathTag: "consolidating", stableSkillId: "y9-percentages-and-money", skillCheckpoints: [{ stableCheckpointId: "y9-percentages-and-money-c1", label: "Percentages of amounts" }] },
        { slug: "percentage-increase-decrease", title: "Percentage Increase and Decrease", description: "Increase or decrease a quantity by a percentage using a multiplying factor.", pathTag: "consolidating", stableSkillId: "y9-percentage-increase-decrease", skillCheckpoints: [{ stableCheckpointId: "y9-percentage-increase-decrease-c1", label: "Percentage increase and decrease" }] },
        { slug: "profits-and-discounts", title: "Profits and Discounts", description: "Calculate profit, loss, percentage profit or loss, and discounts on a price.", pathTag: "consolidating", stableSkillId: "y9-profits-and-discounts", skillCheckpoints: [{ stableCheckpointId: "y9-profits-and-discounts-c1", label: "Profit, loss and discount" }] },
        { slug: "income", title: "Income", description: "Calculate gross income from wages, salaries, overtime, commission and piecework.", pathTag: "core", stableSkillId: "y9-income", skillCheckpoints: [{ stableCheckpointId: "y9-income-c1", label: "Calculating income" }] },
        { slug: "payg-income-tax", title: "The PAYG Income Tax System", description: "Find taxable income, income tax, the Medicare levy and net pay.", pathTag: "core", stableSkillId: "y9-payg-income-tax", skillCheckpoints: [{ stableCheckpointId: "y9-payg-income-tax-c1", label: "PAYG income tax and net pay" }] },
        ...
        { slug: "compound-interest-depreciation", title: "Compound Interest and Depreciation", description: "Calculate compound interest and depreciation by repeated multiplication.", pathTag: "core", stableSkillId: "y9-compound-interest-depreciation", skillCheckpoints: [{ stableCheckpointId: "y9-compound-interest-depreciation-c1", label: "Compound interest and depreciation" }] },
        { slug: "compound-interest-formula", title: "Using a Formula for Compound Interest and Depreciation", description: "Use the compound interest formula to find the final amount when interest is added each period.", pathTag: "core", stableSkillId: "y9-compound-interest-formula", skillCheckpoints: [{ stableCheckpointId: "y9-compound-interest-formula-c1", label: "Compound interest formula" }] },
        ],
      },
      {
        ...
        lessons: [
        { slug: "algebraic-expressions", title: "Algebraic Expressions", description: "Use pronumerals, identify terms and coefficients, and evaluate expressions by substitution.", pathTag: "consolidating", stableSkillId: "y9-algebraic-expressions", skillCheckpoints: [{ stableCheckpointId: "y9-algebraic-expressions-c1", label: "Terms, coefficients and substitution" }] },
        ...
        { slug: "using-formulas", title: "Using Formulas", description: "Substitute values into formulas and solve for an unknown in a formula.", pathTag: "core", stableSkillId: "y9-using-formulas", skillCheckpoints: [{ stableCheckpointId: "y9-using-formulas-c1", label: "Substituting into formulas" }] },
        { slug: "simultaneous-substitution", title: "Linear Simultaneous Equations: Substitution", description: "Solve a pair of linear simultaneous equations by substitution.", pathTag: "path", stableSkillId: "y9-simultaneous-substitution", skillCheckpoints: [{ stableCheckpointId: "y9-simultaneous-substitution-c1", label: "Substitution method" }] },
        { slug: "simultaneous-elimination", title: "Linear Simultaneous Equations: Elimination", description: "Solve simultaneous equations by adding or subtracting to eliminate a variable.", pathTag: "path", stableSkillId: "y9-simultaneous-elimination", skillCheckpoints: [{ stableCheckpointId: "y9-simultaneous-elimination-c1", label: "Elimination method" }] },
        { slug: "simultaneous-equations-problems", title: "Using Linear Simultaneous Equations to Solve Problems", description: "Set up and solve simultaneous equations from word problems.", pathTag: "path", stableSkillId: "y9-simultaneous-equations-problems", skillCheckpoints: [{ stableCheckpointId: "y9-simultaneous-equations-problems-c1", label: "Two-unknown word problems" }] },
        { slug: "quadratic-equations-ax2-c", title: "Quadratic Equations of the Form ax^2 = c", description: "Solve quadratic equations of the form ax^2 = c by taking square roots.", pathTag: "path", stableSkillId: "y9-quadratic-equations-ax2-c", skillCheckpoints: [{ stableCheckpointId: "y9-quadratic-equations-ax2-c-c1", label: "Solving ax^2 = c" }] },
        ],
      },
      {
        ...
        lessons: [
        { slug: "pythagoras-theorem", title: "Pythagoras' Theorem", description: "Use Pythagoras' theorem to find the hypotenuse of a right-angled triangle.", pathTag: "consolidating", stableSkillId: "y9-pythagoras-theorem", skillCheckpoints: [{ stableCheckpointId: "y9-pythagoras-theorem-c1", label: "Finding the hypotenuse" }] },
        { slug: "pythagoras-shorter-sides", title: "Finding the Length of the Shorter Sides", description: "Find the length of a shorter side using a rearrangement of Pythagoras' theorem.", pathTag: "consolidating", stableSkillId: "y9-pythagoras-shorter-sides", skillCheckpoints: [{ stableCheckpointId: "y9-pythagoras-shorter-sides-c1", label: "Finding a shorter side" }] },
        { slug: "pythagoras-2d-problems", title: "Using Pythagoras' Theorem to Solve Two-Dimensional Problems", description: "Apply Pythagoras' theorem to diagonals, distances and other 2D problems.", pathTag: "consolidating", stableSkillId: "y9-pythagoras-2d-problems", skillCheckpoints: [{ stableCheckpointId: "y9-pythagoras-2d-problems-c1", label: "2D Pythagoras problems" }] },
        { slug: "pythagoras-3d-problems", title: "Using Pythagoras' Theorem to Solve Three-Dimensional Problems", description: "Use Pythagoras' theorem in three dimensions to find the space diagonal of a box.", pathTag: "path", stableSkillId: "y9-pythagoras-3d-problems", skillCheckpoints: [{ stableCheckpointId: "y9-pythagoras-3d-problems-c1", label: "3D Pythagoras problems" }] },
        { slug: "introducing-trigonometric-ratios", title: "Introducing the Trigonometric Ratios", description: "Define the sine, cosine and tangent ratios using SOH CAH TOA.", pathTag: "core", stableSkillId: "y9-introducing-trigonometric-ratios", skillCheckpoints: [{ stableCheckpointId: "y9-introducing-trigonometric-ratios-c1", label: "Trig ratios (SOH CAH TOA)" }] },
        { slug: "finding-unknown-side-lengths", title: "Finding Unknown Side Lengths", description: "Find an unknown side using sine, cosine or tangent.", pathTag: "core", stableSkillId: "y9-finding-unknown-side-lengths", skillCheckpoints: [{ stableCheckpointId: "y9-finding-unknown-side-lengths-c1", label: "Finding a side with trig" }] },
        { slug: "solving-for-the-denominator", title: "Solving for the Denominator", description: "Find an unknown side that is in the denominator of a trig ratio by dividing.", pathTag: "core", stableSkillId: "y9-solving-for-the-denominator", skillCheckpoints: [{ stableCheckpointId: "y9-solving-for-the-denominator-c1", label: "Unknown in the denominator" }] },
        { slug: "finding-unknown-angles", title: "Finding Unknown Angles", description: "Find an unknown angle using the inverse trigonometric functions.", pathTag: "core", stableSkillId: "y9-finding-unknown-angles", skillCheckpoints: [{ stableCheckpointId: "y9-finding-unknown-angles-c1", label: "Finding an angle with inverse trig" }] },
        { slug: "trigonometry-applications", title: "Using Trigonometry to Solve Problems", description: "Apply trigonometry to angles of elevation and depression and other real problems.", pathTag: "core", stableSkillId: "y9-trigonometry-applications", skillCheckpoints: [{ stableCheckpointId: "y9-trigonometry-applications-c1", label: "Elevation, depression and applications" }] },
        { slug: "bearings", title: "Bearings", description: "Use three-figure compass bearings and find back (reverse) bearings.", pathTag: "core", stableSkillId: "y9-bearings", skillCheckpoints: [{ stableCheckpointId: "y9-bearings-c1", label: "Three-figure and back bearings" }] },
        ],
      },
      {
        slug: "linear-relationships",
        ...
        lessons: [
        { slug: "introducing-linear-relationships", title: "Introducing Linear Relationships", description: "Recognise linear relationships from tables and equations, and find values from a rule.", pathTag: "consolidating", stableSkillId: "y9-introducing-linear-relationships", skillCheckpoints: [{ stableCheckpointId: "y9-introducing-linear-relationships-c1", label: "Linear rules and tables" }] },
        ...
        { slug: "perpendicular-parallel-lines", title: "Perpendicular Lines and Parallel Lines", description: "Use gradients to identify parallel and perpendicular lines.", pathTag: "path", stableSkillId: "y9-perpendicular-parallel-lines", skillCheckpoints: [{ stableCheckpointId: "y9-perpendicular-parallel-lines-c1", label: "Parallel and perpendicular gradients" }] },
        { slug: "linear-modelling", title: "Linear Modelling", description: "Model real situations with y = mx + c and interpret the gradient and intercept.", pathTag: "core", stableSkillId: "y9-linear-modelling", skillCheckpoints: [{ stableCheckpointId: "y9-linear-modelling-c1", label: "Linear models in context" }] },
        { slug: "graphical-solutions-simultaneous", title: "Graphical Solutions to Simultaneous Equations", description: "Solve simultaneous equations graphically as the intersection point of the lines.", pathTag: "path", stableSkillId: "y9-graphical-solutions-simultaneous", skillCheckpoints: [{ stableCheckpointId: "y9-graphical-solutions-simultaneous-c1", label: "Intersection as solution" }] },
        ],
      },
      {
        ...
        lessons: [
        { slug: "length-and-perimeter", title: "Length and Perimeter", description: "Find the perimeter of rectangles, squares and triangles, and missing sides.", pathTag: "consolidating", stableSkillId: "y9-length-and-perimeter", skillCheckpoints: [{ stableCheckpointId: "y9-length-and-perimeter-c1", label: "Perimeter of simple shapes" }] },
      ...
      },
      {
        ...
        { slug: "operations-with-surds", title: "Simple Operations with Surds", description: "Simplify surds, add like surds and multiply surds.", pathTag: "path", stableSkillId: "y9-operations-with-surds", skillCheckpoints: [{ stableCheckpointId: "y9-operations-with-surds-c1", label: "Operations with surds" }] },
        ],
      },
      {
        ...
        { slug: "similar-triangles", title: "Similar Triangles", description: "Use equal angles and proportional sides of similar triangles to find unknown lengths.", pathTag: "core", stableSkillId: "y9-similar-triangles", skillCheckpoints: [{ stableCheckpointId: "y9-similar-triangles-c1", label: "Finding sides in similar triangles" }] },
        { slug: "proving-similar-triangles", title: "Proving and Applying Similar Triangles", description: "Use the similarity tests (AA, SAS, SSS) to prove triangles similar and find lengths.", pathTag: "path", stableSkillId: "y9-proving-similar-triangles", skillCheckpoints: [{ stableCheckpointId: "y9-proving-similar-triangles-c1", label: "Similarity tests" }] },
        ],
      },
      {
      ...
      },
      {
        ...
        title: "Probability and Data Analysis",
        description:
          "Probability with Venn diagrams, set notation, arrays and tree diagrams, then bivariate data analysis: scatter plots, lines of best fit, data collection and critical evaluation of graphs and statistical claims.",
        syllabusArea: "Statistics and Probability",
        focus:
          "Probability and bivariate data analysis.",
        lessons: [
        { slug: "making-predictions", title: "Making Predictions", description: "Use probability to predict the likelihood of an event, from listing outcomes to the 0–1 probability scale.", pathTag: "consolidating", stableSkillId: "y9-making-predictions", skillCheckpoints: [{ stableCheckpointId: "y9-making-predictions-c1", label: "Probability scale and P = favourable ÷ total" }] },
        { slug: "sample-space-and-probability", title: "Sample Space and Probability", description: "List and count sample spaces for one-stage and two-stage experiments, using tables/arrays, and use them to calculate probabilities.", pathTag: "core", stableSkillId: "y9-sample-space-and-probability", legacySlugs: ["arrays-two-step-experiments"], skillCheckpoints: [{ stableCheckpointId: "y9-sample-space-and-probability-c1", label: "Sample spaces and arrays" }] },
        { slug: "tree-diagrams-multistage-events", title: "Tree Diagrams for Multistage Events", description: "Use tree diagrams to solve multistage chance-experiment problems, multiplying along paths and adding separate successful paths.", pathTag: "core", stableSkillId: "y9-tree-diagrams-multistage-events", legacySlugs: ["tree-diagrams"], skillCheckpoints: [{ stableCheckpointId: "y9-tree-diagrams-multistage-events-c1", label: "Tree diagrams and multistage paths" }] },
        { slug: "dependent-and-independent-events", title: "Dependent and Independent Events", description: "Distinguish independent events from dependent events, and calculate their combined probabilities.", pathTag: "core", stableSkillId: "y9-dependent-and-independent-events", skillCheckpoints: [{ stableCheckpointId: "y9-dependent-and-independent-events-c1", label: "Independent vs dependent events" }] },
        { slug: "probability-simulations", title: "Probability Simulations", description: "Design and interpret probability simulations, using relative frequency to estimate probabilities and forecast expected numbers.", pathTag: "core", stableSkillId: "y9-probability-simulations", legacySlugs: ["relative-frequencies"], skillCheckpoints: [{ stableCheckpointId: "y9-probability-simulations-c1", label: "Relative frequency and simulations" }] },
        { slug: "complementary-events", title: "Complementary Events", description: "Use the complement rule P(not A) = 1 − P(A) to solve probability problems without directly counting.", pathTag: "consolidating", stableSkillId: "y9-complementary-events", skillCheckpoints: [{ stableCheckpointId: "y9-complementary-events-c1", label: "The complement rule" }] },
        { slug: "venn-diagrams", title: "Venn Diagrams", description: "Construct and interpret two-set Venn diagrams using set notation, and calculate probabilities including unions, intersections, complements and mutually exclusive events.", pathTag: "path", stableSkillId: "y9-venn-diagrams", legacySlugs: ["using-set-notation", "venn-diagrams-two-way-tables"], skillCheckpoints: [{ stableCheckpointId: "y9-venn-diagrams-c1", label: "Venn diagrams and set notation" }] },
        { slug: "two-way-tables", title: "Two-Way Tables", description: "Construct and read two-way frequency tables to find marginal frequencies, joint probabilities and informal conditional probabilities, and convert between Venn diagrams and two-way tables.", pathTag: "path", stableSkillId: "y9-two-way-tables", skillCheckpoints: [{ stableCheckpointId: "y9-two-way-tables-c1", label: "Two-way tables" }] },
        { slug: "conditional-probability", title: "Conditional Probability", description: "Apply the formal conditional probability formula P(A|B) = P(A∩B)/P(B), and use precise language for mutually exclusive, inclusive-or, exclusive-or, at-least and at-most events.", pathTag: "path", stableSkillId: "y9-conditional-probability", skillCheckpoints: [{ stableCheckpointId: "y9-conditional-probability-c1", label: "Conditional probability" }] },
        { slug: "gambling-awareness", title: "Gambling Awareness", description: "Apply expected value and long-run probability to critically examine poker machines and loot boxes.", pathTag: "core", stableSkillId: "y9-gambling-awareness", skillCheckpoints: [{ stableCheckpointId: "y9-gambling-awareness-c1", label: "Expected value and the house edge" }] },
        { slug: "single-vs-bivariate-data", title: "Single vs Bivariate Data", description: "Distinguish single-variable from bivariate data, review reading single-variable displays, and identify variables and association vs causation.", pathTag: "core", stableSkillId: "y9-single-vs-bivariate-data", skillCheckpoints: [{ stableCheckpointId: "y9-single-vs-bivariate-data-c1", label: "Single vs bivariate data" }] },
        { slug: "scatter-plots", title: "Scatter Plots", description: "Represent bivariate data as a scatter plot, and recognise rising, falling and unclear trends and outliers.", pathTag: "core", stableSkillId: "y9-scatter-plots", skillCheckpoints: [{ stableCheckpointId: "y9-scatter-plots-c1", label: "Scatter plots" }] },
        { slug: "line-of-best-fit", title: "Line of Best Fit", description: "Construct a line of best fit by eye on a scatter plot, and use a given line's equation to estimate values.", pathTag: "core", stableSkillId: "y9-line-of-best-fit", skillCheckpoints: [{ stableCheckpointId: "y9-line-of-best-fit-c1", label: "Line of best fit" }] },
        { slug: "describing-and-predicting", title: "Describing and Making Predictions", description: "Describe a bivariate association's direction, strength and form, and use a line of best fit for interpolation and extrapolation.", pathTag: "core", stableSkillId: "y9-describing-and-predicting", skillCheckpoints: [{ stableCheckpointId: "y9-describing-and-predicting-c1", label: "Describing associations and predicting" }] },
        { slug: "data-collection", title: "Data Collection", description: "Distinguish population from sample, identify sampling methods and bias, and collect data ethically and efficiently.", pathTag: "path", stableSkillId: "y9-data-collection", legacySlugs: ["data-and-sampling"], skillCheckpoints: [{ stableCheckpointId: "y9-data-collection-c1", label: "Sampling methods and bias" }] },
        { slug: "misleading-graphs", title: "Misleading Graphs", description: "Identify techniques that make graphs misleading, and critically evaluate surveys, polls and media reports for bias or misrepresentation.", pathTag: "path", stableSkillId: "y9-misleading-graphs", skillCheckpoints: [{ stableCheckpointId: "y9-misleading-graphs-c1", label: "Spotting misleading data displays" }] },
        { slug: "statistical-investigation", title: "Statistical Investigation", description: "Plan a statistical inquiry: write an aim and hypothesis, collect data ethically and efficiently, choose a suitable display, and report a well-supported conclusion.", pathTag: "path", stableSkillId: "y9-statistical-investigation", skillCheckpoints: [{ stableCheckpointId: "y9-statistical-investigation-c1", label: "Planning a statistical investigation" }] },
        ],
      },
      {
        ...
        lessons: [
        { slug: "quadratic-equations", title: "Quadratic Equations", description: "Solve factorised quadratic equations using the null factor law.", pathTag: "path", stableSkillId: "y9-quadratic-equations", skillCheckpoints: [{ stableCheckpointId: "y9-quadratic-equations-c1", label: "Null factor law" }] },
        { slug: "solving-quadratics-factorising-basic", title: "Solving ax^2 + bx = 0 and x^2 - d = 0 by Factorising", description: "Solve simple quadratics by common factor or square roots.", pathTag: "path", stableSkillId: "y9-solving-quadratics-factorising-basic", skillCheckpoints: [{ stableCheckpointId: "y9-solving-quadratics-factorising-basic-c1", label: "Basic quadratic solving" }] },
        { slug: "solving-quadratics-factorising", title: "Solving x^2 + bx + c = 0 by Factorising", description: "Solve x² + bx + c = 0 by factorising into two binomials.", pathTag: "path", stableSkillId: "y9-solving-quadratics-factorising", skillCheckpoints: [{ stableCheckpointId: "y9-solving-quadratics-factorising-c1", label: "Solving by factorising" }] },
        { slug: "quadratic-equations-problems", title: "Using Quadratic Equations to Solve Problems", description: "Set up and solve quadratic equations from word problems.", pathTag: "path", stableSkillId: "y9-quadratic-equations-problems", skillCheckpoints: [{ stableCheckpointId: "y9-quadratic-equations-problems-c1", label: "Quadratic word problems" }] },
        { slug: "the-parabola", title: "The Parabola", description: "Recognise the basic parabola y = x²: vertex, axis of symmetry and shape.", pathTag: "path", stableSkillId: "y9-the-parabola", skillCheckpoints: [{ stableCheckpointId: "y9-the-parabola-c1", label: "Features of y = x²" }] },
        { slug: "sketching-dilations-reflections", title: "Sketching y = ax^2 with Dilations and Reflections", description: "Sketch y = ax²: dilations (narrower/wider) and reflections (opening down).", pathTag: "path", stableSkillId: "y9-sketching-dilations-reflections", skillCheckpoints: [{ stableCheckpointId: "y9-sketching-dilations-reflections-c1", label: "Dilations and reflections" }] },
        { slug: "sketching-translations", title: "Sketching Translations of y = x^2", description: "Sketch translations y = x² + k and y = (x − h)², reading the vertex.", pathTag: "path", stableSkillId: "y9-sketching-translations", skillCheckpoints: [{ stableCheckpointId: "y9-sketching-translations-c1", label: "Translations and the vertex" }] },
        { slug: "sketching-parabolas-intercept-form", title: "Sketching Parabolas Using Intercept Form", description: "Sketch parabolas in intercept form: x-intercepts, y-intercept and axis of symmetry.", pathTag: "path", stableSkillId: "y9-sketching-parabolas-intercept-form", skillCheckpoints: [{ stableCheckpointId: "y9-sketching-parabolas-intercept-form-c1", label: "Intercept form" }] },
        ],
      },
    ],
  },
              ...
              },
              {
                      ...
                      "lessons": [
                              ...
                              },
                              {
                                      ...
                                      "description": "Read counts, totals and relative frequencies from two-way tables to explore association.",
                                      "pathTag": "path"
                              },
                              {
                                      "slug": "summary-statistics",
                                      "title": "9D Summary Statistics",
                                      "description": "Calculate and interpret mean, median, mode and range, and choose the best measure.",
                                      "pathTag": "path"
                              },
                              {
                                      "slug": "quartiles-iqr",
                              ...
                              },
                              {
                                      ...
                                      "description": "Interpret a line of best fit and correlation, with interpolation, extrapolation and causation.",
                                      "pathTag": "extending"
                              }
                      ]
              },
              ...
              },
              {
                      ...
                      "lessons": [
                              ...
                              },
                              {
                                      ...
                                      "description": "Recognise isomorphic graphs (same structure) and planar graphs, and apply Euler's formula.",
                                      "pathTag": "path"
                              },
                              {
                              ...
                              },
                              {
                                      ...
                                      "description": "Find shortest paths by minimum total weight, distinct from fewest edges and minimum spanning trees.",
                                      "pathTag": "extending"
                              }
                      ]
              },
  ...
  },
  {
    ...
    status: "available",
    description:
      "Build Stage 4 foundations across number, algebra, geometry, measurement and statistics — the essential groundwork for Year 8 Mathematics.",
    positioning:
      "Year 7 Mathematics covers the Early Stage 4 NSW curriculum (2024). Units map to MA4 outcomes: integers, fractions, algebra, percentages, equations, indices, perimeter, area, angles and data.",
    units: [
      {
        slug: "integers",
        title: "Computation with Integers",
        description: "Compare, order and calculate with integers to solve problems.",
        syllabusArea: "Number and Algebra",
      ...
      },
      {
        ...
        description: "Represent and operate with fractions and decimals to solve problems.",
        syllabusArea: "Number and Algebra",
      ...
      },
      {
        slug: "algebraic-techniques",
        title: "Algebraic Techniques",
        description: "Generalise number properties to operate with algebraic expressions including expansion and factorisation.",
        syllabusArea: "Number and Algebra",
      ...
      },
      {
        ...
        description: "Represent and operate with percentages to solve problems.",
        syllabusArea: "Number and Algebra",
      ...
      },
      {
        slug: "equations",
        title: "Equations",
        description: "Solve linear equations of up to 2 steps and quadratic equations of the form ax² = c.",
        syllabusArea: "Number and Algebra",
      ...
      },
      {
        slug: "indices",
        title: "Indices",
        description: "Operate with primes and roots, positive-integer and zero indices involving numerical bases and establish the relevant index laws.",
        syllabusArea: "Number and Algebra",
      ...
      },
      {
        ...
        description: "Apply knowledge of the perimeter of plane shapes to solve problems.",
        syllabusArea: "Measurement and Space",
      ...
      },
      {
        ...
        description: "Apply knowledge of area and composite area involving triangles and quadrilaterals to solve problems.",
        syllabusArea: "Measurement and Space",
      ...
      },
      {
        ...
        description: "Apply angle relationships to solve problems, including those related to transversals on sets of parallel lines.",
        syllabusArea: "Measurement and Space",
      ...
      },
      {
        ...
        description: "Classify and display data using a variety of graphical representations.",
        syllabusArea: "Statistics and Probability",
  ...
  newCoursePathways.push(
    {
      ...
      yearLevel: "Year 9",
      courseType: "Mathematics Advanced",
      // Live: the Year 9 restructure has been released; this pathway is student-facing.
      status: "available",
      description:
      ...
      positioning:
        "Advanced Stage 5 pathway. Extends base Year 9 content with quadratic and cubic equations, simultaneous equations, variation and rates, Venn diagrams, two-way tables and conditional probability, and linear relationships C.",
