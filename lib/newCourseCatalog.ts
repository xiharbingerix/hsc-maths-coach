  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        lessons: [
        { slug: "review-of-probability", title: "Review of Probability", description: "Find simple probabilities as favourable ÷ total, and use the complement.", pathTag: "consolidating", stableSkillId: "y9-review-of-probability", skillCheckpoints: [{ stableCheckpointId: "y9-review-of-probability-c1", label: "Simple probability and complement" }] },
        { slug: "venn-diagrams-two-way-tables", title: "Venn Diagrams and Two-Way Tables", description: "Use Venn diagrams and two-way tables to find counts and probabilities.", pathTag: "path", stableSkillId: "y9-venn-diagrams-two-way-tables", skillCheckpoints: [{ stableCheckpointId: "y9-venn-diagrams-two-way-tables-c1", label: "Venn diagrams and two-way tables" }] },
        { slug: "using-set-notation", title: "Using Set Notation", description: "Use set notation: union, intersection, complement and n(A).", pathTag: "path", stableSkillId: "y9-using-set-notation", skillCheckpoints: [{ stableCheckpointId: "y9-using-set-notation-c1", label: "Set notation" }] },
        { slug: "arrays-two-step-experiments", title: "Using Arrays for Two-Step Experiments", description: "Use arrays to list the sample space of two-step experiments and find probabilities.", pathTag: "core", stableSkillId: "y9-arrays-two-step-experiments", skillCheckpoints: [{ stableCheckpointId: "y9-arrays-two-step-experiments-c1", label: "Two-step sample spaces" }] },
        { slug: "tree-diagrams", title: "Using Tree Diagrams", description: "Use tree diagrams for multi-step experiments, multiplying along branches.", pathTag: "core", stableSkillId: "y9-tree-diagrams", skillCheckpoints: [{ stableCheckpointId: "y9-tree-diagrams-c1", label: "Tree diagrams" }] },
