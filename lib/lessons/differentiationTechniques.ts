...
export const chainRuleLesson = lesson(
  ...
  [
    ...
    numeric("diff-tech-chain-m6", "Find the gradient at x = 0.", "y=(3x+2)^2", "12"),
    ...
    numeric("diff-tech-chain-m8", "Find f'(1).", "f(x)=\\ln(3x+1)", "3/4", ["0.75"]),
...
export const productQuotientRulesLesson = lesson(
  ...
  [
    ...
    numeric("diff-tech-pq-m6", "Find the derivative value at x = 0.", "y=x\\cos x", "1"),
...
export const applicationsExtendedDifferentiationLesson = lesson(
  ...
  [
    numeric("diff-tech-app-m1", "Find the tangent gradient at x = 1.", "y=(3x-1)^2", "12"),
    numeric("diff-tech-app-m2", "Find the normal gradient when the tangent gradient is 4.", "m_T=4", "-1/4", ["-0.25"]),
    ...
    numeric("diff-tech-app-m4", "Find the rate at t = 0.", "s(t)=e^{3t}", "3"),
    numeric("diff-tech-app-m5", "Find the stationary x-value.", "f'(x)=3x+6", "-2"),
