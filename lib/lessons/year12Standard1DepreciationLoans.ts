...
export function year12Standard1ReducingBalanceLoansLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("rbl-g2", "A loan balance is $10 000 with a monthly interest rate of 1%. Find this month's interest.", "10000 \\times 0.01", "100", 2,
        "Interest = balance × rate.", "Interest = 10 000 × 0.01 = $100.",
        ["$100"]),
      ans("rbl-g3", "This month's interest is $100 and the repayment is $500. How much of the repayment reduces the principal?", "500 - 100", "400", 2,
        "Principal reduced = repayment − interest.", "500 − 100 = $400 reduces the principal.",
        ["$400"]),
      ans("rbl-g4", "A loan balance is $10 000; interest of $100 is added and a $500 repayment is made. Find the new balance.", "10000 + 100 - 500", "9600", 2,
        "New balance = old + interest − repayment.", "10 000 + 100 − 500 = $9 600.",
        ["$9600"]),
    ],
    independentPractice: [
      ans("rbl-i1", "A loan balance is $5 000 with a monthly interest rate of 2%. Find this month's interest.", "5000 \\times 0.02", "100", 2,
      ...
      ans("rbl-i3", "A loan balance is $8 000 with a monthly interest rate of 1.5%. Find this month's interest.", "8000 \\times 0.015", "120", 3,
        "Interest = balance × rate.", "Interest = 8 000 × 0.015 = $120.",
        ["$120"]),
      ans("rbl-i4", "A loan balance is $5 000; interest of $100 is added and a $300 repayment is made. Find the new balance.", "5000 + 100 - 300", "4800", 3,
        "New balance = old + interest − repayment.", "5 000 + 100 − 300 = $4 800.",
        ["$4800"]),
      ans("rbl-i5", "A loan balance is $20 000 at 0.5% per month, with a $1 000 repayment. How much of the repayment reduces the principal?", "1000 - 20000 \\times 0.005", "900", 3,
        "Find the interest first, then subtract from the repayment.", "Interest = 20 000 × 0.005 = $100; principal reduced = 1 000 − 100 = $900.",
        ["$900"]),
    ],
    masteryQuiz: [
      ans("rbl-m1", "A loan balance is $12 000 at a monthly rate of 1%. Find this month's interest.", "12000 \\times 0.01", "120", 2,
      ...
      ans("rbl-m3", "A loan balance is $10 000; interest of $100 is added and a $600 repayment is made. Find the new balance.", "10000 + 100 - 600", "9500", 3,
        "New balance = old + interest − repayment.", "10 000 + 100 − 600 = $9 500.",
        ["$9500"]),
      ans("rbl-m4", "A loan balance is $6 000 at 2% per month, with a $500 repayment. Find the new balance.", "6000 + 6000 \\times 0.02 - 500", "5620", 4,
      ...
      ans("rbl-m6", "A loan balance is $15 000 at a monthly rate of 1%. Find this month's interest.", "15000 \\times 0.01", "150", 2,
        "Interest = balance × rate.", "Interest = 15 000 × 0.01 = $150.",
        ["$150"]),
      ans("rbl-m7", "After month 1 a loan balance is $9 600. At 1% per month, find month 2's interest.", "9600 \\times 0.01", "96", 4,
      ...
      ans("rbl-m9", "A loan balance is $4 000 at 1.5% per month, with a $200 repayment. Find the new balance.", "4000 + 4000 \\times 0.015 - 200", "3860", 4,
        "Interest first, then new balance.", "Interest = 4 000 × 0.015 = $60; new balance = 4 000 + 60 − 200 = $3 860.",
        ["$3860"]),
      ans("rbl-m10", "A loan's monthly interest was $100 in month 1 and $96 in month 2. By how much did the monthly interest fall?", "100 - 96", "4", 4,
...
export function year12Standard1CreditCardStatementsLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("ccs-g2", "A statement shows opening balance $500, purchases $300, payment $200 and no interest. Find the closing balance.", "500 + 300 - 200", "600", 2,
        "Add purchases, subtract payments.", "500 + 300 − 200 = $600.",
        ["$600"]),
      ans("ccs-g3", "A statement shows opening balance $1 000, no purchases and a $400 payment. Find the closing balance.", "1000 - 400", "600", 2,
        "Subtract the payment.", "1 000 − 400 = $600.",
        ["$600"]),
      ans("ccs-g4", "A statement shows opening balance $800, purchases $200 and a $1 000 payment. Find the closing balance.", "800 + 200 - 1000", "0", 2,
        "Add purchases, subtract the payment.", "800 + 200 − 1 000 = $0 (paid off in full).",
        ["$0"]),
    ],
    independentPractice: [
      ans("ccs-i1", "A statement shows opening balance $600, purchases $250, interest $15 and a payment $300. Find the closing balance.", "600 + 250 + 15 - 300", "565", 3,
      ...
      ans("ccs-i3", "A statement shows opening balance $0, purchases $450 and a $450 payment. Find the closing balance.", "0 + 450 - 450", "0", 3,
        "Purchases minus payment.", "0 + 450 − 450 = $0.",
        ["$0"]),
      ans("ccs-i4", "A statement shows opening balance $2 000, purchases $500, interest $40 and a payment $600. Find the closing balance.", "2000 + 500 + 40 - 600", "1940", 3,
        "Add purchases and interest, subtract the payment.", "2 000 + 500 + 40 − 600 = $1 940.",
        ["$1940"]),
      ans("ccs-i5", "A card charges 2% monthly interest on an unpaid balance of $1 000. Find the interest charged.", "1000 \\times 0.02", "20", 3,
        "Interest = balance × monthly rate.", "1 000 × 0.02 = $20.",
        ["$20"]),
    ],
    masteryQuiz: [
      ans("ccs-m1", "A statement shows opening balance $300, purchases $700 and a $500 payment. Find the closing balance.", "300 + 700 - 500", "500", 2,
      ...
      ans("ccs-m3", "A statement shows opening balance $1 200, purchases $300, interest $24 and a payment $500. Find the closing balance.", "1200 + 300 + 24 - 500", "1024", 3,
        "Add purchases and interest, subtract the payment.", "1 200 + 300 + 24 − 500 = $1 024.",
        ["$1024"]),
      ans("ccs-m4", "A card charges 1.5% monthly interest on an unpaid balance of $1 500. Find the interest charged.", "1500 \\times 0.015", "22.50", 3,
      ...
      ans("ccs-m6", "A statement shows opening balance $0, purchases $600 and a $600 payment. Find the closing balance.", "0 + 600 - 600", "0", 2,
        "Purchases minus payment.", "0 + 600 − 600 = $0.",
        ["$0"]),
      ans("ccs-m7", "A statement shows a closing balance of $800 and a minimum payment of 2% of the closing balance. Find the minimum payment.", "800 \\times 0.02", "16", 4,
      ...
      ans("ccs-m9", "A statement shows opening balance $900, purchases $400, interest $18 and a payment $300. Find the closing balance.", "900 + 400 + 18 - 300", "1018", 4,
        "Add purchases and interest, subtract the payment.", "900 + 400 + 18 − 300 = $1 018.",
        ["$1018"]),
      ans("ccs-m10", "A $2 000 balance accrues 1.8% monthly interest while unpaid. Find one month's interest.", "2000 \\times 0.018", "36", 4,
...
export function year12Standard1FeesAndChargesLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("fee-g2", "A loan charges $500 interest plus a $200 establishment fee. Find the total cost.", "500 + 200", "700", 2,
        "Total cost = interest + fees.", "500 + 200 = $700.",
        ["$700"]),
      ans("fee-g3", "An account charges a $5 monthly fee. Find the total fees for one year.", "5 \\times 12", "60", 2,
        "12 months at $5 each.", "5 × 12 = $60.",
        ["$60"]),
      ans("fee-g4", "A card has a $90 annual fee and charges $30 in interest. Find the total yearly cost.", "90 + 30", "120", 2,
        "Total cost = interest + fees.", "90 + 30 = $120.",
        ["$120"]),
    ],
    independentPractice: [
      ans("fee-i1", "A loan charges $1 200 interest, a $150 application fee, and $5 monthly account fees for 12 months. Find the total cost.", "1200 + 150 + 5 \\times 12", "1410", 3,
      ...
      ans("fee-i3", "Card A has no annual fee but $120 interest. Card B has a $60 annual fee and $40 interest. Find the total cost of the cheaper card.", "\\min(120,\\ 60+40)", "100", 3,
        "Total cost of each, then pick the smaller.", "A = $120; B = 60 + 40 = $100; the cheaper is B at $100.",
        ["$100"]),
      ans("fee-i4", "A borrower is charged three late fees of $25 each. Find the total late fees.", "3 \\times 25", "75", 2,
        "3 fees at $25.", "3 × 25 = $75.",
        ["$75"]),
      ans("fee-i5", "An ATM charges $2.50 per withdrawal. Find the total ATM fees for 8 withdrawals.", "8 \\times 2.50", "20", 3,
        "8 withdrawals at $2.50.", "8 × 2.50 = $20.",
        ["$20"]),
    ],
    masteryQuiz: [
      ans("fee-m1", "A loan charges $800 interest and $250 in fees. Find the total cost.", "800 + 250", "1050", 2,
      ...
      ans("fee-m3", "A card has a $99 annual fee and a $4 monthly fee. Find the total fees for one year.", "99 + 4 \\times 12", "147", 3,
        "Annual fee plus 12 monthly fees.", "Monthly fees = 4 × 12 = $48; total = 99 + 48 = $147.",
        ["$147"]),
      ans("fee-m4", "Loan A has a total cost of $5 400 and Loan B a total cost of $5 200. How much cheaper is Loan B?", "5400 - 5200", "200", 3,
      ...
      ans("fee-m6", "A loan charges $300 interest, a $200 establishment fee, and $10 monthly account fees for 12 months. Find the total cost.", "300 + 200 + 10 \\times 12", "620", 4,
        "Add interest and all fees.", "Monthly fees = 10 × 12 = $120; total = 300 + 200 + 120 = $620.",
        ["$620"]),
      ans("fee-m7", "A card charges a $55 annual fee, two $5 late fees, and $25 interest in a year. Find the total cost.", "55 + 2 \\times 5 + 25", "90", 4,
      ...
      ans("fee-m9", "Option X charges $400 interest and no fees. Option Y charges $250 interest and $200 in fees. Find the total cost of the cheaper option.", "\\min(400,\\ 250+200)", "400", 4,
        "Total cost of each, then pick the smaller.", "X = $400; Y = 250 + 200 = $450; the cheaper is X at $400.",
        ["$400"]),
      ans("fee-m10", "A personal loan charges $2 000 interest, a $300 establishment fee, and $8 monthly account fees over 12 months. Find the total cost.", "2000 + 300 + 8 \\times 12", "2396", 4,
