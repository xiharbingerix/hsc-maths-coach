...
export const absoluteValueFunctionsLesson: ExplicitLesson = {
  ...
  description:
    "Interpret and transform absolute value graphs, solve simple absolute value equations, and reason about domain and range without drawing.",
  syllabusArea: "Functions",
  focus: "Graphing techniques",
  status: "active",
  video: {
  ...
  learningIntention:
    "Learn how absolute value changes function outputs and inputs, and use this to interpret graphs and solve simple equations.",
  successCriteria: [
    "Interpret absolute value as distance from zero.",
    "Describe how $y=|f(x)|$ changes a graph.",
    "Describe how $y=f(|x|)$ changes a graph.",
    "Solve simple absolute value equations using cases or distance reasoning.",
    "Identify domain and range features of absolute value graphs.",
    "Recognise common graph interpretation errors without drawing.",
  ],
  teaching: {
    paragraphs: [
      "The absolute value of a number is its distance from zero, so it is never negative.",
      "For $y=|f(x)|$, outputs that were below the x-axis become positive. The parts of $y=f(x)$ below the x-axis reflect upward.",
      "For $y=f(|x|)$, negative inputs are replaced by their positive counterparts. The right-hand side of the graph is copied across the y-axis.",
      "Absolute value equations often have two solutions because two numbers can have the same distance from zero.",
      "Graph questions in this lesson are answered by description and interpretation, not by drawing.",
    ],
    latexBlocks: [
      "|x|=\\begin{cases}x,&x\\ge0\\\\-x,&x<0\\end{cases}",
      "|f(x)|\\ge0",
      "y=|f(x)|:\\ \\text{reflect negative output parts above the x-axis}",
      "y=f(|x|):\\ \\text{keep the right side and reflect it into the left side}",
    ],
  },
  workedExamples: [
    {
      title: "Worked example 1: Solve an absolute value equation",
      questionLatex: "|x-3|=5",
      steps: [
        { explanation: "The expression inside the absolute value is 5 units from zero.", latex: "x-3=5\\quad \\text{or}\\quad x-3=-5" },
        { explanation: "Solve each case.", latex: "x=8\\quad \\text{or}\\quad x=-2" },
      ],
      finalAnswerLatex: "x=-2,\\ 8",
    },
    {
      title: "Worked example 2: Interpret y equals absolute f of x",
      questionLatex: "y=|f(x)|",
      steps: [
        { explanation: "Positive output values stay unchanged.", latex: "f(x)\\ge0\\Rightarrow |f(x)|=f(x)" },
        { explanation: "Negative output values are reflected above the x-axis.", latex: "f(x)<0\\Rightarrow |f(x)|=-f(x)" },
        { explanation: "The transformed graph has no negative y-values.", latex: "y\\ge0" },
      ],
      finalAnswerLatex: "\\text{Reflect parts below the x-axis upward.}",
    },
    {
      title: "Worked example 3: Interpret f of absolute x",
      questionLatex: "y=f(|x|)",
      steps: [
        { explanation: "For x greater than or equal to zero, the graph is unchanged.", latex: "|x|=x\\quad \\text{when }x\\ge0" },
        { explanation: "For negative x-values, the function uses the matching positive input.", latex: "f(|-2|)=f(2)" },
        { explanation: "So the right-hand side is reflected into the left side.", latex: "\\text{symmetry about the y-axis}" },
      ],
      finalAnswerLatex: "\\text{Keep the right side and reflect it into the left side.}",
    },
  ],
  guidedPractice: [
    {
    ...
    {
      id: "abs-guided-2",
      prompt: "Choose the correct graph description.",
      latex: "y=|f(x)|",
      answer: "B",
      choices: [
        { label: "A", text: "shift the graph up by 1" },
        { label: "B", text: "reflect parts below the x-axis above the x-axis" },
        { label: "C", text: "reflect the right side into the left side" },
        { label: "D", text: "reflect the whole graph in the y-axis" },
      ],
      hint: "The absolute value is applied to the output.",
      explanation: "$|f(x)|$ changes negative outputs into positive outputs.",
    },
    {
      id: "abs-guided-3",
      ...
      answer: "-4,4",
      acceptedAnswers: ["4,-4", "x=-4,4", "x=4,-4", "-4 and 4", "4 and -4"],
      hint: "Two numbers are 4 units from zero.",
    ...
    },
    {
      ...
      hint: "The absolute value part is never negative.",
      explanation: "The smallest value is 3, so the range is $y\\ge3$.",
    },
  ],
  independentPractice: [
    {
      ...
      latex: "|x-1|=6",
      answer: "-5,7",
      acceptedAnswers: ["7,-5", "x=-5,7", "x=7,-5", "-5 and 7", "7 and -5"],
      hint: "Set $x-1=6$ or $x-1=-6$.",
      explanation: "The solutions are $x=7$ and $x=-5$.",
    },
    {
      id: "abs-ind-2",
      prompt: "Choose the correct graph description.",
      ...
      answer: "C",
      choices: [
        { label: "A", text: "reflect parts below the x-axis upward" },
        { label: "B", text: "shift the graph right" },
        { label: "C", text: "keep the right side and reflect it into the left side" },
        { label: "D", text: "delete the right side" },
      ],
      hint: "The absolute value is applied to the input.",
      explanation: "$f(|x|)$ uses the right-hand side for both positive and negative inputs.",
    },
    {
      id: "abs-ind-3",
      prompt: "Choose the x-intercepts.",
      latex: "y=|x|-3",
      answer: "D",
      choices: [
      ...
      hint: "Set $|x|-3=0$.",
      explanation: "$|x|=3$, so $x=-3$ or $x=3$.",
    },
    {
      id: "abs-ind-4",
      prompt: "Find the vertex coordinate.",
      latex: "y=|x+4|-2",
      answer: "(-4,-2)",
      acceptedAnswers: ["(-4, -2)", "-4,-2", "-4, -2", "(-4 , -2)"],
      hint: "The vertex occurs when the absolute value expression is zero.",
      explanation: "$x+4=0$, so the vertex is $(-4,-2)$.",
    },
    {
      id: "abs-ind-5",
      ...
      answer: "B",
      choices: [
        { label: "A", text: "The graph is shifted up 4 units." },
        { label: "B", text: "Parts of $y=x^2-4$ below the x-axis are reflected upward." },
        { label: "C", text: "The right side is deleted." },
        { label: "D", text: "The domain becomes $x\\ge0$." },
      ],
      hint: "The absolute value is around the full output.",
      explanation: "The negative-output part is reflected above the x-axis.",
    },
  ],
  commonMistakes: [
    {
      mistake: "Thinking $|f(x)|$ shifts a graph upward.",
      fix: "It reflects only the parts with negative output values above the x-axis.",
    },
    {
      mistake: "Confusing $|f(x)|$ with $f(|x|)$.",
      fix: "$|f(x)|$ changes outputs; $f(|x|)$ changes inputs.",
    },
    {
      mistake: "Giving only one solution to an absolute value equation.",
      fix: "Check both positive and negative cases unless the equation rules one out.",
    },
    {
      mistake: "Reflecting the wrong side for $f(|x|)$.",
      fix: "Keep the right side of $f(x)$ and reflect it into the left side.",
    },
  ],
  masteryQuiz: [
    {
    ...
    },
    {
      ...
      latex: "|x|=9",
      answer: "-9,9",
      acceptedAnswers: ["9,-9", "x=-9,9", "x=9,-9", "-9 and 9", "9 and -9"],
      hint: "Two values are 9 units from zero.",
      explanation: "$x=-9$ or $x=9$.",
    },
    {
      id: "abs-mastery-3",
      prompt: "Choose the correct description.",
      ...
      answer: "A",
      choices: [
        { label: "A", text: "reflect negative-output parts above the x-axis" },
        { label: "B", text: "reflect the right side into the left side" },
        { label: "C", text: "shift the graph up by one unit" },
        { label: "D", text: "restrict the domain to $x\\ge0$" },
      ],
      hint: "The absolute value is applied after the output is found.",
      explanation: "$|f(x)|$ makes negative output values positive.",
    },
    {
      id: "abs-mastery-4",
      prompt: "Choose the correct description.",
      ...
      choices: [
        { label: "A", text: "reflect parts below the x-axis upward" },
        { label: "B", text: "keep the right side and reflect it into the left side" },
        { label: "C", text: "shift the graph left by one unit" },
        { label: "D", text: "make all y-values positive" },
      ],
      hint: "The absolute value is applied before the function receives the input.",
      explanation: "$f(|x|)$ copies the right-hand side across the y-axis.",
    },
    {
      id: "abs-mastery-5",
      prompt: "Choose the range.",
      ...
      hint: "The absolute value has minimum 0.",
      explanation: "The minimum output is -5, so $y\\ge-5$.",
    },
    {
      id: "abs-mastery-6",
      prompt: "Find the vertex coordinate.",
      latex: "y=|x-3|+2",
      answer: "(3,2)",
      acceptedAnswers: ["(3, 2)", "3,2", "3, 2", "(3 , 2)"],
      hint: "Set the expression inside the absolute value equal to zero.",
      explanation: "The vertex is $(3,2)$.",
    },
    {
      id: "abs-mastery-7",
      prompt: "Solve the equation.",
      latex: "|x+2|=5",
      answer: "-7,3",
      acceptedAnswers: ["3,-7", "x=-7,3", "x=3,-7", "-7 and 3", "3 and -7"],
      hint: "Set $x+2=5$ or $x+2=-5$.",
      explanation: "The solutions are $x=3$ and $x=-7$.",
    },
    {
      id: "abs-mastery-8",
      prompt: "Choose the x-intercepts.",
      ...
      hint: "Set the output equal to zero.",
      explanation: "$|x-2|=4$, so $x=-2$ or $x=6$.",
    },
    {
      id: "abs-mastery-9",
      prompt: "The graph of f has a point at (-2,-5). Which point must appear on y=|f(x)|?",
      latex: "(-2,-5)\\text{ on }y=f(x)",
      answer: "C",
      choices: [
        { label: "A", text: "$(-2,-5)$" },
        { label: "B", text: "$(2,5)$" },
      ...
      hint: "The x-value stays the same, and the y-value becomes positive.",
      explanation: "$|f(-2)|=|-5|=5$, so the point becomes $(-2,5)$.",
    },
    {
      id: "abs-mastery-10",
      prompt: "The graph of f has a point at (4,-1). Which point must appear on y=f(|x|)?",
      latex: "(4,-1)\\text{ on }y=f(x)",
      answer: "A",
      choices: [
        { label: "A", text: "$(-4,-1)$" },
        { label: "B", text: "$(-4,1)$" },
      ...
      hint: "The right-hand point is reflected across the y-axis.",
...
export const inverseFunctionsLesson: ExplicitLesson = {
  ...
  description:
    "Use inverse function notation, reflection in y=x, domain restrictions and simple algebraic inverse relationships.",
  syllabusArea: "Functions",
  focus: "Graphing techniques",
  status: "active",
  video: {
  ...
  learningIntention:
    "Learn how inverse functions reverse a function's action and how domain restrictions make inverses possible.",
  successCriteria: [
    "Interpret $f^{-1}(x)$ as an inverse function, not a reciprocal.",
    "Use input-output pairs to identify inverse points.",
    "Describe inverse graphs as reflections in $y=x$.",
    "Use the horizontal line test to decide whether an inverse function exists.",
    "Restrict the domain of a function to make it one-to-one.",
    "Find simple inverse functions when the form is constrained.",
  ],
  teaching: {
    paragraphs: [
      "An inverse function reverses the input-output relationship of the original function.",
      "If $f(a)=b$, then $f^{-1}(b)=a$. On a graph, the point $(a,b)$ on $y=f(x)$ corresponds to $(b,a)$ on $y=f^{-1}(x)$.",
      "The graph of an inverse function is the reflection of the original graph in the line $y=x$.",
      "A function needs to be one-to-one to have an inverse function. The horizontal line test checks whether each output is produced once.",
      "Some functions need a restricted domain before an inverse function can be defined, such as choosing one branch of a parabola.",
      "The notation $f^{-1}(x)$ means inverse function. It does not mean $1/f(x)$.",
    ],
    latexBlocks: [
      "f(a)=b\\quad \\Rightarrow\\quad f^{-1}(b)=a",
      "(a,b)\\text{ on }y=f(x)\\quad \\Rightarrow\\quad (b,a)\\text{ on }y=f^{-1}(x)",
      "\\text{inverse graphs reflect in }y=x",
      "f^{-1}(x)\\ne \\frac{1}{f(x)}",
    ],
  },
  workedExamples: [
    {
      title: "Worked example 1: Reverse an input-output pair",
      questionLatex: "f(3)=10",
      steps: [
        { explanation: "The function sends input 3 to output 10." },
        { explanation: "The inverse reverses this relationship.", latex: "f^{-1}(10)=3" },
      ],
      finalAnswerLatex: "f^{-1}(10)=3",
    },
    {
      title: "Worked example 2: Find a simple inverse",
      questionLatex: "f(x)=2x-5",
      steps: [
        { explanation: "Write the function as y equals the expression.", latex: "y=2x-5" },
        { explanation: "Swap x and y.", latex: "x=2y-5" },
        { explanation: "Solve for y.", latex: "y=\\frac{x+5}{2}" },
      ],
      finalAnswerLatex: "f^{-1}(x)=\\frac{x+5}{2}",
    },
    {
      title: "Worked example 3: Restrict a domain",
      questionLatex: "f(x)=x^2",
      steps: [
        { explanation: "The full parabola fails the horizontal line test." },
        { explanation: "Restricting to the right branch makes it one-to-one.", latex: "x\\ge0" },
        { explanation: "Then the inverse relation becomes a function.", latex: "f^{-1}(x)=\\sqrt{x}" },
      ],
      finalAnswerLatex: "\\text{Restrict to }x\\ge0\\text{ for the principal inverse.}",
    },
  ],
  guidedPractice: [
    {
      id: "inv-guided-1",
      prompt: "Use the inverse relationship.",
      latex: "f(4)=9",
      answer: "4",
      hint: "The inverse reverses input and output.",
      explanation: "$f^{-1}(9)=4$.",
    },
    {
      id: "inv-guided-2",
      prompt: "Choose the inverse point.",
      latex: "(2,7)\\text{ on }y=f(x)",
      answer: "B",
      choices: [
        { label: "A", text: "$(2,7)$" },
        { label: "B", text: "$(7,2)$" },
      ...
      hint: "Reflecting in $y=x$ swaps coordinates.",
      explanation: "The inverse graph contains $(7,2)$.",
    },
    {
      id: "inv-guided-3",
      prompt: "Choose the correct inverse function.",
      latex: "f(x)=x+6",
      answer: "A",
      choices: [
        { label: "A", text: "$f^{-1}(x)=x-6$" },
        { label: "B", text: "$f^{-1}(x)=\\frac1{x+6}$" },
        { label: "C", text: "$f^{-1}(x)=x+6$" },
        { label: "D", text: "$f^{-1}(x)=6x$" },
      ],
      hint: "The inverse undoes adding 6.",
      explanation: "Subtracting 6 reverses adding 6.",
    },
    {
      id: "inv-guided-4",
      prompt: "Which test checks whether a graph has an inverse function?",
      latex: "\\text{one-to-one function}",
      answer: "C",
      choices: [
        { label: "A", text: "vertical asymptote test" },
        { label: "B", text: "x-intercept test" },
        { label: "C", text: "horizontal line test" },
        { label: "D", text: "second derivative test" },
      ],
      hint: "An inverse function needs each output to occur once.",
      explanation: "The horizontal line test checks whether each y-value occurs once.",
    },
  ],
  independentPractice: [
    {
      ...
      latex: "g(-2)=5",
      answer: "-2",
      hint: "The inverse sends output 5 back to input -2.",
      explanation: "$g^{-1}(5)=-2$.",
    },
    {
      id: "inv-ind-2",
      ...
      answer: "D",
      choices: [
        { label: "A", text: "$f^{-1}(x)=3x-1$" },
        { label: "B", text: "$f^{-1}(x)=\\frac{1}{3x+1}$" },
        { label: "C", text: "$f^{-1}(x)=\\frac{x}{3}+1$" },
        { label: "D", text: "$f^{-1}(x)=\\frac{x-1}{3}$" },
      ],
      hint: "Undo adding 1, then undo multiplying by 3.",
      explanation: "Solving $x=3y+1$ gives $y=(x-1)/3$.",
    },
    {
      id: "inv-ind-3",
      prompt: "Which statement describes inverse graphs?",
      latex: "y=f(x)\\text{ and }y=f^{-1}(x)",
      answer: "A",
      choices: [
        { label: "A", text: "They are reflections in $y=x$." },
        { label: "B", text: "They are always translations." },
        { label: "C", text: "They are reflections in the x-axis." },
        { label: "D", text: "They always have the same domain." },
      ],
      hint: "Inverse graphs swap coordinates.",
      explanation: "Swapping coordinates is reflection in $y=x$.",
    },
    {
      id: "inv-ind-4",
      prompt: "Which restriction makes the parabola one-to-one on the right branch?",
      latex: "f(x)=x^2",
      answer: "B",
      choices: [
      ...
      hint: "Choose one side of the parabola.",
      explanation: "Restricting to $x\\ge0$ keeps the right branch only.",
    },
    {
      id: "inv-ind-5",
      prompt: "Choose the correct statement about notation.",
      latex: "f^{-1}(x)",
      answer: "C",
      choices: [
        { label: "A", text: "It always means $\\frac1{f(x)}$." },
        { label: "B", text: "It means the derivative of f." },
        { label: "C", text: "It means the inverse function." },
        { label: "D", text: "It means f is negative." },
      ],
      hint: "The superscript -1 is function notation here.",
      explanation: "$f^{-1}(x)$ means the inverse function, not the reciprocal.",
    },
  ],
  commonMistakes: [
    {
      mistake: "Confusing inverse function notation with a reciprocal.",
      fix: "$f^{-1}(x)$ means inverse function, not $1/f(x)$.",
    },
    {
      mistake: "Forgetting to swap x and y when finding an inverse.",
      fix: "Write $y=f(x)$, swap x and y, then solve for y.",
    },
    {
      mistake: "Assuming every function has an inverse function on its full domain.",
      fix: "Use the horizontal line test and restrict the domain if needed.",
    },
    {
      mistake: "Reflecting inverse graphs in the wrong line.",
      fix: "Inverse graphs reflect in $y=x$, not the x-axis or y-axis.",
    },
  ],
  masteryQuiz: [
    {
      ...
      answer: "5",
      hint: "The inverse reverses input and output.",
      explanation: "$f^{-1}(12)=5$.",
    },
    {
      id: "inv-mastery-2",
      prompt: "Choose the inverse point.",
      latex: "(-3,8)\\text{ on }y=f(x)",
      answer: "D",
      choices: [
        { label: "A", text: "$(-3,8)$" },
        { label: "B", text: "$(3,-8)$" },
      ...
      hint: "Swap the coordinates.",
      explanation: "The inverse graph contains $(8,-3)$.",
    },
    {
      id: "inv-mastery-3",
      prompt: "Choose the correct inverse function.",
      ...
      answer: "B",
      choices: [
        { label: "A", text: "$f^{-1}(x)=2x+7$" },
        { label: "B", text: "$f^{-1}(x)=\\frac{x+7}{2}$" },
        { label: "C", text: "$f^{-1}(x)=\\frac1{2x-7}$" },
        { label: "D", text: "$f^{-1}(x)=\\frac{x-7}{2}$" },
      ],
      hint: "Undo subtracting 7, then undo multiplying by 2.",
      explanation: "Solving $x=2y-7$ gives $y=(x+7)/2$.",
    },
    {
      id: "inv-mastery-4",
      prompt: "Which graph test is relevant for deciding whether an inverse function exists?",
      latex: "f^{-1}\\text{ as a function}",
      answer: "A",
      choices: [
        { label: "A", text: "horizontal line test" },
        { label: "B", text: "vertical shift test" },
        { label: "C", text: "trapezoidal rule" },
        { label: "D", text: "point-gradient test" },
      ],
      hint: "Each output must occur once.",
      explanation: "A graph must pass the horizontal line test to have an inverse function on that domain.",
    },
    {
      id: "inv-mastery-5",
      prompt: "Which restriction gives the left branch of the parabola?",
      latex: "f(x)=x^2",
      answer: "C",
      choices: [
        { label: "A", text: "$x\\ge0$" },
      ...
      hint: "The left branch uses non-positive x-values.",
      explanation: "The left branch is obtained with $x\\le0$.",
    },
    {
      id: "inv-mastery-6",
      prompt: "Choose the correct inverse function.",
      latex: "f(x)=\\frac{x-4}{3}",
      answer: "A",
      choices: [
        { label: "A", text: "$f^{-1}(x)=3x+4$" },
        { label: "B", text: "$f^{-1}(x)=\\frac{x+4}{3}$" },
        { label: "C", text: "$f^{-1}(x)=\\frac{3}{x-4}$" },
        { label: "D", text: "$f^{-1}(x)=3x-4$" },
      ],
      hint: "Undo dividing by 3, then undo subtracting 4.",
      explanation: "Solving $x=(y-4)/3$ gives $y=3x+4$.",
    },
    {
      id: "inv-mastery-7",
      prompt: "Choose the correct relationship between domains and ranges.",
      latex: "y=f(x),\\quad y=f^{-1}(x)",
      answer: "B",
      choices: [
        { label: "A", text: "The domains are always identical." },
        { label: "B", text: "The domain of one is the range of the other." },
        { label: "C", text: "The ranges are always all real numbers." },
        { label: "D", text: "The inverse has no range." },
      ],
      hint: "The inverse swaps inputs and outputs.",
      explanation: "Inputs and outputs swap between a function and its inverse.",
    },
    {
      id: "inv-mastery-8",
      prompt: "Choose the correct statement.",
      latex: "f^{-1}(x)\\text{ notation}",
      answer: "D",
      choices: [
        { label: "A", text: "$f^{-1}(x)=\\frac1x$ for every function" },
        { label: "B", text: "$f^{-1}(x)=f(x)-1$" },
        { label: "C", text: "$f^{-1}(x)$ is the reflection of $f(x)$ in the x-axis" },
        { label: "D", text: "$f^{-1}(x)$ reverses the action of $f(x)$" },
      ],
      hint: "Think of undoing the function.",
      explanation: "The inverse function reverses the original function's input-output rule.",
    },
    {
      id: "inv-mastery-9",
      prompt: "A function has domain $x\\ge2$ and range $y\\ge5$. What is the domain of its inverse?",
      latex: "\\text{domain and range swap}",
      answer: "C",
      choices: [
        { label: "A", text: "$x\\ge2$" },
        { label: "B", text: "$y\\ge5$" },
      ...
      hint: "The inverse domain comes from the original range.",
      explanation: "The original range $y\\ge5$ becomes the inverse domain $x\\ge5$.",
    },
    {
      id: "inv-mastery-10",
      prompt: "Which statement best explains why $f(x)=x^2$ on all real x does not have an inverse function?",
      latex: "f(x)=x^2",
      answer: "A",
      choices: [
        { label: "A", text: "It fails the horizontal line test." },
        { label: "B", text: "It has no y-intercept." },
        { label: "C", text: "It is not defined at x=0." },
        { label: "D", text: "It has no range." },
      ],
      hint: "Many different inputs can give the same output.",
...
const choiceQuestion = (
  ...
  difficulty: number,
  explanation: string,
  hint = "Separate the inside change from the outside change before choosing.",
): PracticeQuestion => ({
  id,
  prompt,
  latex,
...
const typedQuestion = (
  ...
  hint = "Track what happens to the input and output values.",
): PracticeQuestion => ({
  id,
  prompt,
  latex,
...
graphTransformationsLesson.masteryQuizPool = cloneForMasteryPool(graphTransformationsLesson, [
  choiceQuestion(
    "gt-pool-extra-1",
    "Which description matches the transformed graph?",
    "y=f(x+5)-2",
    "C",
    ["right 5, down 2", "left 5, up 2", "left 5, down 2", "right 5, up 2"],
    3,
    "$f(x+5)$ shifts left 5 because the input has changed; the $-2$ outside shifts the graph down 2.",
  ),
  choiceQuestion(
    "gt-pool-extra-2",
    "Which description matches the transformed graph?",
    ...
    "B",
    [
      "left 4, reflect in the x-axis, up 1",
      "right 4, reflect in the x-axis, up 1",
      "right 4, reflect in the y-axis, up 1",
      "right 4, vertical stretch by 4, up 1",
    ],
    3,
    "$x-4$ shifts right 4; the negative outside reflects in the x-axis; $+1$ shifts up 1.",
  ),
  typedQuestion(
    "gt-pool-extra-3",
    "The point $(2,7)$ on $y=f(x)$ moves to $(5,3)$ on $y=f(x-a)+b$. Find $a+b$.",
    "y=f(x-a)+b",
    "-1",
    4,
    "The x-coordinate increased by 3, so $a=3$. The y-coordinate decreased by 4, so $b=-4$. Hence $a+b=-1$.",
    [],
    "Compare the old and new coordinates rather than substituting into a formula.",
  ),
  typedQuestion(
    "gt-pool-extra-4",
    "The vertex of $y=x^2$ becomes $(6,-5)$ after a translation. Find the horizontal shift.",
    "y=(x-6)^2-5",
    "6",
    4,
    "The vertex of $y=x^2$ is $(0,0)$. In $y=(x-6)^2-5$ it becomes $(6,-5)$, so the horizontal shift is 6 units right.",
    ["right 6", "6 right"],
  ),
  choiceQuestion(
    "gt-pool-extra-5",
    "Which rule moves $y=f(x)$ right 2 and up 7?",
    "",
    "D",
    ["$y=f(x+2)+7$", "$y=f(x-7)+2$", "$y=f(x+2)-7$", "$y=f(x-2)+7$"],
    4,
    "A right shift by 2 is written as $f(x-2)$, and an upward shift by 7 is written outside as $+7$.",
  ),
  typedQuestion(
    "gt-pool-extra-6",
    "A point $(1,-3)$ on $y=f(x)$ is transformed by $y=2f(x-4)+5$. Find its new y-coordinate.",
    "y=2f(x-4)+5",
    "-1",
    4,
    "The outside transformation sends each output $y$ to $2y+5$. For $y=-3$, the new y-coordinate is $2(-3)+5=-1$.",
    [],
    "Only the outside operations affect the y-coordinate.",
  ),
  typedQuestion(
    "gt-pool-extra-7",
    "A point $(1,-3)$ on $y=f(x)$ is transformed by $y=2f(x-4)+5$. Find its new x-coordinate.",
    "y=2f(x-4)+5",
    "5",
    4,
    "$f(x-4)$ shifts every point right 4, so the x-coordinate $1$ becomes $5$.",
    [],
    "Only the inside translation affects the x-coordinate here.",
  ),
  choiceQuestion(
    "gt-pool-extra-8",
    "Which transformation is the horizontal effect?",
    "y=f(3x)",
    "A",
    [
      "horizontal dilation by factor $1/3$",
      "horizontal dilation by factor $3$",
      "vertical dilation by factor $3$",
      "translation right $3$",
    ],
    5,
    "Inside multiplication by 3 means the input reaches the same function value three times faster, so the graph is horizontally compressed by factor $1/3$.",
  ),
  typedQuestion(
    "gt-pool-extra-9",
    "The point $(-2,4)$ on $y=f(x)$ moves under $y=-3f(x+1)+2$. Find the new coordinate as $(x,y)$.",
    "y=-3f(x+1)+2",
    "(-3,-10)",
    5,
    "$f(x+1)$ shifts the point left 1, so $x=-3$. The outside rule sends $y$ to $-3y+2$, giving $-3(4)+2=-10$.",
    ["(-3, -10)", "-3,-10", "-3, -10"],
  ),
  typedQuestion(
    "gt-pool-extra-10",
    "The point $(8,6)$ on a transformed graph came from $(3,2)$ on $y=f(x)$ using $y=af(x-h)+k$. Given $a=2$, find $h+k$.",
    "y=af(x-h)+k",
    "7",
    5,
    "The x-coordinate moves from 3 to 8, so $h=5$. The y-coordinate satisfies $6=2(2)+k$, so $k=2$. Hence $h+k=7$.",
    [],
    "Find the horizontal and vertical parameters from the coordinate movement.",
  ),
  typedQuestion(
    "gt-pool-extra-11",
    "For $y=af(x-h)+k$, the point $(2,5)$ moves to $(-1,-7)$. If $a=-2$, find $h+k$.",
    "y=af(x-h)+k",
    "0",
    5,
    "The x-coordinate changes from 2 to -1, so $h=-3$. The y-coordinate satisfies $-7=-2(5)+k$, so $k=3$. Thus $h+k=0$.",
    [],
    "Use the coordinate movement: $x$ shifts by $h$, while $y$ becomes $ay+k$.",
  ),
]);

graphTransformationsLesson.multiPartPractice = [
  {
    id: "gt-multipart-1",
    prompt:
      "A point $(4,-2)$ lies on $y=f(x)$. The graph is transformed to $y=-2f(x-3)+5$.",
    latex: "y=-2f(x-3)+5",
    answer: "7",
    acceptedAnswers: [],
    hint: "Apply the horizontal shift to the x-coordinate and the outside rule to the y-coordinate.",
    explanation:
      "The inside change shifts the point right 3. The outside transformation sends each output $y$ to $-2y+5$.",
    parts: [
      {
        key: "a",
        label: "(a)",
        prompt: "Find the new x-coordinate.",
        marks: 1,
        answer: "7",
        hint: "$x-3$ shifts the point right 3.",
        explanation: "The x-coordinate changes from 4 to 7.",
      },
      {
        key: "b",
        label: "(b)",
        prompt: "Find the new y-coordinate.",
        marks: 2,
        answer: "9",
        hint: "The output is multiplied by $-2$ and then increased by 5.",
        explanation: "The y-coordinate becomes $-2(-2)+5=9$.",
        working: ["-2(-2)+5=9"],
      },
      {
        key: "c",
        label: "(c)",
        prompt: "Find $h+k$ if the point movement is written as $(x,y)\\mapsto(x+h,-2y+k)$.",
        marks: 2,
        answer: "8",
        hint: "Use the horizontal shift and the outside constant.",
        explanation: "Here $h=3$ and $k=5$, so $h+k=8$.",
      },
    ],
  },
];

reflectionsStretchesTranslationsLesson.masteryQuizPool = cloneForMasteryPool(reflectionsStretchesTranslationsLesson, [
  choiceQuestion(
    "rst-pool-extra-1",
    "Which description matches the transformation?",
    "y=-4f(x+2)-3",
    "A",
    [
      "left 2, reflect in x-axis, vertical dilation by 4, down 3",
      "right 2, reflect in x-axis, vertical dilation by 4, down 3",
      "left 2, reflect in y-axis, vertical dilation by 4, down 3",
      "left 2, horizontal dilation by 4, down 3",
    ],
    3,
    "$x+2$ shifts left 2. The $-4$ outside reflects in the x-axis and vertically dilates by factor 4. The $-3$ shifts down 3.",
  ),
  choiceQuestion(
    "rst-pool-extra-2",
    ...
    "C",
    [
      "Reflect in the x-axis and vertically stretch by 2",
      "Shift left 2",
      "Reflect in the y-axis and horizontally dilate by factor $1/2$",
      "Reflect in the y-axis and horizontally dilate by factor $2$",
    ],
    3,
    "The negative inside reflects in the y-axis, and the inside factor 2 gives horizontal dilation by reciprocal factor $1/2$.",
  ),
  typedQuestion(
    "rst-pool-extra-3",
    "Under $y=3f(2x)-1$, a point has original y-coordinate $4$. Find its transformed y-coordinate.",
    "y=3f(2x)-1",
    "11",
    4,
    "The outside rule sends $y$ to $3y-1$. Therefore $3(4)-1=11$.",
    [],
    "Inside changes affect x-values; outside changes affect y-values.",
  ),
  typedQuestion(
    "rst-pool-extra-4",
    "Under $y=f(2x)$, the original point has x-coordinate $6$. Find the transformed x-coordinate.",
    "y=f(2x)",
    "3",
    4,
    "The horizontal dilation factor is $1/2$, so the x-coordinate $6$ becomes $3$.",
  ),
  choiceQuestion(
    "rst-pool-extra-5",
    "Which rule reflects $y=f(x)$ in the y-axis, horizontally compresses it by factor $1/3$, and shifts it up 2?",
    "",
    "B",
    ["$y=-3f(x)+2$", "$y=f(-3x)+2$", "$y=f(x+3)+2$", "$y=3f(-x)+2$"],
    4,
    "A y-axis reflection and horizontal factor $1/3$ both happen inside, giving $f(-3x)$. The upward shift is $+2$ outside.",
  ),
  typedQuestion(
    "rst-pool-extra-6",
    "A point $(6,1)$ on $y=f(x)$ is transformed by $y=-f(3x)+4$. Find the new coordinate.",
    "y=-f(3x)+4",
    "(2,3)",
    5,
    "The x-coordinate is multiplied by $1/3$, so $6$ becomes $2$. The y-coordinate becomes $-1+4=3$.",
    ["(2, 3)", "2,3", "2, 3"],
  ),
  typedQuestion(
    "rst-pool-extra-7",
    "A transformed point is $(5,-8)$ under $y=2f(x-1)-4$. Find the original y-coordinate.",
    "y=2f(x-1)-4",
    "-2",
    5,
    "The output rule is $Y=2y-4$. Solve $-8=2y-4$ to get $2y=-4$, so $y=-2$.",
    [],
    "Work backwards through the outside transformation.",
  ),
  typedQuestion(
    "rst-pool-extra-8",
    "A transformed point is $(5,-8)$ under $y=2f(x-1)-4$. Find the original x-coordinate.",
    "y=2f(x-1)-4",
    "4",
    5,
    "The rule $f(x-1)$ shifts points right 1, so a transformed x-coordinate of 5 came from $x=4$.",
  ),
  choiceQuestion(
    "rst-pool-extra-9",
    "Which expression has no reflection but includes both a horizontal and vertical dilation?",
    "",
    "D",
    ["$y=-2f(3x)$", "$y=2f(-3x)$", "$y=-f(x+3)$", "$y=2f(3x)$"],
    4,
    "$y=2f(3x)$ has vertical dilation factor 2 and horizontal dilation factor $1/3$, with no negative sign causing a reflection.",
  ),
  typedQuestion(
    "rst-pool-extra-10",
    "Under $y=af(bx)$, the point $(10,3)$ moves to $(2,12)$. Find $ab$.",
    "y=af(bx)",
    "20",
    5,
    "The x-coordinate changed by factor $1/b$: $10/b=2$, so $b=5$. The y-coordinate changed by factor $a$: $3a=12$, so $a=4$. Thus $ab=20$.",
    [],
  ),
  typedQuestion(
    "rst-pool-extra-11",
    "Under $y=af(bx)$, the point $(8,-2)$ moves to $(-4,6)$. If the negative x-change is caused by $b<0$, find $a+b$.",
    "y=af(bx)",
    "-5",
    5,
    "The x-coordinate satisfies $8/b=-4$, so $b=-2$. The y-coordinate satisfies $-2a=6$, so $a=-3$. Hence $a+b=-5$.",
    [],
    "For $f(bx)$, transformed x-values equal original x-values divided by $b$.",
  ),
]);

reflectionsStretchesTranslationsLesson.multiPartPractice = [
  {
    id: "rst-multipart-1",
    prompt:
      "The point $(8,-1)$ lies on $y=f(x)$. It is transformed by $y=3f(-2x)+5$.",
    latex: "y=3f(-2x)+5",
    answer: "-4",
    acceptedAnswers: [],
    hint: "For $f(bx)$, divide the original x-coordinate by $b$; for outside changes, use $Y=3y+5$.",
    explanation:
      "The inside factor is $b=-2$, so x-values divide by $-2$. The outside rule sends $y$ to $3y+5$.",
    parts: [
      {
        key: "a",
        label: "(a)",
        prompt: "Find the transformed x-coordinate.",
        marks: 2,
        answer: "-4",
        hint: "Divide the original x-coordinate by $-2$.",
        explanation: "The transformed x-coordinate is $8/(-2)=-4$.",
        working: ["8\\div(-2)=-4"],
      },
      {
        key: "b",
        label: "(b)",
        prompt: "Find the transformed y-coordinate.",
        marks: 1,
        answer: "2",
        hint: "Apply $Y=3y+5$ to the original y-coordinate.",
        explanation: "The y-coordinate becomes $3(-1)+5=2$.",
      },
      {
        key: "c",
        label: "(c)",
        prompt: "Find $a+b$ if the transformation is written as $y=af(bx)+5$.",
        marks: 2,
        answer: "1",
        hint: "Read $a$ and $b$ directly from the rule.",
        explanation: "Here $a=3$ and $b=-2$, so $a+b=1$.",
      },
    ],
  },
];

asymptotesReciprocalGraphsLesson.masteryQuizPool = cloneForMasteryPool(asymptotesReciprocalGraphsLesson, [
  choiceQuestion(
    "arg-pool-extra-1",
    "Which pair of asymptotes matches the graph?",
    "y=\\frac{1}{x-4}+2",
    "C",
    ["$x=2, y=4$", "$x=-4, y=2$", "$x=4, y=2$", "$x=4, y=-2$"],
    3,
    "The denominator is zero at $x=4$, so the vertical asymptote is $x=4$. The outside shift gives horizontal asymptote $y=2$.",
  ),
  choiceQuestion(
    "arg-pool-extra-2",
    "Which graph feature changes when $y=1/x$ becomes $y=1/x-6$?",
    "",
    "A",
    ["horizontal asymptote", "vertical asymptote", "domain only", "neither asymptote"],
    3,
    "Subtracting 6 outside the fraction shifts the graph down 6, moving the horizontal asymptote to $y=-6$.",
  ),
  typedQuestion(
    "arg-pool-extra-3",
    "Find the vertical asymptote value for the reciprocal graph.",
    "y=\\frac{3}{x+7}-1",
    "-7",
    4,
    "The vertical asymptote occurs where the denominator is zero: $x+7=0$, so $x=-7$.",
    ["x=-7"],
  ),
  typedQuestion(
    "arg-pool-extra-4",
    "Find the horizontal asymptote value for the reciprocal graph.",
    "y=\\frac{-2}{x-5}+9",
    "9",
    4,
    "The reciprocal term approaches 0 for large $|x|$, so the graph approaches $y=9$.",
    ["y=9"],
  ),
  typedQuestion(
    "arg-pool-extra-5",
    "For $y=\\frac{a}{x-h}+k$, the asymptotes are $x=-3$ and $y=4$. Find $h+k$.",
    "y=\\frac{a}{x-h}+k",
    "1",
    4,
    "The vertical asymptote is $x=h$, so $h=-3$. The horizontal asymptote is $y=k$, so $k=4$. Thus $h+k=1$.",
  ),
  choiceQuestion(
    "arg-pool-extra-6",
    "Which rule has vertical asymptote $x=2$ and horizontal asymptote $y=-5$?",
    "",
    "B",
    ["$y=\\frac{1}{x+2}-5$", "$y=\\frac{1}{x-2}-5$", "$y=\\frac{1}{x+5}+2$", "$y=\\frac{1}{x-5}+2$"],
    4,
    "A vertical asymptote at $x=2$ needs denominator $x-2$. A horizontal asymptote at $y=-5$ needs $-5$ outside.",
  ),
  typedQuestion(
    "arg-pool-extra-7",
    ...
    "3",
    5,
    "Set $y=0$: $0=6/(x-1)-3$, so $3=6/(x-1)$ and $x-1=2$. Hence $x=3$.",
    ["(3,0)", "(3, 0)"],
    "At the x-intercept, the y-value is 0.",
  ),
  typedQuestion(
    "arg-pool-extra-8",
    ...
    "3",
    5,
    "At the y-intercept, $x=0$. Then $y=8/(0+2)-1=4-1=3$.",
    ["(0,3)", "(0, 3)"],
  ),
  choiceQuestion(
    "arg-pool-extra-9",
    "A reciprocal graph has branches in the top-right and bottom-left relative to its centre. Which sign must $a$ have?",
    "y=\\frac{a}{x-h}+k",
    "A",
    ["positive", "negative", "zero", "cannot be determined from the branches"],
    5,
    "For $a>0$, the reciprocal branches sit top-right and bottom-left from the centre $(h,k)$. For $a<0$, they sit top-left and bottom-right.",
  ),
  typedQuestion(
    "arg-pool-extra-10",
    "For $y=\\frac{a}{x-2}+1$, the point $(4,5)$ lies on the graph. Find $a$.",
    "y=\\frac{a}{x-2}+1",
    "8",
    5,
    "Substitute $(4,5)$: $5=a/(4-2)+1$, so $4=a/2$ and $a=8$.",
  ),
  typedQuestion(
    "arg-pool-extra-11",
    "For $y=\\frac{a}{x-h}+k$, the asymptotes meet at $(5,-2)$ and the graph passes through $(7,1)$. If $a=6$, find the y-value when $x=8$.",
    "y=\\frac{6}{x-5}-2",
    "0",
    5,
    "The centre is $(5,-2)$, so the rule is $y=6/(x-5)-2$. At $x=8$, $y=6/3-2=0$.",
  ),
]);

asymptotesReciprocalGraphsLesson.multiPartPractice = [
  {
    id: "arg-multipart-1",
    prompt:
      "A reciprocal-style graph has equation $y=\\frac{a}{x-h}+k$. Its asymptotes meet at $(3,-2)$ and it passes through $(5,4)$.",
    latex: "y=\\frac{a}{x-h}+k",
    answer: "3",
    acceptedAnswers: [],
    hint: "The asymptote intersection gives $h$ and $k$ before you use the point.",
    explanation:
      "The centre gives $h=3$ and $k=-2$. Substituting the point then determines the stretch parameter.",
    parts: [
      {
        key: "a",
        label: "(a)",
        ...
        marks: 1,
        answer: "3",
        hint: "The vertical asymptote is $x=h$.",
        explanation: "The asymptotes meet at x-coordinate 3, so $h=3$.",
      },
      {
        key: "b",
        label: "(b)",
        ...
        answer: "-2",
        acceptedAnswers: ["-2"],
        hint: "The horizontal asymptote is $y=k$.",
        explanation: "The asymptotes meet at y-coordinate -2, so $k=-2$.",
      },
      {
        key: "c",
        label: "(c)",
        ...
        marks: 3,
        answer: "12",
        hint: "Substitute $(5,4)$ after using $h=3$ and $k=-2$.",
        explanation: "Substitute $(5,4)$: $4=a/(5-3)-2$, so $6=a/2$ and $a=12$.",
        working: ["4=\\frac{a}{5-3}-2", "6=\\frac{a}{2}", "a=12"],
      },
    ],
  },
];

inverseFunctionsLesson.masteryQuizPool = cloneForMasteryPool(inverseFunctionsLesson, [
  choiceQuestion(
    "inv-pool-extra-1",
    "Which statement must be true if $g=f^{-1}$?",
    "",
    "D",
    ["$g(x)=1/f(x)$", "$g$ has the same graph as $f$", "$f(g(x))=0$", "$f(g(x))=x$"],
    3,
    "An inverse function undoes the original function, so composing them returns the original input: $f(g(x))=x$.",
  ),
  typedQuestion(
    "inv-pool-extra-2",
    "If $f(7)=11$, find $f^{-1}(11)$.",
    "",
    "7",
    3,
    "The inverse reverses input and output. Since $f$ sends 7 to 11, $f^{-1}$ sends 11 back to 7.",
  ),
  typedQuestion(
    "inv-pool-extra-3",
    "Find $f^{-1}(10)$ for the function.",
    "f(x)=3x+1",
    "3",
    4,
    "Solve $10=3x+1$. Then $3x=9$, so $x=3$. Therefore $f^{-1}(10)=3$.",
  ),
  typedQuestion(
    "inv-pool-extra-4",
    ...
    "13",
    4,
    "Solve $2=(x-5)/4$. Then $8=x-5$, so $x=13$.",
  ),
  choiceQuestion(
    "inv-pool-extra-5",
    "Which restriction makes this function one-to-one on the restricted domain?",
    "f(x)=x^2",
    "B",
    ["all real $x$", "$x\\ge 0$", "$-2\\le x\\le 2$", "$x\\ne 0$"],
    4,
    "On $x\\ge0$, the parabola passes the horizontal line test, so an inverse function exists on that restricted domain.",
  ),
  typedQuestion(
    "inv-pool-extra-6",
    "For $f(x)=2x-9$, find the value of $x$ such that $f^{-1}(x)=6$.",
    "f(x)=2x-9",
    "3",
    5,
    "If $f^{-1}(x)=6$, then $x=f(6)$. Calculate $f(6)=12-9=3$.",
    [],
    "Use the inverse meaning: the inverse output is the original input.",
  ),
  typedQuestion(
    "inv-pool-extra-7",
    "If $f(x)=\\sqrt{x-1}$ with domain $x\\ge1$, find $f^{-1}(4)$.",
    "f(x)=\\sqrt{x-1}",
    "17",
    5,
    "Solve $4=\\sqrt{x-1}$. Squaring gives $16=x-1$, so $x=17$.",
  ),
  choiceQuestion(
    "inv-pool-extra-8",
    "The graph of $f^{-1}$ is obtained from the graph of $f$ by reflecting in which line?",
    "",
    "A",
    ["$y=x$", "$x=0$", "$y=0$", "$y=-x$"],
    3,
    "Inverse graphs swap x- and y-coordinates, which is reflection in the line $y=x$.",
  ),
  typedQuestion(
    "inv-pool-extra-9",
    "The point $(-4,9)$ lies on $y=f(x)$. Find the corresponding point on $y=f^{-1}(x)$.",
    "",
    "(9,-4)",
    4,
    "Inverse functions swap coordinates, so $(-4,9)$ becomes $(9,-4)$.",
    ["(9, -4)", "9,-4", "9, -4"],
  ),
  typedQuestion(
    "inv-pool-extra-10",
    "For $f(x)=ax+5$, $f^{-1}(17)=3$. Find $a$.",
    "f(x)=ax+5",
    "4",
    5,
    "$f^{-1}(17)=3$ means $f(3)=17$. Therefore $3a+5=17$, so $a=4$.",
  ),
  typedQuestion(
    "inv-pool-extra-11",
    "For $f(x)=\\frac{x+b}{3}$, $f^{-1}(5)=8$. Find $b$.",
    "f(x)=\\frac{x+b}{3}",
    "7",
    5,
    "$f^{-1}(5)=8$ means $f(8)=5$. So $(8+b)/3=5$, giving $8+b=15$ and $b=7$.",
  ),
]);

inverseFunctionsLesson.multiPartPractice = [
  {
    id: "inv-multipart-1",
    prompt:
      "A one-to-one function is defined by $f(x)=\\frac{x-4}{3}$. Its inverse is used to recover the original input from an output.",
    latex: "f(x)=\\frac{x-4}{3}",
    answer: "2",
    acceptedAnswers: [],
    hint: "Work with the inverse meaning: an output of $f$ becomes the input of $f^{-1}$.",
    explanation:
      "The inverse reverses the mapping. Solving output equations for the original input gives the required values.",
    parts: [
      {
        key: "a",
        label: "(a)",
        ...
        marks: 1,
        answer: "2",
        hint: "Substitute $x=10$ into $f(x)$.",
        explanation: "$f(10)=(10-4)/3=2$.",
        working: ["f(10)=\\frac{10-4}{3}=2"],
      },
      {
        key: "b",
        label: "(b)",
        ...
        explanation: "Since $f(10)=2$, the inverse sends 2 back to 10.",
      },
      {
        key: "c",
        label: "(c)",
        ...
        marks: 3,
        answer: "25",
        hint: "Solve $7=(x-4)/3$ for the original input $x$.",
        explanation: "Solve $7=(x-4)/3$: $21=x-4$, so $x=25$.",
        working: ["7=\\frac{x-4}{3}", "21=x-4", "x=25"],
      },
    ],
  },
];
...
export const functionsGraphingTechniquesOutline: LessonOutlineItem[] = [
  ...
  },
  {
    ...
    title: "Absolute Value Functions",
    description:
      "Interpret absolute value transformations, graph features, equations, domain and range.",
    status: "active",
  },
  {
    id: "inverse-functions",
