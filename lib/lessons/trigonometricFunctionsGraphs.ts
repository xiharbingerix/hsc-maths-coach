  ...
  masteryQuizPool: [
    {
      ...
      latex: "135^\\circ",
      answer: "3π/4",
      acceptedAnswers: ["3pi/4", "\\frac{3\\pi}{4}"],
    ...
    {
      id: "rauc-pool-d5-2",
      prompt: "Find the exact value.",
      latex: "\\sin\\tfrac{\\pi}{3}",
      answer: "√3/2",
      acceptedAnswers: ["sqrt(3)/2", "\\frac{\\sqrt3}{2}"],
      hint: "π/3 = 60°.",
    ...
    },
    {
      ...
      hint: "Area = ½ r²θ.",
      explanation: "A = ½ × 16 × π/2 = 4π.",
      difficulty: 5,
    },
    {
      id: "rauc-pool-d5-5",
      prompt: "Find the exact value.",
      latex: "\\tan\\tfrac{5\\pi}{6}",
      answer: "-√3/3",
      acceptedAnswers: ["−√3/3", "-sqrt(3)/3", "-1/\\sqrt3", "-\\frac{\\sqrt3}{3}"],
      hint: "5π/6 is in the second quadrant; tangent is negative there.",
      explanation: "tan(5π/6) = −tan(π/6) = −1/√3 = −√3/3.",
      difficulty: 5,
    },
    {
      id: "rauc-pool-d5-6",
      prompt: "θ is acute and cos θ = 1/2. Find θ in radians.",
      latex: "\\cos\\theta = \\tfrac12,\\ \\theta\\text{ acute}",
      answer: "π/3",
      acceptedAnswers: ["pi/3", "\\frac{\\pi}{3}", "60°"],
      hint: "Which acute angle has cosine 1/2?",
      explanation: "cos(π/3) = 1/2, so θ = π/3.",
      difficulty: 5,
    },
  ],
