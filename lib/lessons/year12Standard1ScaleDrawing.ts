...
export function year12Standard1ScaleRatiosLessonOverride(
  ...
  return {
    ...
    masteryQuiz: [
      ...
      ans("rat-m9", "Two quantities are in the ratio 1 : 4. What fraction of the total is the first quantity?", "", "1/5", 4,
...
export function year12Standard1ScaleDividingRatioLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("divrat-g2", "Divide $60 in the ratio 2 : 3. Find the larger share.", "", "36", 2,
        "One part = 60 ÷ 5 = 12; larger = 3 parts.", "Total parts = 5, one part = $12; larger share = 3 × 12 = $36.",
        ["$36"]),
      ans("divrat-g3", "Divide $60 in the ratio 2 : 3. Find the smaller share.", "", "24", 2,
        "One part = $12; smaller = 2 parts.", "One part = $12; smaller share = 2 × 12 = $24.",
        ["$24"]),
      ans("divrat-g4", "Divide $100 in the ratio 1 : 4. Find the larger share.", "", "80", 2,
        "One part = 100 ÷ 5 = 20; larger = 4 parts.", "Total parts = 5, one part = $20; larger share = 4 × 20 = $80.",
        ["$80"]),
    ],
    independentPractice: [
      ans("divrat-i1", "Divide $120 in the ratio 1 : 2 : 3. Find the largest share.", "", "60", 3,
      ...
      ans("divrat-i3", "Divide 200 g of nuts in the ratio 3 : 5. Find the smaller amount (in g).", "", "75", 3,
        "One part = 200 ÷ 8 = 25 g; smaller = 3 parts.", "Total parts = 8, one part = 25 g; smaller = 3 × 25 = 75 g.",
        ["75 g"]),
      ans("divrat-i4", "Divide $90 in the ratio 4 : 5. Find the larger share.", "", "50", 3,
        "One part = 90 ÷ 9 = 10; larger = 5 parts.", "Total parts = 9, one part = $10; larger = 5 × 10 = $50.",
        ["$50"]),
      ans("divrat-i5", "Share 35 lollies in the ratio 2 : 5. Find the smaller share.", "", "10", 3,
        "One part = 35 ÷ 7 = 5; smaller = 2 parts.", "Total parts = 7, one part = 5; smaller = 2 × 5 = 10.",
        ["10 lollies"]),
    ],
    masteryQuiz: [
      ans("divrat-m1", "Divide $80 in the ratio 3 : 5. Find the larger share.", "", "50", 2,
      ...
      ans("divrat-m3", "Divide 240 in the ratio 1 : 2 : 5. Find the largest share.", "", "150", 3,
        "One part = 240 ÷ 8 = 30; largest = 5 parts.", "Total parts = 8, one part = 30; largest = 5 × 30 = 150."),
      ans("divrat-m4", "Divide $45 in the ratio 4 : 5. Find the smaller share.", "", "20", 3,
      ...
      ans("divrat-m6", "Divide a 60 cm ribbon in the ratio 1 : 3. Find the longer piece (in cm).", "", "45", 3,
        "One part = 60 ÷ 4 = 15 cm; longer = 3 parts.", "Total parts = 4, one part = 15 cm; longer = 3 × 15 = 45 cm.",
        ["45 cm"]),
      ans("divrat-m7", "Divide $150 in the ratio 2 : 3. Find the larger share.", "", "90", 3,
      ...
      ans("divrat-m9", "Divide 500 mL of cordial mix in the ratio 2 : 3. Find the smaller amount (in mL).", "", "200", 4,
        "One part = 500 ÷ 5 = 100 mL; smaller = 2 parts.", "Total parts = 5, one part = 100 mL; smaller = 2 × 100 = 200 mL.",
        ["200 mL"]),
      ans("divrat-m10", "A $1000 profit is shared in the ratio 3 : 7. Find the larger share.", "", "700", 4,
...
export function year12Standard1SimilarityScaleFactorsLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("simsf-g2", "Two similar figures have scale factor 3. A 5 cm side enlarges to what length (in cm)?", "", "15", 2,
        "Multiply by the scale factor.", "5 × 3 = 15 cm.",
        ["15 cm"]),
      ans("simsf-g3", "Two similar triangles have scale factor 2. A side of 7 cm maps to what length (in cm)?", "", "14", 2,
    ...
    independentPractice: [
      ...
      ans("simsf-i3", "A large figure's side is 20 cm and the matching side on the similar smaller figure is 5 cm. Find the scale factor from small to large.", "", "4", 3,
        "Scale factor = large ÷ small.", "20 ÷ 5 = 4.",
        ["4"]),
      ans("simsf-i4", "A shape with area 10 cm² is enlarged by length scale factor 2. Find the new area (in cm²).", "", "40", 3,
        "New area = original × k².", "k² = 2² = 4, so new area = 10 × 4 = 40 cm².",
        ["40 cm²"]),
      ans("simsf-i5", "Two similar rectangles have scale factor 5. A 3 cm side maps to what length (in cm)?", "", "15", 3,
        "Multiply by the scale factor.", "3 × 5 = 15 cm.",
        ["15 cm"]),
    ],
    masteryQuiz: [
      ans("simsf-m1", "A figure is enlarged by scale factor 3. An 8 cm side becomes what length (in cm)?", "", "24", 2,
      ...
      ans("simsf-m3", "A large side is 18 cm and the matching similar side is 6 cm. Find the scale factor from small to large.", "", "3", 3,
        "Scale factor = large ÷ small.", "18 ÷ 6 = 3.",
        ["3"]),
      ans("simsf-m4", "A figure is enlarged by scale factor 10. A 2.5 cm side becomes what length (in cm)?", "", "25", 3,
      ...
      ans("simsf-m6", "A shape with area 7 cm² is enlarged by length scale factor 2. Find the new area (in cm²).", "", "28", 3,
        "New area = original × k².", "k² = 4, so new area = 7 × 4 = 28 cm².",
        ["28 cm²"]),
      ans("simsf-m7", "Lengths are scaled by a factor of 4. By what factor is the area scaled?", "", "16", 4,
      ...
      ans("simsf-m9", "A shape has area 12 cm². It is enlarged with length scale factor 3. Find the new area (in cm²).", "", "108", 4,
...
export function year12Standard1PlansAndElevationsLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("plev-g2", "At a scale of 1 : 100, a wall is 5 cm on the plan. Find the real length in centimetres.", "", "500", 2,
        "Real = drawing × scale.", "5 × 100 = 500 cm.",
        ["500 cm"]),
      ans("plev-g3", "At a scale of 1 : 100, a 5 cm plan length represents how many metres in real life?", "", "5", 2,
    ...
    independentPractice: [
      ans("plev-i1", "At a scale of 1 : 200, a length is 4 cm on the drawing. Find the real length in metres.", "", "8", 3,
      ...
      ans("plev-i3", "A real wall is 6 m long. At a scale of 1 : 100, find its length on the drawing in centimetres.", "", "6", 3,
        "Drawing = real ÷ scale (use cm).", "6 m = 600 cm; 600 ÷ 100 = 6 cm.",
        ["6 cm"]),
      ans("plev-i4", "At a scale of 1 : 50, a length is 3 cm on the drawing. Find the real length in centimetres.", "", "150", 3,
        "Real = drawing × scale.", "3 × 50 = 150 cm.",
        ["150 cm"]),
      ans("plev-i5", "A real length is 10 m. At a scale of 1 : 250, find its length on the drawing in centimetres.", "", "4", 3,
        "Drawing = real ÷ scale (use cm).", "10 m = 1000 cm; 1000 ÷ 250 = 4 cm.",
        ["4 cm"]),
    ],
    masteryQuiz: [
      ans("plev-m1", "At a scale of 1 : 100, a 7 cm plan length represents how many metres in real life?", "", "7", 2,
      ...
      ans("plev-m3", "A real wall is 12 m. At a scale of 1 : 100, find its drawing length in centimetres.", "", "12", 3,
        "Drawing = real ÷ scale (use cm).", "12 m = 1200 cm; 1200 ÷ 100 = 12 cm.",
        ["12 cm"]),
      ans("plev-m4", "At a scale of 1 : 500, a 3 cm drawing length represents how many metres in real life?", "", "15", 3,
      ...
      ans("plev-m6", "A real length is 16 m. At a scale of 1 : 200, find its drawing length in centimetres.", "", "8", 3,
        "Drawing = real ÷ scale (use cm).", "16 m = 1600 cm; 1600 ÷ 200 = 8 cm.",
        ["8 cm"]),
      ans("plev-m7", "At a scale of 1 : 50, a 6 cm drawing length represents how many metres in real life?", "", "3", 4,
      ...
      ans("plev-m9", "A cube is viewed from directly above. What shape is its plan view?", "\\text{top view of a cube}", "square", 4,
        ...
        ["a square"]),
      ans("plev-m10", "At a scale of 1 : 1000, a 2.5 cm drawing length represents how many metres in real life?", "", "25", 4,
