...
export function year11StandardManagingMoneyLessonOverride(
  ...
  if (lesson.slug === "credit-cards-consumer-finance") {
    return {
      ...
      guidedPractice: [
        ...
        moneyAnswer("manage-credit-g2", "A credit card balance is $800. The annual interest rate is 18% p.a. Find the monthly interest charge.", "", "12"),
        moneyAnswer("manage-credit-g3", "A credit card minimum payment is 2% of the balance. The balance is $850. Find the minimum payment.", "", "17"),
      ...
      independentPractice: [
        moneyAnswer("manage-credit-i1", "A credit card balance of $500 carries interest at 24% p.a. Find the monthly interest charge.", "", "10"),
        moneyAnswer("manage-credit-i2", "A credit card balance is $600. Monthly interest of $10 is charged and a minimum payment of $12 is made. Find the new balance.", "", "598"),
        moneyAnswer("manage-credit-i3", "A credit card has an annual fee of $60. How much is this per month?", "", "5"),
        ...
        moneyAnswer("manage-credit-i5", "A $200 purchase is split into 4 equal fortnightly BNPL payments. Find each payment.", "", "50"),
      ],
      commonMistakes: [
      ...
      masteryQuiz: [
        ...
        moneyAnswer("manage-credit-m2", "A credit card balance of $1200 carries interest at 20% p.a. Find the monthly interest charge.", "", "20"),
        moneyAnswer("manage-credit-m3", "A minimum payment is 3% of a $600 balance. Find the minimum payment.", "", "18"),
        moneyAnswer("manage-credit-m4", "A balance of $400 earns $8 monthly interest. A $10 minimum payment is made. Find the new balance.", "", "398"),
        ...
        moneyAnswer("manage-credit-m6", "A credit card balance is $750 and the minimum payment rate is 2%. Find the minimum payment.", "", "15"),
        ...
        moneyAnswer("manage-credit-m8", "A $360 purchase is split into 4 equal BNPL instalments. Find each instalment.", "", "90"),
        ...
        moneyAnswer("manage-credit-m10", "A credit card balance is $900. Monthly interest of $15 is charged and a payment of $50 is made. Find the new balance.", "", "865"),
      ],
    };
  }
  ...
  if (lesson.slug === "gst-discounts-consumer-arithmetic") {
    return {
      ...
      guidedPractice: [
        ...
        moneyAnswer("manage-gst-g2", "A skateboard is priced at $80 before GST. Find the GST amount.", "", "8"),
        moneyAnswer("manage-gst-g3", "A jacket has a pre-GST price of $80. Find the GST-inclusive price.", "", "88"),
        moneyAnswer("manage-gst-g4", "A $150 bag has a 20% discount. Find the sale price.", "", "120"),
      ],
      independentPractice: [
        moneyAnswer("manage-gst-i1", "A laptop costs $132 including GST. Find the pre-GST price.", "", "120"),
        moneyAnswer("manage-gst-i2", "A TV costs $110 including GST. Find the GST amount.", "", "10"),
        moneyAnswer("manage-gst-i3", "A $240 jacket has 30% off. Find the sale price.", "", "168"),
        ...
        moneyAnswer("manage-gst-i5", "A phone case costs $22 before GST. Find the GST-inclusive price.", "", "24.20"),
      ],
      commonMistakes: [
      ...
      masteryQuiz: [
        ...
        moneyAnswer("manage-gst-m2", "A $200 phone has 10% GST added. Find the GST amount.", "", "20"),
        moneyAnswer("manage-gst-m3", "A $200 phone has 10% GST added. Find the GST-inclusive price.", "", "220"),
        moneyAnswer("manage-gst-m4", "A restaurant bill of $165 includes GST. Find the GST amount.", "", "15"),
        moneyAnswer("manage-gst-m5", "A bag costs $220 including GST. Find the pre-GST price.", "", "200"),
        moneyAnswer("manage-gst-m6", "A $180 jacket has 25% off. Find the sale price.", "", "135"),
        ...
        moneyAnswer("manage-gst-m8", "A textbook is $77 including GST. Find the pre-GST price.", "", "70"),
        moneyAnswer("manage-gst-m9", "A student wants to buy a $300 item with 15% off. Find the discount amount.", "", "45"),
  ...
  if (lesson.slug === "vehicle-costs-buying-running") {
    return {
      ...
      masteryQuiz: [
        moneyAnswer("y11s-vcr-m1", "A car uses 9 L/100 km and travels 10,000 km. Fuel is $1.80/L. Find the fuel cost.", "", "1620", ["$1620", "$1,620", "1620.00"]),
        moneyAnswer("y11s-vcr-m2", "Calculate stamp duty on a $25,000 vehicle at 3%.", "", "750", ["$750", "750.00"]),
        moneyAnswer("y11s-vcr-m3", "Annual rego $380, insurance $950, fuel $1,620, servicing $350. Find the total annual running cost.", "", "3300", ["$3300", "$3,300"]),
        moneyAnswer("y11s-vcr-m4", "Purchase $20,000, annual running $3,300, resale $6,000 after 4 years. Total ownership cost?", "", "27200", ["$27200", "$27,200"]),
        ...
        moneyAnswer("y11s-vcr-m6", "A car travels 20,000 km at 6 L/100 km. Fuel is $1.85/L. Find the annual fuel cost.", "", "2220", ["$2220", "$2,220"]),
        ...
        moneyAnswer("y11s-vcr-m8", "A buyer pays $28,000 for a car and $840 stamp duty. What is the total purchase outlay?", "", "28840", ["$28840", "$28,840"]),
        moneyAnswer("y11s-vcr-m9", "Car costs $16,000. Annual running $2,800. Resale after 3 years is $5,500. Total ownership cost?", "", "18900", ["$18900", "$18,900"]),
  ...
  if (lesson.slug === "managing-money-revision") {
    return {
      ...
      masteryQuiz: [
        moneyAnswer("y11s-mmr-m1", "Convert 4.5% to a decimal.", "", "0.045", ["0.0450"]),
        moneyAnswer("y11s-mmr-m2", "Find 25% of $360.", "", "90", ["$90", "90.00"]),
        moneyAnswer("y11s-mmr-m3", "Calculate simple interest on $4,000 at 3% per annum for 5 years.", "", "600", ["$600", "600.00"]),
        moneyAnswer("y11s-mmr-m4", "Find the total amount after earning $600 interest on a $4,000 principal.", "", "4600", ["$4600", "$4,600"]),
        ...
        moneyAnswer("y11s-mmr-m6", "Convert 0.065 to a percentage.", "", "6.5", ["6.5%", "6.50%"]),
        moneyAnswer("y11s-mmr-m7", "Find 9% of $2,400.", "", "216", ["$216", "216.00"]),
        ...
        moneyAnswer("y11s-mmr-m9", "Calculate simple interest on $1,500 at 8% per annum for 2 years.", "", "240", ["$240", "240.00"]),
