...
export function year12Standard1SimpleInterestLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("si-g2", "Find the simple interest on $2000 at 5% p.a. for 3 years.", "", "300", 2,
        "I = Prn with r = 0.05.", "I = 2000 × 0.05 × 3 = $300.", ["$300"]),
      ans("si-g3", "An investment earns $300 interest on a $2000 principal. Find the total amount.", "", "2300", 2,
        "Total = principal + interest.", "A = 2000 + 300 = $2300.", ["$2300"]),
      ans("si-g4", "Find the simple interest on $500 at 4% p.a. for 2 years.", "", "40", 2,
        "I = Prn with r = 0.04.", "I = 500 × 0.04 × 2 = $40.", ["$40"]),
    ],
    independentPractice: [
      ans("si-i1", "Find the simple interest on $1500 at 6% p.a. for 4 years.", "", "360", 2,
      ...
      ans("si-i3", "Find the total amount when $800 earns simple interest at 5% p.a. for 3 years.", "", "920", 3,
        "Find I first, then add the principal.", "I = 800 × 0.05 × 3 = $120; A = 800 + 120 = $920.", ["$920"]),
      ans("si-i4", "$1000 earns $150 simple interest in 3 years. Find the annual rate, as a percentage.", "", "5", 3,
        "Rearrange to r = I/(Pn), then convert to %.", "r = 150 ÷ (1000 × 3) = 0.05 = 5%.", ["5%"]),
      ans("si-i5", "How many years for $2000 at 5% p.a. simple interest to earn $400?", "", "4", 3,
        "Rearrange to n = I/(Pr).", "n = 400 ÷ (2000 × 0.05) = 400 ÷ 100 = 4 years.", ["4 years"]),
    ],
    masteryQuiz: [
      ans("si-m1", "Find the simple interest on $3000 at 4% p.a. for 5 years.", "", "600", 2,
      ...
      ans("si-m3", "Find the total amount when $1200 earns simple interest at 6% p.a. for 2 years.", "", "1344", 3,
        "Find I, then add the principal.", "I = 1200 × 0.06 × 2 = $144; A = 1200 + 144 = $1344.", ["$1344"]),
      ans("si-m4", "$2500 earns $500 simple interest in 4 years. Find the annual rate, as a percentage.", "", "5", 3,
      ...
      ans("si-m6", "Find the simple interest on $600 at 10% p.a. for 1 year.", "", "60", 2,
        "I = Prn.", "I = 600 × 0.10 × 1 = $60.", ["$60"]),
      ans("si-m7", "How many years for $4000 at 5% p.a. simple interest to earn $600?", "", "3", 3,
      ...
      ans("si-m9", "An investment of $5000 grows to $6500 with simple interest over 5 years. Find the annual rate, as a percentage.", "", "6", 4,
        "Find the interest first (A − P), then r = I/(Pn).", "Interest = 6500 − 5000 = $1500; r = 1500 ÷ (5000 × 5) = 0.06 = 6%.", ["6%"]),
      ans("si-m10", "Find the total amount when $1000 earns simple interest at 5% p.a. for 10 years.", "", "1500", 4,
...
export function year12Standard1InterestGraphsLessonOverride(
  ...
  return {
    ...
    independentPractice: [
      ...
      ans("sig-i3", "A simple-interest graph starts at $2000 and rises $120 each year. Find the balance after 4 years.", "", "2480", 3,
        "Add 4 years of interest to the principal.", "Balance = 2000 + 120 × 4 = 2000 + 480 = $2480.", ["$2480"]),
      ans("sig-i4", "A simple-interest balance graph has gradient $150 per year on a $3000 principal. Find the annual rate, as a percentage.", "", "5", 3,
        "Rate = yearly interest ÷ principal.", "Rate = 150 ÷ 3000 = 0.05 = 5%.", ["5%"]),
      ans("sig-i5", "Using the graph, after how many years does the balance first reach $1500?", "", "5", 3,
    ...
    masteryQuiz: [
      ...
      ans("sig-m3", "A simple-interest graph starts at $5000 and rises $250 each year. Find the balance after 6 years.", "", "6500", 3,
        "Add 6 years of interest.", "Balance = 5000 + 250 × 6 = 5000 + 1500 = $6500.", ["$6500"]),
      ans("sig-m4", "A simple-interest balance graph rises from $1000 to $1400 over 4 years. Find the interest added each year.", "", "100", 3,
      ...
      ans("sig-m7", "A simple-interest graph has gradient $80 per year on a $2000 principal. Find the annual rate, as a percentage.", "", "4", 3,
      ...
      ans("sig-m9", "A simple-interest balance graph passes through (0, 4000) and (5, 5000). Find the interest added each year.", "", "200", 4,
        "Gradient between the two points.", "Yearly interest = (5000 − 4000) ÷ 5 = 1000 ÷ 5 = $200.", ["$200"]),
      ans("sig-m10", "A simple-interest balance graph passes through (0, 4000) and (5, 5000). Find the annual rate, as a percentage.", "", "5", 4,
...
export function year12Standard1PresentValueLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("pv-g2", "How much to invest now at 10% p.a. to have $1210 in 2 years?", "", "1000", 2,
        "P = A ÷ (1 + r)ⁿ.", "P = 1210 ÷ 1.1² = 1210 ÷ 1.21 = $1000.", ["$1000"]),
      ans("pv-g3", "Find the present value of $6050 due in 2 years at 10% p.a.", "", "5000", 2,
        "Divide by 1.21.", "P = 6050 ÷ 1.21 = $5000.", ["$5000"]),
      ans("pv-g4", "How much to invest now at 10% p.a. to have $1100 in 1 year?", "", "1000", 2,
        "Divide by the growth factor once.", "P = 1100 ÷ 1.1 = $1000.", ["$1000"]),
    ],
    independentPractice: [
      ans("pv-i1", "Find the present value of $13310 due in 3 years at 10% p.a.", "", "10000", 3,
      ...
      ans("pv-i3", "Find the present value of $2420 due in 2 years at 10% p.a.", "", "2000", 3,
        "Divide by 1.21.", "P = 2420 ÷ 1.21 = $2000.", ["$2000"]),
      ans("pv-i4", "Find the present value of $4410 due in 2 years at 5% p.a.", "", "4000", 3,
    ...
    masteryQuiz: [
      ans("pv-m1", "Find the present value of $1331 due in 3 years at 10% p.a.", "", "1000", 3,
      ...
      ans("pv-m3", "Find the present value of $12100 due in 2 years at 10% p.a.", "", "10000", 3,
        "Divide by 1.21.", "P = 12100 ÷ 1.21 = $10000.", ["$10000"]),
      ans("pv-m4", "Find the present value of $1102.50 due in 2 years at 5% p.a.", "", "1000", 3,
      ...
      ans("pv-m6", "Find the present value of $1100 due in 1 year at 10% p.a.", "", "1000", 2,
        "Divide once by 1.1.", "P = 1100 ÷ 1.1 = $1000.", ["$1000"]),
      ans("pv-m7", "Find the present value of $5512.50 due in 2 years at 5% p.a.", "", "5000", 3,
      ...
      ans("pv-m9", "How much must be invested now at 10% p.a. to have $4000 in 2 years? Give your answer to the nearest cent.", "", "3305.79", 4,
        "Divide by 1.21 and round to cents.", "P = 4000 ÷ 1.21 = 3305.785… ≈ $3305.79.", ["$3305.79"]),
      ans("pv-m10", "Find the present value of $2205 due in 2 years at 5% p.a.", "", "2000", 4,
...
export function year12Standard1CompoundInterestGraphsLessonOverride(
  ...
  return {
    ...
    independentPractice: [
      ...
      ans("cig-i3", "$1000 is invested at 10% p.a. compound. Find the balance after 2 years.", "", "1210", 3,
        "Multiply by 1.1 twice.", "Balance = 1000 × 1.1² = 1000 × 1.21 = $1210.", ["$1210"]),
      ans("cig-i4", "Simple and compound interest both start at $1000 at 10% p.a. Find the balance after 1 year (it is the same for both).", "", "1100", 3,
    ...
    masteryQuiz: [
      ...
      ans("cig-m3", "$2000 is invested at 10% p.a. compound. Find the balance after 2 years.", "", "2420", 3,
        "Multiply by 1.1 twice.", "Balance = 2000 × 1.1² = 2000 × 1.21 = $2420.", ["$2420"]),
      ans("cig-m4", "$1000 at 10% p.a. compound. Find the balance after 3 years.", "", "1331", 3,
      ...
      ans("cig-m7", "$5000 is invested at 4% p.a. compound. Find the balance after 2 years.", "", "5408", 3,
      ...
      ans("cig-m9", "$1000 at 10% p.a. compound. Find the balance after 4 years.", "", "1464.10", 4,
        "Multiply by 1.1 four times.", "Balance = 1000 × 1.1⁴ = 1000 × 1.4641 = $1464.10.", ["$1464.10", "1464.1"]),
      ans("cig-m10", "On $1000 at 10% p.a., find the difference between the compound and simple interest earned after 2 years.", "", "10", 4,
...
export function year12Standard1AppreciationInflationLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("appr-g2", "A painting worth $5000 appreciates 10% in a year. Find its new value.", "", "5500", 2,
        "Multiply by the growth factor 1.10.", "Value = 5000 × 1.10 = $5500.", ["$5500"]),
      ans("appr-g3", "A house worth $300000 appreciates 6% p.a. Find its value after 2 years.", "", "337080", 2,
        "Multiply by 1.06 twice.", "Value = 300000 × 1.06² = 300000 × 1.1236 = $337080.", ["$337080"]),
      ans("appr-g4", "With 5% inflation, find the price in 1 year of a $200 item.", "", "210", 2,
        "Multiply by 1.05.", "Price = 200 × 1.05 = $210.", ["$210"]),
    ],
    independentPractice: [
      ans("appr-i1", "Land worth $80000 appreciates 5% p.a. Find its value after 2 years.", "", "88200", 2,
      ...
      ans("appr-i3", "With 4% inflation, find the cost in 2 years of a $500 item.", "", "540.80", 3,
        "Multiply by 1.04 twice.", "Cost = 500 × 1.04² = 500 × 1.0816 = $540.80.", ["$540.80"]),
      ans("appr-i4", "A collectible worth $2000 appreciates 10% p.a. Find its value after 3 years.", "", "2662", 3,
    ...
    masteryQuiz: [
      ans("appr-m1", "An item worth $1000 appreciates 20% in a year. Find its new value.", "", "1200", 2,
      ...
      ans("appr-m3", "A house worth $400000 appreciates 5% p.a. Find its value after 2 years.", "", "441000", 3,
        "Multiply by 1.05 twice.", "Value = 400000 × 1.05² = 400000 × 1.1025 = $441000.", ["$441000"]),
      ans("appr-m4", "With 4% inflation, find the cost in 2 years of a $250 item.", "", "270.40", 3,
      ...
      ans("appr-m6", "An asset worth $600 appreciates 10% in a year. Find its new value.", "", "660", 2,
        "Multiply by 1.10.", "Value = 600 × 1.10 = $660.", ["$660"]),
      ans("appr-m7", "Property worth $5000 appreciates 6% p.a. Find its value after 2 years.", "", "5618", 3,
      ...
      ans("appr-m9", "A $300000 house appreciates 5% p.a. for 3 years. Find its value.", "", "347287.50", 4,
        "Multiply by 1.05 three times.", "Value = 300000 × 1.05³ = 300000 × 1.157625 = $347287.50.", ["$347287.50"]),
      ans("appr-m10", "With 5% inflation, find the cost in 2 years of an item costing $80 now.", "", "88.20", 4,
