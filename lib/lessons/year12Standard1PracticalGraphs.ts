...
export function year12Standard1ExponentialGraphsLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("expg-g2", "For y = 3·2ˣ, find the y-intercept (the value of y when x = 0).", "", "3", 2,
      ...
      ans("expg-g4", "For y = 5·2ˣ, find y when x = 3.", "", "40", 2,
        "Multiply 5 by 2 three times.", "y = 5 × 2³ = 5 × 8 = 40."),
    ],
    independentPractice: [
      ans("expg-i1", "For y = 100·(0.5)ˣ, find y when x = 2.", "", "25", 2,
      ...
      ans("expg-i4", "An exponential decay curve gets closer and closer to which line but never reaches it?", "", "y=0", 3,
        ...
        ["the x-axis", "x-axis", "0"]),
      ans("expg-i5", "An exponential y = a·bˣ passes through (0, 4). Find a.", "", "4", 3,
        "At x = 0 the value is a.", "At x = 0, bˣ = 1, so y = a. Since the curve passes through (0, 4), a = 4."),
    ],
    masteryQuiz: [
      ans("expg-m1", "State the y-intercept of y = 7·3ˣ.", "", "7", 2,
      ...
      ans("expg-m3", "Using the graph, is this exponential growth or decay?", "\\text{read the trend}", "growth", 2,
        ...
        ["exponential growth"], { cartesianGraph: growthPlot }),
      ans("expg-m4", "For y = 2·5ˣ, find y when x = 2.", "", "50", 2,
        "5² = 25.", "y = 2 × 5² = 2 × 25 = 50."),
      ...
      ans("expg-m6", "A table shows x: 0,1,2 and y: 80,40,20. Is this exponential growth or decay?", "", "decay", 3,
        ...
        ["exponential decay"]),
      ans("expg-m7", "For y = 6·2ˣ, find y when x = 0.", "", "6", 2,
      ...
      ans("expg-m9", "A quantity starts at 5 and multiplies by 2 every step. Find its value after 4 steps.", "", "80", 4,
...
export function year12Standard1ExponentialModelsLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("expm-g2", "A colony of 150 doubles each year. Find the population after 1 year.", "", "300", 2,
        "Double once.", "After 1 year: 150 × 2 = 300."),
      ans("expm-g3", "A colony of 150 doubles each year. Find the population after 3 years.", "", "1200", 2,
        "Multiply by 2 three times.", "After 3 years: 150 × 2³ = 150 × 8 = 1200."),
      ans("expm-g4", "A sample of 800 halves each hour. Find the amount after 2 hours.", "", "200", 2,
        "Halve twice (×0.5 each time).", "After 2 hours: 800 × 0.5² = 800 × 0.25 = 200."),
    ],
    independentPractice: [
      ans("expm-i1", "A culture of 50 triples each day. Find the amount after 2 days.", "", "450", 2,
      ...
      ans("expm-i3", "$1000 grows at 10% per year. Find the amount after 2 years.", "", "1210", 3,
        "Growth factor 1.1, applied twice.", "A = 1000 × 1.1² = 1000 × 1.21 = $1210.", ["$1210"]),
      ans("expm-i4", "A car worth $20000 loses 20% of its value each year. Find its value after 1 year.", "", "16000", 3,
        "Losing 20% keeps 80% (decay factor 0.8).", "Value = 20000 × (1 − 0.2) = 20000 × 0.8 = $16000.", ["$16000"]),
      ans("expm-i5", "Bacteria double every hour, starting from 200. Find the number after 4 hours.", "", "3200", 3,
        "Multiply by 2 four times.", "After 4 hours: 200 × 2⁴ = 200 × 16 = 3200."),
    ],
    masteryQuiz: [
      ans("expm-m1", "A value of 100 doubles each step. Find its value after 5 steps.", "", "3200", 2,
      ...
      ans("expm-m3", "$5000 is invested at 4% per year. Find the amount after 2 years.", "", "5408", 3,
        "Growth factor 1.04, applied twice.", "A = 5000 × 1.04² = 5000 × 1.0816 = $5408.", ["$5408"]),
      ans("expm-m4", "A quantity of 640 halves each step. Find its value after 3 steps.", "", "80", 3,
      ...
      ans("expm-m6", "Equipment worth $8000 depreciates 10% per year. Find its value after 3 years.", "", "5832", 4,
        "Decay factor 0.9, applied three times.", "Value = 8000 × 0.9³ = 8000 × 0.729 = $5832.", ["$5832"]),
      ans("expm-m7", "A culture of 300 triples each hour. Find the amount after 2 hours.", "", "2700", 3,
      ...
      ans("expm-m9", "A population of 1000 grows 20% per year. Find the population after 2 years.", "", "1440", 4,
        "Growth factor 1.2, applied twice.", "A = 1000 × 1.2² = 1000 × 1.44 = 1440."),
      ans("expm-m10", "Sales double every 2 years, starting at 400. Find the sales after 6 years.", "", "3200", 4,
...
export function year12Standard1QuadraticFunctionsLessonOverride(
  ...
  return {
    ...
    independentPractice: [
      ...
      ans("quadf-i3", "Find the axis of symmetry of y = x² − 6x + 8 (use x = −b/(2a)).", "", "3", 3,
        "Substitute a = 1, b = −6 into −b/(2a).", "x = −(−6) ÷ (2 × 1) = 6 ÷ 2 = 3. The axis of symmetry is x = 3.",
        ["x=3"]),
      ans("quadf-i4", "A parabola has x-intercepts at x = 1 and x = 5. Find the x-value of its vertex.", "", "3", 3,
    ...
    masteryQuiz: [
      ...
      ans("quadf-m3", "State the vertex of y = (x − 1)² − 9.", "y = (x-h)^2 + k", "(1,-9)", 3,
        ...
        ["(1, -9)", "1,-9", "(1, −9)"]),
      ans("quadf-m4", "Find the axis of symmetry of y = x² + 4x + 1.", "", "-2", 3,
      ...
      ans("quadf-m6", "A parabola has x-intercepts at x = −2 and x = 6. Find the x-value of its vertex.", "", "2", 3,
      ...
      ans("quadf-m9", "State the minimum value of y for y = (x − 3)² − 4.", "y = (x-h)^2 + k", "-4", 4,
        ...
        ["−4"]),
      ans("quadf-m10", "A parabola y = a(x − 2)² + 1 passes through (0, 5). Find a.", "", "1", 4,
...
export function year12Standard1ReciprocalGraphsLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("recg-g2", "For y = 12/x, find y when x = 3.", "", "4", 2,
    ...
    independentPractice: [
      ans("recg-i1", "For y = 24/x, find y when x = 8.", "", "3", 2,
      ...
      ans("recg-i4", "For y = 36/x, x doubles from 3 to 6. Find the new value of y.", "", "6", 3,
    ...
    masteryQuiz: [
      ans("recg-m1", "For y = 60/x, find y when x = 5.", "", "12", 2,
      ...
      ans("recg-m3", "For y = k/x, y = 8 when x = 5. Find k.", "k = xy", "40", 3,
        "k = xy.", "k = 5 × 8 = 40."),
      ans("recg-m4", "For y = 48/x, find y when x = 12.", "", "4", 2,
      ...
      ans("recg-m7", "For y = 20/x, find y when x = 4.", "", "5", 2,
      ...
      ans("recg-m9", "For y = k/x passing through (4, 9), find y when x = 6.", "", "6", 4,
        "Find k first, then evaluate at x = 6.", "k = 4 × 9 = 36, so y = 36/x. At x = 6, y = 36 ÷ 6 = 6."),
      ans("recg-m10", "x and y vary inversely. When x = 2, y = 18. Find y when x = 3.", "", "12", 4,
...
export function year12Standard1ReciprocalModelsLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("recm-g2", "6 workers take 12 hours on a job. Find the total work in worker-hours.", "", "72", 2,
        "Multiply workers by hours.", "Total work = 6 × 12 = 72 worker-hours."),
      ans("recm-g3", "A job needs 72 worker-hours. How long would 8 workers take, in hours?", "", "9", 2,
        "Divide the total work by the workers.", "Time = 72 ÷ 8 = 9 hours."),
      ans("recm-g4", "Speed × time = 240 km for a trip. At 60 km/h, find the time in hours.", "", "4", 2,
        "Divide the distance by the speed.", "Time = 240 ÷ 60 = 4 hours."),
    ],
    independentPractice: [
      ans("recm-i1", "4 taps fill a tank in 90 minutes. How long would 6 taps take, in minutes?", "", "60", 3,
      ...
      ans("recm-i3", "A trip at 80 km/h takes 3 hours. How long would it take at 120 km/h, in hours?", "", "2", 3,
        "Find the fixed distance, then divide by the new speed.", "Distance = 80 × 3 = 240 km; time at 120 km/h = 240 ÷ 120 = 2 hours."),
      ans("recm-i4", "Pressure × volume is constant at 600. When the volume is 40, find the pressure.", "", "15", 3,
        "Divide the constant by the volume.", "Pressure = 600 ÷ 40 = 15 (since P × V = 600)."),
      ans("recm-i5", "10 machines complete an order in 6 days. Find the total work in machine-days.", "", "60", 3,
        "Multiply machines by days.", "Total work = 10 × 6 = 60 machine-days."),
    ],
    masteryQuiz: [
      ans("recm-m1", "5 painters take 8 days to paint a building. How long would 10 painters take, in days?", "", "4", 3,
      ...
      ans("recm-m3", "A job is 48 worker-hours. How long would 6 workers take, in hours?", "", "8", 3,
        "Divide the total work by the workers.", "Time = 48 ÷ 6 = 8 hours."),
      ans("recm-m4", "A trip is 240 km. At 40 km/h, find the time, in hours.", "", "6", 2,
      ...
      ans("recm-m6", "3 pipes fill a pool in 8 hours. How long would 4 pipes take, in hours?", "", "6", 4,
        "Find pipe-hours, then divide by 4.", "Total = 3 × 8 = 24 pipe-hours; with 4 pipes: 24 ÷ 4 = 6 hours."),
      ans("recm-m7", "Pressure × volume is constant. When V = 12, P = 50. Find P when V = 25.", "", "24", 3,
      ...
      ans("recm-m9", "8 workers finish a job in 15 days. How many workers are needed to finish it in 10 days?", "", "12", 4,
        "Find worker-days, then divide by the target days.", "Total = 8 × 15 = 120 worker-days; to finish in 10 days: 120 ÷ 10 = 12 workers."),
      ans("recm-m10", "A route takes 5 hours at 72 km/h. What constant speed finishes it in 6 hours, in km/h?", "", "60", 4,
...
export function year12Standard1GraphsMiscellaneousLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("gmix-g2", "A table x: 1,2,3 and y: 3,9,27 multiplies by 3 each step. Which model is it?", "", "exponential", 2,
    ...
    independentPractice: [
      ...
      ans("gmix-i2", "A graph is a symmetric U-shape with a single lowest point. Which model is it?", "\\text{U-shape}", "quadratic", 3,
        ...
        ["parabola"]),
      ans("gmix-i3", "A table x: 1,2,3,4 and y: 1,4,9,16 (the squares). Which model is it?", "", "quadratic", 3,
    ...
    masteryQuiz: [
      ...
      ans("gmix-m3", "A table x: 2,4,8 and y: 40,20,10. Which model is it?", "", "inverse variation", 3,
      ...
      ans("gmix-m9", "A table x: 1,2,3,4 and y: 24,12,8,6. Which model is it?", "", "inverse variation", 4,
