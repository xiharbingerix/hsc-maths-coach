...
const algFracAddSubGuided: PracticeQuestion[] = [
  ...
  algChoice("afas-g2", "To rewrite 3/x with denominator 5x, which numerator is correct?", "A",
    ...
    "\\frac{3}{x}=\\frac{?}{5x}"),
  algAnswer("afas-g3", "Simplify 1/4 + 1/x. What is the numerator of the simplified fraction over 4x?", "", "x + 4", ["x+4"]),
...
const algFracAddSubIndependent: PracticeQuestion[] = [
  algAnswer("afas-i1", "Simplify 1/2 + 5/x. What is the numerator of the result over 2x?", "", "x + 10", ["x+10"]),
  ...
  algAnswer("afas-i3", "Simplify 3/x + 2/(x+1). What is the numerator of the result over x(x+1)?", "", "5x + 3", ["5x+3"]),
...
const algFracAddSubMastery: PracticeQuestion[] = [
  ...
  algAnswer("afas-m2", "Simplify 2/3 + 1/x. What is the numerator of the result over 3x?", "", "2x + 3", ["2x+3"]),
  algChoice("afas-m3", "Which is the correct simplification of 1/x + 2/(x+3)?", "B",
    ...
    "\\frac{1}{x}+\\frac{2}{x+3}"),
  algAnswer("afas-m4", "Simplify 5/(x−1) − 2/x. What is the numerator of the result over x(x−1)?", "", "3x + 2", ["3x+2"]),
  algChoice("afas-m5", "Which is the correct simplification of 3/x + 4/(x−2)?", "B",
    ...
    "\\frac{3}{x}+\\frac{4}{x-2}"),
  algAnswer("afas-m6", "Simplify 2/(x+1) + 3/(x−1). What is the numerator of the result over (x+1)(x−1)?", "", "5x + 1", ["5x+1"]),
  ...
  algAnswer("afas-m8", "Simplify 1/(x+3) + 2/(x−1). What is the numerator of the result over (x+3)(x−1)?", "", "3x + 5", ["3x+5"]),
...
export function year10AlgebraicTechniquesLessonOverride(
  ...
  if (!["year-10-mathematics", "year-10-mathematics-advanced", "year-10-mathematics-core"].includes(course.slug) || !["quadratic-expressions-equations"].includes(unit.slug)) {
    return null;
  }
