...
const arraysTwoStep: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-a2s-g2", "How many outcomes when rolling two dice?", "", "36", 2, "6 × 6 = 36.", []),
    ans("y10-a2s-g3", "How many outcomes when tossing a coin and rolling a die?", "", "12", 2, "2 × 6 = 12.", []),
  ...
  independentPractice: [
    ...
    ans("y10-a2s-i2", "How many outcomes when tossing two coins?", "", "4", 2, "2 × 2 = 4.", []),
  ...
  masteryQuiz: [
    ans("y10-a2s-m1", "How many outcomes when rolling two dice?", "", "36", 2, "6 × 6 = 36.", []),
    ans("y10-a2s-m2", "Two dice: find P(sum = 12).", "P(\\text{sum }12)", "1/36", 4, "Only (6,6) — 1 of 36.", ["1 / 36"]),
    ans("y10-a2s-m3", "How many outcomes when tossing three coins?", "", "8", 3, "2 × 2 × 2 = 8.", []),
    ...
    ans("y10-a2s-m6", "How many outcomes: a coin and a die?", "", "12", 2, "2 × 6 = 12.", []),
