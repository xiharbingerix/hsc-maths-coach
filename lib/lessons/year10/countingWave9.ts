...
const factorialNotation: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-cfn-g2", "A cafe has 3 mains and 4 desserts. How many main+dessert meals?", "", "12", 3, "3 × 4 = 12.", []),
  ...
  independentPractice: [
    ...
    ans("y10-cfn-i5", "A meal has 2 entrees, 3 mains, 2 desserts. How many full meals?", "", "12", 3, "2 × 3 × 2 = 12.", []),
  ],
  masteryQuiz: [
    ans("y10-cfn-m1", "How many outcomes for 4 ways then 5 ways?", "", "20", 3, "4 × 5 = 20.", []),
    ...
    ans("y10-cfn-m7", "4 shirts and 3 ties. How many shirt+tie combinations?", "", "12", 3, "4 × 3 = 12.", []),
...
const arrangements: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-arng-g2", "In how many orders can 3 people stand in a row?", "", "6", 3, "3! = 6.", []),
    ans("y10-arng-g3", "Arrange 2 of 4 books in order. How many ways?", "", "12", 3, "4 × 3 = 12.", []),
    ans("y10-arng-g4", "In how many orders can 5 books sit on a shelf?", "", "120", 4, "5! = 120.", []),
  ],
  independentPractice: [
    ans("y10-arng-i1", "In how many orders can 4 people sit in a row?", "", "24", 3, "4! = 24.", []),
    ans("y10-arng-i2", "Arrange 2 of 6 in order. How many ways?", "", "30", 3, "6 × 5 = 30.", []),
    ...
    ans("y10-arng-i4", "Arrange 3 of 5 in order. How many ways?", "", "60", 4, "5 × 4 × 3 = 60.", []),
    ans("y10-arng-i5", "In how many orders can 3 medals be awarded to 3 people?", "", "6", 3, "3! = 6.", []),
  ],
  masteryQuiz: [
    ans("y10-arng-m1", "In how many orders can 5 people stand in a row?", "", "120", 4, "5! = 120.", []),
    ans("y10-arng-m2", "Arrange 2 of 5 in order. How many ways?", "", "20", 3, "5 × 4 = 20.", []),
    ...
    ans("y10-arng-m4", "Arrange 3 of 4 in order. How many ways?", "", "24", 3, "4 × 3 × 2 = 24.", []),
    ans("y10-arng-m5", "In how many orders can 6 people line up?", "", "720", 4, "6! = 720.", []),
    ans("y10-arng-m6", "Arrange 2 of 7 in order. How many ways?", "", "42", 3, "7 × 6 = 42.", []),
    ...
    ans("y10-arng-m8", "Arrange all 4 of 4 in order. How many ways?", "", "24", 3, "4! = 24.", []),
    ans("y10-arng-m9", "Arrange 3 of 6 in order. How many ways?", "", "120", 4, "6 × 5 × 4 = 120.", []),
    ans("y10-arng-m10", "Arrange 2 of 8 in order. How many ways?", "", "56", 3, "8 × 7 = 56.", []),
  ],
  commonMistakes: [
...
const selections: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-seln-g2", "How many ways to choose 2 from 4?", "", "6", 3, "(4×3)/2! = 6.", []),
    ans("y10-seln-g3", "How many ways to choose 3 from 5?", "", "10", 4, "(5×4×3)/3! = 10.", []),
  ...
  independentPractice: [
    ans("y10-seln-i1", "How many ways to choose 2 from 5?", "", "10", 3, "(5×4)/2! = 10.", []),
    ans("y10-seln-i2", "How many ways to choose 2 from 6?", "", "15", 3, "(6×5)/2! = 15.", []),
    ...
    ans("y10-seln-i4", "How many ways to choose 3 from 4?", "", "4", 3, "(4×3×2)/3! = 4.", []),
    ans("y10-seln-i5", "How many ways to choose all 4 from 4?", "", "1", 2, "There is exactly 1 way to choose them all.", []),
  ],
  masteryQuiz: [
    ans("y10-seln-m1", "How many ways to choose 2 from 4?", "", "6", 3, "(4×3)/2! = 6.", []),
    ans("y10-seln-m2", "How many ways to choose 3 from 6?", "", "20", 4, "(6×5×4)/3! = 20.", []),
    ...
    ans("y10-seln-m4", "How many ways to choose 2 from 7?", "", "21", 3, "(7×6)/2! = 21.", []),
    ans("y10-seln-m5", "How many ways to choose 1 from 5?", "", "5", 2, "Choosing 1 from 5 gives 5 ways.", []),
    ...
    ans("y10-seln-m7", "How many ways to choose all 5 from 5?", "", "1", 2, "Exactly 1 way to choose them all.", []),
    ans("y10-seln-m8", "How many ways to choose 2 from 8?", "", "28", 4, "(8×7)/2! = 28.", []),
    ...
    ans("y10-seln-m10", "How many ways to choose 3 from 7?", "", "35", 4, "(7×6×5)/3! = 35.", []),
  ],
  commonMistakes: [
...
const countingInProbability: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-cip-g2", "How many ways to choose 2 from 4 (total selections)?", "", "6", 3, "C(4,2) = 6.", []),
    ans("y10-cip-g3", "Of 6 equally likely outcomes, give the probability of one specific outcome.", "", "1/6", 3, "1 favourable ÷ 6 total = 1/6.", ["1 / 6"]),
  ...
  independentPractice: [
    ans("y10-cip-i1", "Arrange 3 people in a row. How many total orders?", "", "6", 3, "3! = 6.", []),
    ans("y10-cip-i2", "Give the probability of one specific order of 3 people in a row.", "", "1/6", 4, "1 of 3! = 6 orders, so 1/6.", ["1 / 6"]),
    ans("y10-cip-i3", "How many ways to choose 2 from 5 (total selections)?", "", "10", 3, "C(5,2) = 10.", []),
    ans("y10-cip-i4", "Give the probability of one specific pair chosen from 5.", "", "1/10", 4, "1 of C(5,2) = 10, so 1/10.", ["1 / 10"]),
  ...
  masteryQuiz: [
    ans("y10-cip-m1", "How many ways to choose 2 from 6 (total selections)?", "", "15", 3, "C(6,2) = 15.", []),
    ans("y10-cip-m2", "Give the probability of one specific pair chosen from 6.", "", "1/15", 4, "1 of 15, so 1/15.", ["1 / 15"]),
    ans("y10-cip-m3", "Arrange 4 people in a row. How many total orders?", "", "24", 3, "4! = 24.", []),
    ans("y10-cip-m4", "Give the probability of one specific arrangement of 4 people.", "", "1/24", 4, "1 of 24, so 1/24.", ["1 / 24"]),
    ...
    ans("y10-cip-m6", "How many ways to choose 3 from 5 (total selections)?", "", "10", 3, "C(5,3) = 10.", []),
    ans("y10-cip-m7", "Give the probability of one specific selection of 3 from 5.", "", "1/10", 4, "1 of 10, so 1/10.", ["1 / 10"]),
    ...
    ans("y10-cip-m9", "Give the probability of one outcome from 8 equally likely outcomes.", "", "1/8", 3, "1 of 8, so 1/8.", ["1 / 8"]),
