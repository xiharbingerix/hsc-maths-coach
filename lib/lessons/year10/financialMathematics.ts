...
const simpleInterestIndependent: PracticeQuestion[] = [
  ...
  financeChoice("y10-fin-si-i5", "Two simple-interest investments both start with 2000 dollars. Option A earns 4% p.a. for 3 years. Option B earns 3.5% p.a. for 4 years. Which option earns more interest?", "B", ["Option A", "Option B", "They earn the same interest", "There is not enough information"], "Option A earns $240 and Option B earns $280, so Option B earns more.", ""),
];
...
const depreciationMastery: PracticeQuestion[] = [
  ...
  financeChoice("y10-fin-dep-m9", "Car A starts at 20000 dollars and depreciates by 10% in one year. Car B starts at 18000 dollars and depreciates by 5% in one year. Which car has the higher value after one year?", "A", ["Car A", "Car B", "They have the same value", "Neither car has any value"], "Car A is worth $18000 and Car B is worth $17100, so Car A has the higher value.", ""),
...
const comparingInvestmentsIndependent: PracticeQuestion[] = [
  financeChoice("y10-fin-comp-i1", "Two 4000 dollar investments are held for 2 years. Option A pays 3.5% p.a. simple interest. Option B pays 3.4% p.a. compounded yearly. Which option has the higher final amount?", "A", ["Option A", "Option B", "They give the same final amount", "There is not enough information"], "Option A finishes at $4280. Option B finishes at $4276.62, so Option A is higher.", ""),
...
const comparingInvestmentsMastery: PracticeQuestion[] = [
  financeChoice("y10-fin-comp-m1", "Option A returns 2750 dollars on a 2500 dollar investment but charges a 40 dollar fee. Option B returns 2720 dollars on the same 2500 dollar investment with no fee. Which option has the higher net gain?", "B", ["Option A", "Option B", "They have the same net gain", "Option A, because it returns more before fees"], "Net gain = return - cost - fees. Option A: 2750 - 2500 - 40 = $210. Option B: 2720 - 2500 = $220. Option B nets $10 more, because Option A's $40 fee outweighs its extra $30 return.", ""),
  ...
  financeChoice("y10-fin-comp-m6", "Two 5000 dollar investments are held for 2 years. Option A pays 4% p.a. simple interest. Option B pays 3.8% p.a. compounded yearly. Which option has the higher final amount?", "A", ["Option A", "Option B", "They give the same final amount", "The amounts cannot be compared"], "Option A finishes at $5400. Option B finishes at $5387.22, so Option A is higher.", ""),
...
export function year10FinancialMathematicsLessonOverride(
  ...
  if (!["year-10-mathematics", "year-10-mathematics-advanced", "year-10-mathematics-core"].includes(course.slug) || unit.slug !== "financial-mathematics") {
    return null;
  }
