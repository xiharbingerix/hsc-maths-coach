...
const quadraticProblems: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-qp-g3", "Two consecutive integers have a product of 12. Find the smaller integer.", "n(n+1)=12", "3", 3, "n² + n − 12 = 0 factorises to (n + 4)(n − 3) = 0, so n = 3 (the positive integer); the integers are 3 and 4.", ["3"]),
  ...
  independentPractice: [
    ...
    ans("y10-qp-i3", "A square has an area of 49 cm². Find its side length (cm).", "s^2=49", "7", 2, "s² = 49, so s = 7 (a length must be positive).", ["7 cm"]),
    ans("y10-qp-i4", "Two consecutive integers have a product of 30. Find the smaller integer.", "n(n+1)=30", "5", 3, "n² + n − 30 = 0 gives (n + 6)(n − 5) = 0, so n = 5; the integers are 5 and 6.", ["5"]),
  ...
  masteryQuiz: [
    ...
    ans("y10-qp-m3", "A rectangle has width w and length w + 2, with area 35. Find the width.", "w(w+2)=35", "5", 4, "w² + 2w − 35 = 0 gives (w + 7)(w − 5) = 0, so w = 5 (positive).", ["5"]),
    ...
    ans("y10-qp-m6", "Two consecutive integers have a product of 42. Find the smaller integer.", "n(n+1)=42", "6", 3, "n² + n − 42 = 0 gives (n + 7)(n − 6) = 0, so n = 6; the integers are 6 and 7.", ["6"]),
    ...
    ans("y10-qp-m9", "A positive number added to its square gives 20. Find the number.", "n+n^2=20", "4", 4, "n² + n − 20 = 0 gives (n + 5)(n − 4) = 0, so n = 4 (positive).", ["4"]),
    ans("y10-qp-m10", "A rectangle's length is 5 more than its width and its area is 24. Find the width.", "w(w+5)=24", "3", 4, "w² + 5w − 24 = 0 gives (w + 8)(w − 3) = 0, so w = 3 (positive).", ["3"]),
  ],
  commonMistakes: [
