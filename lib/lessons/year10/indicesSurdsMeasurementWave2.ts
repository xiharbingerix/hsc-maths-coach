...
const reviewOfLength: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-rl-g4", "Find the circumference of a circle with diameter 10 (use π = 3.14).", "", "31.4", 3, "C = 3.14 × 10 = 31.4.", ["31.4 cm", "31.4"]),
  ],
  independentPractice: [
    ...
    ans("y10-rl-i3", "Find the circumference of a circle with radius 5 (use π = 3.14).", "", "31.4", 3, "C = 2 × 3.14 × 5 = 31.4.", ["31.4"]),
  ...
  masteryQuiz: [
    ...
    ans("y10-rl-m3", "Find the circumference of a circle with diameter 14 (use π = 22/7).", "", "44", 3, "C = 22/7 × 14 = 44.", ["44"]),
    ...
    ans("y10-rl-m9", "Find the circumference of a circle with radius 10 (use π = 3.14).", "", "62.8", 3, "C = 2 × 3.14 × 10 = 62.8.", ["62.8"]),
...
const areaShapes: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-ar-g3", "Find the area of a circle with radius 10 (use π = 3.14).", "", "314", 3, "3.14 × 100 = 314.", ["314"]),
  ...
  independentPractice: [
    ...
    ans("y10-ar-i4", "Find the area of a 180° sector with radius 6 (use π = 3.14).", "", "56.52", 4, "½ × 3.14 × 36 = 56.52.", ["56.52"]),
  ...
  masteryQuiz: [
    ...
    ans("y10-ar-m3", "Find the area of a circle with radius 3 (use π = 3.14).", "", "28.26", 3, "3.14 × 9 = 28.26.", ["28.26"]),
    ...
    ans("y10-ar-m6", "Find the area of a 90° sector with radius 2 (use π = 3.14).", "", "3.14", 4, "¼ × 3.14 × 4 = 3.14.", ["3.14"]),
    ...
    ans("y10-ar-m9", "Find the area of a circle with radius 1 (use π = 3.14).", "", "3.14", 2, "3.14 × 1 = 3.14.", ["3.14"]),
