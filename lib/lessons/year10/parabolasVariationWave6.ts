...
const lineParabolaIntersection: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-pi-g3", "y = x² and y = x meet where x² = x. Find the non-zero solution.", "x^2=x", "1", 3, "x² − x = 0 → x(x − 1) = 0 → x = 0 or 1; the non-zero is 1.", ["x=1"]),
  ...
  independentPractice: [
    ...
    ans("y10-pi-i3", "y = x² and y = 3x meet where x² = 3x. Find the non-zero solution.", "x^2=3x", "3", 3, "x² − 3x = 0 → x(x − 3) = 0 → x = 0 or 3.", ["x=3"]),
  ...
  masteryQuiz: [
    ...
    ans("y10-pi-m3", "y = x² and y = 4x meet where x² = 4x. Find the non-zero solution.", "x^2=4x", "4", 3, "x(x − 4) = 0 → x = 0 or 4.", ["x=4"]),
    ...
    ans("y10-pi-m7", "y = x² and y = 5x meet where x² = 5x. Find the non-zero solution.", "x^2=5x", "5", 3, "x(x − 5) = 0 → x = 0 or 5.", ["x=5"]),
