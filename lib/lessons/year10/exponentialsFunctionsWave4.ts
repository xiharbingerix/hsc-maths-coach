...
const growthDecay: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-gd-g2", "$500 grows by 10% in one year. Find the new amount.", "", "550", 2, "500 × 1.10 = $550.", ["$550"]),
    ans("y10-gd-g3", "What is the decay factor for a 20% decrease?", "", "0.8", 2, "Keep 100% minus 20%: 1 − 0.20 = 0.80.", ["0.80"]),
    ans("y10-gd-g4", "$1000 grows 10% per year for 2 years. Find the amount.", "", "1210", 3, "1000 × 1.10² = 1000 × 1.21 = $1210.", ["$1210"]),
  ],
  independentPractice: [
    mcq("y10-gd-i1", "What is the decay factor for a 5% decrease?", "C", ["1.05", "0.05", "0.95", "5"], 2, "1 − 0.05 = 0.95."),
    ans("y10-gd-i2", "$2000 grows 5% in one year. Find the new amount.", "", "2100", 2, "2000 × 1.05 = $2100.", ["$2100"]),
    ans("y10-gd-i3", "A population of 1000 grows 10% per year for 2 years. Find the population.", "", "1210", 3, "1000 × 1.21 = 1210.", []),
    ans("y10-gd-i4", "$10 000 decays 10% per year for 2 years. Find the value.", "", "8100", 3, "10000 × 0.81 = $8100.", ["$8100"]),
    mcq("y10-gd-i5", "Growing by 100% means multiplying by:", "B", ["1", "2", "1.1", "100"], 2, "A 100% increase doubles the amount: factor 1 + 1 = 2."),
  ],
  masteryQuiz: [
    ans("y10-gd-m1", "What is the growth factor for an 8% increase?", "", "1.08", 2, "1 + 0.08 = 1.08.", []),
    mcq("y10-gd-m2", "What is the decay factor for a 25% decrease?", "A", ["0.75", "1.25", "0.25", "25"], 2, "1 − 0.25 = 0.75."),
    ans("y10-gd-m3", "$1000 grows 20% per year for 2 years. Find the amount.", "", "1440", 3, "1000 × 1.44 = $1440.", ["$1440"]),
    ans("y10-gd-m4", "$5000 decays 20% in one year. Find the value.", "", "4000", 2, "5000 × 0.80 = $4000.", ["$4000"]),
    ...
    ans("y10-gd-m6", "200 grows by 50% in one year. Find the new amount.", "", "300", 2, "200 × 1.50 = 300.", []),
    ans("y10-gd-m7", "$1000 grows 10% per year for 3 years. Find the amount.", "", "1331", 4, "1000 × 1.331 = $1331.", ["$1331"]),
    ...
    ans("y10-gd-m9", "$8000 decays 50% per year for 2 years. Find the value.", "", "2000", 3, "8000 × 0.25 = $2000.", ["$2000"]),
    ans("y10-gd-m10", "What is the growth factor for a 100% increase?", "", "2", 2, "1 + 1.00 = 2 (the amount doubles).", []),
  ],
  commonMistakes: [
...
const logScales: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y10-ls-g2", "How many times stronger is a Richter 5 earthquake than a Richter 4?", "", "10", 2, "A difference of 1 unit means 10 times.", ["10 times"]),
    ans("y10-ls-g3", "A pH difference of 2 units means how many times more acidic?", "", "100", 3, "Difference of 2 → 10² = 100 times.", ["100 times"]),
  ...
  independentPractice: [
    ...
    ans("y10-ls-i2", "A sound 1000 times louder is how many units higher on a base-10 scale?", "", "3", 3, "1000 = 10³, so it is 3 units higher.", []),
    ans("y10-ls-i3", "Find log₁₀100000.", "\\log_{10} 100000", "5", 2, "10⁵ = 100000, so it is 5.", []),
    ans("y10-ls-i4", "A difference of 3 units on a base-10 log scale means how many times?", "", "1000", 3, "10³ = 1000 times.", ["1000 times"]),
  ...
  masteryQuiz: [
    ans("y10-ls-m1", "How many times stronger is Richter 6 than Richter 3?", "", "1000", 4, "Difference of 3 → 10³ = 1000 times.", ["1000 times"]),
    ...
    ans("y10-ls-m4", "A 10000-times change is how many units on a base-10 log scale?", "", "4", 3, "10000 = 10⁴, so 4 units.", []),
    ...
    ans("y10-ls-m6", "A pH 2 solution is how many times more acidic than pH 4?", "", "100", 3, "Difference of 2 → 100 times.", ["100 times"]),
    ...
    ans("y10-ls-m9", "A difference of 5 units on a base-10 log scale means how many times?", "", "100000", 4, "10⁵ = 100000 times.", ["100000 times"]),
