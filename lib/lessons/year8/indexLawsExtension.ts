...
const negativeIndices: LessonContent = {
  ...
  masteryQuizPool: [
    dAnswer("y8-ile-neg-p1", 1, "Evaluate $2^{-2}$.", "", "1/4",
      "$2^{-2} = \\frac{1}{2^2} = \\frac{1}{4}$.", "Take the reciprocal of $2^2$."),
    dAnswer("y8-ile-neg-p2", 1, "Evaluate $5^{-1}$.", "", "1/5",
    ...
    dAnswer("y8-ile-neg-p4", 1, "Write $\\frac{1}{6^2}$ using a negative index.", "", "6^{-2}",
      "$\\frac{1}{6^2} = 6^{-2}$.", "Use $\\frac{1}{a^n} = a^{-n}$."),
    dAnswer("y8-ile-neg-p5", 2, "Evaluate $3^{-2}$.", "", "1/9",
      "$3^{-2} = \\frac{1}{9}$.", "Reciprocal of $3^2$."),
    dAnswer("y8-ile-neg-p6", 2, "Evaluate $10^{-2}$.", "", "1/100",
      "$10^{-2} = \\frac{1}{100} = 0.01$.", "Powers of ten give unit fractions.", ["0.01"]),
    dAnswer("y8-ile-neg-p7", 2, "Simplify $x^3 \\times x^{-5}$.", "", "x^{-2}",
    ...
    dAnswer("y8-ile-neg-p9", 2, "Write $\\frac{1}{8^3}$ using a negative index.", "", "8^{-3}",
      "$\\frac{1}{8^3} = 8^{-3}$.", "Apply $\\frac{1}{a^n} = a^{-n}$."),
    dAnswer("y8-ile-neg-p10", 2, "Evaluate $4^{-1}$.", "", "1/4",
      "$4^{-1} = \\frac{1}{4}$.", "Reciprocal of the base."),
    dAnswer("y8-ile-neg-p11", 3, "Simplify $\\frac{a^3}{a^7}$ as a negative power.", "", "a^{-4}",
      "$\\frac{a^3}{a^7} = a^{3-7} = a^{-4}$.", "Subtract indices.", ["1/a^4"]),
    dAnswer("y8-ile-neg-p12", 3, "Evaluate $2^{-4} \\times 2^6$.", "", "4",
      "$2^{-4+6} = 2^2 = 4$.", "Add the indices."),
    dAnswer("y8-ile-neg-p13", 3, "Evaluate $5^{-3} \\times 5^3$.", "", "1",
    ...
    dAnswer("y8-ile-neg-p15", 3, "Simplify $\\frac{1}{p^{-3}}$.", "", "p^3",
      "$\\frac{1}{p^{-3}} = p^3$. A negative index in the denominator moves up as a positive index.", "Use $\\frac{1}{a^{-n}} = a^n$."),
    dAnswer("y8-ile-neg-p16", 3, "Evaluate $\\frac{1}{3^{-2}}$.", "", "9",
      "$\\frac{1}{3^{-2}} = 3^2 = 9$.", "Use $\\frac{1}{a^{-n}} = a^n$."),
    dAnswer("y8-ile-neg-p17", 4, "Simplify $\\frac{a^{-2}a^5}{a^4}$ with a positive index, then evaluate at $a=4$.", "", "1/a, 1/4",
      "$a^{-2+5-4}=a^{-1}=1/a$. At $a=4$, the value is $1/4$.", "Combine exponents before rewriting the negative index.", ["a^{-1}, 1/4"]),
    dAnswer("y8-ile-neg-p18", 4, "For $\\frac{2^3 2^{-6}}{2^{-5}}$, find the final exponent of 2 and the numerical value.", "", "2, 4",
      "The exponent is $3-6-(-5)=2$, so the value is $2^2=4$.", "Subtracting the denominator's negative exponent adds 5.", ["exponent 2, value 4"]),
    dAnswer("y8-ile-neg-p19", 4, "Compare $\\left(\\frac12\\right)^{-3}$ with $\\left(\\frac12\\right)^3$. Give both values and the factor between them.", "", "8, 1/8, factor 64",
      "The negative power gives $2^3=8$; the positive power is $1/8$. Their ratio is $8\\div(1/8)=64$.", "Evaluate both powers before comparing them.", ["8, 1/8, 64"]),
    dAnswer("y8-ile-neg-p20", 4, "Evaluate $3^{-1}+3^{-2}$ as a fraction and as a recurring decimal.", "", "4/9, 0.444...",
      "$1/3+1/9=4/9=0.444\\ldots$.", "Rewrite with positive denominators and use a common denominator.", ["\\frac{4}{9}, 0.4 recurring"]),
    dAnswer("y8-ile-neg-p21", 4, "Simplify $\\frac{6^{-2}}{6^{-5}}$. State the resulting exponent and whole-number value.", "", "3, 216",
      "$-2-(-5)=3$, so the expression is $6^3=216$.", "Apply the quotient law to the negative denominator exponent.", ["6^3, 216"]),
    dAnswer("y8-ile-neg-p22", 5, "Simplify $\\frac{(a^2)^{-3}a^8}{a^{-1}}$, then evaluate at $a=2$.", "", "a^3, 8", "Indices give $-6+8-(-1)=3$, so $a^3$; at 2 it is 8.", "Combine indices before substituting.", ["a^3,8"]),
    dAnswer("y8-ile-neg-p23", 5, "Evaluate $2^{-2}+4^{-1}$ as a fraction and decimal.", "", "1/2, 0.5", "Both terms are $1/4$, totaling $1/2=0.5$.", "Convert negative powers, then add.", ["0.5,1/2"]),
    dChoice("y8-ile-neg-p24", 5, "For $\\frac{10^{-3}10^5}{10^{-2}}$, which option gives exponent form and value?", "B",
      ["$10^0,1$", "$10^4,10000$", "$10^{-4},0.0001$", "$10^6,1000000$"],
      "The exponent is $-3+5-(-2)=4$, so the value is 10000.", "Combine signed indices."),
    dAnswer("y8-ile-neg-p25", 5, "Simplify $\\frac{x^{-4}x^6}{x^3x^{-2}}$, then evaluate at $x=-3$.", "", "x, -3", "Top is $x^2$, bottom $x$, giving $x$; at $-3$ it is $-3$.", "Simplify numerator and denominator separately.", ["x,-3"]),
    dAnswer("y8-ile-neg-p26", 5, "For $\\frac{5^{-1}+5^{-2}}{5^{-2}}$, give the numerator as a fraction and the final whole number.", "", "6/25, 6", "The numerator is $1/5+1/25=6/25$; dividing by $1/25$ gives 6.", "Complete numerator before division.", ["6/25,6"]),
  ],
  multiPartPractice: [
    {
      id: "y8-ile-neg-mp1",
...
const scientificNotationLarge: LessonContent = {
  ...
  masteryQuizPool: [
    dAnswer("y8-ile-snl-p1", 1, "Write $40\\,000$ in scientific notation.", "", "4 × 10^4",
      "$40\\,000 = 4 \\times 10^4$.", "Decimal moves 4 places left.", ["4.0 × 10^4", "4 * 10^4"]),
    dAnswer("y8-ile-snl-p2", 1, "Write $2.0 \\times 10^3$ in standard form.", "", "2000",
      "$2.0 \\times 10^3 = 2000$.", "Move the decimal 3 places right.", ["2,000"]),
    dAnswer("y8-ile-snl-p3", 1, "Write $700\\,000$ in scientific notation.", "", "7 × 10^5",
    ...
    dAnswer("y8-ile-snl-p5", 2, "Write $6\\,300\\,000$ in scientific notation.", "", "6.3 × 10^6",
      "$6\\,300\\,000 = 6.3 \\times 10^6$.", "Count places to the first digit.", ["6.3 * 10^6"]),
    dAnswer("y8-ile-snl-p6", 2, "Write $4.7 \\times 10^5$ in standard form.", "", "470000",
      "$4.7 \\times 10^5 = 470\\,000$.", "Move the decimal 5 places right.", ["470,000"]),
    dAnswer("y8-ile-snl-p7", 2, "Write $89\\,000$ in scientific notation.", "", "8.9 × 10^4",
    ...
    dAnswer("y8-ile-snl-p9", 2, "Write $1.04 \\times 10^7$ in standard form.", "", "10400000",
      "$1.04 \\times 10^7 = 10\\,400\\,000$.", "Move the decimal 7 places right.", ["10,400,000"]),
    dAnswer("y8-ile-snl-p10", 2, "Write $3\\,050\\,000$ in scientific notation.", "", "3.05 × 10^6",
      "$3\\,050\\,000 = 3.05 \\times 10^6$.", "Keep the zero between 3 and 5.", ["3.05 * 10^6"]),
    dAnswer("y8-ile-snl-p11", 3, "The mass of Earth is about $5\\,970\\,000\\,000\\,000\\,000\\,000\\,000\\,000\\,000$ kg. Write the coefficient and power: give the answer in scientific notation.", "", "5.97 × 10^24",
      "Counting 24 places after the first digit gives $5.97 \\times 10^{24}$.", "Count the digits after the leading 5.", ["5.97 * 10^24"]),
    dAnswer("y8-ile-snl-p12", 3, "Write $2.6 \\times 10^4$ in standard form, then state how many zeros follow the 6.", "", "26000",
    ...
    dAnswer("y8-ile-snl-p14", 3, "Write $0.72 \\times 10^6$ in correct scientific notation.", "", "7.2 × 10^5",
    ...
    dAnswer("y8-ile-snl-p15", 3, "Write $12\\,000\\,000$ in scientific notation.", "", "1.2 × 10^7",
      "$12\\,000\\,000 = 1.2 \\times 10^7$.", "Coefficient must be between 1 and 10.", ["1.2 * 10^7"]),
    dAnswer("y8-ile-snl-p16", 3, "Write $5.5 \\times 10^8$ in standard form.", "", "550000000",
      "$5.5 \\times 10^8 = 550\\,000\\,000$.", "Move the decimal 8 places right.", ["550,000,000"]),
    dChoice("y8-ile-snl-p17", 4, "Arrange $7.0 \\times 10^5$, $6.9 \\times 10^6$, and $5.0 \\times 10^5$ in ascending order. Then identify the middle value.", "A",
      ...
      "The order is $5.0 \\times 10^5 < 7.0 \\times 10^5 < 6.9 \\times 10^6$, so the middle value is $7.0 \\times 10^5$.", "Compare exponents first; when exponents match, compare coefficients."),
    dAnswer("y8-ile-snl-p18", 4, "A galaxy contains about $4.0 \\times 10^{12}$ stars. Estimate the number of stars in 5 such galaxies, in scientific notation.", "", "2 × 10^13",
      "$5(4.0 \\times 10^{12})=20 \\times 10^{12}=2.0 \\times 10^{13}$ stars. The coefficient 20 must be renormalised to 2.0.", "Multiply the coefficient by 5, then rewrite the result with a coefficient from 1 to 10.", ["2.0 × 10^13", "2 * 10^13"]),
    dAnswer("y8-ile-snl-p19", 4, "Two distances are $3.0 \\times 10^7$ km and $5.0 \\times 10^6$ km. Find both their sum and their positive difference in scientific notation.", "", "3.5 × 10^7, 2.5 × 10^7",
      "$5.0 \\times 10^6=0.5 \\times 10^7$. Therefore the sum is $(3.0+0.5)\\times10^7=3.5\\times10^7$ km and the positive difference is $(3.0-0.5)\\times10^7=2.5\\times10^7$ km.", "Rewrite both distances using $10^7$, then add and subtract their coefficients.", ["3.5 * 10^7, 2.5 * 10^7"]),
    dAnswer("y8-ile-snl-p20", 4, "Stadium A holds $8.0 \\times 10^4$ people and Stadium B holds $1.2 \\times 10^5$. Find their total capacity and how many more people Stadium B holds, in scientific notation.", "", "2 × 10^5, 4 × 10^4",
      "Stadium B holds $12\\times10^4$ people. The total is $(8+12)\\times10^4=2.0\\times10^5$, and the difference is $(12-8)\\times10^4=4.0\\times10^4$.", "Express both capacities with the same power of 10 before finding the sum and difference.", ["2.0 × 10^5, 4.0 × 10^4", "2 * 10^5, 4 * 10^4"]),
    dAnswer("y8-ile-snl-p21", 4, "Write $99\\,000\\,000$ in scientific notation. Then find its gap from $1.0 \\times 10^8$, also in scientific notation.", "", "9.9 × 10^7, 1 × 10^6",
      "$99\\,000\\,000=9.9\\times10^7$. Also, $1.0\\times10^8=100\\,000\\,000$, so the gap is $1\\,000\\,000=1.0\\times10^6$.", "Convert both numbers to standard form to check the subtraction.", ["9.9 * 10^7, 1 * 10^6", "9.9 × 10^7, 1.0 × 10^6"]),
    dAnswer("y8-ile-snl-p22", 5, "GDP is $1.8×10^{12}$ and grows by $2.0×10^{11}$. Find new GDP and percentage growth.", "", "2.0 × 10^12, 11.1%", "New GDP is $2.0×10^{12}$. Growth fraction is $0.2/1.8≈0.111$, or 11.1%.", "Match exponents, then compare growth with original.", ["2e12,11.1"]),
    dChoice("y8-ile-snl-p23", 5, "For $(3×10^4)×20$, which gives proper scientific notation and ordinary form?", "C",
      ["$6×10^4,60000$", "$6×10^6,6000000$", "$6×10^5,600000$", "$60×10^4,60000$"],
      "$3 \\times 20 = 60$, times $10^4 = 60 \\times 10^4 = 6 \\times 10^5$.", "Multiply, then convert to proper form."),
    dAnswer("y8-ile-snl-p24", 5, "A factory makes $2.5×10^4$ items daily for $4.0×10^2$ days. Give total in scientific and ordinary notation.", "", "1.0 × 10^7, 10000000", "Multiplication gives $10×10^6=1.0×10^7$, or 10,000,000.", "Multiply and renormalise.", ["1e7,10000000"]),
    dAnswer("y8-ile-snl-p25", 5, "For $6.4×10^6$ and $3.6×10^6$, find sum and positive difference.", "", "1.0 × 10^7, 2.8 × 10^6", "Sum coefficients gives 10; difference gives 2.8, with common exponent.", "Use the shared exponent for both operations.", ["1e7,2.8e6"]),
  ],
  multiPartPractice: [
    {
      id: "y8-ile-snl-mp1",
...
const scientificNotationSmall: LessonContent = {
  ...
  masteryQuizPool: [
    dAnswer("y8-ile-sns-p1", 1, "Write $0.07$ in scientific notation.", "", "7 × 10^{-2}",
      "$0.07 = 7 \\times 10^{-2}$.", "Move the decimal 2 places right.", ["7.0 × 10^{-2}", "7 * 10^{-2}"]),
    dAnswer("y8-ile-sns-p2", 1, "Write $0.004$ in scientific notation.", "", "4 × 10^{-3}",
      "$0.004 = 4 \\times 10^{-3}$.", "Count 3 places to reach the 4.", ["4.0 × 10^{-3}", "4 * 10^{-3}"]),
    dAnswer("y8-ile-sns-p3", 1, "Write $2.0 \\times 10^{-2}$ as a decimal.", "", "0.02",
    ...
    dAnswer("y8-ile-sns-p5", 2, "Write $0.00045$ in scientific notation.", "", "4.5 × 10^{-4}",
      "$0.00045 = 4.5 \\times 10^{-4}$.", "Move the decimal 4 places right.", ["4.5 * 10^{-4}"]),
    dAnswer("y8-ile-sns-p6", 2, "Write $3.6 \\times 10^{-3}$ as a decimal.", "", "0.0036",
      "$3.6 \\times 10^{-3} = 0.0036$.", "Move the decimal 3 places left."),
    dAnswer("y8-ile-sns-p7", 2, "Write $0.0000082$ in scientific notation.", "", "8.2 × 10^{-6}",
    ...
    dAnswer("y8-ile-sns-p9", 2, "Write $7.04 \\times 10^{-5}$ as a decimal.", "", "0.0000704",
      "$7.04 \\times 10^{-5} = 0.0000704$.", "Move the decimal 5 places left."),
    dAnswer("y8-ile-sns-p10", 2, "Write $0.00012$ in scientific notation.", "", "1.2 × 10^{-4}",
      "$0.00012 = 1.2 \\times 10^{-4}$.", "Coefficient between 1 and 10.", ["1.2 * 10^{-4}"]),
    dAnswer("y8-ile-sns-p11", 3, "The diameter of a human hair is about $0.00007$ m. Write this in scientific notation.", "", "7 × 10^{-5}",
      "$0.00007 = 7 \\times 10^{-5}$.", "Count places to the 7.", ["7.0 × 10^{-5}", "7 * 10^{-5}"]),
    dAnswer("y8-ile-sns-p12", 3, "Write $0.0506$ in scientific notation.", "", "5.06 × 10^{-2}",
    ...
    dAnswer("y8-ile-sns-p14", 3, "Write $8.0 \\times 10^{-8}$ as a decimal.", "", "0.00000008",
      "$8.0 \\times 10^{-8} = 0.00000008$.", "Move the decimal 8 places left."),
    dAnswer("y8-ile-sns-p15", 3, "Write $0.000305$ in scientific notation.", "", "3.05 × 10^{-4}",
    ...
    dAnswer("y8-ile-sns-p17", 4, "Order smallest to largest and give the middle value: $2.0 \\times 10^{-3}$, $9.0 \\times 10^{-5}$, $4.0 \\times 10^{-4}$. Then find the gap between the largest and middle values.", "", "4.0 × 10^{-4}, 1.6 × 10^{-3}",
      "$9.0\\times10^{-5}<4.0\\times10^{-4}<2.0\\times10^{-3}$, so the middle value is $4.0\\times10^{-4}$. Rewriting it as $0.4\\times10^{-3}$ gives a gap of $(2.0-0.4)\\times10^{-3}=1.6\\times10^{-3}$.", "Order by exponent first, then rewrite the two values being subtracted with a common exponent.", ["4 * 10^-4, 1.6 * 10^-3"]),
    dAnswer("y8-ile-sns-p18", 4, "A virus is about $1.2 \\times 10^{-7}$ m wide. Write this as a decimal and convert the width to nanometres, given $1\\text{ m}=10^9\\text{ nm}$.", "", "0.00000012, 120 nm",
      "$1.2\\times10^{-7}$ m is $0.00000012$ m. In nanometres it is $1.2\\times10^{-7}\\times10^9=1.2\\times10^2=120$ nm.", "Move the decimal 7 places left for metres; multiply by $10^9$ for nanometres.", ["0.00000012, 120"]),
    dAnswer("y8-ile-sns-p19", 4, "A sample of $9.6 \\times 10^{-4}$ g is split into 4 equal parts. Find one part in scientific notation and verify that four parts recover the original mass.", "", "2.4 × 10^{-4}, 9.6 × 10^{-4}",
      "One part is $(9.6\\div4)\\times10^{-4}=2.4\\times10^{-4}$ g. Checking, $4(2.4\\times10^{-4})=9.6\\times10^{-4}$ g, which matches the sample.", "Divide the coefficient by 4, then multiply your result by 4 to check.", ["2.4 * 10^-4, 9.6 * 10^-4"]),
    dAnswer("y8-ile-sns-p20", 4, "Write $0.000000067$ in scientific notation. Then find how much smaller it is than $7.0 \\times 10^{-8}$.", "", "6.7 × 10^{-8}, 3 × 10^{-9}",
      "$0.000000067=6.7\\times10^{-8}$. The gap is $(7.0-6.7)\\times10^{-8}=0.3\\times10^{-8}=3.0\\times10^{-9}$.", "Convert the decimal first, then subtract using a common exponent and renormalise.", ["6.7 * 10^-8, 3 * 10^-9", "6.7 × 10^-8, 3.0 × 10^-9"]),
    dAnswer("y8-ile-sns-p21", 4, "A particle of mass $4.0 \\times 10^{-6}$ g loses $1.5 \\times 10^{-6}$ g. Find the remaining mass and the percentage of the original mass that remains.", "", "2.5 × 10^{-6}, 62.5%",
      "The remaining mass is $(4.0-1.5)\\times10^{-6}=2.5\\times10^{-6}$ g. The fraction remaining is $2.5/4.0=0.625$, so $62.5\\%$ remains.", "Subtract the masses, then divide the remainder by the original mass and multiply by 100.", ["2.5 * 10^-6, 62.5", "2.5 × 10^-6, 62.5"]),
    dChoice("y8-ile-sns-p22", 5, "For $(2.0×10^{-3})(4.0×10^{-2})$, which gives scientific and decimal forms?", "C",
      ["$8.0×10^{-6},0.000008$", "$6.0×10^{-5},0.00006$", "$8.0×10^{-5},0.00008$", "$8.0×10^6,8000000$"],
      "$2.0 \\times 4.0 = 8.0$, exponents $-3 + (-2) = -5$.", "Multiply coefficients, add exponents."),
    dAnswer("y8-ile-sns-p23", 5, "A film is $3.5×10^{-4}$ mm thick. Find the thickness of 20 films in scientific and decimal notation.", "", "7.0 × 10^{-3}, 0.007", "The stack is $70×10^{-4}=7.0×10^{-3}$ mm, or 0.007 mm.", "Multiply, renormalise, then convert.", ["7e-3,0.007"]),
    dAnswer("y8-ile-sns-p24", 5, "Evaluate $\\frac{8.0×10^{-3}}{2.0×10^{-6}}$ in scientific notation and as a whole number.", "", "4.0 × 10^3, 4000", "Division gives coefficient 4 and exponent 3, so 4000.", "Divide coefficients and subtract indices.", ["4e3,4000"]),
    dAnswer("y8-ile-sns-p25", 5, "Find the sum and positive difference of 0.000056 and 0.000004 in scientific notation.", "", "6.0 × 10^{-5}, 5.2 × 10^{-5}", "The sum is 0.000060 and difference 0.000052, giving the stated forms.", "Add and subtract before converting.", ["6e-5,5.2e-5"]),
  ],
  multiPartPractice: [
    {
      id: "y8-ile-sns-mp1",
...
const significantFigures: LessonContent = {
  ...
  masteryQuizPool: [
    dAnswer("y8-ile-sig-p1", 1, "How many significant figures does $4.27$ have?", "", "3",
      "All three non-zero digits are significant.", "Count the non-zero digits."),
    dAnswer("y8-ile-sig-p2", 1, "How many significant figures does $508$ have?", "", "3",
    ...
    dAnswer("y8-ile-sig-p9", 2, "Round $0.0006182$ to 2 significant figures.", "", "0.00062",
      "First 2 sig figs 6, 1; next digit 8 (≥ 5) rounds up: 0.00062.", "Begin at the 6."),
    dAnswer("y8-ile-sig-p10", 2, "Round $4582$ to 3 significant figures.", "", "4580",
      "First 3 sig figs 4, 5, 8; next digit 2 (< 5) rounds down: 4580.", "Look at the 4th digit."),
    dAnswer("y8-ile-sig-p11", 3, "Round $0.0099$ to 1 significant figure.", "", "0.01",
      "First sig fig 9; next digit 9 (≥ 5) rounds up, carrying to 0.01.", "Rounding 9 up carries over."),
    dAnswer("y8-ile-sig-p12", 3, "Round $19\\,962$ to 3 significant figures.", "", "20000",
    ...
    dAnswer("y8-ile-sig-p14", 3, "Round $0.072849$ to 3 significant figures.", "", "0.0728",
      "First 3 sig figs 7, 2, 8; next digit 4 (< 5) rounds down: 0.0728.", "Start at the 7."),
    dAnswer("y8-ile-sig-p15", 3, "A measurement is $3.96 \\times 10^{4}$. How many significant figures does it have?", "", "3",
      "In scientific notation, sig figs equal the digits of the coefficient: 3.", "Count the coefficient's digits."),
    dAnswer("y8-ile-sig-p16", 3, "Round $0.0040500$ to 3 significant figures.", "", "0.00405",
      "First 3 sig figs 4, 0, 5; next digit 0 (< 5) rounds down: 0.00405.", "Keep the zero between 4 and 5."),
    dAnswer("y8-ile-sig-p17", 4, "Round $2.9985$ to 3 significant figures, then state the absolute change caused by rounding.", "", "3.00, 0.0015",
      "The fourth significant digit is 8, so $2.9985$ rounds up to $3.00$. The trailing zeros show three significant figures. The absolute change is $3.0000-2.9985=0.0015$.", "Round through the 9s, retain three significant figures, then subtract the original value from the rounded value.", ["3, 0.0015"]),
    dAnswer("y8-ile-sig-p18", 4, "Round $0.0099962$ to 3 significant figures, then write the rounded result in scientific notation.", "", "0.0100, 1.00 × 10^{-2}",
      "The fourth significant digit is 6, so rounding carries through the 9s to $0.0100$. Its three significant figures are shown by $1.00\\times10^{-2}$.", "Round from the first non-zero digit; preserve trailing zeros that communicate precision.", ["0.0100, 1.00 * 10^-2", "0.01, 1.00 × 10^-2"]),
    dChoice("y8-ile-sig-p19", 4, "Which option correctly compares rounding $0.0034$ to 2 decimal places with rounding it to 2 significant figures?", "A",
      ["$0.00$", "$0.0034$", "$0.003$", "$0.34$"],
      "To 2 decimal places the result is $0.00$, but to 2 significant figures it remains $0.0034$. Decimal places count from the decimal point; significant figures begin at the first non-zero digit.", "Work out both roundings before choosing."),
    dAnswer("y8-ile-sig-p20", 4, "Express $0.00528$ in scientific notation with 3 significant figures, then round that value to 2 significant figures.", "", "5.28 × 10^{-3}, 5.3 × 10^{-3}",
      "$0.00528=5.28\\times10^{-3}$. For two significant figures, the third digit is 8, so the coefficient rounds to 5.3 and the result is $5.3\\times10^{-3}$.", "Convert first, then use the third coefficient digit to round to two significant figures.", ["5.28 * 10^-3, 5.3 * 10^-3"]),
    dAnswer("y8-ile-sig-p21", 4, "Round $749\\,500$ to 2 significant figures, then write the rounded result in scientific notation.", "", "750000, 7.5 × 10^5",
      "The third significant digit is 9, so $749\\,500$ rounds to $750\\,000$. In scientific notation this is $7.5\\times10^5$.", "Round using the third significant digit, then move the decimal after the first non-zero digit.", ["750,000, 7.5 × 10^5", "750000, 7.5 * 10^5"]),
    dAnswer("y8-ile-sig-p22", 5, "Round $0.00045650$ to 3 significant figures and write the result in scientific notation.", "", "0.000457, 4.57 × 10^{-4}", "Rounding gives 0.000457, which is $4.57×10^{-4}$.", "Round from the first non-zero digit.", ["0.000457,4.57e-4"]),
    dChoice("y8-ile-sig-p23", 5, "For $1.020×10^{-6}$, which option gives significant-figure count and ordinary decimal?", "C",
      ["2 and 0.00000102", "3 and 0.00001020", "4 and 0.000001020", "5 and 0.0000001020"],
      "The coefficient 1.020 has 4 sig figs (the trailing zero counts).", "Count digits in the coefficient including trailing zeros."),
    dAnswer("y8-ile-sig-p24", 5, "A $4.2$ cm by $3.15$ cm rectangle has unrounded area 13.23 cm². Round appropriately and state the limiting measurement precision.", "", "13 cm^2, 2 significant figures", "The least precise measurement, 4.2, has 2 significant figures, so area rounds to 13 cm².", "Use the fewest significant figures.", ["13,2"]),
    dAnswer("y8-ile-sig-p25", 5, "Round 98,765 to 1 significant figure and state the absolute rounding change.", "", "100000, 1235", "It rounds to 100,000; the change is $100000-98765=1235$.", "Round first, then subtract.", ["100000,1235"]),
  ],
  multiPartPractice: [
    {
      id: "y8-ile-sig-mp1",
...
const operationsWithScientificNotation: LessonContent = {
  ...
  masteryQuizPool: [
    dAnswer("y8-ile-ops-p1", 1, "Calculate $(2 \\times 10^2) \\times (3 \\times 10^3)$.", "", "6 × 10^5",
      "$2 \\times 3 = 6$, $10^{2+3} = 10^5$.", "Multiply coefficients, add exponents.", ["6 * 10^5"]),
    dAnswer("y8-ile-ops-p2", 1, "Calculate $\\frac{6 \\times 10^8}{2 \\times 10^3}$.", "", "3 × 10^5",
      "$\\frac{6}{2} = 3$, $10^{8-3} = 10^5$.", "Divide coefficients, subtract exponents.", ["3 * 10^5"]),
    dAnswer("y8-ile-ops-p3", 1, "Calculate $4.0 \\times 10^4 + 3.0 \\times 10^4$.", "", "7.0 × 10^4",
    ...
    dAnswer("y8-ile-ops-p5", 2, "Calculate $(3 \\times 10^4) \\times (3 \\times 10^2)$.", "", "9 × 10^6",
      "$3 \\times 3 = 9$, $10^{4+2} = 10^6$.", "Multiply coefficients, add exponents.", ["9 * 10^6"]),
    dAnswer("y8-ile-ops-p6", 2, "Calculate $\\frac{8.4 \\times 10^9}{2.0 \\times 10^4}$.", "", "4.2 × 10^5",
      "$\\frac{8.4}{2.0} = 4.2$, $10^{9-4} = 10^5$.", "Divide coefficients, subtract exponents.", ["4.2 * 10^5"]),
    dAnswer("y8-ile-ops-p7", 2, "Calculate $6.0 \\times 10^{-2} \\times 3.0 \\times 10^{5}$.", "", "1.8 × 10^4",
    ...
    dAnswer("y8-ile-ops-p9", 2, "Calculate $9.0 \\times 10^{-4} - 4.0 \\times 10^{-4}$.", "", "5.0 × 10^{-4}",
      "Same exponent: $(9.0 - 4.0) \\times 10^{-4} = 5.0 \\times 10^{-4}$.", "Subtract coefficients.", ["5 × 10^{-4}", "5 * 10^{-4}"]),
    dAnswer("y8-ile-ops-p10", 2, "Calculate $\\frac{9.0 \\times 10^6}{3.0 \\times 10^2}$.", "", "3.0 × 10^4",
      "$\\frac{9.0}{3.0} = 3.0$, $10^{6-2} = 10^4$.", "Divide coefficients, subtract exponents.", ["3 × 10^4", "30000"]),
    dAnswer("y8-ile-ops-p11", 3, "Calculate $(5 \\times 10^3) \\times (6 \\times 10^4)$, giving the answer in proper scientific notation.", "", "3 × 10^8",
      "$5 \\times 6 = 30$, $10^{3+4} = 10^7$: $30 \\times 10^7 = 3 \\times 10^8$.", "Adjust the coefficient to between 1 and 10.", ["3.0 × 10^8", "3 * 10^8"]),
    dAnswer("y8-ile-ops-p12", 3, "Calculate $7.2 \\times 10^5 + 8.0 \\times 10^4$.", "", "8.0 × 10^5",
    ...
    dAnswer("y8-ile-ops-p14", 3, "Calculate $\\frac{1.5 \\times 10^3}{5.0 \\times 10^6}$.", "", "3.0 × 10^{-4}",
      "$\\frac{1.5}{5.0} = 0.3$, $10^{3-6} = 10^{-3}$: $0.3 \\times 10^{-3} = 3.0 \\times 10^{-4}$.", "Divide, subtract exponents, then adjust.", ["3 × 10^{-4}", "3 * 10^{-4}"]),
    dAnswer("y8-ile-ops-p15", 3, "Calculate $6.5 \\times 10^7 - 1.5 \\times 10^7$.", "", "5.0 × 10^7",
      "Same exponent: $(6.5 - 1.5) \\times 10^7 = 5.0 \\times 10^7$.", "Subtract coefficients.", ["5 × 10^7", "5 * 10^7"]),
    dAnswer("y8-ile-ops-p16", 3, "Calculate $(8 \\times 10^{-3}) \\times (2 \\times 10^{-2})$.", "", "1.6 × 10^{-4}",
      "$8 \\times 2 = 16$, $10^{-3+(-2)} = 10^{-5}$: $16 \\times 10^{-5} = 1.6 \\times 10^{-4}$.", "Multiply, add exponents, then adjust.", ["1.6 * 10^{-4}"]),
    dAnswer("y8-ile-ops-p17", 4, "Light travels at $3.0 \\times 10^8$ m/s for $2.0 \\times 10^{-3}$ s. Find the distance in scientific notation in metres, then convert it to kilometres.", "", "6 × 10^5 m, 600 km",
      "Multiplying gives $(3.0\\times2.0)\\times10^{8-3}=6.0\\times10^5$ m. Dividing by $10^3$ converts metres to kilometres: $6.0\\times10^2=600$ km.", "Multiply the scientific-notation values, then divide the metre result by $10^3$.", ["6.0 × 10^5, 600", "6 * 10^5 m, 600 km"]),
    dAnswer("y8-ile-ops-p18", 4, "Calculate $\\frac{4.8 \\times 10^{-2}}{1.6 \\times 10^{3}}$ in scientific notation and as an ordinary decimal.", "", "3 × 10^{-5}, 0.00003",
      "$4.8/1.6=3$ and $10^{-2}/10^3=10^{-5}$, so the quotient is $3.0\\times10^{-5}=0.00003$.", "Divide coefficients, subtract exponents, then move the decimal five places left.", ["3.0 × 10^-5, 0.00003", "3 * 10^-5, 0.00003"]),
    dAnswer("y8-ile-ops-p19", 4, "For $3.6 \\times 10^6$ and $9.0 \\times 10^5$, find both the sum and the positive difference in proper scientific notation.", "", "4.5 × 10^6, 2.7 × 10^6",
      "$9.0\\times10^5=0.9\\times10^6$. The sum is $(3.6+0.9)\\times10^6=4.5\\times10^6$, and the difference is $(3.6-0.9)\\times10^6=2.7\\times10^6$.", "Match the exponents before adding and subtracting coefficients.", ["4.5 * 10^6, 2.7 * 10^6"]),
    dAnswer("y8-ile-ops-p20", 4, "A battery stores $3.6 \\times 10^5$ J and supplies $9.0 \\times 10^1$ J each second. Find how long it lasts in seconds and in minutes, rounding minutes to 1 decimal place.", "", "4 × 10^3 s, 66.7 min",
      "Time is energy divided by energy per second: $(3.6/9.0)\\times10^{5-1}=0.4\\times10^4=4.0\\times10^3$ s. Dividing 4000 by 60 gives $66.7$ min to one decimal place.", "Divide to find seconds, then divide the ordinary-number result by 60.", ["4000 s, 66.7 min", "4.0 × 10^3, 66.7"]),
    dAnswer("y8-ile-ops-p21", 4, "Calculate $(2.5 \\times 10^{-4}) \\times (4.0 \\times 10^{6})$ in proper scientific notation and as an ordinary number.", "", "1 × 10^3, 1000",
      "The product is $10\\times10^2$. Renormalising gives $1.0\\times10^3$, which is 1000.", "Multiply coefficients and add exponents, then ensure the coefficient is between 1 and 10.", ["1.0 × 10^3, 1000", "1 * 10^3, 1000"]),
    dAnswer("y8-ile-ops-p22", 5, "Using masses $1.99×10^{30}$ kg and $5.97×10^{24}$ kg, find the ratio to 2 significant figures in scientific and ordinary notation.", "", "3.3 × 10^5, 330000", "Division gives about $3.3×10^5$, or 330,000.", "Divide coefficients, subtract exponents, then convert.", ["3.3e5,330000"]),
    dChoice("y8-ile-ops-p23", 5, "For $(6×10^4)(5×10^{-9})$, which gives proper scientific and decimal forms?", "B",
      ["$30×10^{-5},0.00003$", "$3.0×10^{-4},0.0003$", "$3.0×10^{-5},0.00003$", "$3.0×10^4,30000$"],
      "$6 \\times 5 = 30$, $10^{4+(-9)} = 10^{-5}$: $30 \\times 10^{-5} = 3.0 \\times 10^{-4}$.", "Multiply, add exponents, then adjust."),
    dAnswer("y8-ile-ops-p24", 5, "For $4.2×10^{-3}$ and $8.0×10^{-4}$, find sum and positive difference.", "", "5.0 × 10^{-3}, 3.4 × 10^{-3}", "Rewrite the second as $0.8×10^{-3}$, then add and subtract coefficients.", "Match exponents for both operations.", ["5e-3,3.4e-3"]),
    dAnswer("y8-ile-ops-p25", 5, "$2.4×10^{12}$ bytes are shared over $8.0×10^3$ servers. Find bytes per server in scientific and ordinary notation.", "", "3.0 × 10^8, 300000000", "Division gives $0.3×10^9=3.0×10^8$, or 300,000,000.", "Divide and renormalise.", ["3e8,300000000"]),
  ],
  multiPartPractice: [
    {
      id: "y8-ile-ops-mp1",
