...
const negativeIndices: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    dAnswer("y8-ile-neg-p17", 4, "Simplify $\\frac{a^{-2} \\times a^5}{a^4}$.", "", "a^{-1}",
      "Numerator: $a^{-2+5} = a^3$. Then $\\frac{a^3}{a^4} = a^{3-4} = a^{-1}$.", "Combine the numerator first, then divide.", ["1/a"]),
    dAnswer("y8-ile-neg-p18", 4, "Evaluate $\\frac{2^3 \\times 2^{-6}}{2^{-5}}$.", "", "4",
    ...
    dAnswer("y8-ile-neg-p20", 4, "Evaluate $3^{-1} + 3^{-2}$ as a single fraction.", "", "4/9",
      "$\\frac{1}{3} + \\frac{1}{9} = \\frac{3}{9} + \\frac{1}{9} = \\frac{4}{9}$.", "Convert each to a fraction with denominator 9."),
    dAnswer("y8-ile-neg-p21", 4, "Simplify $\\frac{6^{-2}}{6^{-5}}$ as a whole number.", "", "216",
      "$6^{-2-(-5)} = 6^3 = 216$.", "Subtract indices: $-2 - (-5) = 3$."),
    dAnswer("y8-ile-neg-p22", 5, "Simplify $\\frac{(a^2)^{-3} \\times a^8}{a^{-1}}$.", "", "a^3",
      "$(a^2)^{-3} = a^{-6}$. Numerator: $a^{-6+8} = a^2$. Then $\\frac{a^2}{a^{-1}} = a^{2-(-1)} = a^3$.", "Apply the power-of-a-power rule first."),
    dAnswer("y8-ile-neg-p23", 5, "Evaluate $2^{-2} + 4^{-1}$ as a single fraction.", "", "1/2",
    ...
    dAnswer("y8-ile-neg-p25", 5, "Simplify $\\frac{x^{-4} \\times x^{6}}{x^{3} \\times x^{-2}}$.", "", "x",
      "Numerator: $x^{-4+6} = x^2$. Denominator: $x^{3-2} = x^1$. So $\\frac{x^2}{x^1} = x$.", "Simplify top and bottom separately, then divide.", ["x^1"]),
    dAnswer("y8-ile-neg-p26", 5, "Evaluate $\\frac{5^{-1} + 5^{-2}}{5^{-2}}$ as a whole number.", "", "6",
...
const scientificNotationLarge: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    dAnswer("y8-ile-snl-p18", 4, "A galaxy contains about $4\\,000\\,000\\,000\\,000$ stars. Write this in scientific notation.", "", "4 × 10^12",
      "$4\\,000\\,000\\,000\\,000 = 4 \\times 10^{12}$.", "Count 12 places.", ["4.0 × 10^12", "4 * 10^12"]),
    dAnswer("y8-ile-snl-p19", 4, "Two distances are $3.0 \\times 10^7$ km and $5.0 \\times 10^6$ km. Find their sum in scientific notation.", "", "3.5 × 10^7",
      "$5.0 \\times 10^6 = 0.5 \\times 10^7$; sum $= 3.5 \\times 10^7$.", "Match exponents, then add coefficients.", ["3.5 * 10^7"]),
    dAnswer("y8-ile-snl-p20", 4, "Stadium A holds $8.0 \\times 10^4$ people and Stadium B holds $1.2 \\times 10^5$. Find the total in scientific notation.", "", "2.0 × 10^5",
      "$8.0 \\times 10^4 = 0.8 \\times 10^5$; total $= 2.0 \\times 10^5$.", "Convert to a common power of 10 first.", ["2 × 10^5", "2 * 10^5"]),
    dAnswer("y8-ile-snl-p21", 4, "Write $99\\,000\\,000$ in scientific notation (round coefficient to 1 decimal place).", "", "9.9 × 10^7",
      "$99\\,000\\,000 = 9.9 \\times 10^7$.", "Place the decimal after the first 9.", ["9.9 * 10^7"]),
    dAnswer("y8-ile-snl-p22", 5, "A country's GDP is $1.8 \\times 10^{12}$ dollars and grows by $2.0 \\times 10^{11}$ dollars. Find the new GDP in scientific notation.", "", "2.0 × 10^12",
    ...
    dAnswer("y8-ile-snl-p24", 5, "A factory makes $2.5 \\times 10^4$ items per day. How many in $4.0 \\times 10^2$ days? Give scientific notation.", "", "1.0 × 10^7",
    ...
    dAnswer("y8-ile-snl-p25", 5, "The total of $6.4 \\times 10^6$ and $3.6 \\times 10^6$ is written in proper scientific notation as:", "", "1.0 × 10^7",
...
const scientificNotationSmall: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    dAnswer("y8-ile-sns-p17", 4, "Order smallest to largest and give the middle value: $2.0 \\times 10^{-3}$, $9.0 \\times 10^{-5}$, $4.0 \\times 10^{-4}$.", "", "4.0 × 10^{-4}",
    ...
    dAnswer("y8-ile-sns-p18", 4, "A virus is about $1.2 \\times 10^{-7}$ m wide. Write this as a decimal.", "", "0.00000012",
      "$1.2 \\times 10^{-7} = 0.00000012$.", "Move the decimal 7 places left."),
    dAnswer("y8-ile-sns-p19", 4, "A sample of $9.6 \\times 10^{-4}$ g is split into 4 equal parts. Find the mass of one part in scientific notation.", "", "2.4 × 10^{-4}",
      "$\\frac{9.6}{4} = 2.4$, exponent stays $-4$: $2.4 \\times 10^{-4}$.", "Divide the coefficient by 4.", ["2.4 * 10^{-4}"]),
    dAnswer("y8-ile-sns-p20", 4, "Write $0.000000067$ in scientific notation.", "", "6.7 × 10^{-8}",
      "$0.000000067 = 6.7 \\times 10^{-8}$.", "Count places to the 6.", ["6.7 * 10^{-8}"]),
    dAnswer("y8-ile-sns-p21", 4, "A particle of mass $4.0 \\times 10^{-6}$ g loses $1.5 \\times 10^{-6}$ g. Find the remaining mass in scientific notation.", "", "2.5 × 10^{-6}",
    ...
    dAnswer("y8-ile-sns-p23", 5, "A thin film is $3.5 \\times 10^{-4}$ mm thick. A stack of 20 such films has what thickness in scientific notation?", "", "7.0 × 10^{-3}",
      "$20 \\times 3.5 = 70$, times $10^{-4} = 70 \\times 10^{-4} = 7.0 \\times 10^{-3}$.", "Multiply then convert to proper form.", ["7 × 10^{-3}", "7 * 10^{-3}"]),
    dAnswer("y8-ile-sns-p24", 5, "Find $\\frac{8.0 \\times 10^{-3}}{2.0 \\times 10^{-6}}$ as a whole number.", "", "4000",
      "$\\frac{8.0}{2.0} = 4.0$, exponents $-3 - (-6) = 3$: $4.0 \\times 10^3 = 4000$.", "Divide coefficients, subtract exponents.", ["4 × 10^3", "4.0 × 10^3"]),
    dAnswer("y8-ile-sns-p25", 5, "Write $0.000056 + 0.000004$ as a single number in scientific notation.", "", "6.0 × 10^{-5}",
...
const significantFigures: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    dAnswer("y8-ile-sig-p17", 4, "Round $2.9985$ to 3 significant figures.", "", "3.00",
      "First 3 sig figs 2, 9, 9; next digit 8 (≥ 5) rounds up, carrying: 3.00.", "Rounding 9s up carries through."),
    dAnswer("y8-ile-sig-p18", 4, "Round $0.0099962$ to 3 significant figures.", "", "0.0100",
    ...
    dAnswer("y8-ile-sig-p20", 4, "Express $0.00528$ in scientific notation showing 3 significant figures.", "", "5.28 × 10^{-3}",
      "$0.00528 = 5.28 \\times 10^{-3}$; the coefficient has 3 sig figs.", "Move the decimal to make a coefficient between 1 and 10.", ["5.28 * 10^{-3}"]),
    dAnswer("y8-ile-sig-p21", 4, "Round $749\\,500$ to 2 significant figures.", "", "750000",
      "First 2 sig figs 7, 4; next digit 9 (≥ 5) rounds up: 750000.", "Look at the 3rd digit.", ["750,000"]),
    dAnswer("y8-ile-sig-p22", 5, "Round $0.00045650$ to 3 significant figures.", "", "0.000457",
    ...
    dAnswer("y8-ile-sig-p24", 5, "A rectangle is $4.2$ cm by $3.15$ cm. Its area is $13.23$ cm². Round the area to the least number of significant figures of the measurements.", "", "13",
    ...
    dAnswer("y8-ile-sig-p25", 5, "Round $98\\,765$ to 1 significant figure.", "", "100000",
...
const operationsWithScientificNotation: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    dAnswer("y8-ile-ops-p17", 4, "Light travels at $3.0 \\times 10^8$ m/s. How far does it travel in $2.0 \\times 10^{-3}$ s? Give scientific notation.", "", "6.0 × 10^5",
      "$3.0 \\times 2.0 = 6.0$, $10^{8+(-3)} = 10^5$: $6.0 \\times 10^5$ m.", "Multiply coefficients, add exponents.", ["6 × 10^5", "6 * 10^5"]),
    dAnswer("y8-ile-ops-p18", 4, "Calculate $\\frac{4.8 \\times 10^{-2}}{1.6 \\times 10^{3}}$.", "", "3.0 × 10^{-5}",
      "$\\frac{4.8}{1.6} = 3.0$, $10^{-2-3} = 10^{-5}$.", "Divide coefficients, subtract exponents.", ["3 × 10^{-5}", "3 * 10^{-5}"]),
    dAnswer("y8-ile-ops-p19", 4, "Calculate $3.6 \\times 10^6 + 9.0 \\times 10^5$, giving proper scientific notation.", "", "4.5 × 10^6",
      "$9.0 \\times 10^5 = 0.90 \\times 10^6$; sum $= 4.5 \\times 10^6$.", "Match exponents, then add.", ["4.5 * 10^6"]),
    dAnswer("y8-ile-ops-p20", 4, "A battery stores $3.6 \\times 10^5$ J and is used at $9.0 \\times 10^1$ J/s. How many seconds does it last? Give scientific notation.", "", "4.0 × 10^3",
      "$\\frac{3.6}{9.0} = 0.4$, $10^{5-1} = 10^4$: $0.4 \\times 10^4 = 4.0 \\times 10^3$.", "Divide, subtract exponents, then adjust.", ["4 × 10^3", "4000"]),
    dAnswer("y8-ile-ops-p21", 4, "Calculate $(2.5 \\times 10^{-4}) \\times (4.0 \\times 10^{6})$.", "", "1.0 × 10^3",
      "$2.5 \\times 4.0 = 10$, $10^{-4+6} = 10^2$: $10 \\times 10^2 = 1.0 \\times 10^3$.", "Multiply, add exponents, then adjust.", ["1 × 10^3", "1000"]),
    dAnswer("y8-ile-ops-p22", 5, "The mass of the Sun is $1.99 \\times 10^{30}$ kg and Earth is $5.97 \\times 10^{24}$ kg. How many times heavier is the Sun (to 2 sig figs)?", "", "3.3 × 10^5",
    ...
    dAnswer("y8-ile-ops-p24", 5, "Calculate $4.2 \\times 10^{-3} + 8.0 \\times 10^{-4}$, giving proper scientific notation.", "", "5.0 × 10^{-3}",
      "$8.0 \\times 10^{-4} = 0.80 \\times 10^{-3}$; sum $= 5.0 \\times 10^{-3}$.", "Match exponents, then add.", ["5 × 10^{-3}", "5 * 10^{-3}"]),
    dAnswer("y8-ile-ops-p25", 5, "A data centre processes $2.4 \\times 10^{12}$ bytes per day, shared equally over $8.0 \\times 10^{3}$ servers. Bytes per server? Give scientific notation.", "", "3.0 × 10^8",
