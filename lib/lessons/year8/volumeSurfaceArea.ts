...
const volumeOfPrisms: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    // ── Difficulty 4 ──────────────────────────────────────────────────────
    poolA("y8-vsa-vp-p17", 4, "A triangular prism has cross-section base 16 cm and height 9 cm, and length 20 cm. Find its volume, then find how many complete 120 cm³ packs could be filled from that volume.", "", "1440 cm^3, 12 packs", "The cross-sectional area is 1/2 × 16 × 9 = 72 cm², so the volume is 72 × 20 = 1440 cm³. Dividing by 120 cm³ per pack gives 12 complete packs.", "Find the triangular area and prism volume before applying the per-pack capacity.", ["1440, 12", "1440 cm³, 12"]),
    poolA("y8-vsa-vp-p18", 4, "A prism has cross-sectional area 35 cm² and volume 595 cm³. Find its length, then decide whether it fits in a space limited to 16.5 cm.", "", "17 cm, no", "Length = volume / cross-sectional area = 595 / 35 = 17 cm. Since 17 cm exceeds 16.5 cm by 0.5 cm, it does not fit.", "Recover the missing prism dimension, then compare it with the stated limit.", ["17, no", "17 cm, does not fit"]),
    poolA("y8-vsa-vp-p19", 4, "A rectangular water trough is 150 cm long, 60 cm wide and 50 cm deep. Find its full capacity in litres, then the water volume when it is filled to 80% of capacity.", "", "450 L, 360 L", "The volume is 150 × 60 × 50 = 450000 cm³. Since 1000 cm³ = 1 L, the capacity is 450 L. At 80%, it holds 0.8 × 450 = 360 L.", "Calculate in cubic centimetres, convert to litres, then apply the fill percentage.", ["450, 360", "450 litres, 360 litres"]),
    poolA("y8-vsa-vp-p20", 4, "A rectangular prism has volume 240 cm³. Every dimension is doubled. A student doubles the volume to 480 cm³. Give the correct scale factor for volume and the new volume.", "", "factor 8, 1920 cm^3", "Each of three dimensions contributes a factor of 2, so volume scales by 2³ = 8. The new volume is 8 × 240 = 1920 cm³. The student's method accounts for only one dimension.", "Track the scale factor in all three independent dimensions.", ["8, 1920", "factor 8, 1920 cm³"]),
    poolA("y8-vsa-vp-p21", 4, "A triangular prism has cross-section base 12 cm, length 25 cm and volume 1500 cm³. Find the triangle's perpendicular height and its cross-sectional area.", "", "10 cm, 60 cm^2", "From 1/2 × 12 × h × 25 = 1500, we get 150h = 1500 and h = 10 cm. The cross-sectional area is then 1/2 × 12 × 10 = 60 cm².", "Solve for the missing triangle height, then use it to report the cross-section requested.", ["10, 60", "10 cm, 60 cm²"]),
    // ── Difficulty 5 ──────────────────────────────────────────────────────
    poolA("y8-vsa-vp-p22", 5, "A 50 m by 20 m pool has uniform depth 1.5 m. Find its volume in m³ and litres.", "", "1500 m^3, 1500000 L", "Volume is $50×20×1.5=1500$ m³. Since $1$ m³ is 1000 L, this is 1,500,000 L.", "Find cubic metres first, then multiply by 1000.", ["1500,1500000"]),
    poolA("y8-vsa-vp-p23", 5, "A prism is 12 cm long and 4 cm high with volume 480 cm³. Find its width and base area.", "", "10 cm, 120 cm^2", "$w=480/(12×4)=10$ cm. Its base area is $12×10=120$ cm².", "Recover the missing dimension, then use it for area.", ["10,120"]),
    poolA("y8-vsa-vp-p24", 5, "Tank A is $40×30×20$ cm. Tank B is a triangular prism with cross-section base 30 cm, height 16 cm and length 25 cm. Find both volumes and their difference.", "", "24000, 6000, 18000 cm^3", "A is 24,000 cm³. B is $\\frac12(30)(16)(25)=6000$ cm³. Difference is 18,000 cm³.", "Compute each volume before comparing.", ["24000,6000,18000"]),
    poolC("y8-vsa-vp-p25", 5, "A prism's length doubles, width halves and height is unchanged. Which option gives the overall scale factor and new volume?", "B", ["$\\frac12$ and $\\frac12V$", "$1$ and $V$", "$2$ and $2V$", "$4$ and $4V$"], "The factor is $2×\\frac12×1=1$, so volume remains $V$.", "Multiply all dimension scale factors."),
    poolA("y8-vsa-vp-p26", 5, "A triangular prism has cross-section base 18 cm, height 12 cm and length 30 cm. Find cross-sectional area and volume.", "", "108 cm^2, 3240 cm^3", "Area is $\\frac12(18)(12)=108$ cm²; volume is $108×30=3240$ cm³.", "Area first, then multiply by length.", ["108,3240"]),
  ],
  multiPartPractice: [
    {
      id: "y8-vsa-vp-mp1",
...
const surfaceAreaOfPrisms: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    // ── Difficulty 4 ──────────────────────────────────────────────────────
    poolA("y8-vsa-sp-p17", 4, "A triangular prism has a right-triangle cross-section with legs 9 cm and 12 cm, hypotenuse 15 cm, and length 20 cm. Find its surface area, then the minimum number of 100 cm² covering sheets needed.", "", "828 cm^2, 9 sheets", "The two triangular ends total 108 cm². The three rectangles total (9 + 12 + 15) × 20 = 720 cm², so SA = 828 cm². Since 8 sheets cover only 800 cm², 9 whole sheets are required.", "Include every exposed face, then round the sheet count upward because partial supply is not available.", ["828, 9", "828 cm², 9"]),
    poolA("y8-vsa-sp-p18", 4, "A triangular prism has a right-triangle cross-section with sides 5 cm, 12 cm and 13 cm. Its surface area is 240 cm². Find the prism length and then its volume.", "", "6 cm, 180 cm^3", "The two triangular ends total 2 × (1/2 × 5 × 12) = 60 cm². The lateral area is (5 + 12 + 13)l = 30l, so 60 + 30l = 240 and l = 6 cm. The volume is cross-sectional area 30 × length 6 = 180 cm³.", "Use surface area to recover the length before switching to the volume formula.", ["6, 180", "6 cm, 180 cm³"]),
    poolA("y8-vsa-sp-p19", 4, "A closed storage crate is 150 cm by 90 cm by 60 cm. Find its surface area in square metres, then the total area coated by two complete coats of paint.", "", "5.58 m^2, 11.16 m^2", "SA = 2(150×90 + 150×60 + 90×60) = 55800 cm². Dividing by 10000 converts this to 5.58 m². Two coats cover 2 × 5.58 = 11.16 m² of painted area.", "Calculate all six faces, convert square units correctly, then account for both coats.", ["5.58, 11.16", "5.58 m² and 11.16 m²"]),
    poolA("y8-vsa-sp-p20", 4, "A cube has surface area S. Its edge length is doubled. A student says the new area is 2S. Give the correct area scale factor and new surface area in terms of S.", "", "factor 4, 4S", "Surface area is two-dimensional, so doubling every edge multiplies each face area by 2² = 4. The number of faces is unchanged, hence the new surface area is 4S.", "Area scales with the square of a linear scale factor.", ["4, 4S", "factor 4; new area 4S"]),
    poolA("y8-vsa-sp-p21", 4, "A rectangular prism has width 5 cm, height 4 cm and surface area 166 cm². Find its length, then its volume.", "", "7 cm, 140 cm^3", "Using SA = 2(lw + lh + wh), 2(5l + 4l + 20) = 166. Thus 18l + 40 = 166 and l = 7 cm. The volume is 7 × 5 × 4 = 140 cm³.", "Recover the missing dimension from surface area before multiplying dimensions for volume.", ["7, 140", "7 cm, 140 cm³"]),
    // ── Difficulty 5 ──────────────────────────────────────────────────────
    poolA("y8-vsa-sp-p22", 5, "A closed box is $25×18×12$ cm. Find total surface area and the percentage contributed by the two $25×18$ faces, to 1 decimal place.", "", "1932 cm^2, 46.6%", "SA is $2(450+300+216)=1932$ cm². The two largest faces total 900 cm², or $900/1932×100≈46.6\\%$.", "Find total and selected-face area separately.", ["1932,46.6"]),
    poolA("y8-vsa-sp-p23", 5, "A triangular prism has three 10 cm cross-section sides, triangle height 8.66 cm and length 15 cm. Find end-face area, lateral area and total surface area.", "", "86.6, 450, 536.6 cm^2", "Two ends total 86.6 cm²; three rectangles total $30×15=450$ cm²; total is 536.6 cm².", "Separate end faces from lateral faces.", ["86.6,450,536.6"]),
    poolA("y8-vsa-sp-p24", 5, "An open-top planter is $80×40×35$ cm. Find timber area and how much less this is than a closed box.", "", "11600 cm^2, 3200 cm^2 less", "Open area is $3200+5600+2800=11600$ cm². A lid adds $80×40=3200$ cm².", "Compute the open shape, then compare with adding the top.", ["11600,3200"]),
    poolC("y8-vsa-sp-p25", 5, "Cube A has edge 6 cm; prism B is $8×6×4$ cm. Which option gives both surface areas and the comparison?", "A", ["216 and 208; A by 8 cm²", "208 and 216; B by 8 cm²", "216 and 216; equal", "240 and 208; A by 32 cm²"], "A has SA 216 cm² and B has SA 208 cm², so A is greater by 8 cm².", "Calculate both totals before comparing."),
    poolA("y8-vsa-sp-p26", 5, "A prism has length 10 cm, width 6 cm and surface area 376 cm². Find its height and volume.", "", "8 cm, 480 cm^3", "$2(60+16h)=376$ gives $h=8$ cm. Volume is $10×6×8=480$ cm³.", "Solve for height before calculating volume.", ["8,480"]),
  ],
  multiPartPractice: [
    {
      id: "y8-vsa-sp-mp1",
...
const volumeOfCylinders: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    // ── Difficulty 4 ──────────────────────────────────────────────────────
    poolA("y8-vsa-vc-p17", 4, "A cylindrical tank has radius 50 cm and height 100 cm. Find its exact capacity in litres, then give an approximate capacity to the nearest litre.", "", "250π L, 785 L", "V = π × 50² × 100 = 250000π cm³. Dividing by 1000 converts to 250π L, which is approximately 785.4 L and rounds to 785 L.", "Calculate in cubic centimetres, convert capacity units, and round only at the end.", ["250π, 785", "250π litres, 785 litres"]),
    poolA("y8-vsa-vc-p18", 4, "A cylinder has radius 5 cm and volume 250π cm³. Find its height, then the exact surface area if it is closed.", "", "10 cm, 150π cm^2", "From π × 5² × h = 250π, h = 10 cm. Closed surface area is 2πr(r + h) = 2π × 5 × 15 = 150π cm².", "Recover height from volume before counting both ends in surface area.", ["10, 150π", "10 cm and 150π cm²"]),
    poolA("y8-vsa-vc-p19", 4, "A cylinder has height 9 cm and volume 144π cm³. Find its radius and diameter.", "", "4 cm, 8 cm", "The volume equation gives 9πr² = 144π, so r² = 16 and the positive radius is 4 cm. The diameter is twice the radius, 8 cm.", "After taking the positive square root, distinguish radius from diameter.", ["4, 8", "radius 4 cm, diameter 8 cm"]),
    poolA("y8-vsa-vc-p20", 4, "A pipe has outer radius 4 cm, inner radius 3 cm and length 100 cm. Find the exact material volume and the percentage this is of the unbored outer cylinder.", "", "700π cm^3, 43.75%", "The outer volume is 1600π cm³ and the hollow volume is 900π cm³, leaving 700π cm³. As a percentage of the outer cylinder, 700π / 1600π × 100 = 43.75%.", "Subtract volumes first, then compare the material with the full outer cylinder.", ["700π, 43.75%", "700π cm³ and 43.75 percent"]),
    poolA("y8-vsa-vc-p21", 4, "A cylinder has volume V. Its radius is tripled while its height is divided by 3. A student says these changes cancel. Give the radius-squared factor, height factor and final volume.", "", "9, 1/3, 3V", "Tripling radius multiplies r² by 3² = 9. Dividing height by 3 multiplies it by 1/3. The net volume factor is 9 × 1/3 = 3, so the new volume is 3V; the changes do not cancel.", "Volume depends on radius squared, so compare factors in the actual formula.", ["9, one third, 3V", "9, 1/3, 3V"]),
    // ── Difficulty 5 ──────────────────────────────────────────────────────
    poolA("y8-vsa-vc-p22", 5, "Cylinder A has $r=5,h=12$ cm; B has $r=6,h=8$ cm. Find both exact volumes and their positive difference.", "", "300π, 288π, 12π cm^3", "The volumes are $300π$ and $288π$ cm³, differing by $12π$ cm³.", "Calculate both before subtracting.", ["300π,288π,12π"]),
    poolA("y8-vsa-vc-p23", 5, "A cylindrical tank has radius 80 cm and height 120 cm. Using $π=3.14$, find volume in cm³ and litres.", "", "2411520 cm^3, 2411.52 L", "Volume is $3.14×80^2×120=2,411,520$ cm³. Dividing by 1000 gives 2411.52 L.", "Convert cubic centimetres to litres after finding volume.", ["2411520,2411.52"]),
    poolA("y8-vsa-vc-p24", 5, "A cylinder has radius 3 cm and volume $99π$ cm³. Find its height and curved surface area.", "", "11 cm, 66π cm^2", "$9πh=99π$ gives $h=11$. Curved area is $2πrh=66π$ cm².", "Recover height, then use $2πrh$.", ["11,66π"]),
    poolA("y8-vsa-vc-p25", 5, "A cylinder $r=6,h=10$ cm has a through-hole $r=2$ cm. Find the outer, removed and remaining exact volumes.", "", "360π, 40π, 320π cm^3", "Outer is $360π$, hole $40π$, leaving $320π$ cm³.", "Calculate both cylinders before subtraction.", ["360π,40π,320π"]),
    poolA("y8-vsa-vc-p26", 5, "Compare a cylinder $r=3,h=10$ cm with a $6×5×10$ cm prism using $π=3.14$. Find both volumes and their difference.", "", "282.6, 300, 17.4 cm^3", "Cylinder is 282.6 cm³ and prism 300 cm³, so prism is greater by 17.4 cm³.", "Compute both using their own formulas.", ["282.6,300,17.4"]),
  ],
  multiPartPractice: [
    {
      id: "y8-vsa-vc-mp1",
...
const surfaceAreaOfCylinders: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    // ── Difficulty 4 ──────────────────────────────────────────────────────
    poolA("y8-vsa-sc-p17", 4, "A closed cylinder has radius 6 cm and surface area 192π cm². Find its height, then its exact volume.", "", "10 cm, 360π cm^3", "Using 2πr(r + h), 12π(6 + h) = 192π, so h = 10 cm. The volume is πr²h = π × 36 × 10 = 360π cm³.", "Use surface area to recover height before changing to the volume formula.", ["10, 360π", "10 cm, 360π cm³"]),
    poolA("y8-vsa-sc-p18", 4, "A closed cylinder has radius 5 cm and surface area 150π cm². Find its height and exact volume.", "", "10 cm, 250π cm^3", "The equation 2π × 5(5 + h) = 150π simplifies to 5 + h = 15, so h = 10 cm. Then V = π × 5² × 10 = 250π cm³.", "Keep π symbolic while solving, then use the recovered height in the volume.", ["10, 250π", "10 cm, 250π cm³"]),
    poolA("y8-vsa-sc-p19", 4, "A closed cylinder has radius 10 cm and height 15 cm. Find its exact surface area, then the minimum number of sheets needed if each sheet covers 100π cm².", "", "500π cm^2, 5 sheets", "The two circles total 200π cm² and the curved surface is 300π cm², giving 500π cm². Dividing by 100π gives exactly 5 sheets.", "Include both circular ends and the curved surface before applying the coverage rate.", ["500π, 5", "500π cm², 5"]),
    poolA("y8-vsa-sc-p20", 4, "A cylinder has surface area S and volume V. Both its radius and height are tripled. Give the new surface area and volume in terms of S and V.", "", "9S, 27V", "All lengths scale by 3. Surface area scales by 3² = 9, giving 9S, while volume scales by 3³ = 27, giving 27V. Confusing these powers is the key trap.", "Separate the two-dimensional and three-dimensional scale effects.", ["9S and 27V", "surface 9S, volume 27V"]),
    poolA("y8-vsa-sc-p21", 4, "An open-top cylindrical tin has radius 7 cm and height 10 cm. Find its exact surface area, then how much additional area is needed to make it closed.", "", "189π cm^2, add 49π cm^2", "The open tin has one base, 49π, plus curved surface 2π × 7 × 10 = 140π, totalling 189π cm². Closing it adds one circular top of area 49π cm².", "Count the circular faces carefully before and after adding the lid.", ["189π, 49π", "189π cm² and 49π cm²"]),
    // ── Difficulty 5 ──────────────────────────────────────────────────────
    poolA("y8-vsa-sc-p22", 5, "A closed can has $r=5,h=12$ cm. Using $π=3.14$, find combined end area, curved area and total surface area.", "", "157, 376.8, 533.8 cm^2", "Ends total 157 cm²; curved area 376.8 cm²; total 533.8 cm².", "Separate circular ends from curved surface.", ["157,376.8,533.8"]),
    poolA("y8-vsa-sc-p23", 5, "A closed cylinder has radius 4 cm and surface area $176π$ cm². Find its height and volume.", "", "18 cm, 288π cm^3", "$8π(4+h)=176π$ gives $h=18$. Volume is $π(4^2)(18)=288π$ cm³.", "Solve surface area for height, then calculate volume.", ["18,288π"]),
    poolA("y8-vsa-sc-p24", 5, "A label wraps a can with radius 4 cm and height 11 cm. Find the label's exact width when unrolled and its exact area.", "", "8π cm, 88π cm^2", "The width is circumference $2πr=8π$ cm; area is width times height $88π$ cm².", "Unroll the curved surface to a rectangle.", ["8π,88π"]),
    poolC("y8-vsa-sc-p25", 5, "Closed A and open-top B both have $r=3,h=6$ cm. Which option gives both surface areas and their difference?", "B", ["$72π,63π;6π$", "$72π,63π;9π$", "$90π,72π;18π$", "$63π,63π;0$"], "A has $72π$ cm² and B $63π$ cm²; the missing top is $9π$ cm².", "Compute or identify the one missing circle."),
    poolA("y8-vsa-sc-p26", 5, "A closed cylinder has $r=h=7$ cm. Find end area, curved area and total surface area exactly.", "", "98π, 98π, 196π cm^2", "The two ends total $98π$ and curved area is also $98π$, so total is $196π$ cm².", "Calculate the two components separately.", ["98π,98π,196π"]),
  ],
  multiPartPractice: [
    {
      id: "y8-vsa-sc-mp1",
...
const volumeOfCompositeSolids: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    // ── Difficulty 4 ──────────────────────────────────────────────────────
    poolA("y8-vsa-cv-p17", 4, "A solid joins a 20 cm by 12 cm by 8 cm prism and an 8 cm by 6 cm by 8 cm prism. Find the total volume and the percentage contributed by the smaller prism, to 1 decimal place.", "", "2304 cm^3, 16.7%", "The volumes are 1920 cm³ and 384 cm³, totalling 2304 cm³. The smaller prism contributes 384 / 2304 × 100 = 16.666...%, or 16.7%.", "Add component volumes, then compare the smaller component with the composite total.", ["2304, 16.7%", "2304 cm³ and 16.7 percent"]),
    poolA("y8-vsa-cv-p18", 4, "A cylindrical hole of radius 3 cm and length 10 cm is drilled through a cube of edge 10 cm. Find the exact remaining volume and the exact percentage of the original cube removed.", "", "1000 - 90π cm^3, 9π%", "The cube volume is 1000 cm³ and the hole is π × 3² × 10 = 90π cm³, so 1000 - 90π cm³ remains. The removed percentage is 90π / 1000 × 100 = 9π%.", "Subtract for remaining volume, but divide the removed volume by the original for the percentage.", ["1000 - 90π, 9π%", "(1000−90π) cm³ and 9π percent"]),
    poolA("y8-vsa-cv-p19", 4, "A house-shaped solid has a 12 cm by 8 cm by 6 cm rectangular prism and a triangular-prism roof with triangular base 12 cm, height 5 cm and length 8 cm. Find the total volume and the roof's percentage of it to 1 decimal place.", "", "816 cm^3, 29.4%", "The base volume is 576 cm³. The roof volume is 1/2 × 12 × 5 × 8 = 240 cm³, so total volume is 816 cm³. The roof contributes 240 / 816 × 100 ≈ 29.4%.", "Calculate each component with its own formula before comparing part with whole.", ["816, 29.4%", "816 cm³ and 29.4 percent"]),
    poolA("y8-vsa-cv-p20", 4, "A 480 cm³ rectangular prism and 120 cm³ triangular prism are joined, then a 60 cm³ hole is drilled through. Find the final volume and the percentage removed from the joined solid.", "", "540 cm^3, 10%", "Before drilling, the joined volume is 480 + 120 = 600 cm³. Removing 60 cm³ leaves 540 cm³. The removed fraction is 60 / 600 = 0.10, or 10%.", "Use the pre-drilling composite as the base for the removed percentage.", ["540, 10%", "540 cm³ and 10 percent"]),
    poolA("y8-vsa-cv-p21", 4, "A stepped solid stacks prisms 12 cm by 8 cm by 2 cm, 8 cm by 8 cm by 2 cm, and 4 cm by 8 cm by 2 cm. Find the total volume and the fraction contributed by the top two prisms together.", "", "384 cm^3, 1/2", "The three volumes are 192, 128 and 64 cm³, totalling 384 cm³. The top two contribute 128 + 64 = 192 cm³, and 192 / 384 = 1/2.", "Compute all three parts, then group the requested components before forming part over whole.", ["384, 1/2", "384 cm³, one half", "384 cm³, 50%"]),
    // ── Difficulty 5 ──────────────────────────────────────────────────────
    poolA("y8-vsa-cv-p22", 5, "A cylinder $r=20,h=300$ cm stands on an $80×80×30$ cm base. Find each component volume and the exact total.", "", "120000π, 192000, 120000π+192000 cm^3", "Cylinder is $120000π$ cm³ and base 192000 cm³; add for the total.", "Keep unlike exact terms separate.", ["120000π,192000,120000π+192000"]),
    poolA("y8-vsa-cv-p23", 5, "A full $50×40×30$ cm tank receives a fully submerged 10 cm cube. Find tank capacity, displaced volume and overflow.", "", "60000, 1000, 1000 cm^3", "Capacity is 60000 cm³. The cube displaces $10^3=1000$ cm³, so that amount overflows.", "A submerged solid displaces its own volume.", ["60000,1000,1000"]),
    poolA("y8-vsa-cv-p24", 5, "A $15×10×8$ cm prism has a triangular-prism notch with triangle base 6 cm, height 4 cm and length 10 cm. Find original, removed and remaining volumes.", "", "1200, 120, 1080 cm^3", "Original is 1200 cm³; notch is $\\frac12(6)(4)(10)=120$ cm³; remainder is 1080 cm³.", "Calculate both solids before subtracting.", ["1200,120,1080"]),
    poolC("y8-vsa-cv-p25", 5, "A pool combines $10×6×1$ m and $10×6×2$ m sections. Which option gives both component volumes and total?", "C", ["60,60;120 m³", "60,90;150 m³", "60,120;180 m³", "120,120;240 m³"], "The sections hold 60 and 120 m³, totalling 180 m³.", "Treat sections separately."),
    poolA("y8-vsa-cv-p26", 5, "A $60×40×30$ cm planter has a cylindrical hole $r=10$, depth 30 cm. Find box volume, hole volume and exact soil volume.", "", "72000, 3000π, 72000-3000π cm^3", "Box is 72000 cm³, hole $3000π$ cm³, leaving $72000-3000π$ cm³.", "Subtract the hole from the box.", ["72000,3000π,72000-3000π"]),
  ],
  multiPartPractice: [
    {
      id: "y8-vsa-cv-mp1",
...
const surfaceAreaOfCompositeSolids: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    // ── Difficulty 4 ──────────────────────────────────────────────────────
    poolA("y8-vsa-cs-p17", 4, "A three-prism staircase has separate surface areas 216 cm², 152 cm² and 88 cm². The two joint areas are 48 cm² and 24 cm². Find the exposed surface area and the amount hidden at the joints.", "", "312 cm^2, 144 cm^2 hidden", "The separate total is 456 cm². Each joint hides the matching area on both solids, so hidden area = 2(48 + 24) = 144 cm². Exposed area = 456 - 144 = 312 cm².", "Every joint removes two formerly exposed faces, one from each touching prism.", ["312, 144", "312 cm² exposed, 144 cm² hidden"]),
    poolA("y8-vsa-cs-p18", 4, "A house-shaped solid has a 12 cm by 6 cm by 4 cm rectangular base and a triangular-prism roof with triangular base 12 cm, height 8 cm, slants 10 cm and length 6 cm. Find the exposed surface area, then the area covered by two coats.", "", "432 cm^2, 864 cm^2", "The exposed base surfaces total 216 cm² when its covered top is excluded. The roof's two triangles and two sloping rectangles total 216 cm² when its covered bottom is excluded. Thus exposed SA = 432 cm², and two coats cover 864 cm².", "Exclude the joined roof/base faces, then multiply the exposed area by the number of coats.", ["432, 864", "432 cm² and 864 cm²"]),
    poolA("y8-vsa-cs-p19", 4, "A small 8 cm by 5 cm by 3 cm prism sits on a 12 cm by 8 cm by 4 cm prism. Their full surface areas are 158 cm² and 352 cm², and the joint is 8 cm by 5 cm. Find the exposed area and the amount a simple sum would overcount.", "", "430 cm^2, overcount 80 cm^2", "The full areas sum to 510 cm². The 40 cm² joint is counted once on each prism, so a simple sum overcounts by 2 × 40 = 80 cm². The exposed area is 510 - 80 = 430 cm².", "A contact region disappears from both component surfaces."),
    poolA("y8-vsa-cs-p20", 4, "Cubes of edge 4 cm and 2 cm are joined across one 2 cm by 2 cm face. A student adds their surface areas to get 120 cm². Find the exposed surface area and the student's overcount.", "", "112 cm^2, overcount 8 cm^2", "The separate areas are 96 cm² and 24 cm², totalling 120 cm². The joint area is 4 cm² on each cube, so 8 cm² is hidden. The exposed area is 120 - 8 = 112 cm².", "Subtract the joint twice because both touching faces become internal.", ["112, 8", "112 cm², 8 cm²"]),
    poolA("y8-vsa-cs-p21", 4, "A stepped solid joins prisms 16 cm by 6 cm by 3 cm and 10 cm by 6 cm by 3 cm across a 10 cm by 6 cm face. Their separate surface areas are 324 cm² and 216 cm². Find the exposed area and hidden joint area.", "", "420 cm^2, 120 cm^2 hidden", "The separate total is 540 cm². The 60 cm² joint is hidden on both prisms, so hidden area is 120 cm². Therefore exposed area = 540 - 120 = 420 cm².", "Compute the contact rectangle and remove one copy from each component.", ["420, 120", "420 cm² exposed, 120 cm² hidden"]),
    // ── Difficulty 5 ──────────────────────────────────────────────────────
    poolA("y8-vsa-cs-p22", 5, "Three prisms have separate SAs 372, 208 and 94 cm², with joints 48 and 12 cm². Find summed SA, hidden area and exposed SA.", "", "674, 120, 554 cm^2", "Sum is 674. Hidden area is $2(48+12)=120$, leaving 554 cm².", "Each joint hides two faces.", ["674,120,554"]),
    poolA("y8-vsa-cs-p23", 5, "Stacked cylinders have separate SAs $192π$ and $48π$ cm² and joint radius 3 cm. Find joint area, hidden area and exposed SA.", "", "9π, 18π, 222π cm^2", "Joint is $9π$ and two copies are hidden, so exposed SA is $240π-18π=222π$.", "Subtract the joint twice.", ["9π,18π,222π"]),
    poolA("y8-vsa-cs-p24", 5, "A house solid has exposed base-prism area 220 cm² and roof with two triangular ends $(b=10,h=12)$ plus two $13×6$ slopes. Find roof and total exposed areas.", "", "276, 496 cm^2", "Roof area is $2(60)+2(78)=276$ cm²; total is $220+276=496$ cm².", "Exclude the hidden roof bottom.", ["276,496"]),
    poolC("y8-vsa-cs-p25", 5, "Prisms with SAs 80 and 240 cm² share a 20 cm² face. Which option gives naive sum, correct SA and overstatement?", "B", ["320,300,20", "320,280,40", "300,240,60", "320,240,80"], "Naive sum 320; subtract two joint faces, 40, giving 280 and overstatement 40.", "A join hides one face on each solid."),
    poolA("y8-vsa-cs-p26", 5, "A 3 cm cube sits on a 6 cm cube. Find both separate SAs, hidden joint area total and composite SA.", "", "54, 216, 18, 252 cm^2", "SAs are 54 and 216. The 9 cm² joint hides twice, so subtract 18: total 252 cm².", "Compute both cubes and subtract two joint faces.", ["54,216,18,252"]),
  ],
  multiPartPractice: [
    {
      id: "y8-vsa-cs-mp1",
...
const reauthoredHighTierIds = new Set([
  "y8-vsa-vp-p17", "y8-vsa-vp-p18", "y8-vsa-vp-p19", "y8-vsa-vp-p20", "y8-vsa-vp-p21",
  "y8-vsa-sp-p17", "y8-vsa-sp-p18", "y8-vsa-sp-p19", "y8-vsa-sp-p20", "y8-vsa-sp-p21",
  "y8-vsa-vc-p17", "y8-vsa-vc-p18", "y8-vsa-vc-p19", "y8-vsa-vc-p20", "y8-vsa-vc-p21",
  "y8-vsa-sc-p17", "y8-vsa-sc-p18", "y8-vsa-sc-p19", "y8-vsa-sc-p20", "y8-vsa-sc-p21",
  "y8-vsa-cv-p17", "y8-vsa-cv-p18", "y8-vsa-cv-p19", "y8-vsa-cv-p20", "y8-vsa-cv-p21",
  "y8-vsa-cs-p17", "y8-vsa-cs-p18", "y8-vsa-cs-p19", "y8-vsa-cs-p20", "y8-vsa-cs-p21",
  "y8-vsa-vp-p22", "y8-vsa-vp-p23", "y8-vsa-vp-p24", "y8-vsa-vp-p25", "y8-vsa-vp-p26",
  "y8-vsa-sp-p22", "y8-vsa-sp-p23", "y8-vsa-sp-p24", "y8-vsa-sp-p25", "y8-vsa-sp-p26",
  "y8-vsa-vc-p22", "y8-vsa-vc-p23", "y8-vsa-vc-p24", "y8-vsa-vc-p25", "y8-vsa-vc-p26",
  "y8-vsa-sc-p22", "y8-vsa-sc-p23", "y8-vsa-sc-p24", "y8-vsa-sc-p25", "y8-vsa-sc-p26",
  "y8-vsa-cv-p22", "y8-vsa-cv-p23", "y8-vsa-cv-p24", "y8-vsa-cv-p25", "y8-vsa-cv-p26",
  "y8-vsa-cs-p22", "y8-vsa-cs-p23", "y8-vsa-cs-p24", "y8-vsa-cs-p25", "y8-vsa-cs-p26",
]);
...
function addQuestionVisual(question: PracticeQuestion): PracticeQuestion {
  const visual =
    ...
    specialCompositeSolidVisuals[question.id];
  if (!visual) return question;
  const merged = { ...question, ...visual };
  return reauthoredHighTierIds.has(question.id)
    ? { ...merged, prompt: question.prompt }
    : merged;
}
