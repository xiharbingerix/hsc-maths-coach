...
function pAnswer(
  ...
  const question = { ...answer(id, prompt, latex, value, explanation, acceptedAnswers), difficulty };
...
anglesTrianglesQuadrilaterals.masteryQuizPool = [
  ...
  // D4
  pAnswer("y8-geo-tri-p18", "A triangle's angles are (x + 10)°, (x + 20)° and (x + 30)°. Find x and the largest angle. Enter both.", "", "40, 70°", "The triangle sum gives 3x + 60 = 180, so x = 40. The angles are 50°, 60° and 70°, making 70° the largest.", 4, ["40, 70", "x = 40, largest 70°"], "Solve for the variable, then substitute it into all three expressions before choosing the largest angle."),
  pAnswer("y8-geo-tri-p19", "A quadrilateral's angles are x°, (x + 20)°, (x + 40)° and (x + 60)°. Find x, then find the difference between its largest and smallest angles.", "", "60, 60°", "Using the quadrilateral sum, 4x + 120 = 360, so x = 60. The angles are 60°, 80°, 100° and 120°; the difference is 120 - 60 = 60°.", 4, ["60, 60", "x = 60, difference 60°"], "Use 360°, not 180°, for the total; the requested difference comes after substitution."),
  pAnswer("y8-geo-tri-p20", "An exterior angle of a triangle is 3x°. Its two remote interior angles are 2x° and 40°. Find x and the size of the exterior angle.", "", "40, 120°", "The exterior-angle theorem gives 3x = 2x + 40, so x = 40. The exterior angle is 3(40) = 120°.", 4, ["40, 120", "x = 40, exterior 120°"], "The equation finds x; it does not yet give the requested exterior angle."),
  pAnswer("y8-geo-tri-p21", "A triangle's angles are 2x°, 3x° and (x + 20)°. Find x exactly, then state the largest angle.", "", "80/3, 80°", "The angle sum gives 6x + 20 = 180, so x = 160/6 = 80/3. The angles are 160/3°, 80° and 140/3°, so the largest is 80°.", 4, ["80/3, 80", "x = 80/3, largest 80°", "26.67, 80°"], "Keep x as a fraction until you have evaluated and compared all three angles."),
  pAnswer("y8-geo-tri-p22", "A right-angled triangle has its two acute angles in the ratio 2:1. A student divides 180° in this ratio. Find both acute angles and identify the total that should be divided.", "", "60°, 30°; divide 90°", "The right angle already uses 90°, so the two acute angles total 90°, not 180°. Three ratio parts represent 90°, so one part is 30° and the angles are 60° and 30°.", 4, ["60, 30, 90", "60° and 30°; 90°", "30°, 60°; divide 90°"], "Remove the known right angle from the triangle total before applying the ratio."),
  pAnswer("y8-geo-tri-p23", "A student treats a quadrilateral with angles 3x°, 3x°, 2x° and 2x° as a triangle and uses a total of 180°. Find the correct value of x and the largest angle.", "", "36, 108°", "A quadrilateral's angles sum to 360°, so 10x = 360 and x = 36. The largest angles are 3x = 108°. The student's 180° total is the structural error.", 4, ["36, 108", "x = 36, largest 108°"], "Choose the angle-sum rule from the number of sides before solving."),
  // D5
  pAnswer("y8-geo-tri-p24", "A triangle's angles are in the ratio $2:3:4$. Find all three angles and classify the triangle as acute, right or obtuse.", "", "40°, 60°, 80°; acute", "The ratio has 9 parts, so each part is $180/9=20°$. The angles are $40°,60°,80°$; all are below $90°$, so the triangle is acute.", 5, ["40, 60, 80, acute"]),
  pAnswer("y8-geo-tri-p25", "A quadrilateral's angles are in the ratio $1:2:3:4$. Find all four angles and identify whether any pair is supplementary.", "", "36°, 72°, 108°, 144°; 36°+144° and 72°+108°", "Ten ratio parts total $360°$, so one part is $36°$. The angles are $36°,72°,108°,144°$. The smallest and largest sum to $180°$, as do the middle pair.", 5, ["36,72,108,144; two supplementary pairs"]),
  pAnswer("y8-geo-tri-p26", "In a triangle, the second angle is double the first and the third is $30°$ more than the first. Find all three angles and classify the triangle.", "", "37.5°, 75°, 67.5°; acute", "Let the first angle be $x$. Then $x+2x+(x+30)=180$, so $x=37.5°$. The angles are $37.5°,75°,67.5°$, all acute.", 5, ["37.5,75,67.5, acute"]),
  pAnswer("y8-geo-tri-p27", "A triangle's exterior angle is five times the smaller remote interior angle; the other remote interior angle is $80°$. Find the smaller angle, the exterior angle, and the adjacent interior angle.", "", "20°, 100°, 80°", "If the smaller remote angle is $x$, the exterior-angle theorem gives $5x=x+80$, so $x=20°$. The exterior angle is $100°$ and its adjacent interior angle is $80°$.", 5, ["20,100,80"]),
  pAnswer("y8-geo-tri-p28", "A quadrilateral has three equal angles and a fourth angle of $120°$. Find the equal angles and state whether the quadrilateral could be a parallelogram.", "", "80° each; no", "The three angles total $360-120=240°$, so each is $80°$. A parallelogram needs opposite angles equal, but one angle is $120°$ while the other three are $80°$, so it cannot be one.", 5, ["80, no"]),
];
...
propertiesOfPolygons.masteryQuizPool = [
  ...
  // D4
  pAnswer("y8-geo-pol-p18", "A regular polygon has each interior angle equal to 162°. A student divides 360 by 162 to find the number of sides. Find the exterior angle and the correct number of sides.", "", "18°, 20 sides", "The interior and exterior angles at a vertex are supplementary, so the exterior angle is 180 - 162 = 18°. Exterior angles make one full turn, giving n = 360 / 18 = 20 sides. Dividing by the interior angle uses the wrong angle sum.", 4, ["18, 20", "18° and 20", "exterior 18°, 20 sides"], "Convert the interior angle to the turning angle before using the 360° exterior-angle sum."),
  pAnswer("y8-geo-pol-p19", "A polygon's interior angle sum is 1800°. A student says it has 10 sides because 1800 ÷ 180 = 10. Find the number of triangles in the fan and the actual number of sides.", "", "10 triangles, 12 sides", "The sum formula is (n - 2) × 180 = 1800, so n - 2 = 10. This 10 counts triangles from one vertex; therefore n = 12 sides.", 4, ["10, 12", "10 triangles and 12 sides"], "The quotient by 180 equals n - 2, not n."),
  pAnswer("y8-geo-pol-p20", "A regular polygon has each exterior angle equal to 18°. Find each interior angle and the number of sides. Enter both.", "", "162°, 20 sides", "The interior angle is 180 - 18 = 162°. Since the exterior angles total 360°, the number of sides is 360 / 18 = 20.", 4, ["162, 20", "162° and 20 sides"], "Use the exterior angle once to find the supplementary interior angle and again to count a full turn."),
  pAnswer("y8-geo-pol-p21", "A regular polygon has each interior angle equal to 156°. Find its exterior turning angle and the number of sides.", "", "24°, 15 sides", "The exterior angle is 180 - 156 = 24°. A full turn is 360°, so n = 360 / 24 = 15 sides.", 4, ["24, 15", "24° and 15 sides"], "The number of equal turns must complete 360°."),
  pAnswer("y8-geo-pol-p22", "The interior angle sum of a polygon is 2340°. If the polygon is regular, find its number of sides and each exterior angle.", "", "15 sides, 24°", "From (n - 2) × 180 = 2340, n - 2 = 13 and n = 15. For a regular 15-gon, each exterior angle is 360 / 15 = 24°.", 4, ["15, 24", "15 sides and 24°"], "First recover n from the interior sum; regularity is needed only for the equal exterior angle."),
  pAnswer("y8-geo-pol-p23", "A regular polygon has 24 sides. Find its total interior angle sum and each interior angle. Enter both.", "", "3960°, 165°", "The total interior sum is (24 - 2) × 180 = 3960°. Regularity makes all 24 angles equal, so each is 3960 / 24 = 165°.", 4, ["3960, 165", "3960° and 165°"], "Do not confuse the total for all vertices with the size of one regular interior angle."),
  // D5
  pAnswer("y8-geo-pol-p24", "Each interior angle of a regular polygon is five times its exterior angle. Find the exterior angle, interior angle, and number of sides.", "", "30°, 150°, 12 sides", "Let the exterior angle be $e$. Since $5e+e=180°$, $e=30°$ and the interior angle is $150°$. Then $n=360/30=12$.", 5, ["30,150,12"]),
  pAnswer("y8-geo-pol-p25", "A regular polygon has interior angle $168°$. Find its exterior angle, number of sides, and interior-angle sum.", "", "12°, 30 sides, 5040°", "The exterior angle is $180-168=12°$, so $n=360/12=30$. The interior-angle sum is $(30-2)180=5040°$.", 5, ["12,30,5040"]),
  pAnswer("y8-geo-pol-p26", "A regular polygon has interior-angle sum $3240°$. Find the number of sides, each interior angle, and each exterior angle.", "", "20 sides, 162°, 18°", "$(n-2)180=3240$ gives $n=20$. Each interior angle is $3240/20=162°$, so each exterior angle is $18°$.", 5, ["20,162,18"]),
  pAnswer("y8-geo-pol-p27", "A regular polygon's interior angle is four times its exterior angle. Find both angles and the number of sides.", "", "144°, 36°, 10 sides", "If the exterior angle is $e$, then $4e+e=180°$, giving $e=36°$ and interior angle $144°$. Hence $n=360/36=10$.", 5, ["144,36,10"]),
  pAnswer("y8-geo-pol-p28", "A regular polygon's exterior angle is one-eighth of its interior angle. Find both angles and the number of sides.", "", "20°, 160°, 18 sides", "Write the interior angle as $8e$. Then $8e+e=180°$, so $e=20°$ and the interior angle is $160°$. Thus $n=360/20=18$.", 5, ["20,160,18"]),
];
...
congruentTriangles.masteryQuizPool = [
  ...
  // D4
  pAnswer("y8-geo-con-p18", "Triangles ABC and DEF are congruent in the stated order. Angle D is 2x° and angle A is 50°. Find x and the size of angle D.", "", "25, 50°", "The order ABC ≅ DEF gives A ↔ D. Corresponding angles are equal, so 2x = 50 and x = 25. Therefore angle D is 50°, not 25°.", 4, ["25, 50", "x = 25, angle D = 50°"], "Use the correspondence order, then distinguish the variable from the full angle expression."),
  pAnswer("y8-geo-con-p19", "Triangles ABC and PQR are congruent in the stated order. AB = (3x - 4) cm and PQ = 11 cm. Find x and verify the common side length.", "", "5, 11 cm", "The order gives AB ↔ PQ, so 3x - 4 = 11. Hence 3x = 15 and x = 5. Substitution gives AB = 3(5) - 4 = 11 cm, matching PQ.", 4, ["5, 11", "x = 5, side 11 cm"], "First justify which sides correspond; then substitute the solved value as a check."),
  pAnswer("y8-geo-con-p20", "Triangles ABC and DEF are congruent in the stated order. Angle A is 55° and angle E is 65°. Find angle C and its corresponding angle in triangle DEF, naming that angle.", "", "60°, angle F", "The order gives B ↔ E, so angle B = 65°. In triangle ABC, angle C = 180 - 55 - 65 = 60°. Since C ↔ F, angle F is also 60°.", 4, ["60, F", "angle C = 60°, angle F = 60°", "60°, ∠F"], "Translate the congruence order before using the triangle angle sum."),
  pAnswer("y8-geo-con-p21", "Triangles ABC and DEF are congruent in the stated order. BC = (4x + 1) cm and EF = (2x + 9) cm. Find x and the common corresponding length.", "", "4, 17 cm", "The order gives BC ↔ EF, so 4x + 1 = 2x + 9. Thus 2x = 8 and x = 4. Both expressions then equal 17 cm.", 4, ["4, 17", "x = 4, length 17 cm"], "Solving for x is an intermediate step; evaluate either side expression for the requested length."),
  pAnswer("y8-geo-con-p22", "An isosceles triangle with apex angle 50° is split along its axis of symmetry into two congruent right triangles. Find both acute angles in either right triangle.", "", "25°, 65°", "The symmetry axis bisects the 50° apex, giving 25°. It also forms a right angle at the base, so the other acute angle is 180 - 90 - 25 = 65°. Equivalently, 65° is a base angle of the original isosceles triangle.", 4, ["25 and 65", "25°, 65°", "65°, 25°"], "Use both consequences of the symmetry line: it bisects the apex and creates two right triangles."),
  pAnswer("y8-geo-con-p23", "Triangles ABC and PQR are congruent in the stated order. Angle P is (3x + 10)° and angle A is (x + 40)°. Find x and the common angle size.", "", "15, 55°", "A ↔ P, so 3x + 10 = x + 40. This gives 2x = 30 and x = 15. Substitution gives both corresponding angles as 55°.", 4, ["15, 55", "x = 15, angle 55°"], "After equating corresponding angles, substitute x back; x itself is not the angle size."),
  // D5
  pAnswer("y8-geo-con-p24", "$\\triangle ABC\\cong\\triangle DEF$. Triangle $ABC$ has perimeter 30 cm, $AB=8$ cm and $BC=11$ cm. Find $CA$, the corresponding side $DF$, and the perimeter of $DEF$.", "", "11 cm, 11 cm, 30 cm", "$CA=30-8-11=11$ cm. Congruence gives $DF=CA=11$ cm and preserves perimeter, so triangle $DEF$ also has perimeter 30 cm.", 5, ["11,11,30"]),
  pAnswer("y8-geo-con-p25", "$\\triangle ABC\\cong\\triangle PQR$ with $A\\leftrightarrow P$. In $ABC$, angles are $(2x+10)°$, $3x°$, and $(x+20)°$. Find $x$, all three angles, and $\\angle P$.", "", "x=25; 60°, 75°, 45°; angle P=60°", "The angle sum gives $6x+30=180$, so $x=25$. Thus $A=60°$, $B=75°$, $C=45°$, and correspondence gives $P=A=60°$.", 5, ["25;60,75,45;60"]),
  pAnswer("y8-geo-con-p26", "Two congruent triangles form a rectangle of area $48\\text{ cm}^2$. Find each triangle's area and explain why the diagonal divides the rectangle into equal areas.", "", "24 cm^2 each; congruent triangles have equal area", "The two congruent triangles share the rectangle's 48 cm² equally, so each has area $48/2=24$ cm². Congruence guarantees equal corresponding dimensions and therefore equal area.", 5, ["24, congruent"]),
  pAnswer("y8-geo-con-p27", "$\\triangle ABC\\cong\\triangle DEF$. In $ABC$, $\\angle A=90°$, $\\angle B=5x°$ and $\\angle C=4x°$. Find $x$, angles $B$ and $C$, and their corresponding angles in $DEF$.", "", "x=10; B=50°, C=40°; E=50°, F=40°", "$5x+4x=90°$, so $x=10$. Hence $B=50°$ and $C=40°$. From the stated order, $B\\leftrightarrow E$ and $C\\leftrightarrow F$.", 5, ["10,50,40,50,40"]),
  pAnswer("y8-geo-con-p28", "$\\triangle ABC\\cong\\triangle DEF$ with $AB=(2x+3)$ cm corresponding to $DE=13$ cm. Find $x$, $AB$, and the scale factor from $ABC$ to $DEF$.", "", "x=5, AB=13 cm, scale factor 1", "Corresponding sides of congruent triangles are equal: $2x+3=13$, so $x=5$ and $AB=13$ cm. Congruent figures have scale factor 1.", 5, ["5,13,1"]),
];
...
geometricReasoning.masteryQuizPool = [
  ...
  // D4
  pAnswer("y8-geo-rea-p17", "A triangle has angles (2x + 5)°, (3x - 10)° and 95°. Find x and the smallest angle.", "", "18, 41°", "The triangle sum gives 2x + 5 + 3x - 10 + 95 = 180, so 5x + 90 = 180 and x = 18. The angles are 41°, 44° and 95°, so the smallest is 41°.", 4, ["18, 41", "x = 18, smallest 41°"], "Solve using the triangle total, then evaluate and compare every angle expression."),
  pAnswer("y8-geo-rea-p18", "Two parallel lines are cut by a transversal. A pair of co-interior angles are (3x + 20)° and (2x + 10)°. Find x and both angle sizes.", "", "30, 110° and 70°", "Co-interior angles are supplementary, so 5x + 30 = 180 and x = 30. The angles are 3(30) + 20 = 110° and 2(30) + 10 = 70°.", 4, ["30, 110, 70", "x = 30; angles 110° and 70°"], "The relationship supplies 180°; substitution is still needed to obtain the actual angles."),
  pAnswer("y8-geo-rea-p19", "A quadrilateral has angles 2x°, 3x°, 4x° and 6x°. Find its largest and smallest angles, then give their difference.", "", "144°, 48°, difference 96°", "The quadrilateral sum gives 15x = 360, so x = 24. The largest angle is 6x = 144°, the smallest is 2x = 48°, and their difference is 96°.", 4, ["144, 48, 96", "largest 144°, smallest 48°, difference 96°"], "Use the quadrilateral total first, then evaluate the extreme coefficients and subtract."),
  pAnswer("y8-geo-rea-p20", "A triangle has angles (x + 15)°, 2x° and (3x - 15)°. Find the largest angle and classify the triangle as acute, right or obtuse.", "", "75°, acute", "The sum gives 6x = 180, so x = 30. The angles are 45°, 60° and 75°. The largest is 75°, and because every angle is less than 90°, the triangle is acute.", 4, ["75, acute", "75° and acute triangle"], "Classification depends on the largest evaluated angle, not on the appearance or the variable coefficients."),
  pAnswer("y8-geo-rea-p21", "Two lines intersect. Adjacent angles are (5x + 8)° and (4x + 1)°. Find x, then find the angle vertically opposite the larger of the two.", "", "19, 103°", "Adjacent angles on a straight line sum to 180°, so 9x + 9 = 180 and x = 19. The angles are 103° and 77°. The angle vertically opposite the larger angle is also 103°.", 4, ["19, 103", "x = 19, angle 103°"], "Use supplementary angles to solve, then use vertical equality for the final requested angle."),
  pAnswer("y8-geo-rea-p22", "Two parallel lines are cut by a transversal. Alternate angles (6x - 5)° and (4x + 25)° are equal. Find their common angle and the co-interior angle supplementary to it.", "", "85°, 95°", "Equality gives 6x - 5 = 4x + 25, so x = 15. The alternate angles are 85°. The co-interior partner is 180 - 85 = 95°.", 4, ["85, 95", "common 85°, co-interior 95°"], "There are two relationships: equality finds the alternate angle; supplementation finds its co-interior partner."),
  // D5
  pAnswer("y8-geo-rea-p23", "$AB\\parallel CD$. Co-interior angles are $3x°$ and $(2x+40)°$. Find $x$, both angles, and the alternate angle equal to the smaller one.", "", "x=28; 84°, 96°; alternate 84°", "Co-interior angles sum to $180°$, so $5x+40=180$ and $x=28$. The angles are $84°$ and $96°$; the alternate angle corresponding to the smaller angle is also $84°$.", 5, ["28,84,96,84"]),
  pAnswer("y8-geo-rea-p24", "A triangle's angles are in ratio $3:4:5$. Find all interior angles and the exterior angle adjacent to the largest interior angle.", "", "45°, 60°, 75°; exterior 105°", "Twelve parts total $180°$, so one part is $15°$. The interiors are $45°,60°,75°$ and the adjacent exterior is $180-75=105°$.", 5, ["45,60,75,105"]),
  pAnswer("y8-geo-rea-p25", "$AB\\parallel CD$. Co-interior angles $x$ and $y$ differ by $50°$, with $x>y$. Find both angles and verify their sum.", "", "x=115°, y=65°; sum 180°", "$x=y+50$ and $x+y=180$. Thus $2y+50=180$, giving $y=65°$ and $x=115°$; they sum to $180°$.", 5, ["115,65,180"]),
  pAnswer("y8-geo-rea-p26", "In triangle $ABC$, $A=2B$ and $C=B+30°$. Find all three angles and classify the triangle.", "", "A=75°, B=37.5°, C=67.5°; acute", "$2B+B+(B+30)=180$ gives $B=37.5°$. Then $A=75°$ and $C=67.5°$; all are acute.", 5, ["75,37.5,67.5,acute"]),
  pAnswer("y8-geo-rea-p27", "A pentagon has interior angles $100°,110°,120°,x°,x°$. Find $x$ and identify whether the pentagon could be regular.", "", "x=105°; no", "A pentagon's interior sum is $540°$. Thus $2x=540-330=210$ and $x=105°$. The angles are not all equal, so it is not regular.", 5, ["105,no"]),
  pAnswer("y8-geo-rea-p28", "Two vertically opposite angles are $(7x-4)°$ and $(5x+20)°$. Find $x$, those angles, and each adjacent angle.", "", "x=12; opposite angles 80°; adjacent angles 100°", "Vertical angles are equal, so $7x-4=5x+20$ and $x=12$. Each is $80°$; adjacent angles are $180-80=100°$.", 5, ["12,80,100"]),
];
...
quadrilateralProperties.masteryQuizPool = [
  ...
  // D4
  pAnswer("y8-geo-qprop-p18", "In parallelogram ABCD, angle A = (2x + 30)° and angle C = 3x°. Find x and the common angle size. What additional classification follows from that angle size?", "", "30, 90°, rectangle", "Opposite angles of a parallelogram are equal, so 2x + 30 = 3x and x = 30. Both angles are 90°. A parallelogram with a right angle has four right angles, so it is a rectangle.", 4, ["30, 90, rectangle", "x = 30, angles 90°, rectangle"], "Use the opposite-angle property, then interpret what a right angle implies for a parallelogram."),
  pAnswer("y8-geo-qprop-p19", "In parallelogram ABCD, angle A = (4x + 10)° and adjacent angle B = (2x + 20)°. Find x and both angle sizes.", "", "25, 110° and 70°", "Adjacent angles in a parallelogram are supplementary: 6x + 30 = 180, so x = 25. Then angle A = 110° and angle B = 70°.", 4, ["25, 110, 70", "x = 25; A = 110°, B = 70°"], "The supplementary equation finds x; substitute back into both expressions."),
  pAnswer("y8-geo-qprop-p20", "A diagonal of a rhombus bisects a 76° vertex angle. Each half-angle is labelled 2x°. Find x and the size of each half-angle.", "", "19, 38°", "The two equal halves total 76°, so 2(2x) = 76 and x = 19. Each labelled half-angle is 2x = 38°, not 19°.", 4, ["19, 38", "x = 19, half-angle 38°"], "Distinguish the variable x from the angle expression 2x."),
  pAnswer("y8-geo-qprop-p21", "A pair of co-interior angles in a trapezium with parallel bases are (3x - 10)° and (2x + 40)°. Find x and both angle sizes.", "", "30, 80° and 100°", "Co-interior angles sum to 180°, so 5x + 30 = 180 and x = 30. The angles are 3(30) - 10 = 80° and 2(30) + 40 = 100°.", 4, ["30, 80, 100", "x = 30; angles 80° and 100°"], "Use the marked parallel sides to justify supplementation, then evaluate both expressions."),
  pAnswer("y8-geo-qprop-p22", "In parallelogram ABCD, angle A = (5x - 5)° and opposite angle C = (3x + 35)°. Find angle A and the adjacent angle B.", "", "95°, 85°", "Opposite angles are equal: 5x - 5 = 3x + 35, giving x = 20. Thus angle A = 95°. Adjacent angles are supplementary, so angle B = 180 - 95 = 85°.", 4, ["95, 85", "A = 95°, B = 85°"], "Use one parallelogram property to find A and a second property to find B."),
  pAnswer("y8-geo-qprop-p23", "In rhombus ABCD, angle A = 2x°. Diagonal AC splits angle A into two 35° angles. Find x and the adjacent interior angle B.", "", "35, 110°", "The diagonal gives angle A = 35 + 35 = 70°, so 2x = 70 and x = 35. Adjacent angles of a rhombus are supplementary, hence angle B = 180 - 70 = 110°.", 4, ["35, 110", "x = 35, B = 110°"], "Reconstruct the full bisected angle before using the supplementary adjacent-angle property."),
  // D5
  pAnswer("y8-geo-qprop-p24", "In a rhombus, one diagonal makes a $28°$ angle with a side. Find the angle between the diagonals and the other acute angle in the right triangle formed.", "", "90°, 62°", "Rhombus diagonals are perpendicular, so their angle is $90°$. In the resulting right triangle, the remaining acute angle is $180-90-28=62°$.", 5, ["90,62"]),
  pAnswer("y8-geo-qprop-p25", "Parallelogram $ABCD$ has angle ratio $2:3:2:3$. Find all four angles and identify the supplementary adjacent pair.", "", "72°,108°,72°,108°; every adjacent pair", "Ten parts total $360°$, so one part is $36°$. The angles are $72°,108°,72°,108°$, and every adjacent $72°+108°$ pair is supplementary.", 5, ["72,108,72,108"]),
  pAnswer("y8-geo-qprop-p26", "In rhombus $ABCD$, $A=70°$ and diagonal $AC$ bisects $A$. Given $B=110°$, find all angles of triangle $ABC$ and explain why two are equal.", "", "35°,110°,35°; AB=BC", "The diagonal bisects $A$, so $BAC=35°$. Then $ACB=180-110-35=35°$. Equal base angles occur because adjacent rhombus sides $AB$ and $BC$ are equal.", 5, ["35,110,35; isosceles"]),
  pAnswer("y8-geo-qprop-p27", "A kite has two $90°$ angles and its other two angles are in ratio $2:1$. Find both remaining angles and check the quadrilateral sum.", "", "120°,60°; sum 360°", "The two right angles total $180°$, leaving $180°$ in ratio $2:1$. One part is $60°$, so the angles are $120°$ and $60°$; all four total $360°$.", 5, ["120,60,360"]),
  pAnswer("y8-geo-qprop-p28", "In rectangle $ABCD$, diagonals meet at $O$. Since $OA=OB$, triangle $AOB$ is isosceles and $AOB=50°$. Find both base angles and the supplementary angle $BOC$.", "", "OAB=OBA=65°; BOC=130°", "The equal base angles share $180-50=130°$, so each is $65°$. Since $A,O,C$ are collinear, $BOC=180-50=130°$.", 5, ["65,65,130"]),
];
