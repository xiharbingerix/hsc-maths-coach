...
const introTheorem: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    poolAnswer("y8-pyth-intro-p2", "Calculate 3 squared plus 4 squared.", "3^2 + 4^2 = \\;?", "25", "9 plus 16 equals 25.", 1),
    poolAnswer("y8-pyth-intro-p3", "Calculate 5 squared plus 12 squared.", "5^2 + 12^2 = \\;?", "169", "25 plus 144 equals 169.", 1),
    ...
    poolAnswer("y8-pyth-intro-p5", "Calculate 6 squared plus 8 squared.", "6^2 + 8^2 = \\;?", "100", "36 plus 64 equals 100.", 1),
    ...
    poolAnswer("y8-pyth-intro-p7", "Do sides 3, 4, 5 satisfy Pythagoras' theorem? Enter yes or no.", "3^2+4^2=9+16=25=5^2", "yes", "9 plus 16 equals 25, which equals 5 squared.", 2, ["Yes", "YES"]),
    poolAnswer("y8-pyth-intro-p8", "Do sides 5, 12, 13 satisfy Pythagoras' theorem? Enter yes or no.", "5^2+12^2=25+144=169=13^2", "yes", "25 plus 144 equals 169, which equals 13 squared.", 2, ["Yes", "YES"]),
    poolAnswer("y8-pyth-intro-p9", "Calculate 7 squared plus 24 squared.", "7^2 + 24^2 = \\;?", "625", "49 plus 576 equals 625.", 2),
    ...
    poolAnswer("y8-pyth-intro-p11", "Do sides 4, 5, 6 satisfy Pythagoras' theorem? Enter yes or no.", "4^2+5^2=16+25=41,\\quad 6^2=36", "no", "16 plus 25 equals 41, but 6 squared is 36. The theorem does not hold.", 2, ["No", "NO"]),
    ...
    poolAnswer("y8-pyth-intro-p13", "Calculate 8 squared plus 15 squared.", "8^2 + 15^2 = \\;?", "289", "64 plus 225 equals 289.", 2),
    poolAnswer("y8-pyth-intro-p14", "Do sides 9, 12, 15 satisfy Pythagoras' theorem? Enter yes or no.", "9^2+12^2=81+144=225=15^2", "yes", "81 plus 144 equals 225, which equals 15 squared.", 3),
    ...
    poolAnswer("y8-pyth-intro-p16", "Do sides 7, 24, 25 satisfy Pythagoras' theorem? Enter yes or no.", "7^2+24^2=49+576=625=25^2", "yes", "49 plus 576 equals 625, which equals 25 squared.", 3, ["Yes", "YES"]),
    poolAnswer("y8-pyth-intro-p17", "Calculate 12 squared plus 16 squared.", "12^2 + 16^2 = \\;?", "400", "144 plus 256 equals 400.", 3),
    ...
    poolAnswer("y8-pyth-intro-p19", "Do sides 10, 24, 26 satisfy Pythagoras' theorem? Enter yes or no.", "10^2+24^2=100+576=676=26^2", "yes", "100 plus 576 equals 676, which equals 26 squared.", 3, ["Yes", "YES"]),
    ...
    poolAnswer("y8-pyth-intro-p21", "A triangle has sides 20, 21 and 29. Does it satisfy Pythagoras' theorem? Enter yes or no.", "20^2+21^2=400+441=841=29^2", "yes", "400 plus 441 equals 841, which equals 29 squared.", 4, ["Yes", "YES"]),
    poolAnswer("y8-pyth-intro-p22", "A triangle has sides 9, 40 and 42. Does it satisfy Pythagoras' theorem? Enter yes or no.", "9^2+40^2=81+1600=1681,\\quad 42^2=1764", "no", "81 plus 1600 equals 1681, but 42 squared is 1764. The theorem does not hold.", 4, ["No", "NO"]),
    ...
    poolAnswer("y8-pyth-intro-p24", "Calculate 20 squared plus 21 squared.", "20^2 + 21^2 = \\;?", "841", "400 plus 441 equals 841.", 4),
    poolAnswer("y8-pyth-intro-p25", "A triangle has sides 11, 60 and 61. Does it satisfy Pythagoras' theorem? Enter yes or no.", "11^2+60^2=121+3600=3721=61^2", "yes", "121 plus 3600 equals 3721, which equals 61 squared.", 5, ["Yes", "YES"]),
...
const findingHypotenuse: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    poolAnswer("y8-pyth-hyp-p2", "Find the hypotenuse in metres.", "a=8\\text{ m},\\;b=15\\text{ m}", "17", "Square root of 64 plus 225 equals 17.", 1, ["17 m"]),
    poolAnswer("y8-pyth-hyp-p3", "Find the hypotenuse in centimetres.", "a=9\\text{ cm},\\;b=12\\text{ cm}", "15", "Square root of 81 plus 144 equals 15.", 1, ["15 cm"]),
    poolAnswer("y8-pyth-hyp-p4", "Find the hypotenuse in metres.", "a=7\\text{ m},\\;b=24\\text{ m}", "25", "Square root of 49 plus 576 equals 25.", 1, ["25 m"]),
    ...
    poolAnswer("y8-pyth-hyp-p6", "Find the hypotenuse in metres.", "a=20\\text{ m},\\;b=21\\text{ m}", "29", "Square root of 400 plus 441 equals 29.", 2, ["29 m"]),
    poolAnswer("y8-pyth-hyp-p7", "Find the hypotenuse in millimetres.", "a=12\\text{ mm},\\;b=16\\text{ mm}", "20", "Square root of 144 plus 256 equals 20.", 2, ["20 mm"]),
    poolAnswer("y8-pyth-hyp-p8", "Find the hypotenuse in centimetres. Round to 1 decimal place.", "a=4\\text{ cm},\\;b=7\\text{ cm}", "8.1", "Square root of 65 is approximately 8.1.", 2, ["8.1 cm"]),
    poolAnswer("y8-pyth-hyp-p9", "Find the hypotenuse in metres. Round to 1 decimal place.", "a=5\\text{ m},\\;b=8\\text{ m}", "9.4", "Square root of 89 is approximately 9.4.", 2, ["9.4 m"]),
    poolAnswer("y8-pyth-hyp-p10", "Find the hypotenuse in centimetres.", "a=10\\text{ cm},\\;b=24\\text{ cm}", "26", "Square root of 100 plus 576 equals 26.", 2, ["26 cm"]),
    ...
    poolAnswer("y8-pyth-hyp-p12", "Find the hypotenuse in centimetres. Round to 1 decimal place.", "a=6\\text{ cm},\\;b=8\\text{ cm. Now use }a=6,\\;b=9", "10.8", "Square root of 36 plus 81 equals square root of 117 which is about 10.8.", 3, ["10.8 cm"]),
    poolAnswer("y8-pyth-hyp-p13", "A rectangle is 9 cm by 12 cm. Find its diagonal in centimetres.", "\\text{rectangle }9\\text{ cm by }12\\text{ cm}", "15", "Square root of 81 plus 144 equals 15.", 3, ["15 cm"]),
    poolAnswer("y8-pyth-hyp-p14", "Find the hypotenuse in metres. Round to 1 decimal place.", "a=7\\text{ m},\\;b=11\\text{ m}", "13.0", "Square root of 49 plus 121 equals square root of 170 which is about 13.0.", 3, ["13.0 m", "13 m", "13"]),
    poolAnswer("y8-pyth-hyp-p15", "Find the hypotenuse in centimetres.", "a=18\\text{ cm},\\;b=24\\text{ cm}", "30", "Square root of 324 plus 576 equals 30.", 3, ["30 cm"]),
    ...
    poolAnswer("y8-pyth-hyp-p17", "A square has side length 5 cm. Find its diagonal in centimetres. Round to 1 decimal place.", "\\text{square side }5\\text{ cm}", "7.1", "Square root of 25 plus 25 equals square root of 50 which is about 7.1.", 4, ["7.1 cm"]),
    poolAnswer("y8-pyth-hyp-p18", "A rectangle is 1.5 m by 2.0 m. Find its diagonal in metres.", "\\text{rectangle }1.5\\text{ m by }2.0\\text{ m}", "2.5", "Square root of 2.25 plus 4 equals square root of 6.25 which is 2.5.", 4, ["2.5 m"]),
    poolAnswer("y8-pyth-hyp-p19", "Find the hypotenuse in metres. Round to 2 decimal places.", "a=4.5\\text{ m},\\;b=6\\text{ m}", "7.5", "Square root of 20.25 plus 36 equals square root of 56.25 which is 7.5.", 4, ["7.50 m", "7.5 m", "7.5"]),
    poolAnswer("y8-pyth-hyp-p20", "A right-angled triangle has shorter sides 1.2 m and 1.6 m. Find the hypotenuse in metres.", "a=1.2\\text{ m},\\;b=1.6\\text{ m}", "2", "Square root of 1.44 plus 2.56 equals square root of 4 which is 2.", 4, ["2 m", "2.0 m"]),
    ...
    poolAnswer("y8-pyth-hyp-p22", "Find the hypotenuse in metres. Round to 1 decimal place.", "a=13\\text{ m},\\;b=15\\text{ m}", "19.8", "Square root of 169 plus 225 equals square root of 394 which is about 19.8.", 5, ["19.8 m"]),
    poolAnswer("y8-pyth-hyp-p23", "A ladder leans so its top is 8 m up a wall and its base is 6 m out. Find the ladder length in metres.", "\\text{up }8\\text{ m, out }6\\text{ m}", "10", "Square root of 64 plus 36 equals 10.", 5, ["10 m"]),
    poolAnswer("y8-pyth-hyp-p24", "A rectangular field is 40 m by 9 m. Find the diagonal in metres.", "\\text{field }40\\text{ m by }9\\text{ m}", "41", "Square root of 1600 plus 81 equals square root of 1681 which is 41.", 5, ["41 m"]),
    poolAnswer("y8-pyth-hyp-p25", "Find the hypotenuse in centimetres. Round to 2 decimal places.", "a=2.5\\text{ cm},\\;b=6\\text{ cm}", "6.5", "Square root of 6.25 plus 36 equals square root of 42.25 which is 6.5.", 5, ["6.50 cm", "6.5 cm", "6.5"]),
  ],
  multiPartPractice: [
    {
      id: "y8-pyth-hyp-mp1",
...
const findingShorterSide: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    poolAnswer("y8-pyth-short-p2", "Find the unknown shorter side in metres.", "\\text{hypotenuse }13\\text{ m, shorter side }5\\text{ m}", "12", "Square root of 169 minus 25 equals 12.", 1, ["12 m"]),
    poolAnswer("y8-pyth-short-p3", "Find the unknown shorter side in centimetres.", "\\text{hypotenuse }10\\text{ cm, shorter side }8\\text{ cm}", "6", "Square root of 100 minus 64 equals 6.", 1, ["6 cm"]),
    poolAnswer("y8-pyth-short-p4", "Find the unknown shorter side in metres.", "\\text{hypotenuse }17\\text{ m, shorter side }15\\text{ m}", "8", "Square root of 289 minus 225 equals 8.", 1, ["8 m"]),
    ...
    poolAnswer("y8-pyth-short-p6", "Find the unknown shorter side in millimetres.", "\\text{hypotenuse }25\\text{ mm, shorter side }24\\text{ mm}", "7", "Square root of 625 minus 576 equals 7.", 2, ["7 mm"]),
    poolAnswer("y8-pyth-short-p7", "Find the unknown shorter side in metres.", "\\text{hypotenuse }26\\text{ m, shorter side }10\\text{ m}", "24", "Square root of 676 minus 100 equals 24.", 2, ["24 m"]),
    poolAnswer("y8-pyth-short-p8", "Find the unknown shorter side in centimetres. Round to 1 decimal place.", "\\text{hypotenuse }9\\text{ cm, shorter side }4\\text{ cm}", "8.1", "Square root of 81 minus 16 equals square root of 65 which is about 8.1.", 2, ["8.1 cm"]),
    poolAnswer("y8-pyth-short-p9", "Find the unknown shorter side in metres. Round to 1 decimal place.", "\\text{hypotenuse }12\\text{ m, shorter side }5\\text{ m}", "10.9", "Square root of 144 minus 25 equals square root of 119 which is about 10.9.", 2, ["10.9 m"]),
    ...
    poolAnswer("y8-pyth-short-p11", "A 17 m ladder stands 8 m from a wall. Find the height reached in metres.", "\\text{ladder }17\\text{ m, base }8\\text{ m}", "15", "Square root of 289 minus 64 equals 15.", 2, ["15 m"]),
    poolAnswer("y8-pyth-short-p12", "A 25 m ladder stands 7 m from a wall. Find the height reached in metres.", "\\text{ladder }25\\text{ m, base }7\\text{ m}", "24", "Square root of 625 minus 49 equals 24.", 3, ["24 m"]),
    poolAnswer("y8-pyth-short-p13", "A rectangular gate has diagonal 15 m and one side 9 m. Find the other side in metres.", "\\text{diagonal }15\\text{ m, side }9\\text{ m}", "12", "Square root of 225 minus 81 equals 12.", 3, ["12 m"]),
    poolAnswer("y8-pyth-short-p14", "Find the unknown shorter side in centimetres. Round to 1 decimal place.", "\\text{hypotenuse }14\\text{ cm, shorter side }6\\text{ cm}", "12.6", "Square root of 196 minus 36 equals square root of 160 which is about 12.6.", 3, ["12.6 cm"]),
    ...
    poolAnswer("y8-pyth-short-p16", "Find the unknown shorter side in metres.", "\\text{hypotenuse }41\\text{ m, shorter side }9\\text{ m}", "40", "Square root of 1681 minus 81 equals 40.", 3, ["40 m"]),
    poolAnswer("y8-pyth-short-p17", "A 6.5 m ramp covers 6 m horizontally. Find the rise in metres.", "\\text{ramp }6.5\\text{ m, horizontal }6\\text{ m}", "2.5", "Square root of 42.25 minus 36 equals square root of 6.25 which is 2.5.", 4, ["2.5 m"]),
    poolAnswer("y8-pyth-short-p18", "A rectangular park has diagonal 26 m and length 24 m. Find the width in metres.", "\\text{diagonal }26\\text{ m, length }24\\text{ m}", "10", "Square root of 676 minus 576 equals 10.", 4, ["10 m"]),
    poolAnswer("y8-pyth-short-p19", "Find the unknown shorter side in metres. Round to 2 decimal places.", "\\text{hypotenuse }18\\text{ m, shorter side }11\\text{ m}", "14.25", "Square root of 324 minus 121 equals square root of 203 which is about 14.25.", 4, ["14.25 m"]),
    poolAnswer("y8-pyth-short-p20", "A 13 m guy wire reaches a point 12 m up a pole. Find its horizontal distance from the base in metres.", "\\text{wire }13\\text{ m, height }12\\text{ m}", "5", "Square root of 169 minus 144 equals 5.", 4, ["5 m"]),
    ...
    poolAnswer("y8-pyth-short-p22", "A support cable 2.5 m long is fixed 1.5 m horizontally from a post. Find the height in metres.", "\\text{cable }2.5\\text{ m, horizontal }1.5\\text{ m}", "2", "Square root of 6.25 minus 2.25 equals square root of 4 which is 2.", 5, ["2 m", "2.0 m"]),
    poolAnswer("y8-pyth-short-p23", "A rectangular screen has diagonal 50 cm and height 30 cm. Find its width in centimetres.", "\\text{diagonal }50\\text{ cm, height }30\\text{ cm}", "40", "Square root of 2500 minus 900 equals 40.", 5, ["40 cm"]),
    poolAnswer("y8-pyth-short-p24", "Find the unknown shorter side in metres. Round to 1 decimal place.", "\\text{hypotenuse }20\\text{ m, shorter side }13\\text{ m}", "15.2", "Square root of 400 minus 169 equals square root of 231 which is about 15.2.", 5, ["15.2 m"]),
    poolAnswer("y8-pyth-short-p25", "A 61 cm diagonal brace crosses a panel 60 cm wide. Find the panel height in centimetres.", "\\text{diagonal }61\\text{ cm, width }60\\text{ cm}", "11", "Square root of 3721 minus 3600 equals square root of 121 which is 11.", 5, ["11 cm"]),
  ],
  multiPartPractice: [
    {
...
const realContexts: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    poolAnswer("y8-pyth-ctx-p2", "A 5 m ladder rests with its base 3 m from a wall. Find the height reached in metres.", "\\text{ladder }5\\text{ m, base }3\\text{ m}", "4", "Square root of 25 minus 9 equals 4.", 1, ["4 m"]),
    ...
    poolAnswer("y8-pyth-ctx-p4", "A rectangle is 6 m by 8 m. Find its diagonal in metres.", "\\text{rectangle }6\\text{ m by }8\\text{ m}", "10", "Square root of 36 plus 64 equals 10.", 1, ["10 m"]),
    poolAnswer("y8-pyth-ctx-p5", "A path goes 3 km east then 4 km north. Find the direct distance in kilometres.", "\\text{east }3\\text{ km, north }4\\text{ km}", "5", "Square root of 9 plus 16 equals 5.", 1, ["5 km"]),
    poolAnswer("y8-pyth-ctx-p6", "A television screen is 16 cm wide and 12 cm high. Find its diagonal in centimetres.", "\\text{screen }16\\text{ cm by }12\\text{ cm}", "20", "Square root of 256 plus 144 equals 20.", 2, ["20 cm"]),
    ...
    poolAnswer("y8-pyth-ctx-p8", "A 10 m rope runs from the top of a 6 m pole to the ground. How far from the base does it reach, in metres?", "\\text{rope }10\\text{ m, pole }6\\text{ m}", "8", "Square root of 100 minus 36 equals 8.", 2, ["8 m"]),
    poolAnswer("y8-pyth-ctx-p9", "A square has side 5 cm. Find its diagonal in centimetres. Round to 1 decimal place.", "\\text{square side }5\\text{ cm}", "7.1", "Square root of 50 is about 7.1.", 2, ["7.1 cm"]),
    poolAnswer("y8-pyth-ctx-p10", "A garden path goes 9 m east and 12 m north. Find the direct distance in metres.", "\\text{east }9\\text{ m, north }12\\text{ m}", "15", "Square root of 81 plus 144 equals 15.", 2, ["15 m"]),
    ...
    poolAnswer("y8-pyth-ctx-p12", "Find the distance between the points (0, 0) and (8, 15) in units.", "\\text{points }(0,0)\\text{ and }(8,15)", "17", "Square root of 64 plus 225 equals 17.", 3, ["17 units"]),
    poolAnswer("y8-pyth-ctx-p13", "A 17 m ladder stands 8 m from a wall. Find the height it reaches in metres.", "\\text{ladder }17\\text{ m, base }8\\text{ m}", "15", "Square root of 289 minus 64 equals 15.", 3, ["15 m"]),
    poolAnswer("y8-pyth-ctx-p14", "A square has side 9 m. Find its diagonal in metres. Round to 1 decimal place.", "\\text{square side }9\\text{ m}", "12.7", "Square root of 162 is about 12.7.", 3, ["12.7 m"]),
    ...
    poolAnswer("y8-pyth-ctx-p16", "A rectangular paddock is 20 m by 21 m. Find the diagonal in metres.", "\\text{paddock }20\\text{ m by }21\\text{ m}", "29", "Square root of 400 plus 441 equals 29.", 3, ["29 m"]),
    poolAnswer("y8-pyth-ctx-p17", "A ramp is 6.5 m long and covers 6 m horizontally. Find the rise in metres.", "\\text{ramp }6.5\\text{ m, horizontal }6\\text{ m}", "2.5", "Square root of 42.25 minus 36 equals square root of 6.25 which is 2.5.", 4, ["2.5 m"]),
    poolAnswer("y8-pyth-ctx-p18", "A boat sails 24 km east then 7 km north. Find its direct distance from the start in kilometres.", "\\text{east }24\\text{ km, north }7\\text{ km}", "25", "Square root of 576 plus 49 equals 25.", 4, ["25 km"]),
    poolAnswer("y8-pyth-ctx-p19", "A rectangular room is 4.0 m by 3.0 m. Find the diagonal distance across the floor in metres.", "\\text{room }4.0\\text{ m by }3.0\\text{ m}", "5", "Square root of 16 plus 9 equals 5.", 4, ["5 m", "5.0 m"]),
    poolAnswer("y8-pyth-ctx-p20", "A support cable 14 m long connects to a point 11 m horizontally from a pole. Find the height in metres. Round to 1 decimal place.", "\\text{cable }14\\text{ m, horizontal }11\\text{ m}", "8.7", "Square root of 196 minus 121 equals square root of 75 which is about 8.7.", 4, ["8.7 m"]),
    ...
    poolAnswer("y8-pyth-ctx-p22", "A 2.6 m plank leans against a step, with its base 1.0 m out. Find the height it reaches in metres. Round to 1 decimal place.", "\\text{plank }2.6\\text{ m, base }1.0\\text{ m}", "2.4", "Square root of 6.76 minus 1 equals square root of 5.76 which is 2.4.", 5, ["2.4 m"]),
    poolAnswer("y8-pyth-ctx-p23", "A rectangular pool is 12 m by 35 m. Find the diagonal in metres.", "\\text{pool }12\\text{ m by }35\\text{ m}", "37", "Square root of 144 plus 1225 equals square root of 1369 which is 37.", 5, ["37 m"]),
    poolAnswer("y8-pyth-ctx-p24", "A walker goes 1.2 km east, then 0.9 km north, then stops. Find the straight-line distance back to the start in kilometres.", "\\text{east }1.2\\text{ km, north }0.9\\text{ km}", "1.5", "Square root of 1.44 plus 0.81 equals square root of 2.25 which is 1.5.", 5, ["1.5 km"]),
    poolAnswer("y8-pyth-ctx-p25", "A rectangular box has a base 9 cm by 12 cm. A diagonal is drawn across the base. Find its length in centimetres.", "\\text{base }9\\text{ cm by }12\\text{ cm}", "15", "Square root of 81 plus 144 equals 15.", 5, ["15 cm"]),
  ],
  multiPartPractice: [
    {
      id: "y8-pyth-ctx-mp1",
...
const pythagoreanTriples: LessonContent = {
  ...
  masteryQuizPool: [
    poolAnswer("y8-pyth-trip-p1", "A right triangle has shorter sides 3 cm and 4 cm. State the hypotenuse.", "3\\text{ cm and }4\\text{ cm}", "5", "3-4-5 is the basic triple.", 1, ["5 cm"]),
    poolAnswer("y8-pyth-trip-p2", "A right triangle has shorter sides 5 m and 12 m. State the hypotenuse.", "5\\text{ m and }12\\text{ m}", "13", "5-12-13 is a Pythagorean triple.", 1, ["13 m"]),
    poolAnswer("y8-pyth-trip-p3", "A right triangle has shorter sides 8 cm and 15 cm. State the hypotenuse.", "8\\text{ cm and }15\\text{ cm}", "17", "8-15-17 is a Pythagorean triple.", 1, ["17 cm"]),
    poolAnswer("y8-pyth-trip-p4", "A right triangle has shorter sides 7 m and 24 m. State the hypotenuse.", "7\\text{ m and }24\\text{ m}", "25", "7-24-25 is a Pythagorean triple.", 1, ["25 m"]),
    ...
    poolAnswer("y8-pyth-trip-p6", "A right triangle has shorter sides 6 cm and 8 cm. State the hypotenuse.", "6\\text{ cm and }8\\text{ cm}", "10", "This is 3-4-5 scaled by 2.", 2, ["10 cm"]),
    poolAnswer("y8-pyth-trip-p7", "A right triangle has shorter sides 9 m and 12 m. State the hypotenuse.", "9\\text{ m and }12\\text{ m}", "15", "This is 3-4-5 scaled by 3.", 2, ["15 m"]),
    poolAnswer("y8-pyth-trip-p8", "A right triangle has shorter sides 10 cm and 24 cm. State the hypotenuse.", "10\\text{ cm and }24\\text{ cm}", "26", "This is 5-12-13 scaled by 2.", 2, ["26 cm"]),
    ...
    poolAnswer("y8-pyth-trip-p10", "Do sides 9, 40, 41 form a Pythagorean triple? Enter yes or no.", "9^2+40^2=81+1600=1681=41^2", "yes", "81 plus 1600 equals 1681, which is 41 squared.", 2, ["Yes", "YES"]),
    ...
    poolAnswer("y8-pyth-trip-p12", "A right triangle has shorter sides 15 m and 20 m. State the hypotenuse.", "15\\text{ m and }20\\text{ m}", "25", "This is 3-4-5 scaled by 5.", 3, ["25 m"]),
    poolAnswer("y8-pyth-trip-p13", "The hypotenuse is 26 cm and one shorter side is 10 cm. Find the other shorter side.", "\\text{hypotenuse }26,\\text{ side }10", "24", "5-12-13 scaled by 2 gives 10-24-26.", 3, ["24 cm"]),
    poolAnswer("y8-pyth-trip-p14", "A right triangle has shorter sides 16 m and 30 m. State the hypotenuse.", "16\\text{ m and }30\\text{ m}", "34", "8-15-17 scaled by 2 gives 16-30-34.", 3, ["34 m"]),
    ...
    poolAnswer("y8-pyth-trip-p16", "A right triangle has shorter sides 21 cm and 28 cm. State the hypotenuse.", "21\\text{ cm and }28\\text{ cm}", "35", "3-4-5 scaled by 7 gives 21-28-35.", 3, ["35 cm"]),
    poolAnswer("y8-pyth-trip-p17", "The hypotenuse is 51 m and one shorter side is 24 m. Find the other shorter side.", "\\text{hypotenuse }51,\\text{ side }24", "45", "8-15-17 scaled by 3 gives 24-45-51.", 4, ["45 m"]),
    poolAnswer("y8-pyth-trip-p18", "The hypotenuse is 65 m and one shorter side is 25 m. Find the other shorter side.", "\\text{hypotenuse }65,\\text{ side }25", "60", "5-12-13 scaled by 5 gives 25-60-65.", 4, ["60 m"]),
    poolAnswer("y8-pyth-trip-p19", "A right triangle has shorter sides 24 m and 32 m. State the hypotenuse.", "24\\text{ m and }32\\text{ m}", "40", "3-4-5 scaled by 8 gives 24-32-40.", 4, ["40 m"]),
    ...
    poolAnswer("y8-pyth-trip-p21", "Do sides 11, 60, 61 form a Pythagorean triple? Enter yes or no.", "11^2+60^2=121+3600=3721=61^2", "yes", "121 plus 3600 equals 3721, which is 61 squared.", 4, ["Yes", "YES"]),
    poolAnswer("y8-pyth-trip-p22", "A right triangle has shorter sides 20 km and 21 km. State the hypotenuse.", "20\\text{ km and }21\\text{ km}", "29", "20-21-29 is a Pythagorean triple.", 5, ["29 km"]),
    ...
    poolAnswer("y8-pyth-trip-p24", "The hypotenuse is 85 cm and one shorter side is 13 cm. The triangle uses the 13-84-85 triple. Find the other shorter side.", "\\text{hypotenuse }85,\\text{ side }13", "84", "13-84-85 is a Pythagorean triple, so the missing side is 84.", 5, ["84 cm"]),
    poolAnswer("y8-pyth-trip-p25", "A right triangle has shorter sides 40 m and 42 m. The hypotenuse is found from the 20-21-29 family scaled by 2. State the hypotenuse.", "40\\text{ m and }42\\text{ m}", "58", "20-21-29 scaled by 2 gives 40-42-58.", 5, ["58 m"]),
  ],
  multiPartPractice: [
    {
      id: "y8-pyth-trip-mp1",
...
const distanceBetweenPoints: LessonContent = {
  ...
  masteryQuizPool: [
    poolAnswer("y8-pyth-dist-p1", "Find the distance between (0, 0) and (3, 4) in units.", "\\Delta x=3,\\;\\Delta y=4", "5", "Square root of 9 plus 16 equals 5.", 1, ["5 units"]),
    poolAnswer("y8-pyth-dist-p2", "Find the distance between (0, 0) and (6, 8) in units.", "\\Delta x=6,\\;\\Delta y=8", "10", "Square root of 36 plus 64 equals 10.", 1, ["10 units"]),
    poolAnswer("y8-pyth-dist-p3", "Find the distance between (0, 0) and (5, 12) in units.", "\\Delta x=5,\\;\\Delta y=12", "13", "Square root of 25 plus 144 equals 13.", 1, ["13 units"]),
    poolAnswer("y8-pyth-dist-p4", "Find the distance between (2, 1) and (2, 8) in units.", "\\Delta x=0,\\;\\Delta y=7", "7", "The points share an x-coordinate, so the distance is 7.", 1, ["7 units"]),
    ...
    poolAnswer("y8-pyth-dist-p6", "Find the distance between (1, 2) and (4, 6) in units.", "\\Delta x=3,\\;\\Delta y=4", "5", "Square root of 9 plus 16 equals 5.", 2, ["5 units"]),
    poolAnswer("y8-pyth-dist-p7", "Find the distance between (1, 1) and (7, 9) in units.", "\\Delta x=6,\\;\\Delta y=8", "10", "Square root of 36 plus 64 equals 10.", 2, ["10 units"]),
    poolAnswer("y8-pyth-dist-p8", "Find the distance between (2, 3) and (10, 18) in units.", "\\Delta x=8,\\;\\Delta y=15", "17", "Square root of 64 plus 225 equals 17.", 2, ["17 units"]),
    ...
    poolAnswer("y8-pyth-dist-p10", "Find the distance between (0, 0) and (4, 6) in units. Round to 1 decimal place.", "\\Delta x=4,\\;\\Delta y=6", "7.2", "Square root of 16 plus 36 equals square root of 52 which is about 7.2.", 2, ["7.2 units"]),
    ...
    poolAnswer("y8-pyth-dist-p12", "Find the distance between (-3, 0) and (0, 4) in units.", "\\Delta x=3,\\;\\Delta y=4", "5", "Square root of 9 plus 16 equals 5; the negative sign disappears after squaring.", 3, ["5 units"]),
    poolAnswer("y8-pyth-dist-p13", "Find the distance between (0, 0) and (20, 21) in units.", "\\Delta x=20,\\;\\Delta y=21", "29", "Square root of 400 plus 441 equals 29.", 3, ["29 units"]),
    poolAnswer("y8-pyth-dist-p14", "Find the distance between (2, 5) and (5, 9) in units.", "\\Delta x=3,\\;\\Delta y=4", "5", "Square root of 9 plus 16 equals 5.", 3, ["5 units"]),
    ...
    poolAnswer("y8-pyth-dist-p16", "Find the distance between (1, 2) and (9, 17) in units.", "\\Delta x=8,\\;\\Delta y=15", "17", "Square root of 64 plus 225 equals 17.", 3, ["17 units"]),
    poolAnswer("y8-pyth-dist-p17", "Find the distance between (-2, -1) and (1, 3) in units.", "\\Delta x=3,\\;\\Delta y=4", "5", "Square root of 9 plus 16 equals 5.", 4, ["5 units"]),
    poolAnswer("y8-pyth-dist-p18", "Find the distance between (-4, 2) and (4, -4) in units.", "\\Delta x=8,\\;\\Delta y=6", "10", "Square root of 64 plus 36 equals 10.", 4, ["10 units"]),
    poolAnswer("y8-pyth-dist-p19", "Find the distance between (1, 1) and (6, 13) in units.", "\\Delta x=5,\\;\\Delta y=12", "13", "Square root of 25 plus 144 equals 13.", 4, ["13 units"]),
    poolAnswer("y8-pyth-dist-p20", "Find the distance between (3, 2) and (7, 9) in units. Round to 1 decimal place.", "\\Delta x=4,\\;\\Delta y=7", "8.1", "Square root of 16 plus 49 equals square root of 65 which is about 8.1.", 4, ["8.1 units"]),
    ...
    poolAnswer("y8-pyth-dist-p22", "Find the distance between (-5, -2) and (7, 3) in units.", "\\Delta x=12,\\;\\Delta y=5", "13", "Square root of 144 plus 25 equals 13.", 5, ["13 units"]),
    poolAnswer("y8-pyth-dist-p23", "Find the distance between (-6, 4) and (2, -11) in units.", "\\Delta x=8,\\;\\Delta y=15", "17", "Square root of 64 plus 225 equals 17.", 5, ["17 units"]),
    poolAnswer("y8-pyth-dist-p24", "Find the distance between (2, -3) and (-1, 1) in units.", "\\Delta x=3,\\;\\Delta y=4", "5", "Square root of 9 plus 16 equals 5.", 5, ["5 units"]),
    poolAnswer("y8-pyth-dist-p25", "Find the distance between (0, 0) and (9, 40) in units.", "\\Delta x=9,\\;\\Delta y=40", "41", "Square root of 81 plus 1600 equals square root of 1681 which is 41.", 5, ["41 units"]),
  ],
  multiPartPractice: [
    {
      id: "y8-pyth-dist-mp1",
