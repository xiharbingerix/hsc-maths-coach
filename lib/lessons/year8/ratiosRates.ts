  ...
  workedExamples: [
    ...
    } as WorkedExample,
    {
      ...
      steps: [
        ...
        { explanation: "Compare the first parts: 6 vs 5.", latex: "" },
      ],
    ...
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "See what the first part was multiplied by: 5 → 20 is × 4.", latex: "" },
        { explanation: "Apply the same multiplier to the second part.", latex: "" },
      ],
...
const ratesAndUnitRates: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    withDifficulty(answer("y8-rtr-rat-p20", "Brand A: 1.5 kg for $6.00. Brand B: 900 g for $4.05. Which brand is cheaper per 100 g? Answer A or B.", "", "A", "Brand A: $\\$6.00 \\div 15 = \\$0.40$ per 100 g. Brand B: $\\$4.05 \\div 9 = \\$0.45$ per 100 g. Brand A is cheaper.", "Convert both to cost per 100 g.", ["Brand A"]), 4),
