...
const boxPlots: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    poolAnswer("y8-dat-bxp-p21", "Sorted data: 5, 8, 11, 14, 17, 20, 23, 26. Find the IQR.",
...
const comparingDataWithBoxPlots: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    poolAnswer("y8-dat-cmpbxp-p20", "Group A: Q1 = 18 and Q3 = 30. Group B: Q1 = 20 and Q3 = 34. Find IQR A minus IQR B.",
    ...
    poolAnswer("y8-dat-cmpbxp-p26", "Group A: Min = 20 and Max = 80. Group B: Min = 20 and Max = 60. Find range A minus range B.",
...
const shapeOfDistributions: LessonContent = {
  ...
  masteryQuizPool: [
    ...
    poolChoice("y8-dat-shp-p22", "Data: 10, 12, 12, 13, 40. The mean is 17.4 and the median is 12. Which is the better measure of the typical value and why?", "A",
    ...
    poolChoice("y8-dat-shp-p27", "Data: 3, 4, 4, 5, 5, 5, 6, 6, 7, 40. The mean is 8.5 and the median is 5. The most accurate description is…", "A",
