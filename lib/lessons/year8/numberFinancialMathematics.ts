...
const percentagesBasics: LessonContent = {
  ...
  teaching: {
    paragraphs: [
      "A percentage is just a way of describing a part of a whole, using 100 as the standard whole. The word 'per cent' literally means 'per hundred', so $35\\%$ means 35 parts out of every 100. Using 100 every time makes different amounts easy to compare — a test score of $35\\%$ and a sale of $35\\%$ off both mean the same fraction, 35 out of 100.",
      "Picture a shopkeeper who says a \\(\\$60\\) jacket is $20\\%$ off. The whole price is split into 100 equal parts, and the discount is 20 of those parts. Each part is worth \\(\\$60 \\div 100 = \\$0.60\\), so 20 parts are worth \\(20 \\times \\$0.60 = \\$12\\). That \\(\\$12\\) is the discount.",
      "In notation, a percentage is a fraction with a denominator of 100: $35\\% = \\tfrac{35}{100}$. Because dividing by 100 shifts every digit two places, $35\\% = 0.35$ as a decimal and $8\\% = 0.08$. To find a percentage of an amount, you multiply that decimal by the amount.",
      "Here is why 'convert to a decimal, then multiply' works. Finding $20\\%$ of \\(\\$60\\) means taking $\\tfrac{20}{100}$ of \\(\\$60\\), which is $\\tfrac{20}{100} \\times 60$. The fraction $\\tfrac{20}{100}$ is exactly the decimal $0.20$, so $\\tfrac{20}{100} \\times 60$ and $0.20 \\times 60$ are the same calculation — both give \\(\\$12\\). The decimal is not a shortcut that loses meaning; it is the fraction written another way.",
      "Some benchmarks are worth knowing by heart because they let you build any percentage: $50\\% = 0.5$ (a half), $25\\% = 0.25$ (a quarter), $10\\% = 0.1$ (a tenth), and $1\\% = 0.01$ (a hundredth). Since $10\\%$ is just one tenth, you find it by moving the decimal point one place: $10\\%$ of \\(\\$60\\) is \\(\\$6\\). Then $5\\%$ is half of that, and $15\\% = 10\\% + 5\\%$ — you can assemble awkward percentages from easy pieces.",
      "The most common error is treating the percentage as a dollar amount: writing $20\\%$ of \\(\\$50\\) as $20 \\times 50 = \\$1000$. A percentage is a rate, not a quantity of dollars — it tells you how much *per hundred*, so it must be converted to its decimal $0.20$ first. The check is built in: a percentage of an amount (when the rate is under $100\\%$) is always smaller than the amount, so an answer larger than the original price signals the mistake. In everyday Australian contexts — GST, tips, a discount sticker, interest on savings — the same single move applies: turn the percent into a decimal, then multiply.",
    ],
    latexBlocks: [
      "n\\% = \\frac{n}{100} \\qquad\\text{so}\\qquad 35\\% = \\frac{35}{100} = 0.35",
      "n\\%\\text{ of an amount} = \\frac{n}{100} \\times \\text{amount} = (\\text{decimal}) \\times \\text{amount}",
  ...
  workedExamples: [
    {
      ...
      steps: [
        { explanation: "A percentage is that number over 100, so write it as a fraction.", latex: "45\\% = \\frac{45}{100}" },
        { explanation: "Dividing by 100 moves the decimal point two places left.", latex: "45 \\div 100 = 0.45" },
      ],
      finalAnswerLatex: "45\\% = 0.45",
    } as WorkedExample,
    {
      title: "Find a percentage of an amount",
      questionLatex: "\\text{Find }30\\%\\text{ of }\\$80.",
      steps: [
        { explanation: "Convert the rate to a decimal so it can be multiplied.", latex: "30\\% = \\frac{30}{100} = 0.30" },
        { explanation: "Multiply the decimal by the amount, because finding a percentage of something is multiplication.", latex: "0.30 \\times 80 = 24" },
      ],
      finalAnswerLatex: "30\\%\\text{ of }\\$80 = \\$24",
    } as WorkedExample,
    {
      title: "Use 10% to build 15%",
      questionLatex: "\\text{Find }15\\%\\text{ of }\\$60\\text{ without a calculator.}",
      steps: [
        { explanation: "Find 10% first — it is one tenth, so move the decimal point one place.", latex: "10\\%\\text{ of }\\$60 = \\$6" },
        { explanation: "5% is half of 10%, so halve the previous value.", latex: "5\\%\\text{ of }\\$60 = \\$6 \\div 2 = \\$3" },
        { explanation: "15% is 10% plus 5%, so add the two pieces.", latex: "\\$6 + \\$3 = \\$9" },
      ],
      finalAnswerLatex: "15\\%\\text{ of }\\$60 = \\$9",
    } as WorkedExample,
    {
      title: "Harder: work backwards from a percentage",
      questionLatex: "\\text{A }\\$12\\text{ tip is exactly }15\\%\\text{ of a restaurant bill. Find the full bill.}",
      steps: [
        { explanation: "The tip is 15% of the unknown bill, so first find what 1% is worth by dividing by 15.", latex: "1\\%\\text{ of bill} = \\$12 \\div 15 = \\$0.80" },
        { explanation: "The whole bill is 100%, so multiply the value of 1% by 100.", latex: "100\\%\\text{ of bill} = \\$0.80 \\times 100 = \\$80" },
        { explanation: "Check by finding 15% of $80 to confirm it returns the tip.", latex: "0.15 \\times 80 = \\$12 \\;\\checkmark" },
      ],
      finalAnswerLatex: "\\text{The full bill is }\\$80.",
    } as WorkedExample,
  ],
  guidedPractice: [
    answer(
...
const percentageIncrease: LessonContent = {
  ...
  teaching: {
    paragraphs: [
      "A percentage increase means an amount grows by a fraction of its own starting value. The key word is 'of its own' — a $20\\%$ rise is always measured against the original amount, not some fixed number of dollars. This is how pay rises, rent increases, and price mark-ups are described.",
      "Suppose a \\(\\$50\\) item rises by $20\\%$. The rise is $20\\%$ of \\(\\$50\\), which is $0.20 \\times 50 = \\$10$. You add that to the original: \\(\\$50 + \\$10 = \\$60\\). This is the two-step method — find the increase, then add it on — and it always works.",
      "There is a faster one-step method. After the increase you still have the original $100\\%$, plus an extra $20\\%$, giving $120\\%$ of the original — which as a decimal is $1.20$. So the new amount is original $\\times\\,1.20$. The number you multiply by, $1 + \\text{decimal rate}$, is called the multiplier.",
      "Here is why the two methods give the same answer, written out. The new amount is $\\text{original} + (\\text{rate} \\times \\text{original})$. Factor the original out of both terms: $\\text{original} \\times (1 + \\text{rate})$. The $1$ is the part you keep and the $\\text{rate}$ is the part you add, so the multiplier $(1 + \\text{rate})$ does the 'find and add' in a single multiplication. For $20\\%$ that is $1 + 0.20 = 1.20$.",
      "Because you are always adding something on, the multiplier for an increase is always greater than $1$, and the new amount is always greater than the original. If your answer comes out smaller, you have either used the rate $0.20$ as the multiplier instead of $1.20$, or applied the percentage to the wrong amount.",
      "The most common error is adding the rate number itself: a $20\\%$ rise on \\(\\$70\\) is *not* $70 + 20 = \\$90$. The $20$ is a percentage, not \\(\\$20\\); the actual rise is $0.20 \\times 70 = \\$14$, giving \\(\\$84\\). In real Australian contexts — a wage going up, rent reviewed each year, a ticket price lifted — the multiplier method is fastest: a $3.5\\%$ pay rise on a salary is simply salary $\\times\\,1.035$.",
    ],
    latexBlocks: [
      "\\text{Increase} = \\text{original} \\times \\text{decimal rate}",
      "\\text{New amount} = \\text{original} + \\text{increase} = \\text{original} \\times (1 + \\text{rate})",
      "\\text{multiplier} = 1 + \\text{decimal rate} \\;>\\; 1",
  ...
  workedExamples: [
    {
      ...
      steps: [
        { explanation: "Find the increase: 25% of the original $80.", latex: "0.25 \\times 80 = 20" },
        { explanation: "Add the increase onto the original amount.", latex: "80 + 20 = 100" },
      ],
      finalAnswerLatex: "\\$80\\text{ increased by }25\\% = \\$100",
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "Build the multiplier: keep 100% and add 15%, so 1 + 0.15.", latex: "1 + 0.15 = 1.15" },
        { explanation: "Multiply the original price by the multiplier to get the new price in one step.", latex: "320 \\times 1.15 = 368" },
      ],
      finalAnswerLatex: "\\text{New price} = \\$368",
    } as WorkedExample,
    {
      title: "Wage increase (pay rise)",
      questionLatex: "\\text{Ella earns }\\$18\\text{ per hour and receives a }10\\%\\text{ pay rise. Find her new hourly rate.}",
      steps: [
        { explanation: "The rise is 10% of her current rate.", latex: "0.10 \\times 18 = 1.80" },
        { explanation: "Add the rise to her original rate.", latex: "18 + 1.80 = 19.80" },
      ],
      finalAnswerLatex: "\\text{New rate} = \\$19.80\\text{ per hour}",
    } as WorkedExample,
    {
      title: "Harder: work backwards from the new price",
      questionLatex: "\\text{After a }20\\%\\text{ rise, a rent is }\\$90\\text{ per week. Find the original rent.}",
      steps: [
        { explanation: "A 20% rise multiplies the original by 1.20, so the new rent equals original × 1.20.", latex: "\\text{original} \\times 1.20 = 90" },
        { explanation: "Undo the multiplication by dividing the new rent by the multiplier.", latex: "\\text{original} = 90 \\div 1.20 = 75" },
        { explanation: "Check: a 20% rise on $75 should return $90.", latex: "75 \\times 1.20 = 90 \\;\\checkmark" },
      ],
      finalAnswerLatex: "\\text{The original rent was }\\$75\\text{ per week.}",
    } as WorkedExample,
  ],
  guidedPractice: [
    choice(
...
const percentageDecrease: LessonContent = {
  ...
  teaching: {
    paragraphs: [
      "A percentage decrease means an amount shrinks by a fraction of its own starting value. Like an increase, it is measured against the original amount — a $30\\%$ fall takes away $30\\%$ of what you started with. This is how sale reductions, depreciation, and price drops are described.",
      "Suppose an \\(\\$80\\) item falls by $30\\%$. The fall is $30\\%$ of \\(\\$80\\), which is $0.30 \\times 80 = \\$24$. You take that away: \\(\\$80 - \\$24 = \\$56\\). This is the two-step method — find the decrease, then subtract it.",
      "The one-step method asks how much is left, not how much is taken. If $30\\%$ is removed, then $70\\%$ remains, and $70\\%$ as a decimal is $0.70$. So the new amount is original $\\times\\,0.70$. The multiplier for a decrease is $1 - \\text{decimal rate}$.",
      "Here is why both methods agree. The new amount is $\\text{original} - (\\text{rate} \\times \\text{original})$. Factor the original out: $\\text{original} \\times (1 - \\text{rate})$. The $1$ is the whole you began with and you subtract the $\\text{rate}$ you lose, so $(1 - \\text{rate})$ is the fraction that survives. For $30\\%$ that is $1 - 0.30 = 0.70$.",
      "Because you are taking something away, the multiplier for a decrease is always between $0$ and $1$, and the new amount is always smaller than the original. If your answer is larger than the start, you have likely used $1 + \\text{rate}$ instead of $1 - \\text{rate}$.",
      "The misconception to avoid is mixing up the rate with the multiplier: for $30\\%$ off you multiply by $0.70$, not by $0.30$ (multiplying by $0.30$ would leave only $30\\%$, an $70\\%$ discount). In Australian retail this is the everyday 'sale price' move: a sticker reading '$25\\%$ off' on a \\(\\$160\\) jacket means $160 \\times 0.75 = \\$120$ — keep $75\\%$, multiply, done.",
    ],
    latexBlocks: [
      "\\text{Decrease} = \\text{original} \\times \\text{decimal rate}",
      "\\text{New amount} = \\text{original} - \\text{decrease} = \\text{original} \\times (1 - \\text{rate})",
      "\\text{multiplier} = 1 - \\text{decimal rate},\\qquad 0 < \\text{multiplier} < 1",
  ...
  workedExamples: [
    {
      ...
      steps: [
        { explanation: "Find the decrease: 25% of the original $120.", latex: "0.25 \\times 120 = 30" },
        { explanation: "Subtract the decrease from the original.", latex: "120 - 30 = 90" },
      ],
      finalAnswerLatex: "\\$120\\text{ decreased by }25\\% = \\$90",
    } as WorkedExample,
    {
      title: "Multiplier method on a price",
      questionLatex: "\\text{A coat costs }\\$200.\\text{ Its price falls by }40\\%.\\text{ Find the new price.}",
      steps: [
        { explanation: "Find the fraction that remains: 100% minus 40% leaves 60%.", latex: "1 - 0.40 = 0.60" },
        { explanation: "Multiply the original by the remaining fraction to get the new price.", latex: "200 \\times 0.60 = 120" },
      ],
      finalAnswerLatex: "\\text{New price} = \\$120",
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "Dropping 15% leaves 85% of the price.", latex: "1 - 0.15 = 0.85" },
        { explanation: "Multiply the listed price by 0.85.", latex: "480 \\times 0.85 = 408" },
      ],
      finalAnswerLatex: "\\text{New price} = \\$408",
    } as WorkedExample,
    {
      title: "Harder: find the discount percentage",
      questionLatex: "\\text{A jacket marked }\\$160\\text{ is on sale for }\\$120.\\text{ What percentage discount is this?}",
      steps: [
        { explanation: "Find the actual saving in dollars first.", latex: "160 - 120 = 40" },
        { explanation: "Express the saving as a fraction of the original price, then as a percentage.", latex: "\\frac{40}{160} \\times 100 = 25\\%" },
        { explanation: "Check: a 25% discount keeps 75%, so 160 × 0.75 should give $120.", latex: "160 \\times 0.75 = 120 \\;\\checkmark" },
      ],
      finalAnswerLatex: "\\text{The discount is }25\\%.",
    } as WorkedExample,
  ],
  guidedPractice: [
    choice(
...
const profitAndLoss: LessonContent = {
  ...
  teaching: {
    paragraphs: [
      "Whenever someone buys something to sell it again, two prices matter. The cost price is what you pay to buy or make the item. The selling price is what someone pays you for it. Profit and loss are simply the gap between these two prices.",
      "Imagine you buy a phone for \\(\\$280\\) and later sell it for \\(\\$350\\). You got back more than you put in, so you made a profit: the gain is $350 - 280 = \\$70$. If instead you had only sold it for \\(\\$250\\), you would have got back less than you paid — a loss of $280 - 250 = \\$30$.",
      "In words: profit $=$ selling price $-$ cost price (when selling is higher), and loss $=$ cost price $-$ selling price (when cost is higher). It is always 'bigger minus smaller' so the answer stays positive; the *label* — profit or loss — tells you which way the gap goes.",
      "A raw dollar profit doesn't tell you how *good* a deal was. A \\(\\$15\\) profit is excellent on a \\(\\$50\\) item but tiny on a \\(\\$5000\\) car. So we measure profit as a percentage of what it cost: $\\text{profit}\\% = \\tfrac{\\text{profit}}{\\text{cost price}} \\times 100$. Dividing by the cost price asks 'how big is my gain compared with what I had to spend?', and multiplying by 100 turns that fraction into a percentage.",
      "The reason we always divide by the cost price — never the selling price — is that the cost price is the money you actually risked. A \\(\\$15\\) gain on a \\(\\$50\\) outlay is $\\tfrac{15}{50} = 30\\%$ growth on your money; dividing by the \\(\\$65\\) selling price instead would understate that return and answer a different question. The cost price is your baseline, so it goes on the bottom.",
      "The misconception to watch for is treating the selling price itself as the profit — selling for \\(\\$65\\) is not a \\(\\$65\\) profit; the profit is the \\(\\$15\\) difference. In real Australian contexts — a market stall, reselling concert tickets, a small business — the same two-step idea applies: find the dollar gap, then express it as a percentage of cost to judge whether it was worth doing.",
    ],
    latexBlocks: [
      "\\text{Profit} = \\text{selling price} - \\text{cost price}\\quad(\\text{selling} > \\text{cost})",
      "\\text{Loss} = \\text{cost price} - \\text{selling price}\\quad(\\text{cost} > \\text{selling})",
  ...
  workedExamples: [
    {
      ...
      steps: [
        { explanation: "Compare the prices: selling is higher than cost, so there is a profit.", latex: "350 > 280" },
        { explanation: "Profit is the gap: selling price minus cost price.", latex: "\\text{Profit} = 350 - 280 = 70" },
      ],
    ...
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "Compare the prices: selling is lower than cost, so there is a loss.", latex: "340 < 400" },
        { explanation: "Loss is the gap the other way: cost price minus selling price.", latex: "\\text{Loss} = 400 - 340 = 60" },
      ],
    ...
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "Find the dollar profit first.", latex: "\\text{Profit} = 65 - 50 = 15" },
        { explanation: "Divide by the cost price (the money risked) and multiply by 100.", latex: "\\frac{15}{50} \\times 100 = 30\\%" },
      ],
      finalAnswerLatex: "30\\%\\text{ profit}",
    } as WorkedExample,
    {
      title: "Harder: find the selling price from a target profit",
      questionLatex: "\\text{A trader buys a jacket for }\\$80\\text{ and wants a }35\\%\\text{ profit. What selling price is needed?}",
      steps: [
        { explanation: "A 35% profit means the dollar gain is 35% of the cost price.", latex: "0.35 \\times 80 = 28" },
        { explanation: "Add the required profit onto the cost price to get the selling price.", latex: "80 + 28 = 108" },
        { explanation: "Check: profit ÷ cost as a percentage should be 35%.", latex: "\\frac{28}{80} \\times 100 = 35\\% \\;\\checkmark" },
      ],
      finalAnswerLatex: "\\text{The jacket must be sold for }\\$108.",
    } as WorkedExample,
  ],
  guidedPractice: [
    choice(
...
const discountsAndSales: LessonContent = {
  ...
  teaching: {
    paragraphs: [
      "A discount is money taken off a price. Shops use discounts to attract customers, and they come in two flavours: a flat dollar amount (such as '\\(\\$15\\) off') or a percentage of the original price (such as '$20\\%$ off'). The maths you use depends on which kind the sign is advertising.",
      "A dollar-off discount is the easy case: you simply subtract. A \\(\\$120\\) pair of jeans with a \\(\\$25\\) coupon costs $120 - 25 = \\$95$. The saving is fixed at \\(\\$25\\) no matter what the item costs.",
      "A percentage discount depends on the price. For '$20\\%$ off \\(\\$75\\)', the saving is $20\\%$ of \\(\\$75\\), which is $0.20 \\times 75 = \\$15$, so the sale price is $75 - 15 = \\$60$. The faster route is to ask what fraction you still pay: $20\\%$ off leaves $80\\%$, so sale price $= 75 \\times 0.80 = \\$60$.",
      "Why does multiplying by $(1 - \\text{discount rate})$ give the sale price directly? Because a discount is just a percentage *decrease*. Removing $20\\%$ leaves $100\\% - 20\\% = 80\\%$ of the price, and $80\\%$ as a decimal is $0.80$. Multiplying by the fraction you keep does the 'find the discount and subtract it' in one move. The saving is then simply original price $-$ sale price.",
      "To compare two offers, turn each into the same unit — actual dollars saved — then compare. A percentage off and a flat dollar amount can't be judged by their numbers alone: on a \\(\\$160\\) jacket, '$25\\%$ off' saves $0.25 \\times 160 = \\$40$, which beats a '\\(\\$35\\) off' coupon. But on a cheaper \\(\\$100\\) jacket the same '$25\\%$ off' saves only \\(\\$25\\), so the flat \\(\\$35\\) coupon would win. The better deal depends on the price.",
      "The common trap is using the discount rate as the multiplier: multiplying \\(\\$75\\) by $0.20$ gives \\(\\$15\\) (the *saving*), not the sale price. Multiply by $0.80$ for the price you pay, or by $0.20$ for the amount saved — and never assume a bigger percentage always saves more dollars than a flat coupon without checking the actual amounts.",
    ],
    latexBlocks: [
      "\\text{Sale price (percent off)} = \\text{original price} \\times (1 - \\text{discount rate})",
      "20\\%\\text{ off }\\$75:\\quad 75 \\times 0.80 = \\$60",
      "\\text{Saving} = \\text{original price} - \\text{sale price} = \\text{original} \\times \\text{discount rate}",
      "\\text{Sale price (dollar off)} = \\text{original price} - \\text{coupon}",
    ],
  },
  workedExamples: [
    {
      ...
      steps: [
        { explanation: "30% off leaves 70% of the price, so the multiplier is 1 − 0.30.", latex: "1 - 0.30 = 0.70" },
        { explanation: "Multiply the original price by 0.70 to get the price you pay.", latex: "85 \\times 0.70 = 59.50" },
      ],
      finalAnswerLatex: "\\text{Sale price} = \\$59.50",
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "A dollar-off coupon is a flat amount, so subtract it directly from the price.", latex: "120 - 25 = 95" },
      ],
      finalAnswerLatex: "\\text{Sale price} = \\$95",
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "Turn the percentage offer into dollars saved.", latex: "0.25 \\times 160 = \\$40" },
        { explanation: "The other offer is already in dollars saved.", latex: "\\$35" },
        { explanation: "Compare the two dollar savings to pick the better deal.", latex: "\\$40 > \\$35" },
      ],
      finalAnswerLatex: "25\\%\\text{ off is better (saves }\\$40\\text{ vs }\\$35\\text{)}",
    } as WorkedExample,
    {
      title: "Harder: two discounts applied one after another",
      questionLatex: "\\text{A }\\$200\\text{ coat is }30\\%\\text{ off, and members get a further }10\\%\\text{ off the sale price. Find the final price.}",
      steps: [
        { explanation: "Apply the first discount: 30% off leaves 70%.", latex: "200 \\times 0.70 = 140" },
        { explanation: "Apply the second discount to the new price, not the original: 10% off leaves 90%.", latex: "140 \\times 0.90 = 126" },
        { explanation: "Note the combined effect is not 40% off — that would give $120, which is wrong.", latex: "200 \\times 0.70 \\times 0.90 = 126 \\neq 200 \\times 0.60" },
      ],
      finalAnswerLatex: "\\text{The final price is }\\$126.",
    } as WorkedExample,
  ],
  guidedPractice: [
    choice(
...
const simpleInterestIntroduction: LessonContent = {
  ...
  teaching: {
    paragraphs: [
      "Interest is the rent paid for using money. If you put money in a savings account, the bank pays you interest for letting them use it; if you borrow money, you pay the lender interest for using theirs. Simple interest is the most basic kind: the same fee is charged each year, always calculated on the original amount only.",
      "That original amount has a name — the principal. Say you invest \\(\\$500\\) at $4\\%$ per year. Each year the bank pays you $4\\%$ of \\(\\$500\\), which is $0.04 \\times 500 = \\$20$. Leave it for 3 years and you earn \\(\\$20\\) three times: $3 \\times \\$20 = \\$60$. Notice the \\(\\$20\\) never changes — that 'same amount every year' is exactly what 'simple' means.",
      "We can capture that pattern in a formula: $I = \\dfrac{P \\times R \\times T}{100}$, where $P$ is the principal, $R$ is the annual rate written as a percentage number (like $4$, not $0.04$), and $T$ is the time in years. The total you end up with is $A = P + I$ — the principal plus all the interest.",
      "Here is where the formula comes from, so it isn't just a rule to memorise. One year's interest is $R\\%$ of $P$, and 'percent' means 'divide by 100', so one year's interest is $\\dfrac{R}{100} \\times P$. Because simple interest adds that *same* amount every year, over $T$ years you add it $T$ times: $T \\times \\dfrac{R}{100} \\times P$. Tidy that up and you get $I = \\dfrac{P \\times R \\times T}{100}$. The $\\div 100$ is only there to turn the percentage $R$ into a decimal — nothing more.",
      "This is why simple interest grows in a straight line, by equal steps. \\(\\$500\\) at $4\\%$ is worth \\(\\$520\\), then \\(\\$540\\), then \\(\\$560\\) — \\(\\$20\\) added each year, never more. (Compound interest, in a later lesson, is different because it pays interest on the interest too.)",
      "A frequent slip is putting $R$ in as a decimal *and* dividing by 100 — doing the conversion twice. If you write $R$ as the whole number $4$, keep the $\\div 100$; if you prefer the decimal $0.04$, drop the $\\div 100$ and use $I = P \\times 0.04 \\times T$. In Australian life this formula sits behind short-term savings accounts, personal loans, and lay-by interest — anywhere the charge stays fixed on the starting amount.",
    ],
    latexBlocks: [
      "\\text{One year's interest} = \\frac{R}{100} \\times P",
      "I = T \\times \\frac{R}{100} \\times P = \\frac{P \\times R \\times T}{100}",
      "A = P + I",
      "P = \\$500,\\;R = 4,\\;T = 3:\\quad I = \\frac{500 \\times 4 \\times 3}{100} = \\$60",
    ],
  },
  workedExamples: [
    {
      ...
      steps: [
        { explanation: "Identify the values: P = 400, R = 5, T = 2, then substitute into the formula.", latex: "I = \\frac{400 \\times 5 \\times 2}{100}" },
        { explanation: "Multiply the top, then divide by 100 to convert the percentage.", latex: "I = \\frac{4000}{100} = 40" },
      ],
      finalAnswerLatex: "I = \\$40",
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "Calculate the interest charged over the 3 years.", latex: "I = \\frac{800 \\times 6 \\times 3}{100} = \\$144" },
        { explanation: "He must repay the principal plus the interest, so add them.", latex: "A = 800 + 144 = \\$944" },
      ],
      finalAnswerLatex: "\\text{Total to repay} = \\$944",
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "A decimal rate works the same way; substitute R = 3.5.", latex: "I = \\frac{1200 \\times 3.5 \\times 2}{100} = \\$84" },
        { explanation: "Add the interest earned to her original deposit.", latex: "A = 1200 + 84 = \\$1284" },
      ],
      finalAnswerLatex: "\\text{Balance} = \\$1284",
    } as WorkedExample,
    {
      title: "Harder: find the rate from the interest earned",
      questionLatex: "\\text{An investment of }\\$2000\\text{ earns }\\$240\\text{ simple interest over 4 years. Find the annual rate.}",
      steps: [
        { explanation: "Write the formula with the known values, leaving R unknown.", latex: "240 = \\frac{2000 \\times R \\times 4}{100}" },
        { explanation: "Simplify the known part of the right-hand side.", latex: "240 = 80R" },
        { explanation: "Divide both sides by 80 to isolate R.", latex: "R = \\frac{240}{80} = 3" },
      ],
      finalAnswerLatex: "\\text{The annual rate is }3\\%.",
    } as WorkedExample,
  ],
  guidedPractice: [
    choice(
...
const wagesAndSalary: LessonContent = {
  ...
  teaching: {
    paragraphs: [
      "Most Australian jobs pay in one of two ways. A salary is a fixed yearly amount that does not change with the exact hours you work — a teacher on \\(\\$75\\,000\\) per year earns that whether a particular week is busy or quiet. Wages are paid by the hour, so the total rises and falls with the hours worked. Casual workers usually get a higher hourly rate (called casual loading) to make up for having no paid holidays or sick leave.",
      "A salary is quoted per year, but people are usually paid more often, so we split the yearly figure into equal slices. There are 52 weeks in a year, so weekly pay $=$ annual $\\div\\, 52$. A fortnight is two weeks, and $52 \\div 2 = 26$ fortnights fit in a year, so fortnightly pay $=$ annual $\\div\\, 26$. There are 12 months, so monthly pay $=$ annual $\\div\\, 12$. For a \\(\\$52\\,000\\) salary, weekly pay is $52\\,000 \\div 52 = \\$1000$.",
      "Gross pay is the total you earn *before* any tax or deductions are taken out (net pay, in a later lesson, is what lands in your account after). For an hourly worker, gross pay $=$ hours worked $\\times$ hourly rate, because each hour earns the same fixed rate and you are simply adding that rate up once per hour worked.",
      "Overtime is extra pay for hours worked beyond the standard week (usually 38 hours in Australia). Employers reward those hours at a higher rate: time-and-a-half pays $1.5$ times the normal rate, and double time pays $2$ times. Why $1.5$? It means each overtime hour earns one normal hour's pay plus half again — $1 + 0.5$ of the rate — which is exactly the percentage-increase multiplier from earlier lessons applied to the hourly rate.",
      "The key to overtime is that the higher rate applies *only* to the extra hours, not to the whole week. So the reliable method is to work out regular pay and overtime pay as two separate amounts, then add them. Calculating $\\text{total hours} \\times \\text{overtime rate}$ overpays, because it wrongly boosts the ordinary 38 hours to the overtime rate as well — that is the single most common error in these questions.",
    ],
    latexBlocks: [
  ...
  workedExamples: [
    ...
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "A year holds 26 fortnights, so divide the annual salary by 26.", latex: "89\\,700 \\div 26 = 3450" },
      ],
      finalAnswerLatex: "\\$3450\\text{ per fortnight}",
    } as WorkedExample,
    {
      title: "Harder: a week with two overtime rates",
      questionLatex: "\\text{Sam earns }\\$26/\\text{hr. In one week he works 38 regular hours, 4 hours at time-and-a-half, and 2 hours at double time. Find his gross pay.}",
      steps: [
        { explanation: "Regular pay covers the standard 38 hours at the normal rate.", latex: "38 \\times 26 = 988" },
        { explanation: "Find the time-and-a-half rate, then pay the 4 overtime hours at it.", latex: "(1.5 \\times 26) \\times 4 = 39 \\times 4 = 156" },
        { explanation: "Find the double-time rate, then pay the 2 hours at it.", latex: "(2 \\times 26) \\times 2 = 52 \\times 2 = 104" },
        { explanation: "Add the three separate amounts for total gross pay.", latex: "988 + 156 + 104 = 1248" },
      ],
      finalAnswerLatex: "\\text{Gross pay} = \\$1248",
    } as WorkedExample,
  ],
  guidedPractice: [
    choice(
...
const incomeTaxBasics: LessonContent = {
  ...
  teaching: {
    paragraphs: [
      "Gross income is the total you earn before anything is taken out. Net income, or take-home pay, is what actually reaches your bank account after deductions such as income tax and the Medicare levy. So 'your pay before tax' means gross, and 'what you take home' means net — the difference is the deductions.",
      "In Australia, income tax is collected through PAYG (Pay As You Go) withholding. Your employer estimates the tax owed on each pay, sends it straight to the Australian Tax Office, and pays you the rest. After 30 June each year you lodge a tax return to settle up — getting a refund if too much was withheld, or a bill if too little was.",
      "For now we use a simple flat-rate model: income tax $=$ gross income $\\times$ tax rate. This is just 'find a percentage of an amount' applied to your pay — a $20\\%$ tax on \\(\\$800\\) is $0.20 \\times 800 = \\$160$.",
      "Real Australian tax is actually *progressive*: it is split into brackets, and a higher rate applies only to the income *inside* each higher band, not to all of it. Picture filling buckets — the first slice of income is taxed at a low rate, and only the income that spills into the next bucket is taxed at the higher rate. So a small pay rise that pushes you into a higher bracket does **not** suddenly tax your whole income more. This is why your *average* rate (total tax $\\div$ total income) is always lower than the *marginal* rate (the rate on your last dollar) — a distinction worth remembering even though we use the flat model to practise the arithmetic.",
      "The Medicare levy is an extra $2\\%$ of gross income that most residents pay to fund public health care. Because it is just another percentage of the same gross income, you add it to the income tax and subtract both: take-home pay $=$ gross income $-$ income tax $-$ Medicare levy.",
      "GST (Goods and Services Tax) is a flat $10\\%$ added to most goods and services. Adding $10\\%$ multiplies a price by $1.10$ (the increase multiplier), so a \\(\\$45\\) item becomes $45 \\times 1.10 = \\$49.50$ including GST. To strip GST back out, you *divide* by $1.10$, because dividing undoes multiplying. The classic mistake is taking $10\\%$ off the GST-inclusive price instead of dividing — but $10\\%$ of the larger inclusive price is more than the GST that was actually added, so it gives the wrong original price. Always divide by $1.10$ to work backwards.",
    ],
    latexBlocks: [
  ...
  workedExamples: [
    ...
    } as WorkedExample,
    {
      ...
      steps: [
        { explanation: "The inclusive price is the original × 1.10, so divide by 1.10 to undo it.", latex: "132 \\div 1.10 = 120" },
      ],
      finalAnswerLatex: "\\text{Pre-GST price} = \\$120",
    } as WorkedExample,
    {
      title: "Harder: tax with a tax-free threshold",
      questionLatex: "\\text{Liam earns }\\$1000\\text{ gross per week. The first }\\$300\\text{ is tax-free; the rest is taxed at }19\\%.\\text{ He also pays the }2\\%\\text{ Medicare levy on all gross income. Find his take-home pay.}",
      steps: [
        { explanation: "Only income above the threshold is taxed, so find the taxable part first.", latex: "1000 - 300 = 700" },
        { explanation: "Apply the 19% rate to the taxable part only — this is the bracket idea.", latex: "0.19 \\times 700 = 133" },
        { explanation: "The Medicare levy is 2% of all gross income, not just the taxable part.", latex: "0.02 \\times 1000 = 20" },
        { explanation: "Subtract both deductions from gross income.", latex: "1000 - 133 - 20 = 847" },
      ],
      finalAnswerLatex: "\\text{Take-home pay} = \\$847\\text{ per week}",
    } as WorkedExample,
  ],
  guidedPractice: [
    choice(
...
const compoundInterestIntroduction: LessonContent = {
  ...
  teaching: {
    paragraphs: [
      "Simple interest is worked out on the original principal every single year, so the dollar amount added never changes. Compound interest is worked out on the principal *plus* all the interest already earned — you earn 'interest on your interest'. Because the balance you are earning on keeps growing, compound interest always ends up larger than simple interest at the same rate over the same time.",
      "Watch one year at a time. Invest \\(\\$1000\\) at $5\\%$. After year 1 you have the original plus $5\\%$ more, which is $1000 \\times 1.05 = \\$1050$ — exactly the increase multiplier from earlier lessons. In year 2 you earn $5\\%$ on the *new* \\(\\$1050\\), not the old \\(\\$1000\\), so you multiply again: $1050 \\times 1.05 = \\$1102.50$. Each year you multiply the running balance by $1.05$ once more.",
      "Multiplying by $1.05$ three times in a row is the same as multiplying by $(1.05)^3$ once. That is where the formula comes from: $A = P(1 + r)^n$. Here $A$ is the final amount, $P$ is the principal, $r$ is the annual rate as a decimal, and $n$ is the number of years. The $(1 + r)$ is the one-year increase multiplier, and the power $n$ just means 'apply it $n$ times'. For \\(\\$3000\\) at $5\\%$ for 4 years, $r = 0.05$ and $A = 3000 \\times (1.05)^4$.",
      "So the power is not a mysterious new operation — it is repeated multiplication by the same growth factor, one factor per year. This is why compound growth is called *exponential*: the gap between this year's balance and last year's gets bigger every year, because you are taking a percentage of an ever-larger amount. Simple interest, by contrast, adds the same flat dollar amount each year and grows in a straight line.",
      "To get just the interest earned, subtract the principal at the end: $I = A - P$. A frequent mistake is to report $A$ (the whole balance) as the interest — always check whether the question wants the total amount or only the interest.",
      "In Australian banking, savings accounts, term deposits and home-loan balances all compound. Over one or two years the difference from simple interest is small, but over 10, 20 or 30 years it becomes large — which is exactly why starting to save early, and why paying a loan down quickly, both matter so much.",
    ],
    latexBlocks: [
      "A = P(1 + r)^n",
      "I = A - P",
