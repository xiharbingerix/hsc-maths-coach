...
export function year12Standard1PythagorasLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("pyth-g2", "A right triangle has shorter sides 3 and 4. Find the hypotenuse.", "c = \\sqrt{3^2 + 4^2}", "5", 2,
        "c = √(a² + b²).", "c = √(9 + 16) = √25 = 5."),
      ans("pyth-g3", "A right triangle has shorter sides 6 and 8. Find the hypotenuse.", "c = \\sqrt{6^2 + 8^2}", "10", 2,
        "c = √(a² + b²).", "c = √(36 + 64) = √100 = 10."),
      ans("pyth-g4", "Using the triangle, the two shorter sides are 5 and 12. Find the hypotenuse.", "c = \\sqrt{5^2 + 12^2}", "13", 2,
    ...
    independentPractice: [
      ans("pyth-i1", "A right triangle has shorter sides 8 and 15. Find the hypotenuse.", "c = \\sqrt{8^2 + 15^2}", "17", 2,
      ...
      ans("pyth-i3", "A right triangle has shorter sides 9 and 12. Find the hypotenuse.", "c = \\sqrt{9^2 + 12^2}", "15", 3,
        "c = √(a² + b²).", "c = √(81 + 144) = √225 = 15."),
      ans("pyth-i4", "A right triangle has shorter sides 5 and 5. Find the hypotenuse to 2 decimal places.", "c = \\sqrt{5^2 + 5^2}", "7.07", 3,
        "Square, add, root, then round.", "c = √(25 + 25) = √50 ≈ 7.07.",
        ["7.07"]),
      ans("pyth-i5", "A right triangle has shorter sides 7 and 24. Find the hypotenuse.", "c = \\sqrt{7^2 + 24^2}", "25", 3,
        "c = √(a² + b²).", "c = √(49 + 576) = √625 = 25."),
    ],
    masteryQuiz: [
      ans("pyth-m1", "A right triangle has shorter sides 20 and 21. Find the hypotenuse.", "c = \\sqrt{20^2 + 21^2}", "29", 3,
      ...
      ans("pyth-m3", "A right triangle has shorter sides 10 and 24. Find the hypotenuse.", "c = \\sqrt{10^2 + 24^2}", "26", 3,
        "c = √(a² + b²).", "c = √(100 + 576) = √676 = 26."),
      ans("pyth-m4", "Using the triangle, the two shorter sides are 9 and 40. Find the hypotenuse.", "c = \\sqrt{9^2 + 40^2}", "41", 3,
      ...
      ans("pyth-m6", "A right triangle has shorter sides 2 and 3. Find the hypotenuse to 2 decimal places.", "c = \\sqrt{2^2 + 3^2}", "3.61", 3,
        "Square, add, root, round.", "c = √(4 + 9) = √13 ≈ 3.61.",
        ["3.61"]),
      ans("pyth-m7", "A right triangle has shorter sides 12 and 16. Find the hypotenuse.", "c = \\sqrt{12^2 + 16^2}", "20", 3,
      ...
      ans("pyth-m9", "A right triangle has shorter sides 1 and 1. Find the hypotenuse to 2 decimal places.", "c = \\sqrt{1^2 + 1^2}", "1.41", 4,
        "√2 to 2 dp.", "c = √(1 + 1) = √2 ≈ 1.41.",
        ["1.41"]),
      ans("pyth-m10", "A right triangle has shorter sides 15 and 20. Find the hypotenuse.", "c = \\sqrt{15^2 + 20^2}", "25", 4,
...
export function year12Standard1PythagorasApplicationsLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("pythap-g2", "A right triangle has hypotenuse 13 and one shorter side 5. Find the other shorter side.", "\\sqrt{13^2 - 5^2}", "12", 2,
        "a = √(c² − b²).", "a = √(169 − 25) = √144 = 12."),
      ans("pythap-g3", "A right triangle has hypotenuse 10 and one shorter side 6. Find the other shorter side.", "\\sqrt{10^2 - 6^2}", "8", 2,
        "a = √(c² − b²).", "a = √(100 − 36) = √64 = 8."),
      ans("pythap-g4", "A right triangle has hypotenuse 25 and one shorter side 7. Find the other shorter side.", "\\sqrt{25^2 - 7^2}", "24", 2,
        "a = √(c² − b²).", "a = √(625 − 49) = √576 = 24."),
    ],
    independentPractice: [
      ans("pythap-i1", "A 5 m ladder has its foot 3 m from a wall. How high up the wall does it reach?", "\\sqrt{5^2 - 3^2}", "4", 2,
      ...
      ans("pythap-i3", "A rectangle is 9 cm by 12 cm. Find the length of its diagonal.", "\\sqrt{9^2 + 12^2}", "15", 3,
        "The diagonal is the hypotenuse — add the squares.", "Diagonal = √(81 + 144) = √225 = 15 cm.",
        ["15 cm"]),
      ans("pythap-i4", "A right triangle has hypotenuse 17 and one shorter side 8. Find the other shorter side.", "\\sqrt{17^2 - 8^2}", "15", 3,
        "a = √(c² − b²).", "a = √(289 − 64) = √225 = 15."),
      ans("pythap-i5", "A rectangle is 5 m by 12 m. Find the length of its diagonal.", "\\sqrt{5^2 + 12^2}", "13", 3,
        "Diagonal = √(length² + width²).", "Diagonal = √(25 + 144) = √169 = 13 m.",
        ["13 m"]),
    ],
    masteryQuiz: [
      ans("pythap-m1", "A right triangle has hypotenuse 15 and one shorter side 9. Find the other shorter side.", "\\sqrt{15^2 - 9^2}", "12", 3,
      ...
      ans("pythap-m3", "A right triangle has hypotenuse 26 and one shorter side 10. Find the other shorter side.", "\\sqrt{26^2 - 10^2}", "24", 3,
        "a = √(c² − b²).", "a = √(676 − 100) = √576 = 24."),
      ans("pythap-m4", "A rectangle is 8 m by 15 m. Find the length of its diagonal.", "\\sqrt{8^2 + 15^2}", "17", 3,
      ...
      ans("pythap-m6", "A right triangle has hypotenuse 41 and one shorter side 9. Find the other shorter side.", "\\sqrt{41^2 - 9^2}", "40", 4,
        "a = √(c² − b²).", "a = √(1681 − 81) = √1600 = 40."),
      ans("pythap-m7", "A ramp's sloping surface is 25 m long and rises 7 m vertically. Find the horizontal run.", "\\sqrt{25^2 - 7^2}", "24", 4,
      ...
      ans("pythap-m9", "A right triangle has hypotenuse 100 and one shorter side 60. Find the other shorter side.", "\\sqrt{100^2 - 60^2}", "80", 4,
        "a = √(c² − b²).", "a = √(10000 − 3600) = √6400 = 80."),
      ans("pythap-m10", "A TV screen has a diagonal of 20 inches and a height of 12 inches. Find its width.", "\\sqrt{20^2 - 12^2}", "16", 4,
...
export function year12Standard1TrigSidesLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("tside-g2", "Using the triangle, the angle is 30° and the hypotenuse is 20. Find the side opposite the angle.", "20 \\times \\sin 30^\\circ", "10", 2,
      ...
      ans("tside-g3", "A right triangle has angle 45° with the adjacent side 8. Find the opposite side.", "8 \\times \\tan 45^\\circ", "8", 2,
        "Opposite and adjacent → tangent.", "tan 45° = opp/8, so opp = 8 × 1 = 8."),
      ans("tside-g4", "A right triangle has angle 60° and hypotenuse 10. Find the adjacent side.", "10 \\times \\cos 60^\\circ", "5", 2,
        "Adjacent and hypotenuse → cosine.", "adj = 10 × cos 60° = 10 × 0.5 = 5."),
    ],
    independentPractice: [
      ans("tside-i1", "A right triangle has angle 30° and hypotenuse 50. Find the opposite side.", "50 \\times \\sin 30^\\circ", "25", 2,
      ...
      ans("tside-i3", "Using the triangle, the angle is 40° with the adjacent side 10. Find the opposite side to 2 decimal places. (tan 40° = 0.8391)", "10 \\times \\tan 40^\\circ", "8.39", 3,
      ...
      ans("tside-i4", "A right triangle has angle 35° and hypotenuse 12. Find the opposite side to 2 decimal places. (sin 35° = 0.5736)", "12 \\times \\sin 35^\\circ", "6.88", 3,
        "Opposite and hypotenuse → sine.", "opp = 12 × sin 35° = 12 × 0.5736 = 6.88 (2 dp).",
        ["6.88"]),
      ans("tside-i5", "A right triangle has angle 30° with the adjacent side 12. Find the hypotenuse to 2 decimal places.", "\\frac{12}{\\cos 30^\\circ}", "13.86", 3,
        "Adjacent and hypotenuse → cosine; the hypotenuse is on the bottom, so divide.", "cos 30° = 12/hyp, so hyp = 12 ÷ 0.8660 = 13.86 (2 dp).",
        ["13.86"]),
    ],
    masteryQuiz: [
      ans("tside-m1", "A right triangle has angle 30° and hypotenuse 40. Find the opposite side.", "40 \\times \\sin 30^\\circ", "20", 2,
      ...
      ans("tside-m3", "A right triangle has angle 45° with the adjacent side 9. Find the opposite side.", "9 \\times \\tan 45^\\circ", "9", 3,
        "Opposite and adjacent → tangent.", "opp = 9 × tan 45° = 9 × 1 = 9."),
      ans("tside-m4", "Using the triangle, the angle is 60° and the hypotenuse is 8. Find the adjacent side.", "8 \\times \\cos 60^\\circ", "4", 3,
      ...
      ans("tside-m6", "A right triangle has angle 30° and hypotenuse 18. Find the opposite side.", "18 \\times \\sin 30^\\circ", "9", 3,
        "Opposite and hypotenuse → sine.", "opp = 18 × sin 30° = 18 × 0.5 = 9."),
      ans("tside-m7", "A right triangle has angle 50° with the adjacent side 10. Find the opposite side to 2 decimal places. (tan 50° = 1.1918)", "10 \\times \\tan 50^\\circ", "11.92", 4,
      ...
      ans("tside-m9", "A right triangle has angle 25° and hypotenuse 20. Find the opposite side to 2 decimal places. (sin 25° = 0.4226)", "20 \\times \\sin 25^\\circ", "8.45", 4,
        "Opposite and hypotenuse → sine.", "opp = 20 × sin 25° = 20 × 0.4226 = 8.45 (2 dp).",
        ["8.45"]),
      ans("tside-m10", "A right triangle has angle 60° with the adjacent side 5. Find the opposite side to 2 decimal places. (tan 60° = 1.7321)", "5 \\times \\tan 60^\\circ", "8.66", 4,
...
export function year12Standard1TrigAnglesLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("tang-g2", "A right triangle has opposite side 5 and hypotenuse 10. Find the angle.", "\\sin^{-1}\\!\\left(\\tfrac{5}{10}\\right)", "30", 2,
        "Opposite and hypotenuse → sin⁻¹.", "sin θ = 5/10 = 0.5, so θ = sin⁻¹(0.5) = 30°.",
        ["30°"]),
      ans("tang-g3", "A right triangle has opposite side 5 and adjacent side 5. Find the angle.", "\\tan^{-1}\\!\\left(\\tfrac{5}{5}\\right)", "45", 2,
        "Opposite and adjacent → tan⁻¹.", "tan θ = 5/5 = 1, so θ = tan⁻¹(1) = 45°.",
        ["45°"]),
      ans("tang-g4", "A right triangle has adjacent side 10 and hypotenuse 20. Find the angle.", "\\cos^{-1}\\!\\left(\\tfrac{10}{20}\\right)", "60", 2,
        "Adjacent and hypotenuse → cos⁻¹.", "cos θ = 10/20 = 0.5, so θ = cos⁻¹(0.5) = 60°.",
        ["60°"]),
    ],
    independentPractice: [
      ans("tang-i1", "A right triangle has opposite side 3 and adjacent side 4. Find the angle to the nearest degree.", "\\tan^{-1}\\!\\left(\\tfrac{3}{4}\\right)", "37", 3,
      ...
      ans("tang-i3", "Using the triangle, the opposite side is 8 and the hypotenuse is 10. Find the angle to the nearest degree.", "\\sin^{-1}\\!\\left(\\tfrac{8}{10}\\right)", "53", 3,
      ...
      ans("tang-i4", "A right triangle has adjacent side 12 and hypotenuse 13. Find the angle to the nearest degree.", "\\cos^{-1}\\!\\left(\\tfrac{12}{13}\\right)", "23", 3,
        "Adjacent and hypotenuse → cos⁻¹.", "cos θ = 12/13 = 0.923, so θ = cos⁻¹(0.923) = 22.6° ≈ 23°.",
        ["23°"]),
      ans("tang-i5", "A right triangle has opposite side 7 and adjacent side 24. Find the angle to the nearest degree.", "\\tan^{-1}\\!\\left(\\tfrac{7}{24}\\right)", "16", 3,
        "Opposite and adjacent → tan⁻¹.", "tan θ = 7/24 = 0.2917, so θ = tan⁻¹(0.2917) = 16.26° ≈ 16°.",
        ["16°"]),
    ],
    masteryQuiz: [
      ans("tang-m1", "A right triangle has opposite side 10 and hypotenuse 20. Find the angle.", "\\sin^{-1}\\!\\left(\\tfrac{10}{20}\\right)", "30", 2,
      ...
      ans("tang-m3", "A right triangle has opposite side 6 and adjacent side 6. Find the angle.", "\\tan^{-1}\\!\\left(\\tfrac{6}{6}\\right)", "45", 3,
        "Opposite and adjacent → tan⁻¹.", "tan θ = 6/6 = 1, so θ = tan⁻¹(1) = 45°.",
        ["45°"]),
      ans("tang-m4", "A right triangle has adjacent side 5 and hypotenuse 10. Find the angle.", "\\cos^{-1}\\!\\left(\\tfrac{5}{10}\\right)", "60", 3,
      ...
      ans("tang-m6", "A right triangle has opposite side 9 and adjacent side 12. Find the angle to the nearest degree.", "\\tan^{-1}\\!\\left(\\tfrac{9}{12}\\right)", "37", 3,
        "Opposite and adjacent → tan⁻¹.", "tan θ = 9/12 = 0.75, so θ = tan⁻¹(0.75) = 36.87° ≈ 37°.",
        ["37°"]),
      ans("tang-m7", "A right triangle has opposite side 12 and hypotenuse 13. Find the angle to the nearest degree.", "\\sin^{-1}\\!\\left(\\tfrac{12}{13}\\right)", "67", 4,
      ...
      ans("tang-m9", "A right triangle has adjacent side 8 and hypotenuse 17. Find the angle to the nearest degree.", "\\cos^{-1}\\!\\left(\\tfrac{8}{17}\\right)", "62", 4,
        "Adjacent and hypotenuse → cos⁻¹.", "cos θ = 8/17 = 0.4706, so θ = cos⁻¹(0.4706) = 61.9° ≈ 62°.",
        ["62°"]),
      ans("tang-m10", "A right triangle has opposite side 15 and adjacent side 8. Find the angle to the nearest degree.", "\\tan^{-1}\\!\\left(\\tfrac{15}{8}\\right)", "62", 4,
...
export function year12Standard1ElevationDepressionLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("eldep-g2", "From 80 m away, the angle of elevation to a tower top is 45°. Find the height of the tower.", "80 \\times \\tan 45^\\circ", "80", 2,
        "Height is opposite, 80 m adjacent → tangent.", "height = 80 × tan 45° = 80 × 1 = 80 m.",
        ["80 m"]),
      ans("eldep-g3", "From a point 100 m from a tower, the angle of elevation to the top is 30°. Find the height to 1 decimal place. (tan 30° = 0.5774)", "100 \\times \\tan 30^\\circ", "57.7", 2,
        "height = distance × tan(angle).", "height = 100 × tan 30° = 100 × 0.5774 = 57.7 m (1 dp).",
        ["57.7 m"]),
      ans("eldep-g4", "The angle of depression from a cliff top to a boat equals the angle of elevation from the boat to the cliff top. True or false?", "\\text{alternate angles}", "true", 2,
    ...
    independentPractice: [
      ans("eldep-i1", "From 50 m away, the angle of elevation to a flagpole top is 60°. Find the height to 1 decimal place. (tan 60° = 1.7321)", "50 \\times \\tan 60^\\circ", "86.6", 3,
      ...
      ans("eldep-i3", "A bird is 40 m high and 40 m horizontally from an observer. Find the angle of elevation to the bird.", "\\tan^{-1}\\!\\left(\\tfrac{40}{40}\\right)", "45", 3,
        "tan(angle) = height/distance, then inverse.", "tan θ = 40/40 = 1, so θ = tan⁻¹(1) = 45°.",
        ["45°"]),
      ans("eldep-i4", "From a 30 m cliff, the angle of depression to a boat is 30°. Find the boat's horizontal distance from the base to 1 decimal place. (tan 30° = 0.5774)", "\\frac{30}{\\tan 30^\\circ}", "52.0", 3,
        "tan(angle) = height/distance, so distance = height ÷ tan.", "distance = 30 ÷ tan 30° = 30 ÷ 0.5774 = 52.0 m (1 dp).",
        ["52 m", "52.0 m"]),
      ans("eldep-i5", "From the top of a 25 m building, the angle of depression to a car is 45°. Find the car's horizontal distance from the base.", "\\frac{25}{\\tan 45^\\circ}", "25", 3,
        "distance = height ÷ tan(angle).", "distance = 25 ÷ tan 45° = 25 ÷ 1 = 25 m.",
        ["25 m"]),
    ],
    masteryQuiz: [
      ans("eldep-m1", "From 120 m away, the angle of elevation to a tower top is 45°. Find the height.", "120 \\times \\tan 45^\\circ", "120", 2,
      ...
      ans("eldep-m3", "From 90 m away, the angle of elevation to a tower top is 30°. Find the height to 1 decimal place. (tan 30° = 0.5774)", "90 \\times \\tan 30^\\circ", "52.0", 3,
        "height = distance × tan(angle).", "height = 90 × tan 30° = 90 × 0.5774 = 52.0 m (1 dp).",
        ["52 m", "52.0 m"]),
      ans("eldep-m4", "From a 60 m cliff, the angle of depression to a boat is 45°. Find the boat's horizontal distance from the base.", "\\frac{60}{\\tan 45^\\circ}", "60", 3,
      ...
      ans("eldep-m6", "From 20 m away, the angle of elevation to a tree top is 60°. Find the height to 1 decimal place. (tan 60° = 1.7321)", "20 \\times \\tan 60^\\circ", "34.6", 3,
        "height = distance × tan(angle).", "height = 20 × tan 60° = 20 × 1.7321 = 34.6 m (1 dp).",
        ["34.6 m"]),
      ans("eldep-m7", "From 100 m away, the angle of elevation to a tower top is 30°. Find the height to the nearest metre. (tan 30° = 0.5774)", "100 \\times \\tan 30^\\circ", "58", 4,
      ...
      ans("eldep-m9", "A kite is on a 50 m string at an angle of elevation of 40°. Find the kite's height to 1 decimal place. (sin 40° = 0.6428)", "50 \\times \\sin 40^\\circ", "32.1", 4,
        "The string is the hypotenuse; height is opposite → sine.", "height = 50 × sin 40° = 50 × 0.6428 = 32.1 m (1 dp).",
        ["32.1 m"]),
      ans("eldep-m10", "From a 50 m lighthouse, the angle of depression to a boat is 25°. Find the boat's horizontal distance from the base to the nearest metre. (tan 25° = 0.4663)", "\\frac{50}{\\tan 25^\\circ}", "107", 4,
