...
const projectileMotionResistanceLesson: Partial<ExplicitLesson> = {
  ...
  masteryQuizPool: [
    ...
    { ...mechTyped("y12e2-mech-proj-pool-11", "Horizontal speed vx = vx0·exp(−kt). After TWO half-life intervals (t = 2·(ln2)/k) the speed is vx0·(1/2)² = vx0/4. For vx0 = 40 m/s, find vx.", "v_x = v_{x0}(\\tfrac12)^2", "10", ["10 m/s"], "Two halvings give vx0/4 = 40/4 = 10 m/s."), difficulty: 5 },
