...
export function year11AdvancedWorkingFunctionsLessonOverride(
  ...
  if (lesson.slug === "linear-quadratic-cubic-functions") {
    return {
      ...
      independentPractice: [
        ...
        formulaAnswer("y11adv-lqc-i2", "For the displayed function, give the positive x-intercept.", "f(x)=x^2-9", "3", ["x=3", "(3,0)"]),
        ...
        formulaAnswer("y11adv-lqc-i4", "For the displayed function, find the y-intercept.", "f(x)=2x+7", "7", ["(0,7)", "y=7"]),
  ...
  if (lesson.slug === "polynomial-reciprocal-functions") {
    return {
      ...
      independentPractice: [
        ...
        formulaAnswer("y11adv-poly-i2", "For the displayed reciprocal function, enter the vertical asymptote.", "y=\\frac{1}{x+3}-2", "x=-3", ["-3"]),
        formulaAnswer("y11adv-poly-i3", "For the displayed reciprocal function, enter the horizontal asymptote.", "y=\\frac{1}{x+3}-2", "y=-2", ["-2"]),
  ...
  if (lesson.slug === "working-with-functions-exam-practice") {
    return {
      ...
      independentPractice: [
        ...
        formulaAnswer("y11adv-func-exam-i2", "For the displayed reciprocal function, enter the vertical asymptote.", "y=\\frac{1}{x-4}+1", "x=4", ["4"]),
        formulaAnswer("y11adv-func-exam-i3", "For the displayed function, enter the larger zero.", "f(x)=(x+1)(x-5)", "5", ["x=5"]),
  ...
  if (lesson.slug === "quadratic-equations-discriminant") {
    return {
      ...
      guidedPractice: [
        ...
        qa("y11adv-quad-g2", "Compute the discriminant for $3x^2 - 5x + 2 = 0$.", "", "1", "Δ = (−5)² − 4(3)(2) = 25 − 24.", "Δ = 25 − 24 = 1."),
        ...
        qa("y11adv-quad-g4", "Solve $x^2 - 2x - 8 = 0$ using the quadratic formula. Enter the positive root.", "", "4", "Δ = 4 + 32 = 36. Then x = (2 ± 6)/2.", "Δ = 36. x = (2 ± 6)/2 gives x = 4 or x = −2. The positive root is 4."),
      ],
      independentPractice: [
        ...
        qa("y11adv-quad-i3", "Compute $\\Delta$ for $x^2 - 6x + 9 = 0$.", "", "0", "Δ = 36 − 36.", "Δ = (−6)² − 4(1)(9) = 36 − 36 = 0. One repeated root."),
  ...
  if (lesson.slug === "linear-functions") {
    return {
      ...
      independentPractice: [
        qa("y11adv-lin-i1", "Find the gradient of the line through $(1,\\,3)$ and $(3,\\,7)$.", "", "2", "Rise = 7 − 3 = 4. Run = 3 − 1 = 2.", "m = (7 − 3)/(3 − 1) = 4/2 = 2."),
  ...
  if (lesson.slug === "constructing-using-functions") {
    return {
      ...
      independentPractice: [
        qa("y11adv-model-i1", "Find $n$ when $C = 36$ in the model $C = 3n + 15$.", "", "7", "Subtract 15, then divide by 3.", "3n = 21 → n = 7."),
        ...
        qa("y11adv-model-i3", "Revenue $R = 20n$, cost $C = 12n + 120$. Find the profit when $n = 20$.", "", "40", "P = 8n − 120. Substitute n = 20.", "P = 8(20) − 120 = 160 − 120 = 40."),
  ...
  if (lesson.slug === "direct-inverse-variation") {
    return {
      ...
      guidedPractice: [
        qa("y11adv-var-g1", "If $y = kx$ and $y = 20$ when $x = 5$, find $k$.", "", "4", "k = y/x.", "k = 20/5 = 4."),
        qa("y11adv-var-g2", "If $y = k/x$ and $y = 10$ when $x = 2$, find $k$.", "", "20", "k = xy.", "k = 2 times 10 = 20."),
  ...
  if (lesson.slug === "circles-semicircles") {
    return {
      ...
      guidedPractice: [
        qa("y11adv-cir-g1", "A circle centred at the origin has radius 4. What is $r^2$ in its equation $x^2 + y^2 = r^2$?", "", "16", "Square the radius.", "r² = 4² = 16, so the equation is x² + y² = 16."),
        ...
        qa("y11adv-cir-g4", "For the upper semicircle $x^2 + y^2 = 36$, find $y$ when $x = 0$.", "", "6", "y = √36.", "y = √(36 − 0) = √36 = 6."),
      ],
      independentPractice: [
  ...
  if (lesson.slug === "quadratic-inequalities") {
    return {
      ...
      guidedPractice: [
        qa("y11adv-qi-g1", "Solve $x^2-5x+6=0$. Enter the smaller root.", "x^2-5x+6=0", "2", "Factorise as (x−2)(x−3)=0.", "x²−5x+6=(x−2)(x−3). Roots: x=2 and x=3. Smaller = 2."),
        qa("y11adv-qi-g2", "Solve $x^2-5x+6=0$. Enter the larger root.", "x^2-5x+6=0", "3", "Roots are x=2 and x=3.", "Larger root = 3."),
      ...
      independentPractice: [
        qa("y11adv-qi-i1", "Solve $x^2-4x+3=0$. Enter the smaller root.", "x^2-4x+3=0", "1", "Factorise: (x−1)(x−3)=0.", "x²−4x+3=(x−1)(x−3). Roots: 1 and 3. Smaller = 1."),
        qa("y11adv-qi-i2", "Solve $x^2-4x+3=0$. Enter the larger root.", "x^2-4x+3=0", "3", "The roots are x=1 and x=3.", "Larger root = 3."),
        ...
        qa("y11adv-qi-i5", "Find the largest integer satisfying $x^2-5x+4<0$.", "x^2-5x+4<0", "3", "Solution is 1 < x < 4. Integers strictly inside: 2 and 3.", "1 < x < 4. Integers: 2 and 3. Largest = 3."),
      ],
      commonMistakes: [
  ...
  if (lesson.slug === "composite-functions") {
    return {
      ...
      guidedPractice: [
        qa("y11adv-comp-g1", "Evaluate the inner function first. $f(x)=x^2+1$, $g(x)=2x-3$. Find $g(2)$.", "", "1", "Substitute x = 2 into g(x) = 2x − 3.", "g(2) = 2(2) − 3 = 4 − 3 = 1."),
        qa("y11adv-comp-g2", "Now find $(f\\circ g)(2)$ using $g(2)=1$ and $f(x)=x^2+1$.", "", "2", "Substitute x = 1 into f(x) = x² + 1.", "f(1) = 1² + 1 = 2. So (f∘g)(2) = 2."),
        ...
        qa("y11adv-comp-g4", "$f(x)=2x+5$, $g(x)=x-3$. Evaluate $(f\\circ g)(4)$.", "", "7", "g(4) = 4 − 3 = 1. Then f(1) = 2(1) + 5.", "g(4) = 1. f(g(4)) = f(1) = 2 + 5 = 7."),
      ],
      independentPractice: [
        qa("y11adv-comp-i1", "$f(x)=x^2$, $g(x)=x+1$. Evaluate $(f\\circ g)(3)$.", "", "16", "g(3) = 4, then f(4) = 4².", "g(3) = 4. f(4) = 16. So (f∘g)(3) = 16."),
        qa("y11adv-comp-i2", "$f(x)=x^2$, $g(x)=x+1$. Evaluate $(g\\circ f)(3)$.", "", "10", "f(3) = 9, then g(9) = 9 + 1.", "f(3) = 9. g(9) = 10. So (g∘f)(3) = 10."),
        ...
        qa("y11adv-comp-i4", "$f(x)=3x-1$, $g(x)=x^2$. Evaluate $(f\\circ g)(2)$.", "", "11", "g(2) = 4, then f(4) = 12 − 1.", "g(2) = 4. f(4) = 3(4) − 1 = 11."),
        qa("y11adv-comp-i5", "$f(x)=\\sqrt{x}$, $g(x)=x-4$. What is the minimum $x$-value in the domain of $f\\circ g$?", "", "4", "For f(g(x)) = √(x−4) to be defined, x − 4 ≥ 0.", "f∘g = √(x−4). The square root requires x − 4 ≥ 0, so x ≥ 4. Minimum x is 4."),
      ],
      commonMistakes: [
  ...
  if (lesson.slug === "completing-the-square") {
    return {
      ...
      guidedPractice: [
        ...
        qa("y11adv-cts-g4", "Find the x-coordinate of the vertex of $f(x) = x^2 + 4x - 3$.", "f(x) = x^2 + 4x - 3", "-2", "Complete the square: (x+2)² − 7. Vertex x-coordinate is −2.", "f(x) = (x+2)² − 4 − 3 = (x+2)² − 7. Vertex is (−2, −7). x-coordinate = −2.", ["-2", "−2"]),
      ],
      independentPractice: [
        qa("y11adv-cts-i1", "Find $k$ for $x^2 + 2x + 5 = (x+1)^2 + k$.", "x^2 + 2x + 5 = (x+1)^2 + k", "4", "Expand (x+1)² = x²+2x+1. Then k = 5 − 1.", "k = 5 − 1 = 4."),
        qa("y11adv-cts-i2", "Find the y-coordinate of the vertex of $f(x) = x^2 - 6x + 2$.", "f(x) = x^2 - 6x + 2", "-7", "Complete the square: (x−3)² − 7. Vertex y-coordinate is −7.", "f(x) = (x−3)² − 9 + 2 = (x−3)² − 7. Vertex y-coordinate = −7.", ["-7", "−7"]),
        qa("y11adv-cts-i3", "Solve $x^2 + 2x - 8 = 0$ by completing the square. Enter the positive root.", "x^2 + 2x - 8 = 0", "2", "(x+1)² − 1 − 8 = 0 → (x+1)² = 9 → x = −1 ± 3.", "(x+1)² = 9 → x = −1 + 3 = 2 or x = −1 − 3 = −4. Positive root = 2."),
        ...
        qa("y11adv-cts-i5", "Find $k$ for $3x^2 - 12x + 7 = 3(x-2)^2 + k$.", "", "-5", "3(x−2)² = 3x² − 12x + 12. So k = 7 − 12.", "3(x−2)² = 3x² − 12x + 12. k = 7 − 12 = −5.", ["-5", "−5"]),
      ],
      commonMistakes: [
