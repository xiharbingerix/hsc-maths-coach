...
export function year11AdvancedIntroductionDifferentiationLessonOverride(
  ...
  if (lesson.slug === "curve-sketching-calculus") {
    ...
    return {
      ...
      masteryQuiz: [
        formulaAnswer("y11adv-curve-m1", "For f(x)=x^3-3x, give the local minimum coordinate.", "", "(1,-2)", ["(1, -2)"]),
        formulaAnswer("y11adv-curve-m2", "For f(x)=x^3-3x, state an interval where the function is concave up.", "", "x > 0", ["x>0", "(0, infinity)", "(0, \\infty)"]),
        formulaAnswer("y11adv-curve-m3", "For f(x)=x^3-3x, state an interval where the function is concave down.", "", "x < 0", ["x<0", "(-infinity, 0)", "(-\\infty, 0)"]),
        ...
        formulaAnswer("y11adv-curve-m5", "For f'(x)=3(x-2)(x+1), state the bounded interval where f is decreasing.", "", "-1 < x < 2", ["(-1, 2)", "-1<x<2"]),
        ...
        formulaAnswer("y11adv-curve-m7", "For f(x)=x^3-3x, find the x-coordinate of the point of inflection.", "", "0", ["x=0"]),
        ...
        formulaAnswer("y11adv-curve-m9", "For $y=(x-2)^2-1$, state the range feature from the local minimum.", "", "y >= -1", ["y>=-1", "y \\ge -1", "minimum y=-1", "minimum value -1"]),
  ...
  if (lesson.slug === "introduction-differentiation-exam-practice") {
    return {
      ...
      masteryQuiz: [
        ...
        practicalChoice("y11adv-id-exam-m7", "For f(x)=x^3-3x, classify the stationary point at x=1.", "C", ["Local maximum", "Point of inflection", "Local minimum", "Not stationary"], "f''(1)=6>0, so the stationary point is a local minimum.", ""),
        formulaAnswer("y11adv-id-exam-m8", "For f(x)=x^3-3x, state the interval where f is decreasing.", "", "-1 < x < 1", ["(-1, 1)", "-1<x<1"]),
        ...
        formulaAnswer("y11adv-id-exam-m10", "For f(x)=x^3-3x, give the local maximum coordinate.", "", "(-1,2)", ["(-1, 2)"]),
      ],
      multiPartPractice: [
        {
