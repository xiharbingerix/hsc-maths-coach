...
const lfGuided: PracticeQuestion[] = [
  fa("y11adv-bd-lf-g1", "Given r = 0.6, s_y = 10, s_x = 4, find the slope b of the least squares line.", "", "b = 1.5", ["1.5"]),
  ...
  fa("y11adv-bd-lf-g3", "If b = 2.5 and ȳ = 30, x̄ = 8, find the y-intercept a.", "", "a = 10", ["10"]),
...
const lfIndep: PracticeQuestion[] = [
  fa("y11adv-bd-lf-i1", "Given r = −0.75, s_y = 8, s_x = 5, x̄ = 10, ȳ = 20. Find the regression equation y = a + bx.", "", "y = 32 − 1.2x", ["y=32-1.2x"]),
  ...
  fa("y11adv-bd-lf-i5", "Summary stats: x̄ = 5, ȳ = 14, r = 0.9, s_x = 2, s_y = 6. Find the regression equation.", "", "y = 0.5 + 2.7x", ["y=0.5+2.7x"]),
];
...
const lfMastery: PracticeQuestion[] = [
  ...
  fa("y11adv-bd-lf-m5", "A regression line y = 3 + 0.5x is fitted to data on x = hours of revision and y = exam mark. Predict y when x = 20.", "", "y = 13", ["13"]),
  ...
  fa("y11adv-bd-lf-m7", "Data on advertising spend x ($000) and sales y ($000): x̄ = 8, ȳ = 50, r = 0.75, s_x = 3, s_y = 16. Find the slope b.", "", "b = 4", ["4"]),
...
const ieGuided: PracticeQuestion[] = [
  ...
  fa("y11adv-bd-ie-g2", "The regression line is y = 4 + 3x. An actual data point is (5, 22). Find the residual.", "", "residual = 3", ["3", "+3"]),
...
const ieIndep: PracticeQuestion[] = [
  fa("y11adv-bd-ie-i1", "y = 20 − 1.5x. Predict ŷ when x = 6.", "", "ŷ = 11", ["11"]),
  ...
  fa("y11adv-bd-ie-i3", "y = 8 + 2x and the actual point is (10, 25). Find the residual and state whether the point is above or below the line.", "", "residual = −3; point is below the line", ["−3, below", "-3, below"]),
...
const ieMastery: PracticeQuestion[] = [
  ...
  fa("y11adv-bd-ie-m2", "y = 3 + 0.4x. Actual value at x = 20 is y = 14. Find the residual.", "", "residual = 3", ["3", "+3"]),
  ...
  fa("y11adv-bd-ie-m4", "A regression line y = 100 + 5x is based on data with x ∈ [0, 20]. A student predicts y at x = 50. State the prediction and explain why it may be unreliable.", "", "ŷ = 350; this is extrapolation — the pattern may not continue beyond x = 20", ["350; extrapolation"]),
  ...
  fa("y11adv-bd-ie-m6", "y = 50 + 2.5x. x ∈ [10, 40]. Find ŷ at x = 30 and classify as interpolation or extrapolation.", "", "ŷ = 125; interpolation", ["125; interpolation"]),
...
const dtGuided: PracticeQuestion[] = [
  ...
  fa("y11adv-bd-dt-g2", "If we fit log(y) = 1.2 + 0.5x, what is the back-transformed model (in terms of y and x)?", "", "y = 10^{1.2 + 0.5x}", ["y=10^(1.2+0.5x)"]),
  ...
  fa("y11adv-bd-dt-g4", "After a log transformation, data gives the linear model log(y) = 0.8 + 0.3x. Predict y when x = 4.", "", "y = 100", ["100"]),
];
...
const exMastery: PracticeQuestion[] = [
  fa("y11adv-bd-ex-m1", "x̄ = 10, ȳ = 50, r = 0.75, s_x = 4, s_y = 20. Find the regression line y = a + bx.", "", "y = 12.5 + 3.75x", ["y=12.5+3.75x"]),
  ...
  fa("y11adv-bd-ex-m3", "An actual value at x = 14 is y = 60. Find the residual for the model y = 12.5 + 3.75x.", "", "residual = −5", ["-5"]),
  ...
  fa("y11adv-bd-ex-m5", "log(y) = 1.8 + 0.15x. Find y when x = 6.", "", "y ≈ 501", ["501", "10^2.7"]),
  mc("y11adv-bd-ex-m6", "A plot of (x, y) is non-linear, but (√x, y) gives a linear pattern with equation y = 3 + 8√x. Predict y when x = 25.", "B",
    [{ label: "A", text: "$y = 3 + 8(25) = 203$" }, { label: "B", text: "$y = 3 + 8\\sqrt{25} = 43$" }, { label: "C", text: "$y = 8 + 3\\sqrt{25} = 23$" }, { label: "D", text: "$y = 8\\sqrt{25} = 40$" }],
