  ...
  if (lesson.slug === "arithmetic-series-sigma-notation") {
    return {
      ...
      masteryQuiz: [
        ...
        sequenceChoice("y11adv-seq-aseries-m7", "For the list 3, 7, 11, 15, which expression represents the corresponding series?", "B", ["3, 7, 11, 15", "3 + 7 + 11 + 15", "the 4th term, 15", "the common difference, 4"], "A sequence is the list of terms (3, 7, 11, 15); the corresponding series is their sum, 3 + 7 + 11 + 15."),
