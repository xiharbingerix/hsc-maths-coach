...
const crvGuided: PracticeQuestion[] = [
  ...
  fa("y11adv-cp-crv-g2", "f(x) = c on [0, 5] (uniform). Find c so that f is a valid pdf.", "", "c = 1/5", ["1/5"]),
...
const crvIndep: PracticeQuestion[] = [
  fa("y11adv-cp-crv-i1", "f(x) = kx² on [0, 3]. Find k.", "", "k = 1/9", ["1/9"]),
  ...
  fa("y11adv-cp-crv-i3", "f(x) = (1/2)x on [0, 2]. Find P(0 ≤ X ≤ 1).", "", "P = 1/4", ["1/4"]),
...
const crvMastery: PracticeQuestion[] = [
  ...
  fa("y11adv-cp-crv-m3", "f(x) = k(4−x) on [0, 4]. Find k and P(X > 2).", "", "k = 1/8; P(X>2) = ∫₂⁴ (4-x)/8 dx = 1/4", ["k=1/8; P=1/4"]),
  ...
  fa("y11adv-cp-crv-m5", "X is uniform on [3, 9]. Find the mean μ and variance σ².", "", "μ = 6; σ² = 3", ["μ=6; σ²=3"]),
  ...
  fa("y11adv-cp-crv-m7", "f(x) = 3x² on [0, 1]. Find the median m (where P(X ≤ m) = 0.5).", "", "m³ = 0.5, so m = (1/2)^(1/3) ≈ 0.794", ["0.794", "(0.5)^(1/3)"]),
...
const ndGuided: PracticeQuestion[] = [
  ...
  fa("y11adv-cp-nd-g2", "X ~ N(100, 15²). What interval contains 68% of values?", "", "85 to 115", ["85 to 115", "(85, 115)"]),
  ...
  fa("y11adv-cp-nd-g4", "Test scores are N(72, 10²). What percentage score below 52 or above 92?", "", "5% (100% − 95%)", ["5%"]),
];

const ndIndep: PracticeQuestion[] = [
  fa("y11adv-cp-nd-i1", "X ~ N(50, 4²). Find P(42 < X < 58).", "", "95%", ["95%"]),
  ...
  fa("y11adv-cp-nd-i3", "Rainfall is N(600 mm, 80²). Find the interval containing the middle 99.7% of years.", "", "360 mm to 840 mm", ["360 to 840"]),
...
const ndMastery: PracticeQuestion[] = [
  fa("y11adv-cp-nd-m1", "X ~ N(80, 10²). Find P(60 < X < 110) using the empirical rule.", "", "P = 95%/2 + 99.7%/2 = 47.5% + 49.85% = 97.35%", ["97.35%"]),
  ...
  fa("y11adv-cp-nd-m3", "N(μ=200, σ=25). What value is exceeded by only 0.15% of the distribution?", "", "275", ["275"]),
  ...
  fa("y11adv-cp-nd-m5", "Lifetimes of batteries: N(300 hours, 20²). Find the proportion lasting between 260 and 340 hours.", "", "95%", ["95%"]),
  ...
  fa("y11adv-cp-nd-m7", "N(50, 5²). What % of values are between 45 and 55, given the 68% rule?", "", "68%", ["68%"]),
...
const zsGuided: PracticeQuestion[] = [
  fa("y11adv-cp-zs-g1", "Find the z-score for X = 45 in a N(50, 5²) distribution.", "", "z = −1", ["-1"]),
  ...
  fa("y11adv-cp-zs-g3", "X has μ = 100 and σ = 15. If z = −2, find X.", "", "X = 70", ["70"]),
...
const zsIndep: PracticeQuestion[] = [
  fa("y11adv-cp-zs-i1", "X ~ N(200, 30²). Find z if X = 245.", "", "z = 1.5", ["1.5"]),
  ...
  fa("y11adv-cp-zs-i3", "Heights are N(175, 7²). A man is 189 cm. Find his z-score.", "", "z = 2", ["2"]),
  ...
  fa("y11adv-cp-zs-i5", "Two tests: Test A (μ=60, σ=10, score=75) and Test B (μ=80, σ=6, score=92). Compare relative performance.", "", "zA=1.5; zB=2.0. Test B is better relative to class.", ["Test B better; zA=1.5, zB=2.0"]),
];

const zsMastery: PracticeQuestion[] = [
  fa("y11adv-cp-zs-m1", "X ~ N(50, 8²). Find X when z = −1.5.", "", "X = 38", ["38"]),
  ...
  fa("y11adv-cp-zs-m3", "A factory produces bolts with diameter N(10 mm, 0.1²). A bolt is accepted if its z-score is between −2 and 2. Find the acceptance range.", "", "9.8 mm to 10.2 mm", ["9.8 to 10.2"]),
  ...
  fa("y11adv-cp-zs-m5", "Test scores N(65, 12²). What score corresponds to z = 1.25?", "", "X = 80", ["80"]),
  ...
  fa("y11adv-cp-zs-m7", "N(μ, σ²). If the value at z = 2 is 84 and z = −1 is 66, find μ and σ.", "", "σ = 6; μ = 72", ["σ=6, μ=72"]),
...
const ntGuided: PracticeQuestion[] = [
  ...
  fa("y11adv-cp-nt-g4", "Weights are N(68 kg, 9²). Find P(weight < 50 kg) using z = (50−68)/9 ≈ −2.0.", "", "P ≈ 0.0228 (2.28%)", ["0.0228", "2.28%"]),
];
...
const ntIndep: PracticeQuestion[] = [
  ...
  fa("y11adv-cp-nt-i5", "Exam scores N(65, 12²). Find the minimum score in the top 10%.", "", "X = 65 + 1.28(12) ≈ 80.4", ["80.4"]),
];

const ntMastery: PracticeQuestion[] = [
  fa("y11adv-cp-nt-m1", "P(−1.5 < Z < 2.0) = P(Z < 2.0) − P(Z < −1.5). Evaluate.", "", "0.9772 − 0.0668 = 0.9104", ["0.9104"]),
  ...
  fa("y11adv-cp-nt-m3", "Machine bolts: N(20 mm, 0.3²). Bolts are rejected if X < 19.4 mm. Find the rejection rate.", "", "P(Z<−2) = 0.0228 = 2.28%", ["0.0228", "2.28%"]),
  ...
  fa("y11adv-cp-nt-m5", "N(μ=75, σ=10). Find P(60 < X < 90).", "", "P = 0.9332 − 0.0668 = 0.8664 (86.64%)", ["0.8664", "86.64%"]),
  ...
  fa("y11adv-cp-nt-m7", "IQ scores N(100, 15²). What IQ puts a person in the top 2.5%?", "", "X ≈ 129.4", ["129.4"]),
...
const cpExGuided: PracticeQuestion[] = [
  ...
  fa("y11adv-cp-ex-g2", "X ~ N(45, 6²). Find P(33 < X < 57) using the empirical rule.", "", "95%", ["95%"]),
  fa("y11adv-cp-ex-g3", "X ~ N(80, 10²). Find the z-score for X = 65.", "", "z = −1.5", ["-1.5"]),
...
const cpExIndep: PracticeQuestion[] = [
  fa("y11adv-cp-ex-i1", "f(x) = k(2x − x²) on [0, 2]. Find k and P(0 < X < 1).", "", "k=3/4; P(0<X<1) = 1/2", ["k=3/4; P=1/2"]),
  ...
  fa("y11adv-cp-ex-i3", "X ~ N(72, 9²). Comparing to Y ~ N(50, 5²), which is more extreme: X = 81 or Y = 60?", "", "Y = 60 is more extreme (z = 2 > 1)", ["Y = 60 is more extreme"]),
  ...
  fa("y11adv-cp-ex-i5", "Reaction times: N(250 ms, 20²). Find P(X > 290 ms).", "", "P(Z>2) = 1 − 0.9772 = 0.0228 (2.28%)", ["0.0228", "2.28%"]),
];

const cpExMastery: PracticeQuestion[] = [
  fa("y11adv-cp-ex-m1", "f(x) = 3x²/8 on [0, 2]. Find P(X > 1).", "", "= [x³/8]₁² = 8/8 − 1/8 = 7/8", ["7/8"]),
  ...
  fa("y11adv-cp-ex-m7", "Wages at a company: N($1200, $150²). At least what wage do the top 5% earn?", "", "≈$1446.75", ["1446.75"]),
