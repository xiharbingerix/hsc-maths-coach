...
const completedLessonConfigs = [
  {
    slug: "index-laws-exponential-functions",
    masteryIdPattern: /^y11adv-exp-index-qm\d+$/,
  },
  {
    slug: "logarithms-logarithm-laws",
    masteryIdPattern: /^y11adv-exp-log-qm\d+$/,
  },
  {
    slug: "solving-exponential-logarithmic-equations",
    masteryIdPattern: /^y11adv-exp-solve-qm\d+$/,
  },
  {
    slug: "graphing-exponential-logarithmic-functions",
    masteryIdPattern: /^y11adv-exp-graph-qm\d+$/,
  },
  {
    slug: "exponential-logarithmic-modelling",
    masteryIdPattern: /^y11adv-exp-model-qm\d+$/,
  },
  {
    slug: "exponential-logarithmic-functions-exam-practice",
    masteryIdPattern: /^y11adv-exp-exam-qm\d+$/,
  },
] as const;
...
test("completed Exponential and Logarithmic Functions mastery sets meet the rich-task profile", () => {
...
test("completed Exponential and Logarithmic Functions authored difficulty survives mapping", () => {
...
test("completed Exponential and Logarithmic Functions practice is unique and operationally complete", () => {
  const lessons = completedLessons();
...
test("completed exponential/logarithmic multipart tasks have worked feedback and answer variants", () => {
