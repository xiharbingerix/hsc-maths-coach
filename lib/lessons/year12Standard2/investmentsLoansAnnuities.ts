...
export function year12Standard2FinanceLessonOverride(
  ...
  if (lesson.slug === "investment-compound-interest") {
    return {
      ...
      masteryQuiz: [
        ...
        moneyAnswer("y12s2-invest-m2", "A 1000 dollar account earns 6% p.a. compounded annually for 2 years. Find the balance.", "P=\\$1000,\\quad r=6\\%,\\quad n=2\\text{ yr}", "1123.60", ["1123.6", "$1123.6"]),
        moneyAnswer("y12s2-invest-m3", "A 2500 dollar investment earns 4% p.a. compounded annually for 3 years. Find the balance to the nearest cent.", "P=\\$2500,\\quad r=4\\%,\\quad n=3\\text{ yr}", "2812.16"),
        ...
        moneyAnswer("y12s2-invest-m6", "A 6000 dollar investment at 3% p.a. compounded annually is worth what after 1 year?", "P=\\$6000,\\quad r=3\\%,\\quad n=1\\text{ yr}", "6180"),
  ...
  if (lesson.slug === "depreciation-loans") {
    return {
      ...
      masteryQuiz: [
        ...
        moneyAnswer("y12s2-loan-m2", "A bike worth 900 dollars depreciates by 10% in one year. Find its value after one year.", "V_0=\\$900,\\quad \\text{depreciation}=10\\%", "810"),
        moneyAnswer("y12s2-loan-m3", "A car worth 18000 dollars depreciates by 12% p.a. for 2 years. Find its value.", "V_0=\\$18{,}000,\\quad r=12\\%,\\quad n=2\\text{ yr}", "13939.20", ["13939.2", "$13939.2"]),
        ...
        moneyAnswer("y12s2-loan-m6", "A camera worth 1500 dollars depreciates by 25% in one year. Find its value.", "V_0=\\$1500,\\quad \\text{depreciation}=25\\%", "1125"),
  ...
  if (lesson.slug === "annuities-regular-payments") {
    return {
      ...
      masteryQuiz: [
        ...
        moneyAnswer("y12s2-ann-m4", "A saver deposits 400 dollars at the end of each year. After the first deposit earns 5%, a second deposit is made. Find the balance after the second deposit.", "\\text{deposit}=\\$400,\\quad r=5\\%", "820"),
        ...
        moneyAnswer("y12s2-ann-m7", "A savings account has 900 dollars. It earns 1% interest then receives a 100 dollar deposit. Find the new balance.", "\\text{balance}=\\$900,\\quad r=1\\%,\\quad \\text{deposit}=\\$100", "1009"),
        moneyAnswer("y12s2-ann-m8", "A regular deposit plan adds 75 dollars each month for 6 months with no interest. What is contributed in total?", "\\text{monthly deposit}=\\$75,\\quad \\text{months}=6", "450"),
  ...
  return {
    ...
    masteryQuiz: [
      ...
      moneyAnswer("y12s2-fin-exam-m3", "An investment of 2500 dollars earns 4% p.a. compounded annually for 2 years. Find the balance.", "P=\\$2500,\\quad r=4\\%,\\quad n=2\\text{ yr}", "2704"),
      moneyAnswer("y12s2-fin-exam-m4", "A device worth 1600 dollars depreciates by 20% in one year. Find its value.", "V_0=\\$1600,\\quad \\text{depreciation}=20\\%", "1280"),
