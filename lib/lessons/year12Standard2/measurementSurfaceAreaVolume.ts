...
export function year12Standard2MeasurementSAVLessonOverride(
  ...
  if (lesson.slug === "surface-area-prisms-cylinders") {
    return {
      ...
      guidedPractice: [
        measurementAnswer("y12s2-sa-g1", "Find the total surface area of a rectangular prism with l = 6, w = 4, h = 2 (all in cm).", "", "88 cm^2", ["88", "88cm²", "88 cm2"]),
        measurementAnswer("y12s2-sa-g2", "Find the area of one circular end of a cylinder with r = 3 cm.", "", "9π cm^2", ["9pi cm²", "28.27 cm^2", "28.3 cm^2"]),
      ...
      independentPractice: [
        measurementAnswer("y12s2-sa-i1", "Find the TSA of a rectangular prism: l = 10 cm, w = 6 cm, h = 4 cm.", "", "248 cm^2", ["248", "248cm²"]),
        measurementAnswer("y12s2-sa-i2", "Find the TSA of a closed cylinder with r = 7 cm, h = 15 cm. Give your answer to 1 decimal place.", "", "967.6 cm^2", ["967.6", "967.6 cm2", "967.6cm²"]),
        measurementAnswer("y12s2-sa-i3", "A triangular prism has equilateral triangular faces with base 6 cm and height 5.2 cm. The prism length is 10 cm. Find the TSA.", "", "211.2 cm^2", ["211.2", "211.2 cm2"]),
        ...
        measurementAnswer("y12s2-sa-i5", "Find the TSA of a cube with side length 9 cm.", "", "486 cm^2", ["486", "486cm²"]),
      ],
      commonMistakes: [
      ...
      masteryQuiz: [
        measurementAnswer("y12s2-sa-m1", "Find the TSA of a rectangular prism: l = 5, w = 3, h = 2 (all in cm).", "", "62 cm^2", ["62", "62cm²"]),
        ...
        measurementAnswer("y12s2-sa-m3", "TSA of a closed cylinder with r = 2 cm and h = 8 cm. Give exact answer in terms of π.", "", "40π cm^2", ["40pi cm²", "40π"]),
        measurementAnswer("y12s2-sa-m4", "A storage box (no lid): l = 20, w = 15, h = 10 (all in cm). Find the open TSA.", "", "1000 cm^2", ["1000", "1000cm²"]),
        ...
        measurementAnswer("y12s2-sa-m6", "Find the TSA of a rectangular prism: l = 12, w = 9, h = 6 (all in cm).", "", "468 cm^2", ["468", "468cm²"]),
        measurementAnswer("y12s2-sa-m7", "Find the curved surface area of a cylinder with diameter 10 cm and height 25 cm.", "", "250π cm^2", ["250pi cm²", "785.4 cm^2"]),
        practicalChoice("y12s2-sa-m8", "A rectangular prism has l = w = h = 4 cm. Its TSA is:", "A", ["96 cm²", "64 cm²", "48 cm²", "192 cm²"], "TSA = 6 × 4² = 6 × 16 = 96 cm²."),
        measurementAnswer("y12s2-sa-m9", "A cylinder has r = 6 cm and h = 20 cm. Find TSA to 1 decimal place.", "", "980.2 cm^2", ["980.2", "980.2cm²"]),
  ...
  if (lesson.slug === "volume-prisms-cylinders-spheres") {
    return {
      ...
      guidedPractice: [
        measurementAnswer("y12s2-vol-g1", "Find the volume of a rectangular prism: l = 10, w = 4, h = 5 (all in cm).", "", "200 cm^3", ["200", "200cm³"]),
        measurementAnswer("y12s2-vol-g2", "Find the volume of a cylinder with r = 3 cm and h = 8 cm. Give exact answer in terms of π.", "", "72π cm^3", ["72pi cm³", "72π"]),
      ...
      independentPractice: [
        measurementAnswer("y12s2-vol-i1", "Find the volume of a triangular prism with triangular cross-section base 6 cm, height 4 cm and prism length 15 cm.", "", "180 cm^3", ["180", "180cm³"]),
        measurementAnswer("y12s2-vol-i2", "Find the volume of a cylinder with r = 10 cm and h = 30 cm. Give answer to 1 decimal place.", "", "9424.8 cm^3", ["9424.8", "9424.8cm³"]),
        measurementAnswer("y12s2-vol-i3", "Find the volume of a sphere with r = 3 cm to 1 decimal place.", "", "113.1 cm^3", ["113.1", "113.1cm³"]),
        measurementAnswer("y12s2-vol-i4", "A cylindrical tank has r = 0.8 m and h = 2 m. Find the volume in m³ to 2 decimal places.", "", "4.02 m^3", ["4.02", "4.02m³"]),
        measurementAnswer("y12s2-vol-i5", "The tank in i4 holds how many litres? (1 m³ = 1000 L)", "", "4020 L", ["4020", "4020L"]),
      ],
      commonMistakes: [
      ...
      masteryQuiz: [
        measurementAnswer("y12s2-vol-m1", "Find the volume of a rectangular prism: l = 8, w = 6, h = 4 (all in cm).", "", "192 cm^3", ["192", "192cm³"]),
        ...
        measurementAnswer("y12s2-vol-m3", "Find the volume of a cylinder with r = 6 cm and h = 10 cm. Give exact answer in terms of π.", "", "360π cm^3", ["360pi cm³", "360π"]),
        measurementAnswer("y12s2-vol-m4", "Find the volume of a sphere with r = 9 cm to 1 decimal place.", "", "3053.6 cm^3", ["3053.6", "3053.6cm³"]),
        practicalChoice("y12s2-vol-m5", "A volume of 2.4 m³ is how many litres?", "B", ["24 L", "2400 L", "240 L", "24000 L"], "1 m³ = 1000 L. 2.4 × 1000 = 2400 L."),
        measurementAnswer("y12s2-vol-m6", "A triangular prism: right-triangle cross-section with legs 5 and 12 cm, prism length 20 cm. Find the volume.", "", "600 cm^3", ["600", "600cm³"]),
        ...
        measurementAnswer("y12s2-vol-m8", "Find the volume of a cylinder with diameter 14 cm and h = 10 cm to 1 decimal place.", "", "1539.4 cm^3", ["1539.4", "1539.4cm³"]),
        measurementAnswer("y12s2-vol-m9", "A sphere has r = 5 cm. Find V to the nearest whole number.", "", "524 cm^3", ["524", "524cm³"]),
  ...
  if (lesson.slug === "composite-solids-practical") {
    return {
      ...
      guidedPractice: [
        measurementAnswer("y12s2-comp-g1", "A composite shape consists of a rectangular prism (10 × 4 × 6 cm) on top of a rectangular prism (10 × 8 × 4 cm). Find the total volume.", "", "560 cm^3", ["560", "560cm³"]),
        measurementAnswer("y12s2-comp-g2", "A cylindrical hole (r = 2, h = 10 cm) is drilled through a rectangular block (10 × 10 × 10 cm). Find the remaining volume to 1 decimal place.", "", "874.3 cm^3", ["874.3", "874.3cm³"]),
      ...
      independentPractice: [
        measurementAnswer("y12s2-comp-i1", "A solid consists of a triangular prism (A = 15 cm², length 20 cm) attached to a rectangular prism (20 × 8 × 6 cm). Find the total volume.", "", "1260 cm^3", ["1260", "1260cm³"]),
        measurementAnswer("y12s2-comp-i2", "A cylindrical water tank with r = 1.2 m and h = 2 m. Find the capacity in kilolitres (1 m³ = 1 kL) to 2 decimal places.", "", "9.05 kL", ["9.05", "9.05kL"]),
        measurementAnswer("y12s2-comp-i3", "A concrete step is a prism with a right-angle cross-section: two 'treads' each 30 × 15 cm and risers 15 cm tall. The step is 1.2 m (120 cm) wide. Find the volume of concrete needed.", "", "108000 cm^3", ["108000", "108000cm³"]),
        ...
        measurementAnswer("y12s2-comp-i5", "A hemisphere (half sphere, r = 5 cm) sits on top of a cylinder (r = 5, h = 10 cm). Find the total volume to 1 decimal place.", "", "1047.2 cm^3", ["1047.2", "1047.2cm³"]),
      ],
      commonMistakes: [
      ...
      masteryQuiz: [
        measurementAnswer("y12s2-comp-m1", "A composite solid: cube (5 × 5 × 5 cm) with a rectangular prism (5 × 5 × 3 cm) on top. Find total volume.", "", "200 cm^3", ["200", "200cm³"]),
        ...
        measurementAnswer("y12s2-comp-m3", "A rectangular room (5 × 4 × 3 m) needs the floor and 4 walls painted (no ceiling). Find the area in m².", "", "74 m^2", ["74", "74m²"]),
        ...
        measurementAnswer("y12s2-comp-m5", "A hemisphere with r = 9 cm. Find its volume to 1 decimal place.", "", "1526.8 cm^3", ["1526.8", "1526.8cm³"]),
        measurementAnswer("y12s2-comp-m6", "A fish tank is a rectangular prism: 80 × 40 × 50 cm. It is 3/4 full. Find the volume of water in litres.", "", "120 L", ["120", "120L"]),
        ...
        measurementAnswer("y12s2-comp-m8", "A ramp is a triangular prism: right-triangle cross-section with legs 1.2 m and 0.5 m, length 3 m. Find volume in m³.", "", "0.9 m^3", ["0.9", "0.9m³"]),
        measurementAnswer("y12s2-comp-m9", "A pool is 12 m long, 6 m wide and 2 m deep. Find the capacity in kilolitres (1 m³ = 1 kL).", "", "144 kL", ["144", "144kL"]),
