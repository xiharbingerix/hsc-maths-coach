...
const linearModelling: Partial<ExplicitLesson> = {
  ...
  masteryQuizPool: [
    ...
    ans("y9-lm-p2", "A phone plan costs $30 plus $0.10/min. Find the cost of 100 minutes.", "C=0.1m+30", "40", 5, "30 + 10 = $40.", ["$40"]),
    ans("y9-lm-p3", "A taxi charges $4 plus $2/km. Find the cost of a 12 km trip.", "C=2k+4", "28", 5, "24 + 4 = $28.", ["$28"]),
    ...
    ans("y9-lm-p7", "A gym charges $50 joining plus $20/month. Find the cost after 6 months.", "C=20m+50", "170", 5, "120 + 50 = $170.", ["$170"]),
    ...
    ans("y9-lm-p10", "A car rental is $40/day plus $0.20/km. Find the cost for 3 days and 100 km.", "C=40d+0.2k", "140", 5, "120 + 20 = $140.", ["$140"]),
  ],
  commonMistakes: [
