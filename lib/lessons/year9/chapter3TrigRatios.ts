...
const findingUnknownSides: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-fus-g1", "Find the opposite: hyp = 10, θ = 30°.", "10\\sin30", "5", 2, "10 × 0.5 = 5.", u("5")),
    ans("y9-fus-g2", "Find the adjacent: hyp = 8, θ = 60°.", "8\\cos60", "4", 2, "8 × 0.5 = 4.", u("4")),
    ans("y9-fus-g3", "Find the opposite: adj = 5, θ = 45°.", "5\\tan45", "5", 2, "5 × 1 = 5.", u("5")),
    mcq("y9-fus-g4", "To find the opposite from the hypotenuse and angle, use:", "A", ["sin", "cos", "tan", "Pythagoras"], 2, "opp = hyp × sin θ."),
  ],
  independentPractice: [
    ans("y9-fus-i1", "Find the opposite: hyp = 20, θ = 30°.", "20\\sin30", "10", 2, "20 × 0.5 = 10.", u("10")),
    ans("y9-fus-i2", "Find the adjacent: hyp = 10, θ = 60°.", "10\\cos60", "5", 2, "10 × 0.5 = 5.", u("5")),
    ans("y9-fus-i3", "Find the opposite: adj = 7, θ = 45°.", "7\\tan45", "7", 2, "7 × 1 = 7.", u("7")),
    ans("y9-fus-i4", "Find the opposite: hyp = 12, θ = 30°.", "12\\sin30", "6", 2, "12 × 0.5 = 6.", u("6")),
    mcq("y9-fus-i5", "To find the adjacent from the hypotenuse and angle, use:", "B", ["sin", "cos", "tan", "Pythagoras"], 2, "adj = hyp × cos θ."),
  ],
  masteryQuiz: [
    ans("y9-fus-m1", "Find the opposite: hyp = 8, θ = 30°.", "8\\sin30", "4", 2, "8 × 0.5 = 4.", u("4")),
    ans("y9-fus-m2", "Find the adjacent: hyp = 16, θ = 60°.", "16\\cos60", "8", 2, "16 × 0.5 = 8.", u("8")),
    ans("y9-fus-m3", "Find the opposite: adj = 9, θ = 45°.", "9\\tan45", "9", 2, "9 × 1 = 9.", u("9")),
    ans("y9-fus-m4", "Find the opposite: hyp = 30, θ = 30°.", "30\\sin30", "15", 2, "30 × 0.5 = 15.", u("15")),
    ...
    ans("y9-fus-m6", "Find the adjacent: hyp = 14, θ = 60°.", "14\\cos60", "7", 2, "14 × 0.5 = 7.", u("7")),
    ans("y9-fus-m7", "Find the opposite: adj = 4, θ = 45°.", "4\\tan45", "4", 2, "4 × 1 = 4.", u("4")),
    ans("y9-fus-m8", "Find the opposite: hyp = 100, θ = 30°.", "100\\sin30", "50", 2, "100 × 0.5 = 50.", u("50")),
    ans("y9-fus-m9", "Find the adjacent: hyp = 24, θ = 60°.", "24\\cos60", "12", 2, "24 × 0.5 = 12.", u("12")),
    ans("y9-fus-m10", "Find the opposite: adj = 6, θ = 45°.", "6\\tan45", "6", 2, "6 × 1 = 6.", u("6")),
  ],
  masteryQuizPool: [
    ans("y9-fus-p1", "Find the opposite: hyp = 10, θ = 60° (1 d.p.).", "10\\sin60", "8.7", 5, "10 × 0.866 ≈ 8.7.", u("8.7")),
    ans("y9-fus-p2", "Find the adjacent: hyp = 20, θ = 30° (1 d.p.).", "20\\cos30", "17.3", 5, "20 × 0.866 ≈ 17.3.", u("17.3")),
    ans("y9-fus-p3", "Find the opposite: hyp = 10, θ = 45° (1 d.p.).", "10\\sin45", "7.1", 5, "10 × 0.707 ≈ 7.1.", u("7.1")),
    ans("y9-fus-p4", "Find the opposite: adj = 6, θ = 30° (1 d.p.).", "6\\tan30", "3.5", 5, "6 × 0.577 ≈ 3.5.", u("3.5")),
    ans("y9-fus-p5", "Find the opposite: adj = 5, θ = 60° (1 d.p.).", "5\\tan60", "8.7", 5, "5 × 1.732 ≈ 8.7.", u("8.7")),
    ans("y9-fus-p6", "Find the adjacent: hyp = 16, θ = 45° (1 d.p.).", "16\\cos45", "11.3", 5, "16 × 0.707 ≈ 11.3.", u("11.3")),
    ans("y9-fus-p7", "Find the opposite: hyp = 25, θ = 30°.", "25\\sin30", "12.5", 5, "25 × 0.5 = 12.5.", u("12.5")),
    ans("y9-fus-p8", "Find the adjacent: hyp = 12, θ = 30° (1 d.p.).", "12\\cos30", "10.4", 5, "12 × 0.866 ≈ 10.4.", u("10.4")),
    ans("y9-fus-p9", "Find the opposite: hyp = 18, θ = 60° (1 d.p.).", "18\\sin60", "15.6", 5, "18 × 0.866 ≈ 15.6.", u("15.6")),
    ans("y9-fus-p10", "A ramp rises at 30° over a 10 m slope (hypotenuse). Find its height.", "10\\sin30", "5", 5, "10 × sin 30° = 5 m.", ["5", "5 m"]),
  ],
  commonMistakes: [
...
const solvingForDenominator: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-sfd-g1", "Find the hypotenuse: opp = 5, θ = 30°.", "5\\div\\sin30", "10", 2, "5 ÷ 0.5 = 10.", u("10")),
    ans("y9-sfd-g2", "Find the hypotenuse: adj = 4, θ = 60°.", "4\\div\\cos60", "8", 2, "4 ÷ 0.5 = 8.", u("8")),
    ans("y9-sfd-g3", "Find the hypotenuse: opp = 7, θ = 30°.", "7\\div\\sin30", "14", 3, "7 ÷ 0.5 = 14.", u("14")),
    mcq("y9-sfd-g4", "When the unknown is in the denominator, you:", "B", ["multiply", "divide", "add", "square"], 2, "Rearrange by dividing."),
  ],
  independentPractice: [
    ans("y9-sfd-i1", "Find the hypotenuse: opp = 6, θ = 30°.", "6\\div\\sin30", "12", 2, "6 ÷ 0.5 = 12.", u("12")),
    ans("y9-sfd-i2", "Find the hypotenuse: adj = 5, θ = 60°.", "5\\div\\cos60", "10", 2, "5 ÷ 0.5 = 10.", u("10")),
    ans("y9-sfd-i3", "Find the hypotenuse: opp = 9, θ = 30°.", "9\\div\\sin30", "18", 3, "9 ÷ 0.5 = 18.", u("18")),
    ans("y9-sfd-i4", "Find the hypotenuse: adj = 7, θ = 60°.", "7\\div\\cos60", "14", 3, "7 ÷ 0.5 = 14.", u("14")),
    mcq("y9-sfd-i5", "From sin θ = opp/hyp, the hypotenuse equals:", "C", ["opp × sin θ", "sin θ ÷ opp", "opp ÷ sin θ", "opp + sin θ"], 3, "hyp = opp ÷ sin θ."),
  ],
  masteryQuiz: [
    ans("y9-sfd-m1", "Find the hypotenuse: opp = 5, θ = 30°.", "5\\div\\sin30", "10", 2, "10.", u("10")),
    ans("y9-sfd-m2", "Find the hypotenuse: adj = 6, θ = 60°.", "6\\div\\cos60", "12", 2, "12.", u("12")),
    ans("y9-sfd-m3", "Find the hypotenuse: opp = 10, θ = 30°.", "10\\div\\sin30", "20", 3, "20.", u("20")),
    ans("y9-sfd-m4", "Find the hypotenuse: adj = 8, θ = 60°.", "8\\div\\cos60", "16", 3, "16.", u("16")),
    ...
    ans("y9-sfd-m6", "Find the hypotenuse: opp = 12, θ = 30°.", "12\\div\\sin30", "24", 3, "24.", u("24")),
    ans("y9-sfd-m7", "Find the hypotenuse: adj = 9, θ = 60°.", "9\\div\\cos60", "18", 3, "18.", u("18")),
    ans("y9-sfd-m8", "Find the hypotenuse: opp = 3, θ = 30°.", "3\\div\\sin30", "6", 2, "6.", u("6")),
    ans("y9-sfd-m9", "Find the hypotenuse: adj = 2, θ = 60°.", "2\\div\\cos60", "4", 2, "4.", u("4")),
  ...
  masteryQuizPool: [
    ans("y9-sfd-p1", "Find the hypotenuse: opp = 10, θ = 45° (1 d.p.).", "10\\div\\sin45", "14.1", 5, "10 ÷ 0.707 ≈ 14.1.", u("14.1")),
    ans("y9-sfd-p2", "Find the hypotenuse: adj = 10, θ = 30° (1 d.p.).", "10\\div\\cos30", "11.5", 5, "10 ÷ 0.866 ≈ 11.5.", u("11.5")),
    ans("y9-sfd-p3", "Find the hypotenuse: opp = 7, θ = 30°.", "7\\div\\sin30", "14", 5, "7 ÷ 0.5 = 14.", u("14")),
    ans("y9-sfd-p4", "Find the hypotenuse: opp = 12, θ = 60° (1 d.p.).", "12\\div\\sin60", "13.9", 5, "12 ÷ 0.866 ≈ 13.9.", u("13.9")),
    ans("y9-sfd-p5", "Find the hypotenuse: adj = 8, θ = 45° (1 d.p.).", "8\\div\\cos45", "11.3", 5, "8 ÷ 0.707 ≈ 11.3.", u("11.3")),
    ans("y9-sfd-p6", "Find the adjacent side: opp = 6, θ = 45° using tan (1 d.p.).", "6\\div\\tan45", "6", 5, "6 ÷ 1 = 6.", u("6")),
    ans("y9-sfd-p7", "Find the adjacent: opp = 5, θ = 30°, using tan (1 d.p.).", "5\\div\\tan30", "8.7", 5, "5 ÷ 0.577 ≈ 8.7.", u("8.7")),
    ans("y9-sfd-p8", "Find the hypotenuse: opp = 15, θ = 30°.", "15\\div\\sin30", "30", 5, "15 ÷ 0.5 = 30.", u("30")),
    ans("y9-sfd-p9", "Find the hypotenuse: adj = 20, θ = 60°.", "20\\div\\cos60", "40", 5, "20 ÷ 0.5 = 40.", u("40")),
    ans("y9-sfd-p10", "A kite string makes 30° with the ground; the kite is 6 m high. Find the string length.", "6\\div\\sin30", "12", 5, "6 ÷ sin 30° = 12 m.", ["12", "12 m"]),
  ],
  commonMistakes: [
