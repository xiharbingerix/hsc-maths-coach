...
const findingUnknownAngles: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-fua-g1", "sin θ = 0.5. Find θ (degrees).", "\\sin^{-1}(0.5)", "30", 2, "sin⁻¹(0.5) = 30°.", deg("30")),
    ans("y9-fua-g2", "cos θ = 0.5. Find θ (degrees).", "\\cos^{-1}(0.5)", "60", 2, "cos⁻¹(0.5) = 60°.", deg("60")),
    ans("y9-fua-g3", "tan θ = 1. Find θ (degrees).", "\\tan^{-1}(1)", "45", 2, "tan⁻¹(1) = 45°.", deg("45")),
  ...
  independentPractice: [
    ans("y9-fua-i1", "sin θ = 0.5. Find θ.", "\\sin^{-1}(0.5)", "30", 2, "30°.", deg("30")),
    ans("y9-fua-i2", "tan θ = 1. Find θ.", "\\tan^{-1}(1)", "45", 2, "45°.", deg("45")),
    ans("y9-fua-i3", "cos θ = 0.5. Find θ.", "\\cos^{-1}(0.5)", "60", 2, "60°.", deg("60")),
    ans("y9-fua-i4", "Opposite 3, adjacent 4. Find θ (1 d.p.).", "\\tan^{-1}(0.75)", "36.9", 3, "tan⁻¹(0.75) ≈ 36.9°.", deg("36.9")),
    mcq("y9-fua-i5", "If sin θ = 0.5 then θ is:", "A", ["30°", "45°", "60°", "90°"], 2, "sin 30° = 0.5."),
  ],
  masteryQuiz: [
    ans("y9-fua-m1", "sin θ = 0.5. Find θ.", "\\sin^{-1}(0.5)", "30", 2, "30°.", deg("30")),
    ans("y9-fua-m2", "cos θ = 0.5. Find θ.", "\\cos^{-1}(0.5)", "60", 2, "60°.", deg("60")),
    ans("y9-fua-m3", "tan θ = 1. Find θ.", "\\tan^{-1}(1)", "45", 2, "45°.", deg("45")),
    mcq("y9-fua-m4", "The function sin⁻¹ gives:", "A", ["an angle", "a ratio", "a side length", "the hypotenuse"], 2, "Inverse sine returns the angle."),
    ans("y9-fua-m5", "Opposite 5, hypotenuse 10. Find θ.", "\\sin^{-1}(0.5)", "30", 3, "sin θ = 0.5 → 30°.", deg("30")),
    ans("y9-fua-m6", "Adjacent 5, hypotenuse 10. Find θ.", "\\cos^{-1}(0.5)", "60", 3, "cos θ = 0.5 → 60°.", deg("60")),
    ans("y9-fua-m7", "Opposite 4, adjacent 4. Find θ.", "\\tan^{-1}(1)", "45", 3, "tan θ = 1 → 45°.", deg("45")),
    ans("y9-fua-m8", "sin θ = 0.866. Find θ.", "\\sin^{-1}(0.866)", "60", 3, "sin⁻¹(0.866) ≈ 60°.", deg("60")),
    ans("y9-fua-m9", "cos θ = 0.866. Find θ.", "\\cos^{-1}(0.866)", "30", 3, "cos⁻¹(0.866) ≈ 30°.", deg("30")),
    mcq("y9-fua-m10", "To find θ from opposite and adjacent, use:", "C", ["sin⁻¹", "cos⁻¹", "tan⁻¹", "Pythagoras"], 2, "tan θ = opp/adj → tan⁻¹."),
  ],
  masteryQuizPool: [
    ans("y9-fua-p1", "Opposite 5, adjacent 12. Find θ (1 d.p.).", "\\tan^{-1}(5/12)", "22.6", 5, "tan⁻¹(0.4167) ≈ 22.6°.", deg("22.6")),
    ans("y9-fua-p2", "sin θ = 0.6. Find θ (1 d.p.).", "\\sin^{-1}(0.6)", "36.9", 5, "sin⁻¹(0.6) ≈ 36.9°.", deg("36.9")),
    ans("y9-fua-p3", "cos θ = 0.8. Find θ (1 d.p.).", "\\cos^{-1}(0.8)", "36.9", 5, "cos⁻¹(0.8) ≈ 36.9°.", deg("36.9")),
    ans("y9-fua-p4", "Opposite 8, adjacent 15. Find θ (1 d.p.).", "\\tan^{-1}(8/15)", "28.1", 5, "tan⁻¹(0.533) ≈ 28.1°.", deg("28.1")),
    ans("y9-fua-p5", "Opposite 7, hypotenuse 25. Find θ (1 d.p.).", "\\sin^{-1}(7/25)", "16.3", 5, "sin⁻¹(0.28) ≈ 16.3°.", deg("16.3")),
    ans("y9-fua-p6", "Adjacent 24, hypotenuse 25. Find θ (1 d.p.).", "\\cos^{-1}(24/25)", "16.3", 5, "cos⁻¹(0.96) ≈ 16.3°.", deg("16.3")),
    ans("y9-fua-p7", "tan θ = 2. Find θ (1 d.p.).", "\\tan^{-1}(2)", "63.4", 5, "tan⁻¹(2) ≈ 63.4°.", deg("63.4")),
    ans("y9-fua-p8", "Opposite 9, adjacent 12. Find θ (1 d.p.).", "\\tan^{-1}(9/12)", "36.9", 5, "tan⁻¹(0.75) ≈ 36.9°.", deg("36.9")),
    ans("y9-fua-p9", "sin θ = 0.25. Find θ (1 d.p.).", "\\sin^{-1}(0.25)", "14.5", 5, "sin⁻¹(0.25) ≈ 14.5°.", deg("14.5")),
    ans("y9-fua-p10", "A ramp rises 3 m over a 5 m slope. Find the angle of the ramp (1 d.p.).", "\\sin^{-1}(3/5)", "36.9", 5, "sin θ = 0.6 → 36.9°.", deg("36.9")),
  ],
  commonMistakes: [
...
const trigApplications: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-tap-g1", "A 20 m ramp rises at 30°. Find its height.", "20\\sin30", "10", 2, "20 × 0.5 = 10 m.", ["10", "10 m"]),
    ans("y9-tap-g2", "The angle of elevation to a tree top is 45° from 12 m away. Find the height.", "12\\tan45", "12", 2, "12 × 1 = 12 m.", ["12", "12 m"]),
    ans("y9-tap-g3", "A 10 m ladder leans at 60° to the ground. Find the height it reaches (1 d.p.).", "10\\sin60", "8.7", 3, "10 × 0.866 ≈ 8.7 m.", ["8.7", "8.7 m"]),
  ...
  independentPractice: [
    ans("y9-tap-i1", "From 30 m away the angle of elevation to a flagpole top is 30°. Find its height (1 d.p.).", "30\\tan30", "17.3", 3, "30 × 0.577 ≈ 17.3 m.", ["17.3", "17.3 m"]),
    ans("y9-tap-i2", "A slide is 8 m long at 45° to the ground. Find its height (1 d.p.).", "8\\sin45", "5.7", 3, "8 × 0.707 ≈ 5.7 m.", ["5.7", "5.7 m"]),
    ans("y9-tap-i3", "A building is 50 m high, viewed from 50 m away. Find the angle of elevation.", "\\tan^{-1}(50/50)", "45", 3, "tan⁻¹(1) = 45°.", deg("45")),
    ...
    ans("y9-tap-i5", "A 16 m ramp rises at 30°. Find its height.", "16\\sin30", "8", 2, "16 × 0.5 = 8 m.", ["8", "8 m"]),
  ],
  masteryQuiz: [
    ans("y9-tap-m1", "A 10 m ramp rises at 30°. Find its height.", "10\\sin30", "5", 2, "5 m.", ["5", "5 m"]),
    ans("y9-tap-m2", "A 45° angle of elevation is measured from 10 m away. Find the height.", "10\\tan45", "10", 2, "10 m.", ["10", "10 m"]),
    ans("y9-tap-m3", "A 12 m ladder leans at 60° to the ground. Find the height (1 d.p.).", "12\\sin60", "10.4", 3, "12 × 0.866 ≈ 10.4 m.", ["10.4", "10.4 m"]),
    ...
    ans("y9-tap-m5", "A tower is viewed from 20 m away with a 45° elevation. Find its height.", "20\\tan45", "20", 2, "20 m.", ["20", "20 m"]),
    ans("y9-tap-m6", "A 20 m slide is at 30° to the ground. Find its height.", "20\\sin30", "10", 2, "10 m.", ["10", "10 m"]),
    ans("y9-tap-m7", "From a cliff, the angle of depression to a boat 30 m away (horizontally) is 45°. Find the cliff height.", "30\\tan45", "30", 3, "30 × 1 = 30 m.", ["30", "30 m"]),
    ans("y9-tap-m8", "The angle of elevation is 60° from 10 m away. Find the height (1 d.p.).", "10\\tan60", "17.3", 3, "10 × 1.732 ≈ 17.3 m.", ["17.3", "17.3 m"]),
    ans("y9-tap-m9", "A ramp rises 5 m over a 10 m length. Find its angle.", "\\sin^{-1}(0.5)", "30", 3, "sin θ = 5/10 = 0.5 → 30°.", deg("30")),
  ...
  masteryQuizPool: [
    ans("y9-tap-p1", "A building 30 m high is seen from 40 m away. Find the angle of elevation (1 d.p.).", "\\tan^{-1}(30/40)", "36.9", 5, "tan⁻¹(0.75) ≈ 36.9°.", deg("36.9")),
    ans("y9-tap-p2", "A 15 m wire reaches the top of a pole at 60° to the ground. Find the pole's height (1 d.p.).", "15\\sin60", "13.0", 5, "15 × 0.866 ≈ 13.0 m.", ["13", "13.0", "13 m"]),
    ans("y9-tap-p3", "The angle of depression to a boat is 30° from a 50 m cliff. Find the horizontal distance (1 d.p.).", "50/\\tan30", "86.6", 5, "50 ÷ 0.577 ≈ 86.6 m.", ["86.6", "86.6 m"]),
...
const bearings: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y9-brg-g3", "Find the back bearing of 090°.", "\\text{back }090", "270", 2, "90 + 180 = 270°.", brg("270")),
  ...
  independentPractice: [
    ...
    ans("y9-brg-i2", "Find the back bearing of 120°.", "\\text{back }120", "300", 3, "120 + 180 = 300°.", brg("300")),
    ans("y9-brg-i3", "Write the bearing of NE.", "\\text{NE}", "045", 2, "045°.", brg("045")),
    ans("y9-brg-i4", "Find the back bearing of 200°.", "\\text{back }200", "020", 3, "200 − 180 = 020°.", brg("020")),
  ...
  masteryQuiz: [
    ...
    ans("y9-brg-m2", "Find the back bearing of 050°.", "\\text{back }050", "230", 3, "50 + 180 = 230°.", brg("230")),
    ans("y9-brg-m3", "Write the bearing of SW.", "\\text{SW}", "225", 2, "225°.", brg("225")),
    ans("y9-brg-m4", "Find the back bearing of 315°.", "\\text{back }315", "135", 3, "315 − 180 = 135°.", brg("135")),
    ...
    ans("y9-brg-m7", "Find the back bearing of 080°.", "\\text{back }080", "260", 3, "80 + 180 = 260°.", brg("260")),
    ans("y9-brg-m8", "Write the bearing of due south.", "\\text{south}", "180", 2, "180°.", brg("180")),
    ans("y9-brg-m9", "Find the back bearing of 170°.", "\\text{back }170", "350", 3, "170 + 180 = 350°.", brg("350")),
    mcq("y9-brg-m10", "The bearing of NW is:", "D", ["045°", "135°", "225°", "315°"], 2, "NW = 315°."),
  ],
  masteryQuizPool: [
    ans("y9-brg-p1", "Find the back bearing of 025°.", "\\text{back }025", "205", 5, "25 + 180 = 205°.", brg("205")),
    ans("y9-brg-p2", "Find the back bearing of 250°.", "\\text{back }250", "070", 5, "250 − 180 = 070°.", brg("070")),
    ans("y9-brg-p3", "B is on a bearing of 110° from A. Find the bearing of A from B.", "\\text{reverse }110", "290", 5, "110 + 180 = 290°.", brg("290")),
    ans("y9-brg-p4", "A ship turns from a bearing of 040° to 130°. Through what angle did it turn?", "130-040", "90", 5, "130 − 40 = 90°.", deg("90")),
    ans("y9-brg-p5", "Find the back bearing of 300°.", "\\text{back }300", "120", 5, "300 − 180 = 120°.", brg("120")),
    ans("y9-brg-p6", "Write the bearing of a direction halfway between north (000°) and east (090°).", "\\text{NE}", "045", 5, "NE = 045°.", brg("045")),
    ans("y9-brg-p7", "X is on a bearing of 215° from Y. Find the bearing of Y from X.", "\\text{reverse }215", "035", 5, "215 − 180 = 035°.", brg("035")),
    ans("y9-brg-p8", "A walker on 070° turns clockwise to face 160°. Find the turn angle.", "160-070", "90", 5, "160 − 70 = 90°.", deg("90")),
    ans("y9-brg-p9", "Find the back bearing of 015°.", "\\text{back }015", "195", 5, "15 + 180 = 195°.", brg("195")),
    ans("y9-brg-p10", "Two towns: B is due east of A (090°). What is the bearing of A from B?", "\\text{reverse }090", "270", 5, "90 + 180 = 270° (due west).", brg("270")),
  ],
  commonMistakes: [
