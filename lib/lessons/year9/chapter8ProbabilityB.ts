...
const treeDiagrams: Partial<ExplicitLesson> = {
  ...
  independentPractice: [
    ...
    ans("y9-td-i5", "Two players win independently with P = 0.5 and 0.4. Find P(both win).", "0.5x0.4", "0.2", 3, "0.5 × 0.4 = 0.2.", []),
  ],
  masteryQuiz: [
    ...
    ans("y9-td-m3", "P(red) = 1/2 then P(blue) = 1/3. Find P(red then blue).", "1/2x1/3", "1/6", 3, "1/2 × 1/3 = 1/6.", fr(1, 6)),
    ...
    ans("y9-td-m6", "A team wins each game with P = 0.3. Find P(win twice in a row).", "0.3^2", "0.09", 3, "0.3 × 0.3 = 0.09.", []),
    ...
    ans("y9-td-m9", "Independent events P = 0.5 and 0.6. Find P(both occur).", "0.5x0.6", "0.3", 3, "0.5 × 0.6 = 0.3.", []),
  ...
  masteryQuizPool: [
    ans("y9-td-p1", "Two coins: find P(at least one head) using the complement.", "1-P(TT)", "3/4", 5, "1 − 1/4 = 3/4.", fr(3, 4)),
    ans("y9-td-p2", "A bag: P(red) = 2/5 each draw (with replacement), drawn twice. Find P(red, red).", "(2/5)^2", "4/25", 5, "2/5 × 2/5 = 4/25.", fr(4, 25)),
    ans("y9-td-p3", "Three coins: find P(exactly two heads).", "P(2H)", "3/8", 5, "HHT, HTH, THH → 3/8.", fr(3, 8)),
    ans("y9-td-p4", "Spinner P(win) = 0.2 twice. Find P(win both).", "0.2^2", "0.04", 5, "0.2 × 0.2 = 0.04.", []),
    ans("y9-td-p5", "P(rain) = 0.3 each day. Find P(rain on both of two days).", "0.3^2", "0.09", 5, "0.09.", []),
    ans("y9-td-p6", "Two dice: find P(neither is a six).", "(5/6)^2", "25/36", 5, "5/6 × 5/6 = 25/36.", fr(25, 36)),
    ans("y9-td-p7", "Bag without replacement: 2 red of 5, draw 2. Find P(both red).", "2/5 x 1/4", "1/10", 5, "2/5 × 1/4 = 2/20 = 1/10.", fr(1, 10)),
    ans("y9-td-p8", "P(pass) = 0.9 for two independent tests. Find P(pass both).", "0.9^2", "0.81", 5, "0.81.", []),
    ans("y9-td-p9", "Two coins: find P(at least one tail).", "1-P(HH)", "3/4", 5, "1 − 1/4 = 3/4.", fr(3, 4)),
    ans("y9-td-p10", "A light works with P = 0.95 each; two independent. Find P(both work).", "0.95^2", "0.9025", 5, "0.95 × 0.95 = 0.9025.", []),
  ],
  commonMistakes: [
...
const relativeFrequencies: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-rf-g1", "20 heads in 50 tosses. Find the relative frequency.", "20/50", "0.4", 2, "20 ÷ 50 = 0.4.", ["2/5"]),
    ans("y9-rf-g2", "Expected sixes in 60 rolls, P = 1/6.", "1/6 x 60", "10", 2, "60 ÷ 6 = 10.", []),
    ans("y9-rf-g3", "15 reds in 60 draws. Find the relative frequency.", "15/60", "0.25", 2, "15 ÷ 60 = 0.25.", ["1/4"]),
  ...
  independentPractice: [
    ans("y9-rf-i1", "45 heads in 90 tosses. Find the relative frequency.", "45/90", "0.5", 2, "0.5.", ["1/2"]),
    ans("y9-rf-i2", "Expected heads in 200 tosses, P = 0.5.", "0.5x200", "100", 2, "100.", []),
    ans("y9-rf-i3", "12 sixes in 40 rolls. Find the relative frequency.", "12/40", "0.3", 2, "0.3.", ["3/10"]),
    ans("y9-rf-i4", "Expected number of 1/6 events in 120 trials.", "1/6 x 120", "20", 3, "120 ÷ 6 = 20.", []),
  ...
  masteryQuiz: [
    ans("y9-rf-m1", "30 heads in 50 tosses. Find the relative frequency.", "30/50", "0.6", 2, "0.6.", ["3/5"]),
    ans("y9-rf-m2", "Expected sixes in 60 rolls, P = 1/6.", "1/6x60", "10", 2, "10.", []),
    ans("y9-rf-m3", "18 reds in 60 draws. Find the relative frequency.", "18/60", "0.3", 2, "0.3.", ["3/10"]),
    ans("y9-rf-m4", "Expected heads in 80 tosses, P = 0.5.", "0.5x80", "40", 2, "40.", []),
    ...
    ans("y9-rf-m6", "25 wins in 100 games. Find the relative frequency.", "25/100", "0.25", 2, "0.25.", ["1/4"]),
    ans("y9-rf-m7", "Expected number of 1/4 events in 200 trials.", "1/4x200", "50", 2, "50.", []),
    ans("y9-rf-m8", "40 heads in 50 tosses. Find the relative frequency.", "40/50", "0.8", 2, "0.8.", ["4/5"]),
    ans("y9-rf-m9", "Expected number of 0.3 events in 150 trials.", "0.3x150", "45", 3, "45.", []),
  ...
  masteryQuizPool: [
    ans("y9-rf-p1", "A die rolled 300 times; expected number of 4s (P = 1/6).", "1/6x300", "50", 5, "300 ÷ 6 = 50.", []),
    ans("y9-rf-p2", "A spinner landed on red 36 of 120 spins. Estimate P(red).", "36/120", "0.3", 5, "36 ÷ 120 = 0.3.", ["3/10"]),
    ans("y9-rf-p3", "Expected number of heads in 500 tosses (P = 0.5).", "0.5x500", "250", 5, "250.", []),
    ans("y9-rf-p4", "A factory: 6 faulty in 200. Estimate P(faulty), then expected faulty in 1000.", "expected", "30", 5, "P = 0.03; 0.03 × 1000 = 30.", []),
    ans("y9-rf-p5", "A coin gave 280 heads in 400. Estimate P(head).", "280/400", "0.7", 5, "280 ÷ 400 = 0.7.", ["7/10"]),
    ans("y9-rf-p6", "Expected number of 1/5 events in 250 trials.", "1/5x250", "50", 5, "50.", []),
    ans("y9-rf-p7", "A survey: 45 of 150 prefer tea. Estimate P(tea).", "45/150", "0.3", 5, "0.3.", ["3/10"]),
    ans("y9-rf-p8", "Expected number of sixes in 240 rolls (P = 1/6).", "1/6x240", "40", 5, "40.", []),
    ans("y9-rf-p9", "A drawing pin landed point-up 120 of 200 times. Estimate P(point-up).", "120/200", "0.6", 5, "0.6.", ["3/5"]),
    ans("y9-rf-p10", "If P(win) ≈ 0.15, how many wins are expected in 400 games?", "0.15x400", "60", 5, "0.15 × 400 = 60.", []),
  ],
  commonMistakes: [
...
const dataAndSampling: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y9-ds-g3", "How many in a 1-in-10 sample of 500 people?", "500/10", "50", 2, "500 ÷ 10 = 50.", []),
  ...
  independentPractice: [
    ...
    ans("y9-ds-i2", "How many in a 1-in-20 sample of 1000 people?", "1000/20", "50", 2, "50.", []),
    ...
    ans("y9-ds-i4", "A 1-in-5 sample of 200 students is how many?", "200/5", "40", 2, "40.", []),
  ...
  masteryQuiz: [
    ...
    ans("y9-ds-m3", "How many in a 1-in-10 sample of 800?", "800/10", "80", 2, "80.", []),
    ...
    ans("y9-ds-m6", "A 1-in-25 sample of 1000 is how many?", "1000/25", "40", 3, "40.", []),
    ...
    ans("y9-ds-m8", "A 1-in-4 sample of 240 is how many?", "240/4", "60", 2, "60.", []),
  ...
  masteryQuizPool: [
    ans("y9-ds-p1", "A school of 1200 takes a 1-in-15 sample. How many students?", "1200/15", "80", 5, "1200 ÷ 15 = 80.", []),
    ans("y9-ds-p2", "A stratified sample takes 10% of each group: 200 boys and 150 girls. How many in total?", "10% of 350", "35", 5, "0.10 × 350 = 35.", []),
    ...
    ans("y9-ds-p4", "A 1-in-50 sample of 5000 is how many?", "5000/50", "100", 5, "100.", []),
    ans("y9-ds-p5", "A factory checks 2% of 4500 items. How many are checked?", "2% of 4500", "90", 5, "0.02 × 4500 = 90.", []),
    ...
    ans("y9-ds-p7", "Stratified sampling: 5% of 600 seniors and 5% of 800 juniors. Total sampled?", "5% of 1400", "70", 5, "0.05 × 1400 = 70.", []),
    ans("y9-ds-p8", "A 1-in-8 sample of 2400 is how many?", "2400/8", "300", 5, "300.", []),
    ...
    ans("y9-ds-p10", "A town of 30000 surveys 1 in 100. How many people?", "30000/100", "300", 5, "300.", []),
  ],
  commonMistakes: [
