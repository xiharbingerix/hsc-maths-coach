...
const solvingWordProblems: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-wp-g1", "A number minus 5 is 10. Find the number.", "x-5=10", "15", 2, "x = 15.", []),
    ans("y9-wp-g2", "5 times a number is 35. Find the number.", "5x=35", "7", 2, "x = 7.", []),
    ans("y9-wp-g3", "A number doubled then increased by 1 is 9. Find it.", "2x+1=9", "4", 3, "2x = 8 → x = 4.", []),
    mcq("y9-wp-g4", "‘Twice a number’ translates to:", "B", ["x + 2", "2x", "x − 2", "x/2"], 2, "Twice means × 2 → 2x."),
  ],
  independentPractice: [
    ans("y9-wp-i1", "A number plus 12 is 20. Find it.", "x+12=20", "8", 2, "x = 8.", []),
    ans("y9-wp-i2", "Three times a number is 27. Find it.", "3x=27", "9", 2, "x = 9.", []),
    ans("y9-wp-i3", "Two consecutive integers sum to 25. Find the smaller.", "n+(n+1)=25", "12", 4, "2n + 1 = 25 → n = 12.", []),
    ans("y9-wp-i4", "The perimeter of a square is 36. Find the side length.", "4s=36", "9", 3, "4s = 36 → s = 9.", []),
    mcq("y9-wp-i5", "‘5 less than a number’ translates to:", "C", ["5 − x", "5x", "x − 5", "x + 5"], 2, "Five less than x is x − 5."),
  ],
  masteryQuiz: [
    ans("y9-wp-m1", "A number plus 9 is 16. Find it.", "x+9=16", "7", 2, "x = 7.", []),
    ans("y9-wp-m2", "4 times a number is 28. Find it.", "4x=28", "7", 2, "x = 7.", []),
    ans("y9-wp-m3", "2 more than 3 times a number is 14. Find it.", "3x+2=14", "4", 3, "3x = 12 → x = 4.", []),
    ans("y9-wp-m4", "A rectangle's length is twice its width and the perimeter is 30. Find the width.", "2(2w+w)=30", "5", 4, "6w = 30 → w = 5.", []),
    mcq("y9-wp-m5", "‘A number increased by 6’ translates to:", "A", ["x + 6", "6x", "x − 6", "6 − x"], 2, "Increased by 6 → x + 6."),
    ans("y9-wp-m6", "Half a number is 8. Find it.", "\\tfrac{x}{2}=8", "16", 2, "x = 16.", []),
    ans("y9-wp-m7", "The sum of a number and 15 is 40. Find it.", "x+15=40", "25", 2, "x = 25.", []),
    ans("y9-wp-m8", "5 times a number minus 3 is 22. Find it.", "5x-3=22", "5", 3, "5x = 25 → x = 5.", []),
    ans("y9-wp-m9", "Two consecutive numbers sum to 19. Find the smaller.", "n+(n+1)=19", "9", 4, "2n + 1 = 19 → n = 9.", []),
    ans("y9-wp-m10", "A number times 6 then minus 4 is 20. Find it.", "6x-4=20", "4", 3, "6x = 24 → x = 4.", []),
  ],
  masteryQuizPool: [
    ans("y9-wp-p1", "A pen costs $x and a book costs $3 more. Together they cost $11. Find the pen's price.", "x+(x+3)=11", "4", 5, "2x + 3 = 11 → x = 4.", ["$4"]),
    ans("y9-wp-p2", "Three consecutive even numbers sum to 48. Find the smallest.", "n+(n+2)+(n+4)=48", "14", 5, "3n + 6 = 48 → n = 14.", []),
    ans("y9-wp-p3", "Tom is 4 years older than Sam. Their ages sum to 22. Find Sam's age.", "s+(s+4)=22", "9", 5, "2s + 4 = 22 → s = 9.", []),
    ans("y9-wp-p4", "A number is multiplied by 3, then 7 is added, giving 25. Find the number.", "3x+7=25", "6", 5, "3x = 18 → x = 6.", []),
    ans("y9-wp-p5", "The perimeter of a rectangle is 26 cm; the length is 5 cm more than the width. Find the width.", "2(w+(w+5))=26", "4", 5, "4w + 10 = 26 → w = 4.", ["4 cm"]),
    ans("y9-wp-p6", "Five times a number equals the number plus 16. Find the number.", "5x=x+16", "4", 5, "4x = 16 → x = 4.", []),
    ans("y9-wp-p7", "Two numbers differ by 6 and sum to 30. Find the smaller.", "x+(x+6)=30", "12", 5, "2x + 6 = 30 → x = 12.", []),
    ans("y9-wp-p8", "A father is 3 times as old as his son; the difference is 24 years. Find the son's age.", "3x-x=24", "12", 5, "2x = 24 → x = 12.", []),
    ans("y9-wp-p9", "The sum of three consecutive integers is 72. Find the middle one.", "(n-1)+n+(n+1)=72", "24", 5, "3n = 72 → n = 24.", []),
    ans("y9-wp-p10", "Apples cost $2 each. After buying some and paying a $3 bag fee, the total is $17. How many apples?", "2n+3=17", "7", 5, "2n = 14 → n = 7.", []),
  ],
  commonMistakes: [
