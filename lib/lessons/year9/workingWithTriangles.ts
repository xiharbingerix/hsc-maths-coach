...
const hypotenuse: LessonContent = {
  ...
  masteryQuiz: [
    ...
    choice("y9-tri-hyp-m3", "Which labelled side is the hypotenuse?", "A", ["AB", "AC", "BC", "There is no hypotenuse"], "AB is opposite the right angle at C.", "", triangle("Right triangle ABC with right angle at C.", { AB: "AB", AC: "AC", BC: "BC" })),
...
const shorterSide: LessonContent = {
  ...
  masteryQuiz: [
    ...
    choice("y9-tri-short-m6", "Which side label is the unknown shorter side in the displayed triangle?", "C", ["AB", "AC", "The side labelled x", "The right-angle marker"], "The diagram labels the unknown shorter side as x.", "", triangle("Right triangle with hypotenuse 17 and unknown shorter side x.", { AB: "17", AC: "8", BC: "x" })),
...
const ratios: LessonContent = {
  ...
  guidedPractice: [
    choice("y9-tri-ratio-g1", "Which side is the hypotenuse?", "A", ["AB", "AC", "BC", "Angle A"], "AB is opposite the right angle at C.", "", triangle("Right triangle ABC with right angle at C.", { AB: "AB", AC: "AC", BC: "BC" })),
    choice("y9-tri-ratio-g2", "Relative to angle theta, which side is opposite?", "C", ["AB", "AC", "BC", "The right angle"], "BC lies across from angle theta.", "", triangle("Right triangle with theta at A.", { AB: "AB", AC: "AC", BC: "BC" }, { A: "theta" })),
  ...
  independentPractice: [
    choice("y9-tri-ratio-i1", "Relative to angle theta, which side is adjacent?", "B", ["AB", "AC", "BC", "No side"], "AC touches theta and is not the hypotenuse.", "", triangle("Right triangle with theta at A.", { AB: "AB", AC: "AC", BC: "BC" }, { A: "theta" })),
  ...
  masteryQuiz: [
    ...
    choice("y9-tri-ratio-m4", "Relative to theta at A, identify the adjacent side.", "B", ["AB", "AC", "BC", "Angle C"], "AC touches theta and is not the hypotenuse.", "", triangle("Right triangle with theta at A.", { AB: "AB", AC: "AC", BC: "BC" }, { A: "theta" })),
    ...
    choice("y9-tri-ratio-m7", "Which ratio connects x and 15 in the diagram?", "B", ["Cosine", "Sine", "Tangent", "Midpoint"], "x is opposite theta and 15 is the hypotenuse.", "", triangle("Right triangle with theta at A, hypotenuse 15 and opposite side x.", { AB: "15", BC: "x" }, { A: "theta" })),
    choice("y9-tri-ratio-m8", "A student labels BC adjacent to theta at A. What is the correction?", "D", ["BC is the hypotenuse", "BC touches theta", "AC is opposite", "BC is opposite because it does not touch A"], "BC lies across from theta.", "", triangle("Right triangle with theta at A.", { AB: "AB", AC: "AC", BC: "BC" }, { A: "theta" })),
...
const findingSides: LessonContent = {
  ...
  masteryQuiz: [
    ...
    choice("y9-tri-side-m3", "Which ratio connects the marked angle, x and side 9?", "D", ["Sine", "Cosine", "Pythagoras", "Tangent"], "x is opposite and 9 is adjacent.", "", triangle("Right triangle with angle 38 degrees, adjacent side 9 and unknown opposite x.", { AC: "9", BC: "x" }, { A: "38 degrees" })),
...
const findingAngles: LessonContent = {
  ...
  masteryQuiz: [
    ...
    choice("y9-tri-angle-m4", "Which inverse ratio matches the displayed sides?", "B", ["Inverse sine", "Inverse cosine", "Inverse tangent", "Pythagoras"], "The labelled sides are adjacent and hypotenuse.", "", triangle("Right triangle with unknown theta, adjacent side 7 and hypotenuse 10.", { AB: "10", AC: "7" }, { A: "theta" })),
...
const midpointDistance: LessonContent = {
  ...
  masteryQuiz: [
    ...
    answer("y9-tri-mid-m7", "Find the midpoint of the displayed segment.", "", "(3,4)", "The endpoints are (1, 1) and (5, 7).", ["3,4", "(3, 4)", "3, 4"], undefined, segmentGraph("Coordinate plane showing segment AB from A one comma one to B five comma seven.", { x: 1, y: 1, label: "A" }, { x: 5, y: 7, label: "B" }, { xMin: 0, xMax: 6, yMin: 0, yMax: 8, xStep: 1, yStep: 1 })),
...
const gradient: LessonContent = {
  ...
  masteryQuiz: [
    ...
    answer("y9-tri-grad-m6", "Find the gradient of the displayed segment.", "", "-1", "The marked points are (-2, 4) and (3, -1), giving rise -5 and run 5.", ["m=-1"], undefined, segmentGraph("Coordinate plane showing a falling segment from A negative two comma four to B three comma negative one.", { x: -2, y: 4, label: "A" }, { x: 3, y: -1, label: "B" })),
...
const trigBearings: LessonContent = {
  ...
  masteryQuiz: [
    ...
    answer(
      ...
      "\\text{South component}=40\\cos(30^\\circ)",
      "34.6",
