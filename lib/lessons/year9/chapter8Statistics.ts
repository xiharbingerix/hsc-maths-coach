...
const interpretingDataTablesGraphs: Partial<ExplicitLesson> = {
  ...
  masteryQuizPool: [
    ...
    ans("y9-idt-p3", "A sector graph represents 360 people. The 'sport' sector has an angle of 90°. How many people like sport?", "", "90", 5, "90 ÷ 360 × 360 = 90 people (the sport sector is one quarter).", ["90 people"]),
    ans("y9-idt-p4", "A line graph of a car's distance shows: 0 h = 0 km, 1 h = 60 km, 2 h = 100 km, 3 h = 150 km. Find the average speed over the 3 hours (km/h).", "", "50", 5, "Average speed = total distance ÷ total time = 150 ÷ 3 = 50 km/h.", ["50 km/h"]),
    ans("y9-idt-p5", "A frequency table: value 1→4, 2→6, 3→8, 4→2. Find the mean using Σ(f × value) ÷ Σf.", "", "2.4", 5, "Σ(f × value) = 4 + 12 + 24 + 8 = 48; Σf = 20; mean = 48 ÷ 20 = 2.4.", ["2.40"]),
    ans("y9-idt-p6", "Two column graphs compare classes. Class A has 20 students with mean 60; Class B has 10 students with mean 75. Find the combined mean of all 30 students.", "", "65", 5, "Totals: 1200 and 750; combined = 1950 ÷ 30 = 65.", ["65 marks"]),
    ans("y9-idt-p7", "A table shows weekly rainfall (mm): Mon 4, Tue 0, Wed 12, Thu 6, Fri 8. What fraction of the week's rain fell on Wednesday? Give the simplest fraction.", "", "2/5", 5, "Total = 30 mm; Wednesday = 12 mm; 12/30 = 2/5.", ["0.4"]),
    ans("y9-idt-p8", "A column graph shows weekly profit ($): week 1 = 200, week 4 = 400. By what percentage did profit increase from week 1 to week 4?", "", "100", 5, "Increase = 200 on 200 = 100%.", ["100%"]),
    ans("y9-idt-p9", "A sector graph of a $1200 budget shows rent 50%, food 25%, other 25%. How many dollars are spent on food?", "", "300", 5, "25% of $1200 = 0.25 × 1200 = $300.", ["$300", "300 dollars"]),
    ans("y9-idt-p10", "A line graph shows a population growing by a constant percentage: 2020 = 5000, 2021 = 5500. What is the yearly percentage increase?", "", "10", 5, "Increase = 500 on 5000 = 10%.", ["10%"]),
  ],
  commonMistakes: [
