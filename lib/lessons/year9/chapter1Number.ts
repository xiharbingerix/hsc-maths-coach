...
const ratiosRatesBestBuys: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y9-rr-g2", "A car travels 120 km in 2 hours. Find the unit rate (km/h).", "", "60", 2, "120 ÷ 2 = 60 km/h.", ["60 km/h"]),
  ...
  independentPractice: [
    ...
    ans("y9-rr-i2", "Find the unit price: $12 for 4 kg ($/kg).", "", "3", 2, "12 ÷ 4 = $3/kg.", ["$3", "3/kg"]),
    ans("y9-rr-i3", "Divide $48 in the ratio 1 : 3. Give the smaller share.", "\\$48,\\ 1:3", "12", 3, "4 parts of $12; smaller = $12.", ["$12"]),
    ans("y9-rr-i4", "A printer does 90 pages in 3 minutes. Pages per minute?", "", "30", 2, "90 ÷ 3 = 30.", []),
  ...
  masteryQuiz: [
    ...
    ans("y9-rr-m2", "150 km in 3 hours — unit rate (km/h)?", "", "50", 2, "50 km/h.", ["50 km/h"]),
    ans("y9-rr-m3", "Divide $25 in the ratio 2 : 3. Larger share?", "\\$25,\\ 2:3", "15", 3, "5 parts of $5; 3×$5 = $15.", ["$15"]),
    ans("y9-rr-m4", "Unit price: $20 for 5 kg ($/kg).", "", "4", 2, "$4/kg.", ["$4"]),
    ...
    ans("y9-rr-m7", "240 words in 4 minutes — words per minute?", "", "60", 2, "60.", []),
    ...
    ans("y9-rr-m10", "Unit price: $7.50 for 3 L ($/L).", "", "2.5", 3, "7.50 ÷ 3 = $2.50/L.", ["$2.50", "2.50"]),
  ],
  masteryQuizPool: [
    ...
    ans("y9-rr-p3", "A 750 mL bottle costs $3. Find the unit price in $/L.", "", "4", 5, "750 mL = 0.75 L; 3 ÷ 0.75 = $4/L.", ["$4", "4/L"]),
    ans("y9-rr-p4", "Concrete mixes cement:sand 1:4. How much sand for 2 kg cement?", "1:4", "8", 5, "Sand = 4 × 2 = 8 kg.", ["8 kg"]),
    ans("y9-rr-p5", "A car uses 24 L for 300 km. Find L per 100 km.", "", "8", 5, "24 ÷ 300 × 100 = 8 L/100km.", ["8 L"]),
    ans("y9-rr-p6", "Best buy unit price: $11.20 for 1.4 kg ($/kg).", "", "8", 5, "11.20 ÷ 1.4 = $8/kg.", ["$8"]),
    ...
    ans("y9-rr-p9", "Paint covers 12 m² per litre. Litres for 54 m²?", "", "4.5", 5, "54 ÷ 12 = 4.5 L.", ["4.5 L"]),
