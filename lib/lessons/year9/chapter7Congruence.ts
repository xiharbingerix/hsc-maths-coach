...
const enlargementSimilar: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-es-g1", "Image 12, original 4. Find the scale factor.", "", "3", 2, "12 ÷ 4 = 3.", []),
    ans("y9-es-g2", "Enlarge a length of 5 by scale factor 2.", "", "10", 2, "10.", []),
    ans("y9-es-g3", "Image 18, original 6. Find the scale factor.", "", "3", 2, "3.", []),
    mcq("y9-es-g4", "Similar figures have angles that are:", "A", ["equal", "proportional", "supplementary", "doubled"], 2, "Equal angles."),
  ],
  independentPractice: [
    ans("y9-es-i1", "Image 20, original 5. Find the scale factor.", "", "4", 2, "4.", []),
    ans("y9-es-i2", "Enlarge a length of 7 by scale factor 3.", "", "21", 2, "21.", []),
    ans("y9-es-i3", "Reduce a length of 12 by scale factor 1/2.", "", "6", 2, "6.", []),
    mcq("y9-es-i4", "The scale factor equals:", "B", ["original ÷ image", "image ÷ original", "image × original", "image − original"], 2, "image ÷ original."),
    ans("y9-es-i5", "Image 24, original 8. Find the scale factor.", "", "3", 2, "3.", []),
  ],
  masteryQuiz: [
    ans("y9-es-m1", "Image 10, original 5. Find the scale factor.", "", "2", 2, "2.", []),
    ans("y9-es-m2", "Enlarge a length of 6 by scale factor 4.", "", "24", 2, "24.", []),
    ans("y9-es-m3", "Image 15, original 3. Find the scale factor.", "", "5", 2, "5.", []),
    mcq("y9-es-m4", "Similar figures have the same:", "C", ["size", "perimeter", "shape", "area"], 2, "Same shape."),
    ans("y9-es-m5", "Reduce a length of 20 by scale factor 1/4.", "", "5", 2, "5.", []),
    ans("y9-es-m6", "Image 18, original 6. Find the scale factor.", "", "3", 2, "3.", []),
    ans("y9-es-m7", "Enlarge a length of 9 by scale factor 2.", "", "18", 2, "18.", []),
    ans("y9-es-m8", "Image 20, original 5. Find the scale factor.", "", "4", 2, "4.", []),
    mcq("y9-es-m9", "A scale factor less than 1 produces a:", "B", ["enlargement", "reduction", "rotation", "reflection"], 2, "Reduction."),
    ans("y9-es-m10", "Enlarge a length of 10 by scale factor 1.5.", "", "15", 3, "15.", []),
  ],
  masteryQuizPool: [
    ...
    ans("y9-es-p3", "A photo 6 cm wide is enlarged so the width becomes 15 cm. Find the scale factor.", "", "2.5", 5, "15 ÷ 6 = 2.5.", []),
    ans("y9-es-p4", "A map scale factor reduces 200 cm to 4 cm. Find the scale factor.", "", "0.02", 5, "4 ÷ 200 = 0.02 (1:50).", ["1/50"]),
    ...
    ans("y9-es-p8", "A length of 9 is reduced by scale factor 2/3. Find the image.", "", "6", 5, "9 × 2/3 = 6.", []),
    ans("y9-es-p9", "Similar figures with linear SF 5 — the area scale factor is:", "area SF5", "25", 5, "5² = 25.", []),
    ans("y9-es-p10", "An image side is 21 and the original is 7. Find the scale factor.", "", "3", 5, "3.", []),
  ],
  commonMistakes: [
...
const similarTriangles: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y9-st-g3", "Solve 2/4 = 3/x for the missing side x.", "", "6", 3, "Cross-multiply: 2x = 12 → x = 6.", []),
  ...
  independentPractice: [
    ...
    ans("y9-st-i3", "Solve 3/6 = 4/x for x.", "", "8", 3, "3x = 24 → x = 8.", []),
  ...
  masteryQuiz: [
    ...
    ans("y9-st-m2", "Solve 2/6 = 5/x for x.", "", "15", 3, "2x = 30 → x = 15.", []),
    ...
    ans("y9-st-m5", "Solve 3/9 = 2/x for x.", "", "6", 3, "3x = 18 → x = 6.", []),
    ...
    ans("y9-st-m8", "Solve 4/8 = 6/x for x.", "", "12", 3, "4x = 48 → x = 12.", []),
    mcq("y9-st-m9", "Similar triangles always have:", "C", ["equal areas", "equal sides", "equal angles", "a right angle"], 2, "Equal angles."),
    ans("y9-st-m10", "Reduce by scale factor 1/2: a side of 10 becomes.", "", "5", 2, "5.", []),
  ],
  masteryQuizPool: [
    ans("y9-st-p1", "A 2 m stick casts a 3 m shadow; a tree casts a 12 m shadow. Find the tree's height.", "", "8", 5, "h = 12 × (2/3) = 8 m.", ["8 m"]),
    ans("y9-st-p2", "Similar triangles: 6/10 = 9/x. Find x.", "", "15", 5, "6x = 90 → x = 15.", []),
    ans("y9-st-p3", "Two similar triangles have SF 2.5; a side of 4 maps to:", "SF2.5,4", "10", 5, "4 × 2.5 = 10.", []),
    ans("y9-st-p4", "Nested triangles (parallel line) give 4/6 = 6/x. Find x.", "", "9", 5, "4x = 36 → x = 9.", []),
    ans("y9-st-p5", "A 1.5 m person casts a 2 m shadow; a pole casts an 8 m shadow. Find the pole's height.", "", "6", 5, "h = 8 × 0.75 = 6 m.", ["6 m"]),
    ans("y9-st-p6", "Similar triangles: 5/15 = 7/x. Find x.", "", "21", 5, "5x = 105 → x = 21.", []),
    ans("y9-st-p7", "Similar triangles with SF 4; the smaller has area... a side 3 maps to:", "SF4,3", "12", 5, "3 × 4 = 12.", []),
    ans("y9-st-p8", "Triangles: 8/12 = 10/x. Find x.", "", "15", 5, "8x = 120 → x = 15.", []),
    ...
    ans("y9-st-p10", "Similar triangles: 9/6 = x/4. Find x.", "", "6", 5, "6x = 36 → x = 6.", []),
  ],
  commonMistakes: [
...
const provingSimilar: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ...
    ans("y9-ps-g3", "Similar triangles: 3/6 = 5/x. Find x.", "", "10", 3, "3x = 30 → x = 10.", []),
  ...
  independentPractice: [
    ...
    ans("y9-ps-i2", "Similar triangles: 4/8 = 6/x. Find x.", "", "12", 3, "4x = 48 → x = 12.", []),
  ...
  masteryQuiz: [
    ...
    ans("y9-ps-m2", "Similar triangles: 2/6 = 4/x. Find x.", "", "12", 3, "2x = 24 → x = 12.", []),
  ...
  masteryQuizPool: [
    ...
    ans("y9-ps-p2", "Prove similar then solve 6/9 = 8/x. Find x.", "", "12", 5, "6x = 72 → x = 12.", []),
    ans("y9-ps-p3", "A triangle with a line parallel to one side creates a similar triangle; 4/10 = 6/x. Find x.", "", "15", 5, "4x = 60 → x = 15.", []),
    ans("y9-ps-p4", "Similar triangles: 5/15 = 8/x. Find x.", "", "24", 5, "5x = 120 → x = 24.", []),
    ans("y9-ps-p5", "Sides 4, 6, 8 and 6, 9, 12 — which similarity test (common ratio)?", "ratio 3:2", "SSS", 5, "All sides in ratio 2:3 → SSS.", ["sss"]),
    ans("y9-ps-p6", "Similar triangles: 7/21 = 5/x. Find x.", "", "15", 5, "7x = 105 → x = 15.", []),
    ans("y9-ps-p7", "Two triangles have a 90° angle and another equal angle. Which test?", "right + angle", "AA", 5, "Two equal angles → AA.", ["aa"]),
    ans("y9-ps-p8", "Similar triangles: 9/12 = x/8. Find x.", "", "6", 5, "12x = 72 → x = 6.", []),
    ...
    ans("y9-ps-p10", "Similar triangles: 10/4 = x/6. Find x.", "", "15", 5, "4x = 60 → x = 15.", []),
  ],
  commonMistakes: [
