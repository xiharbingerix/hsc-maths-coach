...
const gradient: LessonContent = {
  ...
  masteryQuiz: [
    ...
    answer("y9-rate-grad-m9", "Find the gradient through the displayed marked points.", "", "2", "The marked points are (1, 2) and (4, 8).", ["m=2"], lineGraph("Line stimulus through marked points one comma two and four comma eight.", [{ kind: "linear", m: 2, b: 0 }], [{ x: 1, y: 2 }, { x: 4, y: 8 }], { xMin: 0, xMax: 5, yMin: 0, yMax: 10, xStep: 1, yStep: 2 })),
...
const interceptForm: LessonContent = {
  ...
  masteryQuiz: [
    ...
    choice("y9-rate-form-m8", "Which equation matches the displayed graph?", "D", ["$y=x+2$", "$y=-2x+1$", "$y=2x-1$", "$y=-x+2$"], "The line crosses at 2 and falls 1 for each step right.", "", lineGraph("Straight line stimulus crossing y-axis at two and falling one per unit right.", [{ kind: "linear", m: -1, b: 2 }], [{ x: 0, y: 2 }, { x: 2, y: 0 }])),
...
const parallel: LessonContent = {
  ...
  masteryQuiz: [
    ...
    choice("y9-rate-par-m8", "Which equation could describe a line parallel to the displayed line?", "B", ["$y=-2x+4$", "$y=2x-4$", "$y=x+2$", "$x=2$"], "The displayed line has gradient 2.", "", lineGraph("Straight line stimulus rising two units per unit right.", [{ kind: "linear", m: 2, b: 1 }])),
...
const distanceTime: LessonContent = {
  ...
  guidedPractice: [
    answer("y9-rate-dist-g1", "Read the distance after 2 hours.", "", "6", "The graph reaches 6 km.", ["6 km"], journey),
    answer("y9-rate-dist-g2", "Find the speed during the first 2 hours.", "", "3", "Six kilometres over two hours.", ["3 km/h"], journey),
    choice("y9-rate-dist-g3", "During which interval is the traveller stopped?", "B", ["0 to 2 h", "2 to 3 h", "3 to 5 h", "5 to 6 h"], "The graph is flat from 2 to 3 hours.", "", journey),
  ...
  independentPractice: [
    answer("y9-rate-dist-i1", "Read the final distance shown.", "", "12", "The final point is at 12 km.", ["12 km"], journey),
    answer("y9-rate-dist-i2", "Find the speed from hour 3 to hour 5.", "", "3", "Distance rises 6 km over 2 hours.", ["3 km/h"], journey),
  ...
  masteryQuiz: [
    ...
    answer("y9-rate-dist-m3", "Read the final distance.", "", "12", "The final point is 12 km.", ["12 km"], journey),
    answer("y9-rate-dist-m4", "How long is the stopped interval?", "", "1", "The stop lasts from hour 2 to hour 3.", ["1 hour", "1 h"], journey),
