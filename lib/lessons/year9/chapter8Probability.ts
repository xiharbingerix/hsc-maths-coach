...
const reviewProbability: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-rp-g1", "A bag has 3 red of 7 marbles. Find P(red).", "", "3/7", 2, "3 ÷ 7.", fr(3, 7)),
  ...
  independentPractice: [
    ans("y9-rp-i1", "A bag has 4 blue of 10. Find P(blue).", "", "2/5", 2, "4/10 = 2/5.", fr(2, 5)),
    ...
    ans("y9-rp-i4", "If P(red) = 1/4, find P(not red).", "", "3/4", 3, "1 − 1/4 = 3/4.", fr(3, 4)),
  ...
  masteryQuiz: [
    ...
    ans("y9-rp-m3", "A bag has 5 red of 20. Find P(red).", "", "1/4", 2, "5/20 = 1/4.", fr(1, 4)),
    ans("y9-rp-m4", "If P(A) = 0.3, find P(not A).", "", "0.7", 2, "1 − 0.3 = 0.7.", []),
    ...
    ans("y9-rp-m9", "A bag has 6 green of 24. Find P(green).", "", "1/4", 2, "6/24 = 1/4.", fr(1, 4)),
  ...
  masteryQuizPool: [
    ...
    ans("y9-rp-p6", "If P(win) = 0.35, find P(not win).", "", "0.65", 5, "1 − 0.35 = 0.65.", []),
...
const vennTwoWay: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-vt-g1", "12 play soccer, 5 play both. How many play soccer only?", "", "7", 2, "12 − 5 = 7.", []),
    ans("y9-vt-g2", "12 soccer, 8 tennis, 5 both. How many play at least one?", "", "15", 3, "12 + 8 − 5 = 15.", []),
    ans("y9-vt-g3", "20 students, 15 play at least one sport. How many play neither?", "", "5", 2, "20 − 15 = 5.", []),
    mcq("y9-vt-g4", "The overlap of a Venn diagram represents:", "C", ["only A", "only B", "both A and B", "neither"], 2, "The intersection (both)."),
  ],
  independentPractice: [
    ans("y9-vt-i1", "10 like apples, 4 like both apples and oranges. How many like apples only?", "", "6", 2, "10 − 4 = 6.", []),
    ans("y9-vt-i2", "15 like apples, 12 like oranges, 7 both. How many like at least one?", "", "20", 3, "15 + 12 − 7 = 20.", []),
    ans("y9-vt-i3", "25 people, 20 like at least one fruit. How many like neither?", "", "5", 2, "25 − 20 = 5.", []),
    ans("y9-vt-i4", "From 20 people, 5 are in both groups. Find P(in both).", "", "1/4", 3, "5/20 = 1/4.", fr(1, 4)),
  ...
  masteryQuiz: [
    ans("y9-vt-m1", "14 play chess, 6 play both chess and go. How many play chess only?", "", "8", 2, "14 − 6 = 8.", []),
    ans("y9-vt-m2", "14 chess, 10 go, 6 both. How many play at least one?", "", "18", 3, "14 + 10 − 6 = 18.", []),
    ans("y9-vt-m3", "25 students, 18 play at least one game. How many play neither?", "", "7", 2, "7.", []),
    ans("y9-vt-m4", "From 30 people, 6 are in both sets. Find P(in both).", "", "1/5", 3, "6/30 = 1/5.", fr(1, 5)),
    mcq("y9-vt-m5", "n(A ∪ B) equals:", "A", ["n(A) + n(B) − n(A ∩ B)", "n(A) + n(B)", "n(A) − n(B)", "n(A) × n(B)"], 3, "Add and subtract the overlap."),
    ans("y9-vt-m6", "20 like tea, 8 like both tea and coffee. How many like tea only?", "", "12", 2, "12.", []),
    ans("y9-vt-m7", "9 like maths, 7 like science, 4 both. How many like at least one?", "", "12", 3, "12.", []),
    ans("y9-vt-m8", "40 people, 28 like at least one subject. How many like neither?", "", "12", 2, "12.", []),
    ans("y9-vt-m9", "From 50 people, 10 are in both sets. Find P(in both).", "", "1/5", 3, "1/5.", fr(1, 5)),
  ...
  masteryQuizPool: [
    ans("y9-vt-p1", "30 students: 18 study French, 12 study German, 5 both. How many study neither?", "", "5", 5, "Union 25; 30 − 25 = 5.", []),
    ans("y9-vt-p2", "A two-way table: 12 boys, 8 of them play sport; 10 girls, 6 play sport. How many play sport?", "", "14", 5, "8 + 6 = 14.", []),
    ans("y9-vt-p3", "40 people: 25 own a cat, 18 own a dog, 10 own both. How many own only a cat?", "", "15", 5, "25 − 10 = 15.", []),
    ans("y9-vt-p4", "Of 40 people, 25 own a cat, 18 own a dog and 10 own both. How many own at least one pet?", "n(C)=25,\\ n(D)=18,\\ n(C\\cap D)=10", "33", 5, "25 + 18 − 10 = 33.", []),
    ans("y9-vt-p5", "50 students: 30 play soccer, 20 play tennis, 8 both. Find P(plays soccer only).", "", "11/25", 5, "22/50 = 11/25.", fr(22, 50)),
    ans("y9-vt-p6", "24 people: 14 like tea, 10 like coffee, 6 both. How many like neither?", "", "6", 5, "Union 18; 24 − 18 = 6.", []),
    ans("y9-vt-p7", "A two-way table totals 60; row totals 35 and 25; one cell is 20. Find the cell in the same row (35 − 20).", "", "15", 5, "35 − 20 = 15.", []),
    ans("y9-vt-p8", "100 people: 60 read books, 45 watch films, 30 both. How many do at least one?", "", "75", 5, "75.", []),
    ans("y9-vt-p9", "Of 100 people, 60 read books, 45 watch films and 30 do both. How many do neither?", "n(B)=60,\\ n(F)=45,\\ n(B\\cap F)=30", "25", 5, "The union is 75, so 100 − 75 = 25.", []),
    ans("y9-vt-p10", "20 students, 5 in both clubs, 8 in club A only, 4 in club B only. How many in neither?", "", "3", 5, "20 − 17 = 3.", []),
  ],
  commonMistakes: [
...
const arraysTwoStep: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-ar2-g1", "How many outcomes when two coins are tossed?", "", "4", 2, "2 × 2 = 4.", []),
    ans("y9-ar2-g2", "Find P(two heads) with two coins.", "P(HH)", "1/4", 2, "1 of 4.", fr(1, 4)),
    ans("y9-ar2-g3", "How many outcomes for a die and a coin?", "", "12", 2, "6 × 2 = 12.", []),
  ...
  independentPractice: [
    ans("y9-ar2-i1", "How many outcomes for two dice?", "", "36", 2, "36.", []),
    ...
    ans("y9-ar2-i4", "How many outcomes for a 4-sector spinner and a coin?", "", "8", 2, "4 × 2 = 8.", []),
  ...
  masteryQuiz: [
    ans("y9-ar2-m1", "How many outcomes for two dice?", "", "36", 2, "36.", []),
    ...
    ans("y9-ar2-m6", "How many outcomes for a die and a coin?", "", "12", 2, "12.", []),
  ...
  masteryQuizPool: [
    ...
    ans("y9-ar2-p4", "Three coins: how many outcomes?", "", "8", 5, "2 × 2 × 2 = 8.", []),
    ...
    ans("y9-ar2-p10", "Spinner (1–3) and a die: how many outcomes?", "", "18", 5, "3 × 6 = 18.", []),
  ],
  commonMistakes: [
