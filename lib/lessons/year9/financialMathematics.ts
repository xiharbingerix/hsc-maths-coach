...
const penalties: LessonContent = {
  ...
  masteryQuiz: [
    ...
    choice("y9-fin-pen-m9", "Plan A pays 6 hours at 32 dollars per hour. Plan B pays 4 ordinary hours and 2 double-time hours at 24 dollars per hour. Which pays more?", "B", ["Plan A by $96", "Plan B by $96", "They pay the same", "Plan B by $24"], "Plan A pays $192 and Plan B pays $288."),
...
export function year9FinancialMathematicsLessonOverride(course: CoursePathwaySeed, unit: CourseUnitSeed, lesson: CourseLessonSeed): Partial<ExplicitLesson> | null {
  if (course.slug !== "year-9-mathematics" || unit.slug !== "financial-mathematics") return null;
