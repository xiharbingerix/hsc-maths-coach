...
const area: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-ar-g1", "Find the area of an 8 cm by 4 cm rectangle.", "", "32", 2, "32.", cm2("32")),
    ans("y9-ar-g2", "Find the area of a triangle with base 10 cm and height 6 cm.", "", "30", 2, "½ × 60 = 30.", cm2("30")),
  ...
  independentPractice: [
    ans("y9-ar-i1", "Find the area of a 12 cm by 5 cm rectangle.", "", "60", 2, "60.", cm2("60")),
    ans("y9-ar-i2", "Find the area of a triangle with base 8 cm and height 5 cm.", "", "20", 2, "½ × 40 = 20.", cm2("20")),
    ans("y9-ar-i3", "Find the area of a parallelogram with base 7 cm and height 4 cm.", "", "28", 2, "28.", cm2("28")),
  ...
  masteryQuiz: [
    ans("y9-ar-m1", "Find the area of a 6 cm by 7 cm rectangle.", "", "42", 2, "42.", cm2("42")),
    ans("y9-ar-m2", "Find the area of a triangle with base 12 cm and height 10 cm.", "", "60", 2, "60.", cm2("60")),
    ans("y9-ar-m3", "Find the area of a square with side 8 cm.", "s=8", "64", 2, "64.", cm2("64")),
    ans("y9-ar-m4", "Find the area of a parallelogram with base 9 cm and height 5 cm.", "", "45", 2, "45.", cm2("45")),
    mcq("y9-ar-m5", "The area of a parallelogram is:", "A", ["base × height", "½ base × height", "side²", "2(b + h)"], 2, "A = bh."),
    ans("y9-ar-m6", "Find the area of a 15 cm by 4 cm rectangle.", "", "60", 2, "60.", cm2("60")),
    ans("y9-ar-m7", "Find the area of a triangle with base 14 cm and height 6 cm.", "", "42", 2, "½ × 84 = 42.", cm2("42")),
    ans("y9-ar-m8", "Find the area of a square with side 11 cm.", "s=11", "121", 2, "121.", cm2("121")),
    ans("y9-ar-m9", "Find the area of a parallelogram with base 10 cm and height 10 cm.", "", "100", 2, "100.", cm2("100")),
  ...
  masteryQuizPool: [
    ans("y9-ar-p1", "Find the area of a trapezium with parallel sides 6 cm and 10 cm and height 4 cm.", "", "32", 5, "½(6 + 10)(4) = 32.", cm2("32")),
    ...
    ans("y9-ar-p4", "Find the area of a trapezium with parallel sides 5 cm and 9 cm and height 6 cm.", "", "42", 5, "½(14)(6) = 42.", cm2("42")),
    ans("y9-ar-p5", "A square has area 49 cm². Find its side length.", "A=49", "7", 5, "√49 = 7.", cm("7")),
    ans("y9-ar-p6", "An L-shape is a 10×6 rectangle with a 4×3 rectangle removed. Find its area.", "", "48", 5, "60 − 12 = 48.", cm2("48")),
    ans("y9-ar-p7", "A triangle has area 30 cm² and height 5 cm. Find its base.", "A=30,h=5", "12", 5, "30 = ½(b)(5) → b = 12.", cm("12")),
    ans("y9-ar-p8", "A rectangle 8×5 has a triangle (base 8, height 3) on top. Find the total area.", "", "52", 5, "40 + 12 = 52.", cm2("52")),
    ans("y9-ar-p9", "A parallelogram has area 60 cm² and base 12 cm. Find its height.", "A=60,b=12", "5", 5, "60 ÷ 12 = 5.", cm("5")),
    ans("y9-ar-p10", "Find the area of a trapezium with parallel sides 8 cm and 12 cm and height 5 cm.", "", "50", 5, "½(20)(5) = 50.", cm2("50")),
  ],
  commonMistakes: [
...
const compositeShapes: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-cs-g1", "An 8×4 rectangle joined to a 2×4 rectangle. Find the total area.", "", "40", 3, "32 + 8 = 40.", cm2("40")),
    ans("y9-cs-g2", "A 10×5 rectangle with a 2×2 square removed. Find the area.", "", "46", 3, "50 − 4 = 46.", cm2("46")),
    ans("y9-cs-g3", "Two squares of side 3 cm and side 4 cm. Find the total area.", "", "25", 2, "9 + 16 = 25.", cm2("25")),
  ...
  independentPractice: [
    ans("y9-cs-i1", "A 12×6 rectangle with a 4×3 rectangle removed. Find the area.", "", "60", 3, "72 − 12 = 60.", cm2("60")),
    ans("y9-cs-i2", "A 5×5 square with a triangle (base 5, height 4) on top. Find the total area.", "", "35", 3, "25 + 10 = 35.", cm2("35")),
    ans("y9-cs-i3", "An L-shape: a 6×6 square with a 2×4 rectangle removed. Find the area.", "", "28", 3, "36 − 8 = 28.", cm2("28")),
    ans("y9-cs-i4", "A 9×4 rectangle joined to a 3×4 rectangle. Find the total area.", "", "48", 3, "36 + 12 = 48.", cm2("48")),
  ...
  masteryQuiz: [
    ans("y9-cs-m1", "A 10×6 rectangle with a 3×2 rectangle removed. Find the area.", "", "54", 3, "60 − 6 = 54.", cm2("54")),
    ans("y9-cs-m2", "An 8×5 rectangle with a triangle (base 8, height 3) on top. Find the total area.", "", "52", 3, "40 + 12 = 52.", cm2("52")),
    ans("y9-cs-m3", "Two rectangles 7×3 and 5×3. Find the total area.", "", "36", 3, "21 + 15 = 36.", cm2("36")),
    ans("y9-cs-m4", "A 6×6 square with a triangle (base 6, height 6) removed. Find the area.", "", "18", 3, "36 − 18 = 18.", cm2("18")),
    ...
    ans("y9-cs-m6", "A 15×4 rectangle joined to a 5×4 rectangle. Find the total area.", "", "80", 3, "60 + 20 = 80.", cm2("80")),
    ans("y9-cs-m7", "A 12×10 rectangle with a 6×5 rectangle removed. Find the area.", "", "90", 3, "120 − 30 = 90.", cm2("90")),
    ans("y9-cs-m8", "A 4×4 square joined to a triangle (base 4, height 6). Find the total area.", "", "28", 3, "16 + 12 = 28.", cm2("28")),
    ans("y9-cs-m9", "An L-shape: a 10×8 rectangle with a 4×4 square removed. Find the area.", "", "64", 3, "80 − 16 = 64.", cm2("64")),
  ...
  masteryQuizPool: [
    ans("y9-cs-p1", "A rectangle 12×8 with a semicircle (radius 4) removed. Find the area in terms of π.", "", "96-8π", 5, "96 − ½π(4²) = 96 − 8π.", ["96 - 8π", "96-8pi"]),
    ...
    ans("y9-cs-p3", "A 20×10 rectangle with two 3×3 squares removed. Find the area.", "", "182", 5, "200 − 2(9) = 182.", cm2("182")),
    ans("y9-cs-p4", "A trapezium (parallel sides 8 and 4, height 5) plus a 4×5 rectangle. Find the total area.", "", "50", 5, "½(8 + 4)(5) = 30; + 20 = 50.", cm2("50")),
    ans("y9-cs-p5", "A 14×10 rectangle with a triangle (base 14, height 6) removed. Find the area.", "", "98", 5, "140 − 42 = 98.", cm2("98")),
    ans("y9-cs-p6", "A square side 10 with a quarter-circle (radius 10) removed. Find the area in terms of π.", "", "100-25π", 5, "100 − ¼π(10²) = 100 − 25π.", ["100 - 25π", "100-25pi"]),
    ans("y9-cs-p7", "Two triangles, each base 6 height 4, joined to a 6×5 rectangle. Find the total area.", "", "54", 5, "2(½·6·4 = 12) = 24; + 30 = 54.", cm2("54")),
    ans("y9-cs-p8", "A 16×9 rectangle with a 9×9 square removed. Find the remaining area.", "", "63", 5, "144 − 81 = 63.", cm2("63")),
    ans("y9-cs-p9", "A house-shape: a 6×4 rectangle with a triangle (base 6, height 3) roof. Find the total area.", "", "33", 5, "24 + 9 = 33.", cm2("33")),
    ans("y9-cs-p10", "A 1 m by 2 m doorway is cut from a 5 m by 3 m wall. Find the wall area remaining.", "", "13", 5, "15 − 2 = 13 m².", ["13", "13 m²"]),
  ],
  commonMistakes: [
