...
const anglesTriangles: Partial<ExplicitLesson> = {
  ...
  independentPractice: [
    ...
    ans("y9-at-i4", "An exterior angle next to interior angles 60° and 70° is:", "60+70", "130", 3, "60 + 70 = 130.", deg("130")),
  ...
  masteryQuiz: [
    ...
    ans("y9-at-m4", "An exterior angle next to interior angles 80° and 40° is:", "80+40", "120", 3, "120.", deg("120")),
...
const parallelLines: Partial<ExplicitLesson> = {
  ...
  masteryQuizPool: [
    ...
    ans("y9-pl-p2", "Two parallel lines: an alternate angle to 3x is 60° and 3x = that angle. Find x.", "3x=60", "20", 5, "3x = 60 → x = 20.", deg("20")),
    ans("y9-pl-p3", "A co-interior angle relationship gives x + 50 = 180. Find x.", "x+50=180", "130", 5, "x = 130.", deg("130")),
    ...
    ans("y9-pl-p6", "An alternate angle is 2x and equals 70°. Find x.", "2x=70", "35", 5, "2x = 70 → x = 35.", deg("35")),
    ans("y9-pl-p7", "A corresponding angle is (x + 30)° and equals 100°. Find x.", "x+30=100", "70", 5, "x = 70.", deg("70")),
    ans("y9-pl-p8", "An angle and its co-interior partner are in the ratio 2 : 1. Find the larger.", "2:1, sum 180", "120", 5, "3 parts = 180 → 60; larger = 2×60 = 120.", deg("120")),
    ...
    ans("y9-pl-p10", "Co-interior angles (3x) and (x) on parallel lines. Find x.", "3x+x=180", "45", 5, "4x = 180 → x = 45.", deg("45")),
  ],
  commonMistakes: [
