...
const percentagesAndMoney: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-pc-g1", "Find 10% of $200.", "10\\%\\times200", "20", 2, "0.10 × 200 = 20.", money("20")),
    ans("y9-pc-g2", "Find 50% of 90.", "50\\%\\times90", "45", 2, "Half of 90.", []),
  ...
  independentPractice: [
    ans("y9-pc-i1", "Find 30% of 60.", "30\\%\\times60", "18", 2, "0.30 × 60 = 18.", []),
    ans("y9-pc-i2", "Find 5% of $400.", "5\\%\\times400", "20", 2, "0.05 × 400 = 20.", money("20")),
  ...
  masteryQuiz: [
    ans("y9-pc-m1", "Find 40% of 50.", "40\\%\\times50", "20", 2, "0.40 × 50 = 20.", []),
    ans("y9-pc-m2", "Find 10% of $35.", "10\\%\\times35", "3.50", 3, "0.10 × 35 = 3.50.", money("3.50")),
    ans("y9-pc-m3", "Find 20% of 150.", "20\\%\\times150", "30", 2, "0.20 × 150 = 30.", []),
    ans("y9-pc-m4", "Write 0.6 as a percentage.", "0.6", "60%", 2, "×100.", ["60"]),
    mcq("y9-pc-m5", "Write 3/4 as a percentage.", "C", ["34%", "43%", "75%", "30%"], 2, "3/4 = 0.75 = 75%."),
    ans("y9-pc-m6", "Find 15% of 200.", "15\\%\\times200", "30", 2, "0.15 × 200 = 30.", []),
    ans("y9-pc-m7", "Write 8% as a decimal.", "8\\%", "0.08", 2, "÷100.", []),
    ans("y9-pc-m8", "Find 100% of 47.", "100\\%\\times47", "47", 2, "100% = the whole.", []),
    ans("y9-pc-m9", "Find 5% of 60.", "5\\%\\times60", "3", 2, "0.05 × 60 = 3.", []),
    mcq("y9-pc-m10", "Write 0.05 as a percentage.", "A", ["5%", "0.5%", "50%", "0.05%"], 2, "×100 → 5%."),
  ],
  masteryQuizPool: [
    ans("y9-pc-p1", "Find 35% of $240.", "35\\%\\times240", "84", 5, "0.35 × 240 = 84.", money("84")),
    ans("y9-pc-p2", "Find 12.5% of 64.", "12.5\\%\\times64", "8", 5, "0.125 × 64 = 8.", []),
    ans("y9-pc-p3", "20% of an amount is $15. Find the amount.", "20\\%=\\$15", "75", 5, "Amount = 15 ÷ 0.20 = 75.", money("75")),
    ans("y9-pc-p4", "Find 7.5% of $1200.", "7.5\\%\\times1200", "90", 5, "0.075 × 1200 = 90.", money("90")),
    ans("y9-pc-p5", "Write 0.025 as a percentage.", "0.025", "2.5%", 5, "×100 → 2.5%.", ["2.5"]),
    ans("y9-pc-p6", "Find 150% of 40.", "150\\%\\times40", "60", 5, "1.5 × 40 = 60.", []),
    ans("y9-pc-p7", "What percentage is 18 of 90?", "18/90", "20%", 5, "18/90 = 0.2 = 20%.", ["20"]),
    ans("y9-pc-p8", "GST is 10%. Find the GST on a $250 item.", "10\\%\\times250", "25", 5, "0.10 × 250 = 25.", money("25")),
    ans("y9-pc-p9", "Find 0.5% of $4000.", "0.5\\%\\times4000", "20", 5, "0.005 × 4000 = 20.", money("20")),
    ans("y9-pc-p10", "What percentage is $12 of $48?", "12/48", "25%", 5, "12/48 = 0.25 = 25%.", ["25"]),
  ],
  commonMistakes: [
...
const percentageIncreaseDecrease: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-pid-g1", "Increase 100 by 20%.", "\\times1.2", "120", 2, "100 × 1.2 = 120.", []),
    ans("y9-pid-g2", "Decrease 100 by 30%.", "\\times0.7", "70", 2, "100 × 0.7 = 70.", []),
    ans("y9-pid-g3", "Increase 40 by 50%.", "\\times1.5", "60", 2, "40 × 1.5 = 60.", []),
    mcq("y9-pid-g4", "Increasing by 10% means multiplying by:", "C", ["0.1", "10", "1.1", "0.9"], 2, "1 + 0.10 = 1.1."),
  ],
  independentPractice: [
    ans("y9-pid-i1", "Increase 80 by 25%.", "\\times1.25", "100", 2, "80 × 1.25 = 100.", []),
    ans("y9-pid-i2", "Decrease 60 by 10%.", "\\times0.9", "54", 2, "60 × 0.9 = 54.", []),
    ans("y9-pid-i3", "Increase $500 by 6%.", "\\times1.06", "530", 3, "500 × 1.06 = 530.", money("530")),
    ans("y9-pid-i4", "Decrease 200 by 15%.", "\\times0.85", "170", 3, "200 × 0.85 = 170.", []),
    mcq("y9-pid-i5", "Decreasing by 20% means multiplying by:", "B", ["0.2", "0.8", "1.2", "0.98"], 2, "1 − 0.20 = 0.8."),
  ],
  masteryQuiz: [
    ans("y9-pid-m1", "Increase 50 by 20%.", "\\times1.2", "60", 2, "50 × 1.2 = 60.", []),
    ans("y9-pid-m2", "Decrease 90 by 10%.", "\\times0.9", "81", 2, "90 × 0.9 = 81.", []),
    ans("y9-pid-m3", "Increase 120 by 25%.", "\\times1.25", "150", 2, "120 × 1.25 = 150.", []),
    ans("y9-pid-m4", "Decrease 40 by 25%.", "\\times0.75", "30", 2, "40 × 0.75 = 30.", []),
    mcq("y9-pid-m5", "The factor for a 5% increase is:", "A", ["1.05", "0.95", "5", "0.05"], 2, "1 + 0.05 = 1.05."),
    ans("y9-pid-m6", "Increase 200 by 50%.", "\\times1.5", "300", 2, "200 × 1.5 = 300.", []),
    ans("y9-pid-m7", "Decrease 150 by 20%.", "\\times0.8", "120", 2, "150 × 0.8 = 120.", []),
    ans("y9-pid-m8", "Increase 80 by 5%.", "\\times1.05", "84", 3, "80 × 1.05 = 84.", []),
    ans("y9-pid-m9", "Decrease 250 by 40%.", "\\times0.6", "150", 2, "250 × 0.6 = 150.", []),
    ans("y9-pid-m10", "Increase 60 by 100%.", "\\times2", "120", 2, "Doubling: 60 × 2 = 120.", []),
  ],
  masteryQuizPool: [
    ans("y9-pid-p1", "Increase $400 by 8%, then decrease the result by 5%.", "\\times1.08\\times0.95", "410.40", 5, "400×1.08 = 432; 432×0.95 = 410.40.", money("410.40")),
    ans("y9-pid-p2", "After a 20% discount a jacket costs $96. Find the original price.", "\\div0.8", "120", 5, "96 ÷ 0.8 = 120.", money("120")),
    ans("y9-pid-p3", "A $60 item rises 15%. Find the new price.", "\\times1.15", "69", 5, "60 × 1.15 = 69.", money("69")),
    ans("y9-pid-p4", "A population of 2000 falls 12%. Find the new population.", "\\times0.88", "1760", 5, "2000 × 0.88 = 1760.", []),
    ans("y9-pid-p5", "After a 25% increase a value is 150. Find the original.", "\\div1.25", "120", 5, "150 ÷ 1.25 = 120.", []),
    ans("y9-pid-p6", "Increase 80 by 10% twice (compound).", "\\times1.1^2", "96.8", 5, "80×1.1=88; 88×1.1=96.8.", []),
    ans("y9-pid-p7", "A $250 fare drops 12% then rises 5%. Final price?", "\\times0.88\\times1.05", "231", 5, "250×0.88=220; 220×1.05=231.", money("231")),
    ans("y9-pid-p8", "After a 10% decrease a price is $45. Find the original.", "\\div0.9", "50", 5, "45 ÷ 0.9 = 50.", money("50")),
    ans("y9-pid-p9", "Increase 500 by 6%, then by 6% again.", "\\times1.06^2", "561.80", 5, "500×1.06=530; 530×1.06=561.80.", money("561.80")),
    ans("y9-pid-p10", "A salary of $48000 rises 2.5%. Find the new salary.", "\\times1.025", "49200", 5, "48000 × 1.025 = 49200.", money("49200")),
  ],
  commonMistakes: [
...
const profitsAndDiscounts: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-pd-g1", "Cost $30, sell $45. Find the profit.", "45-30", "15", 2, "45 − 30 = 15.", money("15")),
    ans("y9-pd-g2", "Find the price after 10% off $50.", "\\times0.9", "45", 2, "50 × 0.9 = 45.", money("45")),
    ans("y9-pd-g3", "Cost $50, profit $10. Find the percentage profit.", "10/50", "20%", 2, "10/50 = 20%.", ["20"]),
  ...
  independentPractice: [
    ans("y9-pd-i1", "Cost $100, sell $130. Find the profit.", "130-100", "30", 2, "30.", money("30")),
    ans("y9-pd-i2", "Find the price after 25% off $200.", "\\times0.75", "150", 2, "200 × 0.75 = 150.", money("150")),
    ans("y9-pd-i3", "Cost $80, sell $60. Find the percentage loss.", "20/80", "25%", 3, "Loss 20; 20/80 = 25%.", ["25"]),
    ans("y9-pd-i4", "Find the price after 15% off $40.", "\\times0.85", "34", 3, "40 × 0.85 = 34.", money("34")),
    ans("y9-pd-i5", "Cost $20, sell $25. Find the percentage profit.", "5/20", "25%", 3, "5/20 = 25%.", ["25"]),
  ],
  masteryQuiz: [
    ans("y9-pd-m1", "Cost $60, sell $75. Find the profit.", "75-60", "15", 2, "15.", money("15")),
    ans("y9-pd-m2", "Find the price after 20% off $250.", "\\times0.8", "200", 2, "250 × 0.8 = 200.", money("200")),
    ans("y9-pd-m3", "Cost $200, profit $50. Percentage profit?", "50/200", "25%", 3, "50/200 = 25%.", ["25"]),
    ans("y9-pd-m4", "Find the price after 30% off $90.", "\\times0.7", "63", 2, "90 × 0.7 = 63.", money("63")),
    mcq("y9-pd-m5", "Selling below cost price is a:", "B", ["profit", "loss", "discount", "markup"], 2, "Sell < cost → loss."),
    ans("y9-pd-m6", "Cost $50, sell $80. Find the profit.", "80-50", "30", 2, "30.", money("30")),
    ans("y9-pd-m7", "Find the price after 5% off $60.", "\\times0.95", "57", 2, "60 × 0.95 = 57.", money("57")),
    ans("y9-pd-m8", "Cost $40, profit $20. Percentage profit?", "20/40", "50%", 3, "20/40 = 50%.", ["50"]),
    ans("y9-pd-m9", "Find the price after 50% off $30.", "\\times0.5", "15", 2, "Half of $30.", money("15")),
    ans("y9-pd-m10", "Cost $120, sell $96. Find the loss.", "120-96", "24", 3, "120 − 96 = 24 loss.", money("24")),
  ],
  masteryQuizPool: [
    ans("y9-pd-p1", "A $200 item is reduced 10%, then a further 5%. Find the final price.", "\\times0.9\\times0.95", "171", 5, "200×0.9=180; 180×0.95=171.", money("171")),
    ans("y9-pd-p2", "An item sells for $100 at a 25% profit. Find the cost price.", "\\div1.25", "80", 5, "Cost = 100 ÷ 1.25 = 80.", money("80")),
    ans("y9-pd-p3", "Cost $250, sold at a 12% loss. Find the selling price.", "\\times0.88", "220", 5, "250 × 0.88 = 220.", money("220")),
    ans("y9-pd-p4", "Marked $80, 20% off, then 10% GST added. Final price?", "\\times0.8\\times1.1", "70.40", 5, "80×0.8=64; 64×1.1=70.40.", money("70.40")),
    ans("y9-pd-p5", "Bought $1500, sold $1800. Percentage profit?", "300/1500", "20%", 5, "300/1500 = 20%.", ["20"]),
    ans("y9-pd-p6", "A 30% discount saves $24. Find the original price.", "0.3\\times P=24", "80", 5, "P = 24 ÷ 0.3 = 80.", money("80")),
    ans("y9-pd-p7", "Cost $40, sold at a 35% profit. Selling price?", "\\times1.35", "54", 5, "40 × 1.35 = 54.", money("54")),
    ans("y9-pd-p8", "An item at $90 after 25% off — what was the original price?", "\\div0.75", "120", 5, "90 ÷ 0.75 = 120.", money("120")),
    ans("y9-pd-p9", "Cost $60, sold $45. Percentage loss?", "15/60", "25%", 5, "Loss 15; 15/60 = 25%.", ["25"]),
    ans("y9-pd-p10", "Two successive 50% discounts on $80 — final price?", "\\times0.5\\times0.5", "20", 5, "80×0.5=40; 40×0.5=20.", money("20")),
  ],
  commonMistakes: [
