...
const income: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-inc-g1", "Find the pay for 40 hours at $20/h.", "40\\times20", "800", 2, "40 × 20 = 800.", money("800")),
    ans("y9-inc-g2", "Find the pay for 35 hours at $24/h.", "35\\times24", "840", 2, "35 × 24 = 840.", money("840")),
    ans("y9-inc-g3", "Find 10% commission on $5000 of sales.", "10\\%\\times5000", "500", 2, "0.10 × 5000 = 500.", money("500")),
  ...
  independentPractice: [
    ans("y9-inc-i1", "Find the pay for 30 hours at $18/h.", "30\\times18", "540", 2, "30 × 18 = 540.", money("540")),
    ans("y9-inc-i2", "Find the overtime pay for 4 hours at time-and-a-half on a $20 base rate.", "4\\times30", "120", 3, "1.5×20 = 30; 4 × 30 = 120.", money("120")),
    ans("y9-inc-i3", "A salary of $78 000/yr is paid monthly. Find the monthly pay.", "78000/12", "6500", 2, "78000 ÷ 12 = 6500.", money("6500")),
    ans("y9-inc-i4", "Find 8% commission on $2500 of sales.", "8\\%\\times2500", "200", 2, "0.08 × 2500 = 200.", money("200")),
  ...
  masteryQuiz: [
    ans("y9-inc-m1", "Find the pay for 38 hours at $25/h.", "38\\times25", "950", 2, "950.", money("950")),
    ans("y9-inc-m2", "A salary of $52 000/yr is paid weekly. Find the weekly pay.", "52000/52", "1000", 2, "1000.", money("1000")),
    ans("y9-inc-m3", "Find 5% commission on $8000 of sales.", "5\\%\\times8000", "400", 2, "400.", money("400")),
    ans("y9-inc-m4", "38 hours at $20/h plus 7 overtime hours at time-and-a-half. Total pay?", "38\\times20+7\\times30", "970", 4, "760 + 7×30(=210) = 970.", money("970")),
    ...
    ans("y9-inc-m6", "A fortnightly pay of $1500 — find the annual amount (26 fortnights).", "1500\\times26", "39000", 3, "1500 × 26 = 39000.", money("39000")),
    ans("y9-inc-m7", "Find the pay for 20 hours at $15/h.", "20\\times15", "300", 2, "300.", money("300")),
    ans("y9-inc-m8", "Find the pay for 5 hours at double-time on a $22 base rate.", "5\\times44", "220", 3, "2×22 = 44; 5 × 44 = 220.", money("220")),
    ans("y9-inc-m9", "Piecework: 200 items at $0.50 each. Find the pay.", "200\\times0.5", "100", 2, "200 × 0.50 = 100.", money("100")),
  ...
  masteryQuizPool: [
    ans("y9-inc-p1", "Earns $20/h, time-and-a-half after 40 h. Find the pay for a 46-hour week.", "40\\times20+6\\times30", "980", 5, "800 + 6×30(=180) = 980.", money("980")),
    ...
    ans("y9-inc-p3", "Base $25 000/yr plus 4% commission on $150 000 sales. Total annual income?", "25000+0.04\\times150000", "31000", 5, "25000 + 6000 = 31000.", money("31000")),
    ans("y9-inc-p4", "Paid $1800/fortnight. Find the equivalent annual salary.", "1800\\times26", "46800", 5, "1800 × 26 = 46800.", money("46800")),
    ans("y9-inc-p5", "Works 35 h at $28/h, plus 5 h at double-time. Total pay?", "35\\times28+5\\times56", "1260", 5, "980 + 5×56(=280) = 1260.", money("1260")),
    ans("y9-inc-p6", "Monthly pay $5500. Find the annual salary.", "5500\\times12", "66000", 5, "5500 × 12 = 66000.", money("66000")),
    ans("y9-inc-p7", "Commission only: 6% on sales. To earn $900, what sales are needed?", "0.06\\times S=900", "15000", 5, "S = 900 ÷ 0.06 = 15000.", money("15000")),
    ans("y9-inc-p8", "$24/h, 38-h week. Find the annual income (52 weeks).", "24\\times38\\times52", "47424", 5, "912/wk × 52 = 47424.", money("47424")),
    ans("y9-inc-p9", "Piecework $0.80/item; produced 350 items, plus a $50 bonus. Total?", "350\\times0.8+50", "330", 5, "280 + 50 = 330.", money("330")),
...
const paygIncomeTax: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-tax-g1", "Find taxable income: gross $45 000, deductions $1500.", "45000-1500", "43500", 2, "45000 − 1500 = 43500.", money("43500")),
    ans("y9-tax-g2", "Find the 2% Medicare levy on $60 000.", "2\\%\\times60000", "1200", 2, "0.02 × 60000 = 1200.", money("1200")),
    ans("y9-tax-g3", "Tax is 19c per $1 over $18 200. Find the tax on $25 000.", "0.19\\times6800", "1292", 3, "0.19 × (25000 − 18200) = 0.19 × 6800 = 1292.", money("1292")),
  ...
  independentPractice: [
    ans("y9-tax-i1", "Find taxable income: gross $80 000, deductions $3000.", "80000-3000", "77000", 2, "77000.", money("77000")),
    ans("y9-tax-i2", "Find the 2% Medicare levy on $48 000.", "2\\%\\times48000", "960", 2, "0.02 × 48000 = 960.", money("960")),
    ans("y9-tax-i3", "Tax is 19c per $1 over $18 200. Find the tax on $40 000.", "0.19\\times21800", "4142", 3, "0.19 × 21800 = 4142.", money("4142")),
    ans("y9-tax-i4", "Net income = gross − tax. Gross $50 000, tax $6000. Find net.", "50000-6000", "44000", 2, "44000.", money("44000")),
    mcq("y9-tax-i5", "The Medicare levy is usually:", "C", ["10%", "5%", "2%", "0.5%"], 2, "Typically 2% of taxable income."),
  ],
  masteryQuiz: [
    ans("y9-tax-m1", "Taxable income: gross $70 000, deductions $2500.", "70000-2500", "67500", 2, "67500.", money("67500")),
    ans("y9-tax-m2", "2% Medicare levy on $75 000.", "2\\%\\times75000", "1500", 2, "1500.", money("1500")),
    ans("y9-tax-m3", "Tax 19c/$ over $18 200. Find the tax on $35 000.", "0.19\\times16800", "3192", 3, "0.19 × 16800 = 3192.", money("3192")),
    ans("y9-tax-m4", "Net = gross − tax. Gross $60 000, tax $11 000. Find net.", "60000-11000", "49000", 2, "49000.", money("49000")),
    mcq("y9-tax-m5", "Income below $18 200 is taxed at:", "A", ["$0", "19%", "2%", "10%"], 2, "Below the tax-free threshold → $0 tax."),
    ans("y9-tax-m6", "Taxable income: gross $90 000, deductions $5000.", "90000-5000", "85000", 2, "85000.", money("85000")),
    ans("y9-tax-m7", "2% Medicare levy on $40 000.", "2\\%\\times40000", "800", 2, "800.", money("800")),
    ans("y9-tax-m8", "Tax 19c/$ over $18 200. Find the tax on $20 000.", "0.19\\times1800", "342", 3, "0.19 × 1800 = 342.", money("342")),
    ans("y9-tax-m9", "Net = gross − tax. Gross $80 000, tax $18 000. Find net.", "80000-18000", "62000", 2, "62000.", money("62000")),
  ...
  masteryQuizPool: [
    ...
    ans("y9-tax-p2", "Income $45 000, tax $5092, levy $900. Find the net income.", "45000-5992", "39008", 5, "45000 − 5992 = 39008.", money("39008")),
    ans("y9-tax-p3", "Gross $66 000, deductions $4000; tax 19c/$ over $18 200 on the taxable income. Find the tax.", "0.19\\times(62000-18200)", "8322", 5, "Taxable 62000; 0.19 × 43800 = 8322.", money("8322")),
    ans("y9-tax-p4", "2% Medicare levy on a taxable income of $83 500.", "2\\%\\times83500", "1670", 5, "0.02 × 83500 = 1670.", money("1670")),
    ...
    ans("y9-tax-p6", "Gross $52 000, deductions $1800, tax 19c/$ over $18 200. Find the tax.", "0.19\\times(50200-18200)", "6080", 5, "Taxable 50200; 0.19 × 32000 = 6080.", money("6080")),
    ans("y9-tax-p7", "Net income after $7000 tax and $1000 levy on a $50 000 gross. Find the net.", "50000-8000", "42000", 5, "50000 − (7000+1000) = 42000.", money("42000")),
    ans("y9-tax-p8", "2% Medicare levy on $123 500.", "2\\%\\times123500", "2470", 5, "0.02 × 123500 = 2470.", money("2470")),
    ans("y9-tax-p9", "Tax 19c/$ over $18 200 on $28 200. Find the tax.", "0.19\\times10000", "1900", 5, "0.19 × 10000 = 1900.", money("1900")),
    ans("y9-tax-p10", "Gross $40 000, tax $4142, levy 2% of gross. Find the net income.", "40000-4142-800", "35058", 5, "Levy 800; net = 40000 − 4142 − 800 = 35058.", money("35058")),
  ],
  commonMistakes: [
...
const compoundInterestDepreciation: Partial<ExplicitLesson> = {
  ...
  guidedPractice: [
    ans("y9-cid-g1", "$1000 at 10% compounded for 1 year. Find the amount.", "\\times1.1", "1100", 2, "1000 × 1.1 = 1100.", money("1100")),
    ans("y9-cid-g2", "$1000 at 10% compounded for 2 years. Find the amount.", "\\times1.1^2", "1210", 3, "1000 × 1.1² = 1210.", money("1210")),
    ans("y9-cid-g3", "Depreciate $5000 by 20% for 1 year.", "\\times0.8", "4000", 2, "5000 × 0.8 = 4000.", money("4000")),
  ...
  independentPractice: [
    ans("y9-cid-i1", "$2000 at 5% compounded for 2 years. Find the amount.", "\\times1.05^2", "2205", 3, "2000 × 1.05² = 2205.", money("2205")),
    ans("y9-cid-i2", "Depreciate $10 000 by 10% per year for 2 years.", "\\times0.9^2", "8100", 3, "10000 × 0.9² = 8100.", money("8100")),
    ans("y9-cid-i3", "$500 at 10% compounded for 3 years. Find the amount.", "\\times1.1^3", "665.50", 4, "500 × 1.1³ = 665.50.", money("665.50")),
    ans("y9-cid-i4", "Depreciate $8000 by 25% for 1 year.", "\\times0.75", "6000", 2, "8000 × 0.75 = 6000.", money("6000")),
  ...
  masteryQuiz: [
    ans("y9-cid-m1", "$1000 at 10% compounded for 2 years.", "\\times1.1^2", "1210", 3, "1210.", money("1210")),
    ans("y9-cid-m2", "$4000 at 5% compounded for 1 year.", "\\times1.05", "4200", 2, "4200.", money("4200")),
    ans("y9-cid-m3", "Depreciate $30 000 by 20% for 1 year.", "\\times0.8", "24000", 2, "24000.", money("24000")),
    ans("y9-cid-m4", "$1000 at 20% compounded for 2 years.", "\\times1.2^2", "1440", 3, "1000 × 1.44 = 1440.", money("1440")),
    ...
    ans("y9-cid-m6", "$2000 at 10% compounded for 2 years.", "\\times1.1^2", "2420", 3, "2000 × 1.21 = 2420.", money("2420")),
    ans("y9-cid-m7", "Depreciate $1000 by 10% per year for 2 years.", "\\times0.9^2", "810", 3, "1000 × 0.81 = 810.", money("810")),
    ans("y9-cid-m8", "$5000 at 4% compounded for 1 year.", "\\times1.04", "5200", 2, "5200.", money("5200")),
    ans("y9-cid-m9", "$1000 at 100% compounded for 2 years.", "\\times2^2", "4000", 3, "1000 × 2² = 4000.", money("4000")),
    ans("y9-cid-m10", "Depreciate $2000 by 50% for 1 year.", "\\times0.5", "1000", 2, "1000.", money("1000")),
  ],
  masteryQuizPool: [
    ans("y9-cid-p1", "$1000 at 10% compounded for 3 years.", "\\times1.1^3", "1331", 5, "1000 × 1.331 = 1331.", money("1331")),
    ans("y9-cid-p2", "Depreciate $25 000 by 20% per year for 3 years.", "\\times0.8^3", "12800", 5, "25000 × 0.512 = 12800.", money("12800")),
    ans("y9-cid-p3", "$3000 at 6% compounded for 2 years.", "\\times1.06^2", "3370.80", 5, "3000 × 1.1236 = 3370.80.", money("3370.80")),
    ans("y9-cid-p4", "Compound interest EARNED on $2000 at 5% over 2 years (interest only).", "A-P", "205", 5, "A = 2205; interest = 205.", money("205")),
    ans("y9-cid-p5", "$10 000 at 8% compounded for 3 years.", "\\times1.08^3", "12597.12", 5, "10000 × 1.259712 = 12597.12.", money("12597.12")),
    ans("y9-cid-p6", "A $40 000 machine depreciates 25%/yr. Value after 2 years?", "\\times0.75^2", "22500", 5, "40000 × 0.5625 = 22500.", money("22500")),
    ...
    ans("y9-cid-p8", "$5000 at 4% compounded for 2 years.", "\\times1.04^2", "5408", 5, "5000 × 1.0816 = 5408.", money("5408")),
    ans("y9-cid-p9", "Depreciate $12 000 by 10%/yr for 3 years.", "\\times0.9^3", "8748", 5, "12000 × 0.729 = 8748.", money("8748")),
    ans("y9-cid-p10", "$800 at 25% compounded for 2 years.", "\\times1.25^2", "1250", 5, "800 × 1.5625 = 1250.", money("1250")),
  ],
  commonMistakes: [
