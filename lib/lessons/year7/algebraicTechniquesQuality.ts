...
const masteryByLesson: Record<string, PracticeQuestion[]> = {
  ...
  "collecting-like-terms": [
    ...
    mcq("y7-alg-like-m7", "Which expression simplifies to zero for every value of $x$?", "\\text{identify complete cancellation}", "D", ["$4x-3x$", "$2x+2$", "$5x-5$", "$7x-3x-4x$"], "For an expression to be zero for every x, both its x-coefficient and constant term must cancel.", "In D, 7x - 3x - 4x = (7 - 3 - 4)x = 0x = 0 for every value of x.", 4),
