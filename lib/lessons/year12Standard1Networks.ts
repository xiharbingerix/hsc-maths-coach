...
export function year12Standard1NetworksIntroductionLessonOverride(
  ...
  return {
    ...
    independentPractice: [
      ...
      ans("nint-i4", "A network has 9 edges. What do all of its vertex degrees add to?", "2 \\times 9", "18", 3,
    ...
    masteryQuiz: [
      ...
      ans("nint-m4", "A network has 8 edges. What do all of its vertex degrees add to?", "2 \\times 8", "16", 3,
      ...
      ans("nint-m6", "A network's vertices have degrees 2, 3, 3 and 4. How many edges does it have?", "\\frac{2 + 3 + 3 + 4}{2}", "6", 3,
      ...
      ans("nint-m9", "A network has 5 vertices whose degrees add to 14. How many edges does it have?", "\\frac{14}{2}", "7", 4,
        "Edges = sum of degrees ÷ 2.", "Edges = 14 ÷ 2 = 7 (the number of vertices is not needed)."),
      ans("nint-m10", "The degrees of all vertices in any network always equal how many times the number of edges?", "2 \\times \\text{edges}", "2", 4,
...
export function year12Standard1NetworksTravellingLessonOverride(
  ...
  return {
    ...
    masteryQuiz: [
      ...
      ans("ntrav-m3", "A route lists 5 vertices with no repeats. How many edges does this path use?", "5 - 1", "4", 3,
      ...
      ans("ntrav-m6", "A circuit returns to its start after visiting 4 different vertices. How many edges does it use?", "\\text{4 edges to return}", "4", 4,
      ...
      ans("ntrav-m10", "A delivery van leaves the depot, visits 6 other stops without repeating any, and returns to the depot. How many edges (legs) does its circuit use?", "7 \\text{ stops, return}", "7", 4,
...
export function year12Standard1NetworksDrawingLessonOverride(
  ...
  return {
    ...
    independentPractice: [
      ...
      ans("ndraw-i5", "In the situation in i4, how many vertices does the network have?", "6 + 1", "7", 3,
    ...
    masteryQuiz: [
      ...
      ans("ndraw-m4", "Five towns are all directly connected to each other (every pair has a road). How many edges is that?", "\\frac{5 \\times 4}{2}", "10", 4,
      ...
      ans("ndraw-m6", "Three friends who all know each other are drawn as a network. How many edges?", "\\frac{3 \\times 2}{2}", "3", 3,
      ...
      ans("ndraw-m9", "Ten houses are each connected only to the two houses next to them in a straight street (the first and last have one neighbour). How many edges?", "10 - 1", "9", 4,
...
export function year12Standard1NetworksProblemsLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("nprob-g2", "Using the town network, find the total distance of the route A–C–E (in km).", "4 + 7", "11", 2,
        "Add the edge weights A–C and C–E.", "A–C is 4 km and C–E is 7 km, so the route is 4 + 7 = 11 km.",
        ["11 km"], { diagram: netW }),
      ans("nprob-g3", "Using the town network, find the total distance of the route A–B–D (in km).", "6 + 5", "11", 2,
    ...
    independentPractice: [
      ans("nprob-i1", "Using the town network, find the total distance of A–B–D–E (in km).", "6 + 5 + 3", "14", 3,
      ...
      ans("nprob-i3", "Using the town network, find the total distance of the route B–C–E (in km).", "2 + 7", "9", 3,
      ...
      ans("nprob-i4", "Using the town network, how many different towns can be reached directly from B (B's degree)?", "\\text{count B's edges}", "3", 3,
        ...
        [], { diagram: netW }),
      ans("nprob-i5", "Using the town network, find the total distance of A–C–B–D (in km).", "4 + 2 + 5", "11", 3,
    ...
    masteryQuiz: [
      ...
      ans("nprob-m3", "Using the town network, find the total distance of A–B–C–E (in km).", "6 + 2 + 7", "15", 3,
        "Add A–B, B–C and C–E.", "6 + 2 + 7 = 15 km.",
        ["15 km"], { diagram: netW }),
      ans("nprob-m4", "From B to E, compare B–C–E (9 km) with B–D–E (5 + 3). Give the distance of the shorter route (in km).", "5 + 3", "8", 4,
      ...
      ans("nprob-m6", "Using the town network, find the total distance of A–C–B (in km).", "4 + 2", "6", 3,
        "Add A–C and C–B.", "4 + 2 = 6 km.",
        ["6 km"], { diagram: netW }),
      ans("nprob-m7", "A delivery from A to E must avoid town C (it is closed). Find the distance of the route A–B–D–E (in km).", "6 + 5 + 3", "14", 4,
      ...
      ans("nprob-m9", "Using the town network, find the total distance of the circuit A–B–C–A (in km).", "6 + 2 + 4", "12", 4,
        "Add A–B, B–C and C–A.", "A–B 6 + B–C 2 + C–A 4 = 12 km for the circuit back to A.",
        ["12 km"], { diagram: netW }),
      ans("nprob-m10", "From A to E, the routes are A–C–E (11 km), A–B–D–E (14 km) and A–C–B–D–E (4+2+5+3). Give the distance of the longest of these three (in km).", "4 + 2 + 5 + 3", "14", 4,
...
export function year12Standard1NetworksMSTLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("nmst-g2", "How many edges does a spanning tree of 5 vertices have?", "5 - 1", "4", 2,
    ...
    independentPractice: [
      ans("nmst-i1", "Using the town network, find the total weight of the minimal spanning tree (in km).", "2 + 3 + 4 + 5", "14", 3,
      ...
      ans("nmst-i3", "A spanning tree of 8 vertices has how many edges?", "8 - 1", "7", 3,
        "n − 1 edges.", "8 − 1 = 7 edges."),
      ans("nmst-i4", "Using the town network, how many edges are in its minimal spanning tree?", "5 - 1", "4", 3,
        "5 vertices → 4 edges.", "The network has 5 towns, so its spanning tree has 5 − 1 = 4 edges.",
        [], { diagram: netW }),
      ans("nmst-i5", "Using the town network, the MST uses B–C, D–E, A–C and B–D. Which weight-6 and weight-7 edges are left OUT? Give the count of left-out edges.", "6 - 4", "2", 3,
        "Total edges minus MST edges.", "The network has 6 edges and the MST uses 4, so 2 edges are left out (A–B at 6 and C–E at 7).",
        [], { diagram: netW }),
    ],
    masteryQuiz: [
      ans("nmst-m1", "How many edges are in a spanning tree of 6 vertices?", "6 - 1", "5", 2,
      ...
      ans("nmst-m3", "Using the town network, give the total weight of its minimal spanning tree (in km).", "2 + 3 + 4 + 5", "14", 3,
      ...
      ans("nmst-m6", "A spanning tree of 10 vertices has how many edges?", "10 - 1", "9", 3,
        "n − 1.", "10 − 1 = 9 edges."),
      ...
      ans("nmst-m9", "A minimal spanning tree connects 7 sites. Its edges weigh 3, 4, 4, 5, 6 and 8. Find its total weight.", "3 + 4 + 4 + 5 + 6 + 8", "30", 4,
        "A 7-site tree has 6 edges; add their weights.", "7 − 1 = 6 edges (matches the list); total = 3 + 4 + 4 + 5 + 6 + 8 = 30."),
      ans("nmst-m10", "Using the town network, the MST weight is 14 km. The direct route A–B alone is 6 km. By how much more than that single road is the whole MST (in km)?", "14 - 6", "8", 4,
...
export function year12Standard1NetworksShortestPathLessonOverride(
  ...
  return {
    ...
    guidedPractice: [
      ...
      ans("nsp-g2", "Using the town network, find the total distance of A–C–E (in km).", "4 + 7", "11", 2,
        "Add A–C and C–E.", "4 + 7 = 11 km.",
        ["11 km"], { diagram: netW }),
      ans("nsp-g3", "Using the town network, find the total distance of A–B–D–E (in km).", "6 + 5 + 3", "14", 2,
        "Add A–B, B–D and D–E.", "6 + 5 + 3 = 14 km.",
        ["14 km"], { diagram: netW }),
      ans("nsp-g4", "Comparing A–C–E (11 km) and A–B–D–E (14 km) from A to E, give the shortest distance (in km).", "\\min(11, 14)", "11", 2,
        "Pick the smaller total.", "11 km (via A–C–E) is shorter than 14 km, so the shortest distance is 11 km.",
        ["11 km"], { diagram: netW }),
    ],
    independentPractice: [
      ans("nsp-i1", "Using the town network, find the shortest distance from B to E (in km).", "\\min(2+7,\\ 5+3)", "8", 3,
      ...
      ans("nsp-i3", "Using the town network, find the shortest distance from A to D (in km).", "\\min(6+5,\\ 4+2+5)", "11", 3,
        "Compare A–B–D and A–C–B–D.", "A–B–D = 11 km and A–C–B–D = 4 + 2 + 5 = 11 km, so the shortest distance is 11 km.",
        ["11 km"], { diagram: netW }),
      ans("nsp-i4", "Using the town network, find the total distance of A–C–B–D–E (in km).", "4 + 2 + 5 + 3", "14", 3,
    ...
    masteryQuiz: [
      ans("nsp-m1", "Using the town network, find the shortest distance from A to E (in km).", "\\min(11, 14)", "11", 3,
      ...
      ans("nsp-m3", "Using the town network, find the shortest distance from B to E (in km).", "\\min(9, 8)", "8", 3,
        "Compare B–C–E (9) and B–D–E (8).", "B–D–E = 8 km is shorter than B–C–E = 9 km, so the shortest distance is 8 km.",
        ["8 km"], { diagram: netW }),
      ans("nsp-m4", "Using the town network, find the total distance of A–B–C–E (in km).", "6 + 2 + 7", "15", 3,
      ...
      ans("nsp-m6", "Using the town network, find the shortest distance from A to D (in km).", "\\min(11, 11)", "11", 3,
        "Compare A–B–D and A–C–B–D.", "Both A–B–D and A–C–B–D total 11 km, so the shortest distance is 11 km.",
        ["11 km"], { diagram: netW }),
      ans("nsp-m7", "Town C is closed, so its roads cannot be used. Using the town network, find the shortest distance from A to E avoiding C (in km).", "6 + 5 + 3", "14", 4,
      ...
      ans("nsp-m9", "Using the town network, by how many km is the shortest A-to-E route shorter than A–B–D–E (in km)?", "14 - 11", "3", 4,
        "Subtract the shortest from the A–B–D–E total.", "Shortest A–C–E = 11 km; A–B–D–E = 14 km; difference = 14 − 11 = 3 km.",
        ["3 km"], { diagram: netW }),
      ans("nsp-m10", "From A to E, the routes are A–C–E (11), A–B–D–E (14) and A–B–C–E (15). Give the shortest distance (in km).", "\\min(11, 14, 15)", "11", 4,
