...
export const stationaryPointClassificationLesson = applicationLesson(
  ...
  [
    ...
    appNumber("appdiff-stat-m3", "Find the stationary x-value.", "f'(x)=3x+12", "-4"),
    ...
    appNumber("appdiff-stat-m8", "Find the stationary x-value.", "f'(x)=x^2-9\\quad \\text{use the positive solution}", "3"),
...
export const optimisationLesson = applicationLesson(
  ...
  [
    appNumber("appdiff-opt-i1", "Find the x-value that maximises the function.", "R(x)=40x-2x^2", "10"),
    appNumber("appdiff-opt-i2", "Find the x-value that minimises the function.", "C(x)=x^2-6x+20", "3"),
    ...
    appNumber("appdiff-opt-i5", "Find the maximum value.", "R(x)=12x-x^2", "36"),
  ],
  [
...
export const kinematicsRatesChangeLesson = applicationLesson(
  ...
  [
    appNumber("appdiff-kin-m1", "Find v(1).", "s(t)=t^2+5t", "7"),
    appNumber("appdiff-kin-m2", "Find a(2).", "s(t)=t^3", "12"),
    appNumber("appdiff-kin-m3", "Find when the particle is at rest.", "v(t)=5t-20", "4"),
    ...
    appNumber("appdiff-kin-m5", "Find the displacement over the interval.", "s(1)=4,\\quad s(5)=19", "15"),
    ...
    appNumber("appdiff-kin-m7", "Find the speed when v(2) = -9.", "v(2)=-9", "9"),
...
export const applicationsDifferentiationExamPracticeLesson = applicationLesson(
  ...
  [
    ...
    appChoice("appdiff-exam-m8", "Which conclusion follows from f'(2)=0 and f''(2)=0?", "\\text{Select A, B, C, or D.}", "C", ["Local maximum", "Local minimum", "No stationary point", "More testing is required"], "The second derivative test is inconclusive."),
