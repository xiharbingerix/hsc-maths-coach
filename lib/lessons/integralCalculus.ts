  ...
  masteryQuiz: [
    {
      ...
      latex: "f'(x)=8x",
      answer: "4x^2+C",
      acceptedAnswers: ["f(x)=4x^2+C", "4x^2 + C"],
    ...
    },
    {
      ...
      answer: "x^2+4",
      acceptedAnswers: ["f(x)=x^2+4", "x^2 + 4"],
    ...
    },
    {
      ...
      answer: "3x^2-2x+2",
      acceptedAnswers: ["y=3x^2-2x+2", "3x^2 - 2x + 2"],
    ...
    },
    {
      ...
      answer: "2t^2+t+6",
      acceptedAnswers: ["Q(t)=2t^2+t+6", "2t^2 + t + 6"],
      hint: "Integrate $4t+1$.",
      explanation:
...
export const mixedIntegralCalculusExamPracticeLesson: ExplicitLesson = {
  ...
  masteryQuiz: [
    ...
    },
    {
      ...
      answer: "2x^2-3x+5",
      acceptedAnswers: ["f(x)=2x^2-3x+5", "2x^2 - 3x + 5"],
