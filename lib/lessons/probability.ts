...
export const probabilityBasicsVennDiagramsLesson = probLesson(
  ...
  [
    probNumeric("prob-basic-g1", "P(A) = 3/8. Find P(Ā).", "P(\\bar{A})=1-\\tfrac{3}{8}", "5/8", ["0.625"], "P(Ā) = 1 − 3/8 = 5/8."),
    probNumeric("prob-basic-g2", "A bag has 4 red, 3 blue, 3 green. Find P(not red).", "P(\\text{not red})=\\frac{6}{10}", "3/5", ["0.6", "6/10"], "Not red means blue or green: 6 out of 10, so P = 6/10 = 3/5."),
    probNumeric("prob-basic-g3", "P(A) = 0.4, P(B) = 0.35, P(A∩B) = 0.15. Find P(A∪B).", "P(A\\cup B)=0.4+0.35-0.15", "0.6", [], "P(A∪B) = 0.4 + 0.35 − 0.15 = 0.60."),
  ...
  [
    probNumeric("prob-basic-i1", "P(A) = 0.72. Find P(Ā).", "P(\\bar{A})=1-0.72", "0.28", [], "P(Ā) = 1 − 0.72 = 0.28."),
    probNumeric("prob-basic-i2", "A deck of 52 cards. Find P(queen or heart).", "P(Q\\cup H)=\\frac{4}{52}+\\frac{13}{52}-\\frac{1}{52}", "4/13", ["0.3077", "16/52", "0.308"], "4 queens + 13 hearts − 1 queen of hearts = 16 cards. P = 16/52 = 4/13."),
    probNumeric("prob-basic-i3", "P(A) = 0.5, P(B) = 0.4, P(A∩B) = 0.2. Find P(A∪B).", "P(A\\cup B)=0.5+0.4-0.2", "0.7", [], "P(A∪B) = 0.5 + 0.4 − 0.2 = 0.70."),
    probNumeric("prob-basic-i4", "P(A∪B) = 0.75, P(A) = 0.5, P(B) = 0.4. Find P(A∩B).", "P(A\\cap B)=0.5+0.4-0.75", "0.15", [], "Rearrange: P(A∩B) = 0.5 + 0.4 − 0.75 = 0.15."),
  ...
  [
    probNumeric("prob-basic-m1", "P(A) = 0.65. Find P(Ā).", "P(\\bar{A})=1-0.65", "0.35", [], "P(Ā) = 1 − 0.65 = 0.35."),
    probNumeric("prob-basic-m2", "P(A) = 0.4, P(B) = 0.3, P(A∩B) = 0.12. Find P(A∪B).", "P(A\\cup B)=0.4+0.3-0.12", "0.58", [], "P(A∪B) = 0.4 + 0.3 − 0.12 = 0.58."),
    probNumeric("prob-basic-m3", "Venn: n(A only) = 5, n(B only) = 3, n(A∩B) = 2, n(neither) = 4. Find P(A∪B).", "P(A\\cup B)=\\frac{5+3+2}{14}", "5/7", ["0.714", "10/14", "0.7143"], "n(A∪B) = 5 + 3 + 2 = 10. Total = 14. P = 10/14 = 5/7."),
    probChoice("prob-basic-m4", "P(Ā) = 0.3. What is P(A)?", "C", ["0.3", "0.6", "0.7", "Cannot determine"], "P(A) = 1 − P(Ā) = 1 − 0.3 = 0.7."),
    probNumeric("prob-basic-m5", "P(A∪B) = 0.6, P(A∩B) = 0.1, P(B) = 0.25. Find P(A).", "P(A)=P(A\\cup B)-P(B)+P(A\\cap B)", "0.45", [], "Rearrange addition rule: P(A) = 0.6 − 0.25 + 0.1 = 0.45."),
    probNumeric("prob-basic-m6", "30 students: 18 play sport, 12 play music, 5 play both. Find P(sport or music).", "P=\\frac{18+12-5}{30}", "5/6", ["0.8333", "25/30", "0.833"], "P = (18 + 12 − 5)/30 = 25/30 = 5/6."),
...
export const conditionalProbabilityTreeDiagramsLesson = probLesson(
  ...
  [
    probNumeric("prob-cond-g1", "P(A) = 0.6, P(B|A) = 0.4. Find P(A∩B).", "P(A\\cap B)=P(A)\\times P(B\\mid A)=0.6\\times0.4", "0.24", [], "P(A∩B) = 0.6 × 0.4 = 0.24."),
    probNumeric("prob-cond-g2", "P(A) = 0.5, P(B|A) = 0.6, P(B|Ā) = 0.3. Find P(B).", "P(B)=0.5\\times0.6+0.5\\times0.3", "0.45", [], "P(B) = 0.5 × 0.6 + 0.5 × 0.3 = 0.30 + 0.15 = 0.45."),
    probNumeric("prob-cond-g3", "P(A∩B) = 0.3, P(B) = 0.5. Find P(A|B).", "P(A\\mid B)=\\frac{0.3}{0.5}", "0.6", [], "P(A|B) = 0.3 / 0.5 = 0.6."),
  ...
  [
    probNumeric("prob-cond-i1", "P(A) = 0.3, P(B|A) = 0.5. Find P(A∩B).", "P(A\\cap B)=0.3\\times0.5", "0.15", [], "P(A∩B) = 0.3 × 0.5 = 0.15."),
    probNumeric("prob-cond-i2", "P(A) = 0.3, P(B|A) = 0.5, P(B|Ā) = 0.2. Find P(B).", "P(B)=0.3\\times0.5+0.7\\times0.2", "0.29", [], "P(B) = 0.15 + 0.14 = 0.29."),
    probNumeric("prob-cond-i3", "P(A∩B) = 0.18, P(A) = 0.6. Find P(B|A).", "P(B\\mid A)=\\frac{0.18}{0.6}", "0.3", [], "P(B|A) = 0.18 / 0.6 = 0.30."),
    probNumeric("prob-cond-i4", "Bag: 4 red, 6 blue. Two drawn without replacement. Find P(both red).", "P=\\frac{4}{10}\\times\\frac{3}{9}", "2/15", ["0.1333", "12/90", "0.133"], "P = 4/10 × 3/9 = 12/90 = 2/15."),
  ...
  [
    probNumeric("prob-cond-m1", "P(A) = 0.4, P(B|A) = 0.6. Find P(A∩B).", "P(A\\cap B)=0.4\\times0.6", "0.24", [], "P(A∩B) = 0.4 × 0.6 = 0.24."),
    probNumeric("prob-cond-m2", "P(A) = 0.4, P(B|A) = 0.6, P(B|Ā) = 0.25. Find P(B).", "P(B)=0.4\\times0.6+0.6\\times0.25", "0.39", [], "P(B) = 0.24 + 0.15 = 0.39."),
    ...
    probNumeric("prob-cond-m4", "P(A∩B) = 0.24, P(B) = 0.8. Find P(A|B).", "P(A\\mid B)=\\frac{0.24}{0.8}", "0.3", [], "P(A|B) = 0.24 / 0.8 = 0.30."),
    probNumeric("prob-cond-m5", "P(A∩B) = 0.2, P(A) = 0.4. Find P(B|A).", "P(B\\mid A)=\\frac{0.2}{0.4}", "0.5", [], "P(B|A) = 0.2 / 0.4 = 0.50."),
    probNumeric("prob-cond-m6", "Urn: 3 red, 5 blue. Two drawn without replacement. Find P(2nd blue | 1st red).", "P(B_2\\mid R_1)=\\frac{5}{7}", "5/7", ["0.714", "0.7143"], "After removing 1 red: 5 blue remain out of 7 total. P = 5/7."),
    ...
    probNumeric("prob-cond-m8", "P(A) = 0.55, P(B|A) = 0.4, P(B|Ā) = 0.2. Find P(A∩B).", "P(A\\cap B)=0.55\\times0.4", "0.22", [], "P(A∩B) = 0.55 × 0.4 = 0.22."),
    probNumeric("prob-cond-m9", "P(A) = 0.55, P(B|A) = 0.4, P(B|Ā) = 0.2. Find P(B).", "P(B)=0.55\\times0.4+0.45\\times0.2", "0.31", [], "P(B) = 0.22 + 0.09 = 0.31."),
    probNumeric("prob-cond-m10", "P(A|B) = 0.5, P(B) = 0.6. Find P(A∩B).", "P(A\\cap B)=P(A\\mid B)\\times P(B)=0.5\\times0.6", "0.3", [], "Rearrange: P(A∩B) = P(A|B) × P(B) = 0.5 × 0.6 = 0.30."),
  ]
);
...
export const independenceMultiplicationRuleLesson = probLesson(
  ...
  [
    probNumeric("prob-indep-g1", "P(A) = 0.4, P(B) = 0.5. A and B are independent. Find P(A∩B).", "P(A\\cap B)=0.4\\times0.5", "0.2", [], "P(A∩B) = 0.4 × 0.5 = 0.20."),
  ...
  [
    probNumeric("prob-indep-i1", "P(A) = 0.7, P(B) = 0.6. A and B are independent. Find P(A∩B).", "P(A\\cap B)=0.7\\times0.6", "0.42", [], "P(A∩B) = 0.7 × 0.6 = 0.42."),
    ...
    probNumeric("prob-indep-i4", "A fair die is rolled twice independently. Find P(both show 4).", "P=\\frac{1}{6}\\times\\frac{1}{6}", "1/36", ["0.0278", "0.028"], "P(4 and 4) = 1/6 × 1/6 = 1/36."),
  ...
  [
    probNumeric("prob-indep-m1", "P(A) = 0.6, P(B) = 0.4. A and B are independent. Find P(A∩B).", "P(A\\cap B)=0.6\\times0.4", "0.24", [], "P(A∩B) = 0.6 × 0.4 = 0.24."),
    ...
    probNumeric("prob-indep-m5", "A biased coin has P(H) = 0.6. It is flipped twice independently. Find P(HH).", "P(HH)=0.6\\times0.6", "0.36", [], "P(HH) = 0.6 × 0.6 = 0.36."),
    probNumeric("prob-indep-m6", "P(A) = 0.5, P(B) = 0.7. A and B are independent. Find P(A∪B).", "P(A\\cup B)=0.5+0.7-0.5\\times0.7", "0.85", [], "P(A∪B) = 0.5 + 0.7 − 0.35 = 0.85."),
...
export const probabilityExamPracticeLesson = probLesson(
  ...
  [
    ...
    probNumeric("prob-exam-g2", "P(A) = 0.5, P(B) = 0.6, and A and B are independent. Find P(A∪B).", "P(A\\cup B)=0.5+0.6-0.5\\times0.6", "0.8", [], "P(A∪B) = 0.5 + 0.6 − 0.30 = 0.80."),
    probNumeric("prob-exam-g3", "P(A) = 0.4, P(B|A) = 0.3, P(B|Ā) = 0.1. Find P(A|B).", "P(A\\cap B)=0.12,\\;P(B)=0.12+0.06=0.18,\\;P(A\\mid B)=\\frac{0.12}{0.18}", "2/3", ["0.6667", "0.667"], "P(A∩B) = 0.12, P(Ā∩B) = 0.6×0.1 = 0.06, P(B) = 0.18. P(A|B) = 0.12/0.18 = 2/3."),
  ...
  [
    probNumeric("prob-exam-i1", "Table: n(A∩B) = 15, n(B) = 50. Find P(A|B).", "P(A\\mid B)=\\frac{15}{50}", "3/10", ["0.3", "0.30"], "P(A|B) = 15/50 = 3/10."),
    probNumeric("prob-exam-i2", "P(A) = 0.3, P(B) = 0.5. Independent. Find P(A∪B).", "P(A\\cup B)=0.3+0.5-0.15", "0.65", [], "P(A∪B) = 0.3 + 0.5 − 0.15 = 0.65."),
    probNumeric("prob-exam-i3", "P(A) = 0.5, P(B|A) = 0.4, P(B|Ā) = 0.1. Find P(A∩B).", "P(A\\cap B)=0.5\\times0.4", "0.2", [], "P(A∩B) = P(A) × P(B|A) = 0.5 × 0.4 = 0.20."),
    probNumeric("prob-exam-i4", "A coin is flipped 3 times independently. P(all heads).", "P(HHH)=\\left(\\tfrac{1}{2}\\right)^3", "1/8", ["0.125"], "P(HHH) = (1/2)³ = 1/8."),
  ...
  [
    probNumeric("prob-exam-m1", "P(A) = 0.55. Find P(Ā).", "P(\\bar{A})=1-0.55", "0.45", [], "P(Ā) = 1 − 0.55 = 0.45."),
    probNumeric("prob-exam-m2", "P(A) = 0.4, P(B) = 0.35, P(A∩B) = 0.15. Find P(A∪B).", "P(A\\cup B)=0.4+0.35-0.15", "0.6", [], "P(A∪B) = 0.4 + 0.35 − 0.15 = 0.60."),
    probNumeric("prob-exam-m3", "P(A∩B) = 0.2, P(B) = 0.5. Find P(A|B).", "P(A\\mid B)=\\frac{0.2}{0.5}", "0.4", [], "P(A|B) = 0.20 / 0.50 = 0.40."),
    ...
    probNumeric("prob-exam-m5", "P(A) = 0.6, P(B|A) = 0.5, P(B|Ā) = 0.2. Find P(B).", "P(B)=0.6\\times0.5+0.4\\times0.2", "0.38", [], "P(B) = 0.30 + 0.08 = 0.38."),
    probNumeric("prob-exam-m6", "A bag has 5 red, 5 blue. Two drawn with replacement. Find P(one of each colour).", "P=2\\times\\frac{5}{10}\\times\\frac{5}{10}", "1/2", ["0.5", "0.50"], "P(RB) + P(BR) = 2 × (1/2 × 1/2) = 1/2."),
