...
export const spreadIqrBoxPlotsOutliersLesson: ExplicitLesson = {
  ...
  masteryQuiz: [
    ...
    { id: "spread-mastery-4", prompt: "From the box plot shown, identify the lower quartile.", latex: "", answer: "8", hint: "The lower quartile is the left edge of the box.", explanation: "The box starts at 8, so Q1 = 8.", boxPlotDiagram: { description: "Box plot with whiskers from 3 to 25, a box from 8 to 18 and a median line at 12.", plots: [{ label: "Data", min: 3, q1: 8, median: 12, q3: 18, max: 25 }], showValueLabels: true } },
    { id: "spread-mastery-5", prompt: "From the box plot shown, identify the upper quartile.", latex: "", answer: "18", hint: "The upper quartile is the right edge of the box.", explanation: "The box ends at 18, so Q3 = 18.", boxPlotDiagram: { description: "Box plot with whiskers from 3 to 25, a box from 8 to 18 and a median line at 12.", plots: [{ label: "Data", min: 3, q1: 8, median: 12, q3: 18, max: 25 }], showValueLabels: true } },
    ...
    { id: "spread-mastery-8", prompt: "From the box plot shown, find the width of its box.", latex: "", answer: "8", hint: "The box runs from Q1 to Q3 — its width is the IQR.", explanation: "The box runs from 6 to 14, so its width is 14 minus 6, which is 8 — the IQR.", boxPlotDiagram: { description: "Box plot with whiskers from 2 to 20, a box from 6 to 14 and a median line at 10.", plots: [{ label: "Data", min: 2, q1: 6, median: 10, q3: 14, max: 20 }], showValueLabels: true } },
