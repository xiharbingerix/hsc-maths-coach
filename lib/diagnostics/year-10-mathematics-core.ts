...
export const diagnosticData: DiagnosticData = {
  ...
  // Remapped to the current Core pathway units. Diagnostic unit slugs are also
  // topic slugs for student_mastery, so these must match the course catalogue.
  units: [
    {
      slug: "quadratic-expressions-equations",
      title: "Quadratic Expressions and Equations",
      startHref: "/course/year-10-mathematics-core/quadratic-expressions-equations",
    },
    {
      slug: "algebra-equations-linear-relationships",
      title: "Algebra, Equations and Linear Relationships",
      startHref: "/course/year-10-mathematics-core/algebra-equations-linear-relationships",
    },
    {
    ...
    },
    {
      ...
      startHref: "/course/year-10-mathematics-core/geometrical-figures-circle-geometry",
    },
    {
      slug: "probability",
      title: "Probability",
    ...
    },
    {
      ...
      startHref: "/course/year-10-mathematics-core/single-variable-bivariate-statistics",
    },
    {
