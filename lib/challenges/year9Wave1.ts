...
export const gradientY9Challenge: PracticeQuestion[] = [
  ...
  { id: "chal-y9-gr-8", prompt: "Find the gradient of the vertical line x = 4.", latex: "x=4", answer: "not defined", acceptedAnswers: ["undefined", "no gradient"], hint: "What is the run?", explanation: "Run is 0, so the gradient is not defined." },
