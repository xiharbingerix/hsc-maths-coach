...
// ── Subtopic 4: Further Calculus Exam Practice — D6 (exam-mastery synoptic) ───
// Multi-part Section II–style: each combines ≥2 of the topic's techniques
// (trig-integral identities, substitution, integration by parts) across linked
// stages.
const furtherCalcExamD6: TopicTestQuestion[] = [
  {
    id: "y12e1-fcalc-ex-d6-1",
    prompt: "Consider the curve y = x√(x² + 1).",
    latex: "y = x\\sqrt{x^2 + 1}",
    marks: 7,
    difficulty: 6,
    explanation: "Substitution u = x² + 1, then an area and a related integral.",
    parts: [
      { key: "a", label: "(a)", prompt: "Find ∫ x√(x² + 1) dx.", marks: 2,
        answer: "(1/3)(x^2+1)^(3/2) + C", acceptedAnswers: ["(x^2+1)^(3/2)/3 + C"],
        explanation: "u = x² + 1, du = 2x dx: (1/2)∫u^{1/2} du = (1/3)(x²+1)^{3/2} + C." },
      { key: "b", label: "(b)", prompt: "Find the exact area under the curve from x = 0 to x = √3.", marks: 3,
        answer: "7/3", acceptedAnswers: ["2.3333", "2.333"],
        explanation: "[(1/3)(x²+1)^{3/2}]₀^{√3} = (1/3)(4^{3/2} − 1) = (1/3)(8 − 1) = 7/3." },
      { key: "c", label: "(c)", prompt: "Evaluate ∫₀^{√3} x/√(x² + 1) dx.", marks: 2,
        answer: "1", explanation: "[√(x²+1)]₀^{√3} = √4 − √1 = 1." },
    ],
  },
  {
    id: "y12e1-fcalc-ex-d6-2",
    prompt: "Let I = ∫ x e^{x²} dx and J = ∫ x³ e^{x²} dx.",
    latex: "I = \\int x e^{x^2}\\, dx, \\quad J = \\int x^3 e^{x^2}\\, dx",
    marks: 7,
    difficulty: 6,
    explanation: "Substitution, then substitution combined with parts.",
    parts: [
      { key: "a", label: "(a)", prompt: "Find I.", marks: 2, answer: "(1/2)e^(x^2) + C",
        acceptedAnswers: ["e^(x^2)/2 + C"], explanation: "u = x²: I = (1/2)e^{x²} + C." },
      { key: "b", label: "(b)", prompt: "Find J.", marks: 4, answer: "(1/2)(x^2-1)e^(x^2) + C",
        acceptedAnswers: ["(x^2-1)e^(x^2)/2 + C"],
        explanation: "u = x²: J = (1/2)∫u e^u du = (1/2)(u − 1)e^u = (1/2)(x² − 1)e^{x²} + C." },
      { key: "c", label: "(c)", prompt: "Evaluate ∫₀¹ x e^{x²} dx.", marks: 1, answer: "(e-1)/2",
        acceptedAnswers: ["(1/2)(e-1)", "0.8591"], explanation: "[(1/2)e^{x²}]₀¹ = (e − 1)/2." },
    ],
  },
  {
    id: "y12e1-fcalc-ex-d6-3",
    prompt: "Evaluate the following definite integrals over [0, π/2].",
    latex: "\\text{over } [0, \\tfrac{\\pi}{2}]",
    marks: 6,
    difficulty: 6,
    explanation: "Half-angle identities across three related integrals.",
    parts: [
      { key: "a", label: "(a)", prompt: "Evaluate ∫₀^{π/2} sin²x dx.", marks: 2, answer: "pi/4",
        acceptedAnswers: ["π/4", "0.7854"], explanation: "(1 − cos 2x)/2 → [x/2 − sin2x/4]₀^{π/2} = π/4." },
      { key: "b", label: "(b)", prompt: "Evaluate ∫₀^{π/2} cos²x dx.", marks: 2, answer: "pi/4",
        acceptedAnswers: ["π/4", "0.7854"], explanation: "By the same method (or symmetry), π/4." },
      { key: "c", label: "(c)", prompt: "Evaluate ∫₀^{π/2} sin²x cos²x dx.", marks: 2, answer: "pi/16",
        acceptedAnswers: ["π/16", "0.19635"], explanation: "sin²x cos²x = (1 − cos4x)/8 → [x/8 − sin4x/32]₀^{π/2} = π/16." },
    ],
  },
  {
    id: "y12e1-fcalc-ex-d6-4",
    prompt: "Let I = ∫ x² cos x dx.",
    latex: "I = \\int x^2 \\cos x \\, dx",
    marks: 6,
    difficulty: 6,
    explanation: "Integration by parts twice, then two definite evaluations.",
    parts: [
      { key: "a", label: "(a)", prompt: "Find I.", marks: 3,
        answer: "x^2 sin(x) + 2x cos(x) - 2sin(x) + C",
        acceptedAnswers: ["x^2*sin(x)+2*x*cos(x)-2*sin(x)+C"],
        explanation: "Parts twice: I = x² sin x + 2x cos x − 2 sin x + C." },
      { key: "b", label: "(b)", prompt: "Evaluate ∫₀^{π} x² cos x dx.", marks: 2, answer: "-2pi",
        acceptedAnswers: ["−2π", "-6.2832"], explanation: "[…]₀^π = 2π·(−1) = −2π." },
      { key: "c", label: "(c)", prompt: "Evaluate ∫₀^{π/2} x² cos x dx.", marks: 1, answer: "pi^2/4 - 2",
        acceptedAnswers: ["π^2/4 - 2", "0.4674"], explanation: "[…]₀^{π/2} = π²/4 − 2." },
    ],
  },
  {
    id: "y12e1-fcalc-ex-d6-5",
    prompt: "Consider integrals of (2x + 1) against exponentials.",
    latex: "\\int (2x + 1) e^{kx} \\, dx",
    marks: 7,
    difficulty: 6,
    explanation: "Integration by parts with a linear factor, indefinite and definite.",
    parts: [
      { key: "a", label: "(a)", prompt: "Find ∫ (2x + 1)eˣ dx.", marks: 3, answer: "(2x-1)e^x + C",
        acceptedAnswers: ["(2x - 1)*e^x + C"],
        explanation: "Parts: (2x+1)eˣ − ∫2eˣ dx = (2x+1)eˣ − 2eˣ = (2x − 1)eˣ + C." },
      { key: "b", label: "(b)", prompt: "Evaluate ∫₀¹ (2x + 1)eˣ dx.", marks: 2, answer: "e+1",
        acceptedAnswers: ["e + 1", "3.7183"], explanation: "[(2x−1)eˣ]₀¹ = e − (−1) = e + 1." },
      { key: "c", label: "(c)", prompt: "Find ∫ (2x + 1)e^{2x} dx.", marks: 2, answer: "x e^(2x) + C",
        acceptedAnswers: ["x*e^(2x) + C"],
        explanation: "Parts with v = (1/2)e^{2x}: (2x+1)/2 e^{2x} − (1/2)e^{2x} = x e^{2x} + C." },
    ],
  },
  {
    id: "y12e1-fcalc-ex-d6-6",
    prompt: "Let I = ∫ eˣ sin x dx.",
    latex: "I = \\int e^x \\sin x \\, dx",
    marks: 6,
    difficulty: 6,
    explanation: "The cyclic integration-by-parts method, then a definite integral.",
    parts: [
      { key: "a", label: "(a)", prompt: "Find I.", marks: 2, answer: "(e^x/2)(sin(x) - cos(x)) + C",
        acceptedAnswers: ["e^x(sin(x)-cos(x))/2 + C"],
        explanation: "Parts twice → 2I = eˣ(sin x − cos x), so I = (eˣ/2)(sin x − cos x) + C." },
      { key: "b", label: "(b)", prompt: "Hence find ∫ eˣ cos x dx.", marks: 2, answer: "(e^x/2)(sin(x) + cos(x)) + C",
        acceptedAnswers: ["e^x(sin(x)+cos(x))/2 + C"],
        explanation: "The same method gives (eˣ/2)(sin x + cos x) + C." },
      { key: "c", label: "(c)", prompt: "Evaluate ∫₀^{π} eˣ sin x dx.", marks: 2, answer: "(e^pi+1)/2",
        acceptedAnswers: ["(e^π + 1)/2", "12.07"],
        explanation: "[(eˣ/2)(sin x − cos x)]₀^π = e^π/2 − (−1/2) = (e^π + 1)/2." },
    ],
  },
  {
    id: "y12e1-fcalc-ex-d6-7",
    prompt: "Consider integrals of powers of sine and cosine over [0, π/2].",
    latex: "\\int_0^{\\pi/2} \\sin^m x \\cos^n x \\, dx",
    marks: 6,
    difficulty: 6,
    explanation: "Substitution u = cos x with an odd power split.",
    parts: [
      { key: "a", label: "(a)", prompt: "Find ∫ sin x cos⁴x dx.", marks: 2, answer: "-(cos(x)^5)/5 + C",
        acceptedAnswers: ["-cos(x)^5/5 + C", "-(1/5)cos(x)^5 + C"],
        explanation: "u = cos x, du = −sin x dx: −∫u⁴ du = −(cos⁵x)/5 + C." },
      { key: "b", label: "(b)", prompt: "Hence evaluate ∫₀^{π/2} sin x cos⁴x dx.", marks: 2, answer: "1/5",
        acceptedAnswers: ["0.2"], explanation: "[−cos⁵x/5]₀^{π/2} = 0 − (−1/5) = 1/5." },
      { key: "c", label: "(c)", prompt: "Evaluate ∫₀^{π/2} sin³x cos²x dx.", marks: 2, answer: "2/15",
        acceptedAnswers: ["0.1333"],
        explanation: "sin³x = sin x(1 − cos²x); u = cos x gives ∫₀¹(u² − u⁴) du = 1/3 − 1/5 = 2/15." },
    ],
  },
  {
    id: "y12e1-fcalc-ex-d6-8",
    prompt: "Consider ∫ x sin²x dx.",
    latex: "\\int x \\sin^2 x \\, dx",
    marks: 6,
    difficulty: 6,
    explanation: "Apply a half-angle identity, then integrate by parts, then evaluate.",
    parts: [
      { key: "a", label: "(a)", prompt: "Write sin²x using a double-angle identity.", marks: 1,
        answer: "(1-cos(2x))/2", acceptedAnswers: ["(1 - cos(2x))/2", "1/2 - cos(2x)/2"],
        explanation: "sin²x = (1 − cos 2x)/2." },
      { key: "b", label: "(b)", prompt: "Hence find ∫ x sin²x dx.", marks: 3,
        answer: "x^2/4 - (x/4)sin(2x) - (1/8)cos(2x) + C",
        acceptedAnswers: ["x^2/4 - x sin(2x)/4 - cos(2x)/8 + C"],
        explanation: "∫x(1 − cos2x)/2 dx = x²/4 − (1/2)∫x cos2x dx = x²/4 − (x/4)sin2x − (1/8)cos2x + C." },
      { key: "c", label: "(c)", prompt: "Evaluate ∫₀^{π} x sin²x dx.", marks: 2, answer: "pi^2/4",
        acceptedAnswers: ["π^2/4", "2.4674"], explanation: "The sin2x/cos2x terms cancel at the limits, leaving [x²/4]₀^π = π²/4." },
    ],
  },
  {
    id: "y12e1-fcalc-ex-d6-9",
    prompt: "A function satisfies F'(x) = x eˣ and F(0) = 5.",
    latex: "F'(x) = x e^x, \\quad F(0) = 5",
    marks: 6,
    difficulty: 6,
    explanation: "Integrate by parts, apply the condition, then evaluate.",
    parts: [
      { key: "a", label: "(a)", prompt: "Find F(x) (include the constant).", marks: 2, answer: "(x-1)e^x + C",
        acceptedAnswers: ["x e^x - e^x + C"], explanation: "∫x eˣ dx = (x − 1)eˣ + C." },
      { key: "b", label: "(b)", prompt: "Find C.", marks: 2, answer: "6",
        explanation: "F(0) = (−1)(1) + C = 5, so C = 6." },
      { key: "c", label: "(c)", prompt: "Find F(1).", marks: 2, answer: "6",
        explanation: "F(1) = (0)e + 6 = 6." },
    ],
  },
  {
    id: "y12e1-fcalc-ex-d6-10",
    prompt: "Let I = ∫₀² 1/(x² + 4) dx and J = ∫₀² x/(x² + 4) dx.",
    latex: "I = \\int_0^2 \\tfrac{1}{x^2+4}\\,dx, \\quad J = \\int_0^2 \\tfrac{x}{x^2+4}\\,dx",
    marks: 6,
    difficulty: 6,
    explanation: "A standard inverse-trig form and a substitution, then combine.",
    parts: [
      { key: "a", label: "(a)", prompt: "Find I.", marks: 2, answer: "pi/8",
        acceptedAnswers: ["π/8", "0.3927"], explanation: "(1/2)[tan⁻¹(x/2)]₀² = (1/2)(π/4) = π/8." },
      { key: "b", label: "(b)", prompt: "Find J.", marks: 3, answer: "(1/2)ln(2)",
        acceptedAnswers: ["ln(2)/2", "0.3466"],
        explanation: "u = x² + 4: (1/2)[ln(x² + 4)]₀² = (1/2)(ln 8 − ln 4) = (1/2)ln 2." },
      { key: "c", label: "(c)", prompt: "Hence evaluate ∫₀² (1 + x)/(x² + 4) dx.", marks: 1,
        answer: "pi/8 + (1/2)ln(2)", acceptedAnswers: ["π/8 + ln(2)/2", "0.7393"],
        explanation: "The integral is I + J = π/8 + (1/2)ln 2." },
    ],
  },
];
