  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          id: "y12a-p1-q3",
          prompt:
            "A least-squares regression line is $y = 4x + 12$. When $x = 6$, the actual value is 39. Find the residual.",
          latex: "y = 4x + 12",
          marks: 2,
          difficulty: 4,
          topicSlug: "statistical-analysis",
          topicTitle: "Least-squares regression and residuals",
          remediationHref: REMEDIATION,
          answer: "3",
          acceptedAnswers: ["+3"],
          explanation:
            "The predicted value is $4(6) + 12 = 36$. Residual = actual - predicted = $39 - 36 = 3$.",
        },
        {
          id: "y12a-p1-q4",
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          transfer: true,
          topicSlug: "calculus-applications",
          topicTitle: "Rates of change with exponential growth",
          remediationHref: REMEDIATION,
          explanation:
        ...
        },
        {
          ...
          latex: "\\begin{array}{c|ccc}x&0&1&2\\\\P(X=x)&0.2&0.5&0.3\\end{array}",
          marks: 3,
          difficulty: 4,
          topicSlug: "statistical-analysis",
          ...
          remediationHref: REMEDIATION,
          explanation:
            "The probabilities add to 1. The expected value is E(X) = 0(0.2) + 1(0.5) + 2(0.3) = 1.1.",
          parts: [
            {
              key: "a",
              label: "(a)",
              ...
              marks: 1,
              answer: "0.3",
              explanation: "Read the probability in the column where x = 2.",
            },
            {
              key: "b",
              label: "(b)",
